...
{english: data[49].english, arabic: 'برج ميشيل في هامبورغ هو المعلم البارز للمدينة. Fernsehturm برلين يبلغ ارتفاعه 368 متراً. الكلمة Turm مرتبطة بالكلمة الإنجليزية "tower".'},
...
{english: data[55].english, arabic: 'يقع حي HafenCity في هامبورغ على ضفة الإلبه. "Am Ufer" (على الضفة) من أجمل العبارات في مفردات هامبورغ.'},
...
{english: data[75].english, arabic: '"Flugbegleiterin" (مرافقة الطيران، مؤنث) هي البديل الحديث لـ Stewardess. يعكس هذا التحول الجهود الألمانية المستمرة لتحديث الألقاب الوظيفية المرتبطة بالجنس.'},
