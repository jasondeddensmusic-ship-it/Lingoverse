...
,{id:"ruv2_u15l_b1_society", title:"Гражданство и убеждения", icon:"🗣", xp:20, board:true, steps:[

{type:"intro", title:"Civic Life and Abstract Thought",
 desc:"B1 vocabulary for discussing opinions, civic processes, and qualities of people and ideas. Essential for TRKI B1 spoken and written tasks.",
 goals:["Use verbs for discussion and persuasion","Describe qualities with свободный, равный, сильный, слабый","Discuss decisions and creation"]},

{type:"teach", trg:"обсуждать", src:"to discuss (imperfective)", pos:"verb", gender:null,
...
{type:"teach", trg:"убеждать", src:"to convince / persuade (imperfective)", pos:"verb", gender:null,
 ...
 example:"A: Он старается убеждать всех.\nB: Да, он говорит очень хорошо.",
 exampleSrc:"A: He tries to convince everyone.\nB: Yes, he speaks very well.",
 funFact:"Убеждать shares its root with беда (trouble/misfortune) via a Proto-Slavic root meaning 'to overcome.' To convince someone is to overcome their doubts."},

{type:"teach", trg:"решать", src:"to decide / solve (imperfective)", pos:"verb", gender:null,
...
{type:"teach", trg:"создавать", src:"to create (imperfective)", pos:"verb", gender:null,
 ...
 example:"A: Что они создают?\nB: Они создают новый план для работы.",
 exampleSrc:"A: What are they creating?\nB: They are creating a new plan for work.",
 funFact:"Создавать comes from Church Slavic. The prefix со- means 'together'; the root -зда- is related to здание (building). To create is to build something together from parts."},

{type:"teach", trg:"свободный", src:"free / independent", pos:"adj", gender:null,
...
{type:"teach", trg:"слабый", src:"weak / feeble", pos:"adj", gender:null,
 ...
 example:"A: Его план очень слабый.\nB: Да, надо думать лучше.",
 exampleSrc:"A: His plan is very weak.\nB: Yes, he needs to think better.",
...
{type:"match", pairs:[
  ...
  {trg:"поддерживать", src:"to support"},
  {trg:"отклонять", src:"to reject"},
  {trg:"убеждать", src:"to convince"},
  {trg:"создавать", src:"to create"}
]},

{type:"match", pairs:[
  {trg:"свободный", src:"free / independent"},
  {trg:"равный", src:"equal"},
  {trg:"сильный", src:"strong"},
  {trg:"слабый", src:"weak"},
  {trg:"решать", src:"to decide (imperfective)"}
]}
