...
,{type:"fb", s:"Я отправил сообщение {1}.",
 a:["друзьям"],
 opts:["друзьям","другу","подруге","другом"],
 hint:"Dative plural: sending to more than one friend.",
 sSrc:"I sent a message to (my) friends."},
