...
{type:"teach", trg:"жарко", src:"(it is) hot", pos:"adv", gender:null,
 ...
 example:"A: Тебе жарко?\nB: Нет, мне тепло.",
 exampleSrc:"A: Are you hot?\nB: No, I'm warm.",
...
{type:"mc", q:"The correct Russian way to say 'I'm cold' is:",
 opts:["Мне холодно","Я есть холодно","Мне есть холодно","Я холодный"],
 ans:"Мне холодно",
...
{type:"teach", trg:"зима", src:"winter", pos:"noun", gender:"f",
 ...
 example:"A: Зима холодная?\nB: Да, зимой холодно.",
 exampleSrc:"A: Is winter cold?\nB: Yes, in winter it's cold.",
...
{type:"teach", trg:"весна", src:"spring", pos:"noun", gender:"f",
 ...
 example:"A: Весной холодно?\nB: Нет, весной тепло.",
 exampleSrc:"A: Is it cold in spring?\nB: No, it's warm in spring.",
...
{type:"teach", trg:"лето", src:"summer", pos:"noun", gender:"n",
 ...
 example:"A: Летом жарко?\nB: Да, летом жарко.",
 exampleSrc:"A: Is it hot in summer?\nB: Yes, it's hot in summer.",
...
{type:"teach", trg:"осень", src:"autumn / fall", pos:"noun", gender:"f",
 ...
 example:"A: Осенью холодно?\nB: Да, осенью прохладно.",
 exampleSrc:"A: Is it cold in autumn?\nB: Yes, it's cool in autumn.",
...
{type:"teach", trg:"зимой", src:"in winter", pos:"adv", gender:null,
 ...
 example:"A: Зимой холодно?\nB: Да, зимой очень холодно.",
 exampleSrc:"A: Is it cold in winter?\nB: Yes, in winter it's very cold.",
...
{type:"mc", q:"How do you say 'It will be warm tomorrow'?",
 opts:["Завтра будет тепло","Завтра будем тепло","Завтра тепло","Завтра есть тепло"],
 ans:"Завтра будет тепло",
 hint:"Use будет (future of быть) + impersonal weather word."},

{type:"mc", q:"'+15°C' in Russian is:",
 opts:["Плюс пятнадцать","Плюс пятнадцать градусов","Пятнадцать плюс","Пятнадцать градусов плюс"],
