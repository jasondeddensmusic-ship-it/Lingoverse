...
{type:"mc", q:"What does 'тронуть' mean in an emotional context?",
 opts:["to move emotionally","to recollect a memory","to signify importance","to form gradually"],
...
{type:"mc", q:"Which suffix pattern creates 'незабываемый'?",
 opts:["вос- + noun + -ие","не- + verb root + -емый","без- + noun + -ный","по- + adj + -ый"],
...
{type:"mc", q:"Which word means a neutral party who helps resolve a dispute?",
 opts:["посредник","недоразумение","конфликт","компромисс"],
 ans:"посредник",
