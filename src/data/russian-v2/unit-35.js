...
{type:"teach", trg:"водить за нос", src:"to lead by the nose (deceive)", pos:"phrase", gender:null,
 ...
 example:"A: Он говорил правду?\nB: Нет, водил за нос.",
 exampleSrc:"A: Was he telling the truth?\nB: No, he was deceiving (leading by the nose).",
...
{type:"teach", trg:"убить двух зайцев", src:"kill two rabbits (with one stone)", pos:"phrase", gender:null,
 ...
 example:"A: Идёшь на работу и в магазин?\nB: Два зайца.",
 exampleSrc:"A: Going to work and to the store?\nB: Two rabbits.",
