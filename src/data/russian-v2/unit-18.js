...
{type:"mc", q:"'I see Anton', form of 'Антон'?",
 opts:["Антона","Антону","Антоном","Антон"],
 ans:"Антона",
...
{type:"mc", q:"'I'm going to school', школа in:",
 opts:["Accusative (школу)","Prepositional (школе)","Genitive (школы)","Nominative (школа)"],
 ans:"Accusative (школу)",
 hint:"Direction/motion toward = ___."},

{type:"mc", q:"'I'm at school', школа in:",
 opts:["Accusative","Prepositional","Dative","Nominative"],
 ans:"Prepositional",
 hint:"Location = ___."},
