...
{type:"mc", q:"50 rubles in Russian is:",
 opts:["Пятьдесят рублей","Пятьдесят рубли","Пятьдесят рубль","Пятьдесят рубля"],
...
{type:"fb", s:"A: Где {1} свежий хлеб?\nB: В пекарне возле метро.",
 a:["продают"],
 opts:["продают","продавал","продаёт","продам"],
...
{type:"mc", q:"'Do you like this shirt?' in Russian:",
 opts:["Тебе нравится эта рубашка?","Ты любишь эта рубашка?","Ты хочешь эта рубашка?","Ты нравишь эта рубашка?"],
...
{type:"mc", q:"Why is 'платье' neuter despite being a dress (a traditionally feminine item)?",
 opts:["It's a loanword","Grammatical category is based on ending","Russian has no gender","Dresses used to be worn by men"],
