...
{type:"mc", q:"Which verb means 'to study' (student sense)?",
 opts:["учиться","учёба","учитель","учить"],
 ans:"учиться",
...
{type:"mc", q:"Which is reflexive?",
 opts:["одеваться","идти","вставать","смотреть"],
 ans:"одеваться",
