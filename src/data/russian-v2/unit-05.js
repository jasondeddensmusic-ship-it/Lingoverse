...
{type:"fb", s:"A: Когда ты ложишься спать?\nB: Я всегда ложусь {1}.",
 ...
 hint:"The sentence 'I always go to bed ___' could mean early or late. Given the context of 'всегда' (always), something consistent.",
...
,{id:"ruv2_u5l_verb", title:"Повседневные глаголы", icon:"📝", xp:15, board:true, steps:[

{type:"intro", title:"Essential Daily Verbs",
 desc:"Learn 7 core Russian verbs for daily life: to see, to live, to sleep, to watch, to read, to write, to walk. These imperfective verbs are essential for TRKI A1 and cover the most common daily actions.",
 goals:["Master 7 core daily verbs","Use imperfective present tense forms","Talk about daily habits and routines"]},

{type:"teach", trg:"видеть", src:"to see", pos:"verb", gender:null,
...
{type:"teach", trg:"смотреть", src:"to watch / to look", pos:"verb", gender:null,
 ...
 example:"A: Ты смотришь телевизор?\nB: Да, я смотрю.",
 exampleSrc:"A: Are you watching TV?\nB: Yes, I'm watching.",
 funFact:"Смотреть can mean 'to watch' (a film, TV) or 'to look' at something. To say 'look at': смотреть НА + accusative: 'смотри на меня' (look at me). The same verb covers sight directed at a screen or an object."},
...
{type:"teach", trg:"писать", src:"to write", pos:"verb", gender:null,
 ...
 example:"A: Ты пишешь сейчас?\nB: Да, я пишу.",
 exampleSrc:"A: Are you writing right now?\nB: Yes, I'm writing.",
 funFact:"The с→ш change in писать→пишу is a consonant mutation rule in Russian. It appears in every present-tense form of this verb: all persons use the пиш- stem. Perfective: написать (to have written)."},

{type:"teach", trg:"ходить", src:"to go on foot (habitual)", pos:"verb", gender:null,
 note:"2nd conjugation. Present: хожу, ходишь, ходит.\nNote д→ж in 1st-person singular. For routine or multi-directional movement.",
 example:"A: Ты ходишь в школу?\nB: Да, я хожу каждый день.",
...
{type:"fb", s:"A: Где ты {1}?\nB: Я живу здесь.",
 a:["живёшь"],
 opts:["живёшь","живёт","живёте","жить"],
 hint:"The question uses 'ты' (you, singular). Match the conjugation: 2nd-person singular of жить.",
 sSrc:"A: Where do you {1}?\nB: I live here."},

{type:"fb", s:"A: Ты {1} книгу?\nB: Да, я читаю книгу.",
 a:["читаешь"],
 opts:["читаешь","читает","читаю","читать"],
 hint:"The question is addressed to 'ты' (you). Use the 2nd-person singular present form of читать.",
 sSrc:"A: Are you {1} a book?\nB: Yes, I'm reading a book."},

{type:"fb", s:"A: Ты {1} сейчас?\nB: Нет, я не сплю.",
 a:["спишь"],
 opts:["спишь","сплю","спят","спать"],
 hint:"The question uses 'ты.' Use the 2nd-person singular present of спать.",
 sSrc:"A: Are you {1} right now?\nB: No, I'm not sleeping."},

{type:"match", pairs:[
 {trg:"видеть", src:"to see"},
 {trg:"жить", src:"to live"},
 {trg:"спать", src:"to sleep"},
 {trg:"смотреть", src:"to watch / to look"},
 {trg:"ходить", src:"to go on foot (habitual)"}
]},

{type:"match", pairs:[
 {trg:"читать", src:"to read"},
 {trg:"писать", src:"to write"},
 {trg:"живёшь", src:"you live"},
 {trg:"пишу", src:"I write"},
 {trg:"смотрю", src:"I watch"}
]}
