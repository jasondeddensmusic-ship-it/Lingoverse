...
{type:"mc", q:"Which word means 'grandmother'?",
 opts:["бабушка","тётя","мама","дедушка"],
 ans:"бабушка",
 hint:"The -ба- beginning is distinctive. Grandfather starts with дед-."},

{type:"mc", q:"Why is 'дядя' grammatically masculine?",
 opts:["It ends in a soft consonant","It refers to a male person","It's neuter","It ends in -а"],
...
{type:"mc", q:"Which word means 'female friend'?",
 opts:["подруга","женщина","знакомый","друг"],
 ans:"подруга",
...
{type:"mc", q:"What is the irregular plural of 'человек' (person)?",
 opts:["людьми","люди","человека","человеки"],
 ans:"люди",
