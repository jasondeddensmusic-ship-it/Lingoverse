...
{type:"mc", q:"What gender is 'тело' (body)?",
 opts:["Neuter","Ambiguous","Masculine","Feminine"],
 ans:"Neuter",
...
{type:"mc", q:"How do you say 'I have a fever' in Russian?",
 opts:["У меня температура","Мне температура","Я есть температура","У меня есть температура"],
 ans:"У меня температура",
 hint:"Symptoms omit 'есть', just 'У меня + symptom.'"},

{type:"mc", q:"Which sentence uses the right aspect?",
 opts:["Я уставала каждый вечер","Я устаю каждый вечер","Я устал каждый вечер","Я уставал каждый вечер"],
...
{type:"mc", q:"Which verb means 'to make an appointment'?",
 opts:["записывать","записаться","записывание","писать"],
 ans:"записаться",
...
{type:"mc", q:"Which phrase means 'to make an appointment' in Russian?",
 opts:["записаться на приём","подтвердить приём","перенести приём","записать врача"],
...
{type:"mc", q:"Which verb means 'to cancel' an appointment?",
 opts:["записаться","отменить","перенести","подтвердить"],
 ans:"отменить",
...
{type:"mc", q:"What does 'Когда Вам удобно?' mean?",
 opts:["Who is your doctor?","Where is the clinic?","When is convenient for you?","How long is the wait?"],
...
{type:"mc", q:"How do you say 'We are at home' in Russian?",
 opts:["Мы дома","Мы будем дома","Мы есть дома","Мы быть дома"],
 ans:"Мы дома",
...
{type:"mc", q:"What does отказываться take in Russian?",
 opts:["Instrumental with с","Accusative case for the thing refused","Genitive with от for the thing refused","Dative case for the person refusing"],
...
{type:"mc", q:"Which verb means 'to refuse or decline' something?",
 opts:["записываться","советовать","иметь","отказываться"],
 ans:"отказываться",
