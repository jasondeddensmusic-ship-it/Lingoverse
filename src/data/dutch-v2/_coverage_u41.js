...
const COVERAGE_U41 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de bestselleritis",src:"the bestseller obsession"},{trg:"de bauxiet",src:"the bauxite"},{trg:"de antraciet",src:"the anthracite (type of coal)"},{trg:"de avatar",src:"the avatar"}]},
