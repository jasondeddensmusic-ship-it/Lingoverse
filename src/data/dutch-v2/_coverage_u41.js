...
const COVERAGE_U41 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de afwasborstel",src:"the dish brush"},{trg:"de badmuts",src:"the swimming cap"},{trg:"de bierlucht",src:"the smell of beer"},{trg:"het biermerk",src:"the beer brand"}]},
    {type:"match",pairs:[{trg:"de borstzak",src:"the breast pocket"},{trg:"het bivak",src:"the bivouac, the camp"},{trg:"de boerderijlodge",src:"the farm lodge"},{trg:"de binnenbrand",src:"the indoor fire, the building fire"}]},
    {type:"match",pairs:[{trg:"de binnenste",src:"the inner part, the inside"},{trg:"de acne",src:"the acne"},{trg:"de bewaking",src:"the monitoring (medical)"},{trg:"de beweegnorm",src:"the exercise guideline"}]},
    {type:"match",pairs:[{trg:"de bewegingsruimte",src:"the room to move, the freedom of movement"},{trg:"de bereiding",src:"the preparation (of food/medicine)"},{trg:"de ambulancesirene",src:"the ambulance siren"},{trg:"de borstoefening",src:"the chest exercise"}]},
    {type:"match",pairs:[{trg:"de billenoefening",src:"the glute exercise"},{trg:"benauwen",src:"to suffocate, to feel oppressed"},{trg:"de begroeiing",src:"the vegetation, the overgrowth"},{trg:"de blik",src:"the glance, the gaze; a tin can"}]},
    {type:"match",pairs:[{trg:"het blikveld",src:"the field of vision"},{trg:"de boekbespreking",src:"the book review"},{trg:"het bliksembezoek",src:"the lightning visit"},{trg:"de bekendmaking",src:"the announcement"}]},
    {type:"match",pairs:[{trg:"de bevestiging",src:"the confirmation"},{trg:"de bewering",src:"the claim, the assertion"},{trg:"de benaming",src:"the designation, the name"},{trg:"allicht",src:"probably, naturally"}]},
    {type:"match",pairs:[{trg:"al dan niet",src:"whether or not"},{trg:"de aandeelhoudersstructuur",src:"the shareholder structure"},{trg:"de aardewerkindustrie",src:"the pottery industry"},{trg:"het bedrijfsverzamelgebouw",src:"the shared office building"}]},
    {type:"match",pairs:[{trg:"de bestselleritis",src:"the bestseller obsession"},{trg:"het bauxiet",src:"the bauxite"},{trg:"de antraciet",src:"the anthracite (type of coal)"},{trg:"de avatar",src:"the avatar"}]},
    {type:"match",pairs:[{trg:"het alcoholgebruik",src:"the alcohol consumption"},{trg:"de actieveling",src:"the active person, the go-getter"},{trg:"de aai",src:"the stroke, the caress"},{trg:"bobsleeën",src:"to bobsled"}]},
    {type:"match",pairs:[{trg:"basketten",src:"to play basketball"},{trg:"het avonduur",src:"the evening hour"},{trg:"het bliksembezoek",src:"the lightning visit"},{trg:"het avonturenboek",src:"the adventure book"}]},
