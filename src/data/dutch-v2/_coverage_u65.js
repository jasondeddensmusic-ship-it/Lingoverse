...
const COVERAGE_U65 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"in het werk stellen",src:"to make every effort"},{trg:"in omloop brengen",src:"to put into circulation"},{trg:"ineen",src:"into each other, together"},{trg:"interrumperen",src:"to interrupt"}]},
    {type:"match",pairs:[{trg:"individualiseren",src:"to individualize, to personalize"},{trg:"inhaleren",src:"to inhale"},{trg:"inprenten",src:"to impress upon, to instil"},{trg:"de ingeval",src:"in case"}]},
    {type:"match",pairs:[{trg:"de bindkosten",src:"binding costs, commitment fees"},{trg:"het inkomensprobleem",src:"income problem"},{trg:"de hulpverleningssector",src:"social services sector"},{trg:"de interimbasis",src:"interim basis, temporary basis"}]},
    {type:"match",pairs:[{trg:"de inschakeling",src:"engagement, activation"},{trg:"de informaticajunk",src:"information junkie"},{trg:"de beleidsmens",src:"policy person, bureaucrat"},{trg:"het ip-adres",src:"IP address"}]},
