...
const COVERAGE_U32 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"het been",src:"the leg"},{trg:"de griep",src:"the flu"},{trg:"dood",src:"dead"},{trg:"mager",src:"thin / lean / skinny"}]},
    {type:"match",pairs:[{trg:"dik",src:"thick / fat"},{trg:"nat",src:"wet"},{trg:"lang",src:"long / tall"},{trg:"knap",src:"handsome / attractive / clever"}]},
    {type:"match",pairs:[{trg:"blond",src:"blonde"},{trg:"de kam",src:"the comb"},{trg:"kammen",src:"to comb"},{trg:"fris",src:"fresh / cool"}]},
    {type:"match",pairs:[{trg:"hard",src:"hard / loud / fast"},{trg:"de kraan",src:"the tap / faucet"},{trg:"donker",src:"dark"},{trg:"het dorp",src:"the village"}]},
    {type:"match",pairs:[{trg:"het noorden",src:"the north"},{trg:"de grond",src:"the ground / soil"},{trg:"het ijs",src:"the ice / ice cream"},{trg:"de krant",src:"the newspaper"}]},
    {type:"match",pairs:[{trg:"de foto",src:"the photo"},{trg:"het internet",src:"the internet"},{trg:"het idee",src:"the idea"},{trg:"de informatie",src:"the information"}]},
    {type:"match",pairs:[{trg:"interessant",src:"interesting"},{trg:"de film",src:"the film / movie"},{trg:"de euro",src:"the euro"},{trg:"de dollar",src:"the dollar"}]},
    {type:"match",pairs:[{trg:"de klant",src:"the customer"},{trg:"de groentewinkel",src:"the vegetable shop / greengrocer"},{trg:"de fles",src:"the bottle"},{trg:"het bord",src:"the plate / sign"}]},
