...
const COVERAGE_U44 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de acne",src:"the acne"},{trg:"angstwekkend",src:"alarming, frightening"},{trg:"besmetten",src:"to infect, to contaminate"},{trg:"chemisch",src:"chemical"}]},
    {type:"match",pairs:[{trg:"de chemicalien",src:"the chemicals"},{trg:"braken",src:"to vomit"},{trg:"het academiejaar",src:"the academic year"},{trg:"het adjectief",src:"the adjective"}]},
    {type:"match",pairs:[{trg:"het alfabet",src:"the alphabet"},{trg:"het computerforum",src:"the computer forum"},{trg:"de communicatiewetenschap",src:"the communication science"},{trg:"de conceptualisatie",src:"the conceptualization"}]},
    {type:"match",pairs:[{trg:"het collegerooster",src:"the lecture timetable"},{trg:"de criticus",src:"the critic"},{trg:"de aardbol",src:"the globe, the earth"},{trg:"het baggerwerk",src:"the dredging work"}]},
    {type:"match",pairs:[{trg:"het bauxiet",src:"the bauxite"},{trg:"de afvalophaling",src:"the waste collection"},{trg:"de afscheiding",src:"the separation, the secretion"},{trg:"het antraciet",src:"the anthracite"}]},
    {type:"match",pairs:[{trg:"aanwakkeren",src:"to fan, to stoke"},{trg:"het canvas",src:"the canvas"},{trg:"caribisch",src:"Caribbean"},{trg:"het cliche",src:"the cliche"}]},
    {type:"match",pairs:[{trg:"de coach",src:"the coach"},{trg:"het advertentiebudget",src:"the advertising budget"},{trg:"de animatieserie",src:"the animation series"},{trg:"het blijk",src:"the sign, the token"}]},
    ...
    {type:"match",pairs:[{trg:"behoeden",src:"to protect, to guard"},{trg:"collectivistisch",src:"collectivist"},{trg:"het consumentenonderzoek",src:"the consumer research"}]},
