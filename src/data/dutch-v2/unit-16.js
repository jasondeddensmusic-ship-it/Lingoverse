...
export default {n:16,lang:"nl",srcLang:"en",track:"v2",title:"Het Wordt Gedaan",sub:"Passive Voice & Formal Register",icon:"📰",level:"B1.2",color:"#7B5EE8",lessons:[
  ...
  {id:"v2u16l7",title:"Door Wie? Waardoor?",icon:"🔍",xp:15,board:true,steps:[
        ...
        {type:"mc",q:"In '...dat het gedaan moet worden', why are verbs at the end?",opts:["Passive always ends sentences","Sub-clause: all verbs cluster at the end","It is a question","Random word order"],ans:"Sub-clause: all verbs cluster at the end",hint:"In Dutch, certain connecting words trigger a special word order rule"},
