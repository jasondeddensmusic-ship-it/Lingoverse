...
export default {n:16,lang:"nl",srcLang:"en",track:"v2",title:"Het Wordt Gedaan",sub:"Passive Voice & Formal Register",icon:"📰",level:"B1.2",color:"#7B5EE8",lessons:[
  {id:"v2u16l1",title:"Actief vs Passief",icon:"📰",xp:15,board:true,steps:[
        ...
        {type:"mc",q:"'Het besluit is genomen.' focuses on:",opts:["Who made the decision","The decision itself (result)","The future","A question"],ans:"The decision itself (result)",hint:"Passive puts the action/result in focus"},
  ...
  {id:"v2u16l2",title:"Worden + Gedaan",icon:"📐",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"'Het boek wordt door veel mensen gelezen.' What is 'door veel mensen'?",opts:["The subject","The agent (who does it)","The object","The verb"],ans:"The agent (who does it)",hint:"Door = by (identifies who performs the action)"},
  ...
  {id:"v2u16l3",title:"Werd Geschreven",icon:"📐",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"Present passive: 'De brief wordt geschreven.' Past passive:",opts:["De brief werd geschreven.","De brief is geschreven.","De brief was geschreven.","De brief heeft geschreven."],ans:"De brief werd geschreven.",hint:"Just change wordt to werd"},
  ...
  {id:"v2u16l5",title:"Er Wordt Gefietst",icon:"🚲",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"'Er wordt hier hard gewerkt.' Can this be translated literally to English?",opts:["Yes: It is worked here","No  -  English needs a real subject","Yes: There is worked here","Yes: Here is worked"],ans:"No  -  English needs a real subject",hint:"Dutch impersonal passive has no English equivalent"},
        ...
        {type:"mc",q:"The impersonal passive is used for:",opts:["Specific people doing things","Rules, general activities, atmosphere","Questions only","Past tense only"],ans:"Rules, general activities, atmosphere",hint:"No specific subject  -  general/impersonal"},
  ...
  {id:"v2u16l6",title:"De Krant Lezen",icon:"📰",xp:15,board:true,steps:[
        ...
        {type:"mc",q:"'Het plan is bedoeld om de luchtkwaliteit te verbeteren.' 'Is bedoeld' is:",opts:["Active voice","Worden-passive (process)","Zijn-passive (state/result)","Future tense"],ans:"Zijn-passive (state/result)",hint:"Is + PP = state passive (the plan IS intended)"},
  ...
  {id:"v2u16l7",title:"Door Wie? Waardoor?",icon:"🔍",xp:15,board:true,steps:[
        ...
        {type:"mc",q:"In '...dat het gedaan moet worden', why are verbs at the end?",opts:["Passive always ends sentences","Sub-clause: all verbs cluster at the end","It is a question","Random word order"],ans:"Sub-clause: all verbs cluster at the end",hint:"dat + ... + verb cluster at end"},
  ...
  {id:"v2u16l8",title:"Unit 16 Review",icon:"🔄",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"Active: 'Zij leest het boek.' What is the correct passive?",opts:["Het boek wordt gelezen.","Zij wordt gelezen.","Het boek is gelezen.","Het boek werd gelezen."],ans:"Het boek wordt gelezen.",hint:"Object becomes subject + wordt + PP (present)"},
