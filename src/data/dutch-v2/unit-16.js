...
export default {n:16,lang:"nl",srcLang:"en",track:"v2",title:"Het Wordt Gedaan",sub:"Passive Voice & Formal Register",icon:"📰",level:"B1.2",color:"#7B5EE8",lessons:[
  {id:"v2u16l1",title:"Actief vs Passief",icon:"📰",xp:15,board:true,steps:[
        ...
        {type:"mc",q:"In 'De brief wordt geschreven', the focus is on:",opts:["The letter itself","Who writes it","The past","The future"],ans:"The letter itself",hint:"Passive = focus on what happens, not who does it"},
        ...
        {type:"mc",q:"'Het besluit is genomen.' focuses on:",opts:["Who made the decision","The future","The decision itself (result)","A question"],ans:"The decision itself (result)",hint:"Passive puts the action/___ in focus"},
  ...
  {id:"v2u16l2",title:"Worden + Gedaan",icon:"📐",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"Active: 'Zij leest het boek.' Passive:",opts:["Het boek word gelezen.","Zij wordt gelezen.","Het boek heeft gelezen.","Het boek wordt gelezen."],ans:"Het boek wordt gelezen.",hint:"Object becomes subject + passive auxiliary + PP"},
        ...
        {type:"mc",q:"'Het boek wordt door veel mensen gelezen.' What is 'door veel mensen'?",opts:["The agent (who does it)","The subject","The object","The verb"],ans:"The agent (who does it)",hint:"Door = by (identifies ___ performs the action)"},
  ...
  {id:"v2u16l3",title:"Werd Geschreven",icon:"📐",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"'De wet werd aangenomen.'  -  this happened:",opts:["In the past","Now","In the future","Always"],ans:"In the past",hint:"Werd = ___ tense of worden"},
        ...
        {type:"mc",q:"Active: 'De minister nam het besluit.' → Past passive:",opts:["De minister werd genomen.","Het besluit wordt genomen.","Het besluit werd genomen door de minister.","Het besluit was genomen."],ans:"Het besluit werd genomen door de minister.",hint:"___ + PP + ___ + agent"},
        ...
        {type:"mc",q:"Present passive: 'De brief wordt geschreven.' Past passive:",opts:["De brief heeft geschreven.","De brief is geschreven.","De brief was geschreven.","De brief werd geschreven."],ans:"De brief werd geschreven.",hint:"Just change wordt to ___"},
  ...
  {id:"v2u16l4",title:"Is Geschreven",icon:"📐",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"'De winkel is gesloten.'  -  this means:",opts:["The shop is closed (result/state)","Someone is closing the shop now","The shop will close","The shop was being closed"],ans:"The shop is closed (result/state)",hint:"Zijn + PP = r.../s..."},
        ...
        {type:"mc",q:"'De deur wordt gesloten' vs 'De deur is gesloten'. Which is the result?",opts:["wordt gesloten (process)","Both are results","is gesloten (result)","Neither"],ans:"is gesloten (result)",hint:"Zijn-passive = the action is DONE"},
        ...
        {type:"mc",q:"On a Dutch sign you see 'Verboden toegang!' This means:",opts:["Welcome!","Open today","Emergency exit","No entry! (forbidden access)"],ans:"No entry! (forbidden access)",hint:"A common Dutch sign: ___ toegang (no e...)"},
  ...
  {id:"v2u16l5",title:"Er Wordt Gefietst",icon:"🚲",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"'Er wordt hier niet gerookt.'  -  who is the subject?",opts:["There is no real subject","The smoker","Er","Het"],ans:"There is no real subject",hint:"Er is just a placeholder  -  impersonal!"},
        ...
        {type:"mc",q:"'Er wordt hier hard gewerkt.' Can this be translated literally to English?",opts:["Yes: It is worked here","Yes: There is worked here","No  -  English needs a real subject","Yes: Here is worked"],ans:"No  -  English needs a real subject",hint:"Dutch impersonal passive has no ___ equivalent"},
        {type:"fb",opts:["werd","wordt","is","was"],hint:"Past impersonal passive: 'er' placeholder + past tense of 'worden' + past participle",s:"Er ___ veel gelachen op het feest. (past  -  people laughed a lot)",a:"werd"},
        ...
        {type:"mc",q:"The impersonal passive is used for:",opts:["Specific people doing things","Past tense only","Questions only","Rules, general activities, atmosphere"],ans:"Rules, general activities, atmosphere",hint:"No specific subject  -  ___/impersonal"},
        {type:"fb",opts:["wordt","werd","is","zijn"],hint:"Present impersonal passive: 'er' + present tense of 'worden' + past participle",s:"Er ___ hier niet gefietst! (present  -  no cycling here)",a:"wordt"},
  ...
  {id:"v2u16l6",title:"De Krant Lezen",icon:"📰",xp:15,board:true,steps:[
        ...
        {type:"mc",q:"In the text, 'werd aangekondigd' is:",opts:["Past passive","Present passive","State passive","Active voice"],ans:"Past passive",hint:"Werd = ___ tense of worden"},
        ...
        {type:"mc",q:"'Er werd veel over gesproken'  -  what type of passive?",opts:["Normal passive","Impersonal passive","State passive","Not passive"],ans:"Impersonal passive",hint:"Er + werd + PP, no real subject"},
        ...
        {type:"mc",q:"'Er werd veel over gesproken in het parlement.' What type of passive?",opts:["Normal passive","State passive","Active voice","Impersonal passive"],ans:"Impersonal passive",hint:"Er + werd + PP, no real subject"},
        ...
        {type:"mc",q:"'Niet iedereen is het ermee eens.' means:",opts:["Not everyone agrees","Everyone agrees","Nobody agrees","The minister agrees"],ans:"Not everyone agrees",hint:"Niet iedereen = not e..."},
  ...
  {id:"v2u16l7",title:"Door Wie? Waardoor?",icon:"🔍",xp:15,board:true,steps:[
        ...
        {type:"mc",q:"In '...dat het gedaan moet worden', why is 'worden' last?",opts:["It's always last","Sub-clause: all verbs go to the end","Random order","Passive always ends sentences"],ans:"Sub-clause: all verbs go to the end",hint:"In Dutch, certain connecting words trigger a special word order rule"},
        ...
        {type:"mc",q:"'Door wie?' asks about a person. For things, you ask:",opts:["Door wat?","Waarom?","Waardoor?","Hoe?"],ans:"Waardoor?",hint:"Waar + door = by what (for things/causes)"},
        {type:"fb",opts:["zou","had","werd","is"],hint:"Conditional: the auxiliary expressing 'should' in a passive + modal construction",s:"Het ___ besproken moeten worden. (should  -  conditional)",a:"zou"},
        {type:"mc",q:"In '...dat het gedaan moet worden', why are verbs at the end?",opts:["Passive always ends sentences","Random word order","It is a question","Sub-clause: all verbs cluster at the end"],ans:"Sub-clause: all verbs cluster at the end",hint:"In Dutch, certain connecting words trigger a special word order rule"},
  ...
  {id:"v2u16l8",title:"Unit 16 Review",icon:"🔄",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"Active: 'De minister nam het besluit.' → Passive:",opts:["De minister werd genomen.","Het besluit werd genomen door de minister.","Het besluit wordt genomen.","Het werd minister genomen."],ans:"Het besluit werd genomen door de minister.",hint:"Object → subject, ___ + PP, ___ + agent"},
        ...
        {type:"mc",q:"Worden-passive vs zijn-passive:",opts:["No difference","worden = formal, zijn = informal","worden = past, zijn = present","worden = process, zijn = result"],ans:"worden = process, zijn = result",hint:"Becoming vs being"},
        ...
        {type:"fb",opts:["wordt","werd","is","werden"],hint:"Present impersonal passive: 'er' placeholder + present tense of 'worden' + past participle",s:"Er ___ hier niet gerookt. (present impersonal)",a:"wordt"},
