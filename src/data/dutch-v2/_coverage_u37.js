...
const COVERAGE_U37 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de afwijking",src:"the deviation / the abnormality"},{trg:"aandringen",src:"to insist / to urge"},{trg:"beheersen",src:"to master / to control"},{trg:"beheren",src:"to manage / to administer"}]},
    {type:"match",pairs:[{trg:"de beheerder",src:"the manager / the administrator"},{trg:"aangeven",src:"to indicate / to declare"},{trg:"afraden",src:"to advise against"},{trg:"aanwijzen",src:"to point out / to appoint"}]},
    {type:"match",pairs:[{trg:"afwachten",src:"to wait and see"},{trg:"allang",src:"for a long time already"},{trg:"alom",src:"everywhere / universally"},{trg:"aanduiden",src:"to indicate / to designate"}]},
