...
const COVERAGE_U57 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"herontdekken",src:"to rediscover"},{trg:"herschrijven",src:"to rewrite"},{trg:"falen",src:"to fail"},{trg:"het design",src:"design"}]},
    {type:"match",pairs:[{trg:"de examencommissie",src:"the exam committee"},{trg:"het bachelorjaar",src:"the bachelor year"},{trg:"de finale",src:"the final, the finale"},{trg:"het fragment",src:"the fragment, the excerpt"}]},
    {type:"match",pairs:[{trg:"grammaticaal",src:"grammatical"},{trg:"de geuzennaam",src:"a name originally meant as an insult but worn with pride"},{trg:"de gezegde",src:"the saying, the proverb"},{trg:"het goudhaantje",src:"the golden boy, the star performer"}]},
