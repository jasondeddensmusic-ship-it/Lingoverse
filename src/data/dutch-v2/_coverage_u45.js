...
const COVERAGE_U45 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de cultuurwetenschap",src:"the cultural studies"},{trg:"het avondmaal",src:"the Last Supper, the evening meal (formal)"},{trg:"het avonturenboek",src:"the adventure book"},{trg:"de bistro",src:"the bistro"}]},
    {type:"match",pairs:[{trg:"de ceremonieel",src:"the ceremonial"},{trg:"het casino",src:"the casino"},{trg:"het appartheidsregime",src:"the apartheid regime"},{trg:"het begeleidingstraject",src:"the guidance program, the support trajectory"}]},
    {type:"match",pairs:[{trg:"de beoefenaar",src:"the practitioner"},{trg:"de beleidsverstrengeling",src:"the conflict of interest (in policy)"},{trg:"de borstzak",src:"the breast pocket"},{trg:"de chef",src:"the boss, the head"}]},
    {type:"match",pairs:[{trg:"beroepen",src:"to appeal (legal), to invoke"},{trg:"bevoorrechten",src:"to privilege, to favor"},{trg:"cirkelen",src:"to circle, to orbit"},{trg:"collaboreren",src:"to collaborate (with enemy)"}]},
    {type:"match",pairs:[{trg:"consumeren",src:"to consume"},{trg:"afschuimen",src:"to skim (off), to scour"},{trg:"aangebeten",src:"to have bitten into"},{trg:"aankopen",src:"to purchase (formal)"}]},
    {type:"match",pairs:[{trg:"de astroloog",src:"the astrologer"},{trg:"de aanvangstijd",src:"the starting time"},{trg:"het compensatiemiddel",src:"the compensatory measure"},{trg:"de contributieperiode",src:"the membership period"}]},
    ...
    {type:"match",pairs:[{trg:"de autosuggestie",src:"the autosuggestion"},{trg:"het attentieniveau",src:"the attention level"},{trg:"het blikveld",src:"the field of vision"},{trg:"de businessclass",src:"the business class"},{trg:"de cocktailparty",src:"the cocktail party"},{trg:"het concentratiekamp",src:"the concentration camp"}]},
