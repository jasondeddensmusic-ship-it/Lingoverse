...
const COVERAGE_U45 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de ceremonieel",src:"the ceremonial"},{trg:"het casino",src:"the casino"},{trg:"de appartheidsregime",src:"the apartheid regime"},{trg:"de begeleidingstraject",src:"the guidance program, the support trajectory"}]},
