...
const COVERAGE_U46 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de buitengerechtelijk",src:"extrajudicial, out of court"},{trg:"de boekenkist",src:"the book chest"},{trg:"de aanvangstijd",src:"the starting time"},{trg:"de aardbol",src:"the globe, the earth"}]},
    {type:"match",pairs:[{trg:"de binnenhuistafereel",src:"the interior scene (painting)"},{trg:"het consumentenonderzoek",src:"the consumer research"},{trg:"de controversie",src:"the controversy"},{trg:"de complimenteren",src:"to compliment"}]},
    {type:"match",pairs:[{trg:"de contributieperiode",src:"the contribution period"},{trg:"de collectivistisch",src:"collectivist"},{trg:"het consumentenonderzoek",src:"the consumer research"},{trg:"de concentratieverlies",src:"the loss of concentration"}]},
    {type:"match",pairs:[{trg:"de correlatie",src:"the correlation"},{trg:"de blazer",src:"the blazer (jacket)"},{trg:"de borstzak",src:"the breast pocket"},{trg:"het casino",src:"the casino"}]},
    {type:"match",pairs:[{trg:"de avonturenboek",src:"the adventure book"},{trg:"het avonturengame",src:"the adventure game"},{trg:"de bola",src:"the bola (throwing weapon)"},{trg:"de branche",src:"the sector, the industry"}]},
