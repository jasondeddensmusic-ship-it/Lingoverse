...
const COVERAGE_U47 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de allochtoon",src:"the person of foreign origin"},{trg:"de emigratie",src:"the emigration"},{trg:"emigreren",src:"to emigrate"},{trg:"de arbeidersklasse",src:"the working class"}]},
    {type:"match",pairs:[{trg:"de eensgezindheid",src:"the unanimity, the consensus"},{trg:"associeren",src:"to associate"},{trg:"eminent",src:"eminent, distinguished"},{trg:"de entourage",src:"the entourage, the circle"}]},
    {type:"match",pairs:[{trg:"eigentijds",src:"contemporary, modern"},{trg:"de denkwijze",src:"the way of thinking, the mindset"},{trg:"denkbaar",src:"thinkable, conceivable"},{trg:"de denktank",src:"the think tank"}]},
    {type:"match",pairs:[{trg:"doelbewust",src:"deliberate, purposeful"},{trg:"doeltreffend",src:"effective, efficient"},{trg:"de continuiteit",src:"the continuity"},{trg:"het cynisme",src:"the cynicism"}]},
    {type:"match",pairs:[{trg:"de efficientie",src:"the efficiency"},{trg:"het discours",src:"the discourse"},{trg:"doorprikken",src:"to puncture, to see through"},{trg:"de doorstroming",src:"the flow, the throughput"}]},
    {type:"match",pairs:[{trg:"de doorsnee",src:"the average, the cross-section"},{trg:"de diepgang",src:"the depth, the profundity"},{trg:"de dynamiek",src:"the dynamics, the dynamic"},{trg:"daaropvolgend",src:"subsequent, following"}]},
