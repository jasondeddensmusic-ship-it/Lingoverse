...
const COVERAGE_U78 = {
  id:"duv2_u78_coverage_review", title:"Herhaling: Dekkingscheck", icon:"🎯", xp:10, board:true,
  steps:[
    ...
    {type:"match",pairs:[{trg:"de samenvatting",src:"the summary"},{trg:"de evaluatie",src:"the evaluation"}]}
  ]
};
