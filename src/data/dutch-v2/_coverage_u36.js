...
const COVERAGE_U36 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"amuseren",src:"to amuse / to entertain"},{trg:"de actualiteit",src:"current events / the news"},{trg:"artistiek",src:"artistic"},{trg:"het bankstel",src:"the sofa set / the couch"}]},
    {type:"match",pairs:[{trg:"de badhanddoek",src:"the bath towel"},{trg:"het artikel",src:"the article / the item"},{trg:"de azijn",src:"the vinegar"},{trg:"de alarmmelding",src:"the alarm notification"}]},
    {type:"match",pairs:[{trg:"afbeelden",src:"to depict / to illustrate"},{trg:"het bebouwd",src:"built-up (area)"},{trg:"academisch",src:"academic"},{trg:"het beginniveau",src:"the beginner level"}]},
