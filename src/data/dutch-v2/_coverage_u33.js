...
const COVERAGE_U33 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"favoriet",src:"favorite"},{trg:"dom",src:"stupid / dumb"},{trg:"erg",src:"very / badly"},{trg:"nerveus",src:"nervous"}]},
    {type:"match",pairs:[{trg:"lui",src:"lazy"},{trg:"de chauffeur",src:"the driver"},{trg:"autorijden",src:"to drive (a car)"},{trg:"hardlopen",src:"to run / to jog"}]},
    {type:"match",pairs:[{trg:"langs",src:"along / past"},{trg:"naast",src:"next to / beside"},{trg:"de docent",src:"the teacher (secondary/higher)"},{trg:"de lerares",src:"the teacher (female)"}]},
    {type:"match",pairs:[{trg:"de oefening",src:"the exercise"},{trg:"het boek",src:"the book"},{trg:"het hoofdstuk",src:"the chapter"},{trg:"het onderwerp",src:"the subject / topic"}]},
    {type:"match",pairs:[{trg:"de geschiedenis",src:"the history"},{trg:"de kantine",src:"the canteen / cafeteria"},{trg:"het kantoor",src:"the office"},{trg:"dansen",src:"to dance"}]},
    {type:"match",pairs:[{trg:"de computer",src:"the computer"},{trg:"de e-mail",src:"the e-mail"},{trg:"de mail",src:"the mail / email"},{trg:"het interview",src:"the interview"}]},
