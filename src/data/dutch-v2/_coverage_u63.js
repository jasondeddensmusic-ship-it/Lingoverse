...
const COVERAGE_U63 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"het internetgedrag",src:"internet behaviour"},{trg:"de internettoegang",src:"internet access"},{trg:"de inloggegevens",src:"login credentials"},{trg:"de informatieovervloed",src:"information overload"}]},
    {type:"match",pairs:[{trg:"het item",src:"the item, the segment"},{trg:"de graffiti",src:"graffiti"},{trg:"de darmontsteking",src:"intestinal inflammation"},{trg:"de gezondheidsklacht",src:"health complaint"}]},
    {type:"match",pairs:[{trg:"de gezondheidscampagne",src:"health campaign"},{trg:"het inslaapprobleem",src:"difficulty falling asleep"},{trg:"de indicatie",src:"the indication"},{trg:"de helikopter",src:"the helicopter"}]},
    {type:"match",pairs:[{trg:"het helium",src:"helium"},{trg:"de hoofdwond",src:"head wound"},{trg:"de investeerder",src:"the investor"},{trg:"de holding",src:"the holding company"}]},
    ...
    {type:"match",pairs:[{trg:"het individualisme",src:"individualism"},{trg:"individualistisch",src:"individualistic"},{trg:"de individualisering",src:"individualization"},{trg:"de industriestad",src:"industrial city"}]},
    {type:"match",pairs:[{trg:"de heilige",src:"the saint"},{trg:"het groepsverband",src:"group context, in a group"},{trg:"het documentatiemateriaal",src:"documentation material"},{trg:"de informatieverschaffing",src:"provision of information"},{trg:"het informatiemateriaal",src:"informational material"},{trg:"de ingenieur",src:"the engineer"}]},
