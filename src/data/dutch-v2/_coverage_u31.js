...
const COVERAGE_U31 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"heten",src:"to be called"},{trg:"goed",src:"good"},{trg:"echt",src:"really / genuine"},{trg:"glimlachen",src:"to smile"}]},
    {type:"match",pairs:[{trg:"lachen",src:"to laugh"},{trg:"noemen",src:"to call / to name"},{trg:"gewoon",src:"normal / just / simply"},{trg:"normaal",src:"normal / usual"}]},
    {type:"match",pairs:[{trg:"de familie",src:"the family"},{trg:"de moeder",src:"the mother"},{trg:"mam",src:"mom"},{trg:"de broer",src:"the brother"}]},
    {type:"match",pairs:[{trg:"de dochter",src:"the daughter"},{trg:"de jongen",src:"the boy"},{trg:"de mens",src:"the person / human being"},{trg:"het leven",src:"the life"}]},
    {type:"match",pairs:[{trg:"het jaar",src:"the year"},{trg:"jong",src:"young"},{trg:"het brood",src:"the bread"},{trg:"de komkommer",src:"the cucumber"}]},
    {type:"match",pairs:[{trg:"de koek",src:"the cookie / cake"},{trg:"de chocola",src:"the chocolate"},{trg:"de melk",src:"the milk"},{trg:"het bier",src:"the beer"}]},
