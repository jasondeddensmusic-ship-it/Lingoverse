...
const COVERAGE_U51 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de allochtoon",src:"the person of foreign origin"},{trg:"de bevolkingssamenstelling",src:"the population composition"},{trg:"de arbeidersklasse",src:"the working class"},{trg:"gebrekkig",src:"deficient, flawed, poor"}]},
    {type:"match",pairs:[{trg:"het geheugen",src:"the memory (faculty)"},{trg:"de bedrijvigheid",src:"the business activity, the industry"},{trg:"de exploitatie",src:"the operation, the running (of a business)"},{trg:"exploiteren",src:"to operate, to run (a business)"}]},
    {type:"match",pairs:[{trg:"de dagtaak",src:"the daily task, the day's work"},{trg:"het beslag",src:"the batter; the seizure; the fittings"},{trg:"de associatie",src:"the association"},{trg:"de continuïteit",src:"the continuity"}]},
    {type:"match",pairs:[{trg:"exact",src:"exact, precise"},{trg:"existentieel",src:"existential"},{trg:"experimenteel",src:"experimental"},{trg:"geconcentreerd",src:"concentrated, focused"}]},
    ...
    {type:"match",pairs:[{trg:"het geldmiddel",src:"the funds, the financial resources"},{trg:"geldelijk",src:"financial, monetary"},{trg:"fysiologisch",src:"physiological"},{trg:"de echo",src:"the echo; the ultrasound"}]},
