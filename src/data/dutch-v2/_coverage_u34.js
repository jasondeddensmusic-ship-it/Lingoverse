...
const COVERAGE_U34 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"geven",src:"to give"},{trg:"blijven",src:"to stay / to remain"},{trg:"bestaan",src:"to exist"},{trg:"huilen",src:"to cry"}]},
    {type:"match",pairs:[{trg:"gooien",src:"to throw"},{trg:"liggen",src:"to lie / to be located"},{trg:"besturen",src:"to steer / to manage / to govern"},{trg:"nodigen",src:"to invite"}]},
    {type:"match",pairs:[{trg:"afvallen",src:"to lose weight / to fall off"},{trg:"missen",src:"to miss"},{trg:"jij",src:"you (stressed)"},{trg:"je",src:"you (unstressed) / your"}]},
    {type:"match",pairs:[{trg:"hem",src:"him"},{trg:"hen",src:"them (object after preposition)"},{trg:"mij",src:"me (stressed)"},{trg:"jou",src:"you (object, stressed)"}]},
    {type:"match",pairs:[{trg:"ergens",src:"somewhere"},{trg:"dicht bij",src:"close to / near"},{trg:"het ding",src:"the thing"},{trg:"het antwoord",src:"the answer"}]},
    {type:"match",pairs:[{trg:"het lokaal",src:"the room / premises"},{trg:"het bedrijf",src:"the company"},{trg:"de loop",src:"the course / walk"},{trg:"het leven",src:"the life"}]},
    {type:"match",pairs:[{trg:"de hond",src:"the dog"},{trg:"de kat",src:"the cat"},{trg:"de beet",src:"the bite"},{trg:"de kus",src:"the kiss"}]},
