...
const COVERAGE_U62 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de godenwereld",src:"the world of the gods, the divine realm"},{trg:"handenvol",src:"handfuls of, lots of"},{trg:"het establishment",src:"the establishment"},{trg:"de hartstichting",src:"the heart foundation"}]},
