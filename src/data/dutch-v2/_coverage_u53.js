...
const COVERAGE_U53 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de fruitsoort",src:"the type of fruit"},{trg:"de fastfoodrestaurant",src:"the fast food restaurant"},{trg:"het bauxiet",src:"the bauxite"},{trg:"het chloorwater",src:"the chlorinated water"}]},
