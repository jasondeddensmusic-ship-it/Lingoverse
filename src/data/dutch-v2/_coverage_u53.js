...
const COVERAGE_U53 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"de flexibilisering",src:"the flexibilization"},{trg:"de gelegenheidsonderneming",src:"the ad hoc enterprise, the opportunistic business"},{trg:"de exploitatie",src:"the exploitation, the operation (of a business)"},{trg:"de facilititeit",src:"the facility"}]},
    {type:"match",pairs:[{trg:"de feedback",src:"the feedback"},{trg:"de fractie",src:"the fraction; the political faction"},{trg:"de financiële",src:"financial (used as noun: the financial sector)"},{trg:"de feministe",src:"the feminist (female)"}]},
    {type:"match",pairs:[{trg:"feministisch",src:"feminist (adjective)"},{trg:"de dwarsverbinding",src:"the cross-connection, the lateral link"},{trg:"dwepen",src:"to be infatuated with, to dote on"},{trg:"de eenvoud",src:"the simplicity"}]},
    {type:"match",pairs:[{trg:"extreem",src:"extreme"},{trg:"extern",src:"external, outside"},{trg:"de ethiek",src:"the ethics"},{trg:"de friettent",src:"the chip shop, the fry stand"}]},
    {type:"match",pairs:[{trg:"de fruitsoort",src:"the type of fruit"},{trg:"het fastfoodrestaurant",src:"the fast food restaurant"},{trg:"het bauxiet",src:"the bauxite"},{trg:"het chloorwater",src:"the chlorinated water"}]},
    {type:"match",pairs:[{trg:"het burgerservicenummer",src:"the citizen service number (BSN)"},{trg:"de creamer",src:"the creamer (coffee creamer)"},{trg:"de fetisj",src:"the fetish"},{trg:"de fietsambtenaar",src:"the cycling official/officer"}]},
    {type:"match",pairs:[{trg:"geconcentreerd",src:"concentrated, focused"},{trg:"de diepgang",src:"the depth; the profundity"},{trg:"het dialectniveau",src:"the dialect level"},{trg:"het bedrijfsverzamelgebouw",src:"the business collection building, the shared office building"}]},
