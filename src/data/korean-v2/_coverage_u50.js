...
const COVERAGE_U50 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"기본적",src:"basic, fundamental"},{trg:"기막히다",src:"to be astounding, breathtaking"},{trg:"기성",src:"established, existing"},{trg:"기성세대",src:"the older generation, establishment"}]},
    {type:"match",pairs:[{trg:"기억나다",src:"to come to mind, to recall"},{trg:"기억되다",src:"to be remembered"},{trg:"기호",src:"preference, taste; symbol"},{trg:"기능",src:"function, feature"}]},
    {type:"match",pairs:[{trg:"기다",src:"to crawl, to creep"},{trg:"기대다",src:"to lean on, to rely on"},{trg:"기대되다",src:"to be anticipated, to be expected"},{trg:"기울다",src:"to tilt, to lean, to decline"}]},
    {type:"match",pairs:[{trg:"기울이다",src:"to devote, to concentrate (effort)"},{trg:"기원",src:"origin, prayer/wish"},{trg:"기원전",src:"B.C., before the common era"},{trg:"기도",src:"prayer"}]},
    {type:"match",pairs:[{trg:"기도하다",src:"to pray"},{trg:"긴장감",src:"tension, sense of nervousness"},{trg:"긴장되다",src:"to be nervous, to feel tense"},{trg:"기뻐하다",src:"to rejoice, to be delighted"}]},
    {type:"match",pairs:[{trg:"길가",src:"roadside, edge of the road"},{trg:"길거리",src:"street, the streets"},{trg:"길어지다",src:"to become longer, to be prolonged"},{trg:"깊숙이",src:"deep inside, deeply"}]},
    {type:"match",pairs:[{trg:"까다",src:"to peel, to hatch, to shell"},{trg:"까만색",src:"black color"},{trg:"까먹다",src:"to forget (colloquial)"},{trg:"깔다",src:"to spread, to lay down"}]},
    {type:"match",pairs:[{trg:"깔리다",src:"to be spread, to be crushed under"},{trg:"깜빡",src:"with a blink, forgetting momentarily"},{trg:"남부",src:"southern part, the South"},{trg:"남북",src:"South and North, north-south"}]},
    {type:"match",pairs:[{trg:"깨끗해지다",src:"to become clean"},{trg:"깨닫다",src:"to realize, to come to understand"},{trg:"깨뜨리다",src:"to break, to shatter"},{trg:"깨소금",src:"ground sesame seeds"}]},
    {type:"match",pairs:[{trg:"깨어나다",src:"to wake up, to awaken"},{trg:"깨어지다",src:"to be broken, to shatter"},{trg:"깨우다",src:"to wake someone up"},{trg:"꺼지다",src:"to go out, to turn off, to get lost"}]},
    {type:"match",pairs:[{trg:"껌",src:"chewing gum"},{trg:"꼬리",src:"tail"},{trg:"꼬마",src:"little kid, tot"},{trg:"꼴",src:"appearance, state (often negative)"}]},
