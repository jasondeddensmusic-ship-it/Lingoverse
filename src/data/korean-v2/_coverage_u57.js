...
const COVERAGE_U57 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"등록증",src:"registration card, certificate"},{trg:"등록하다",src:"to register, to enroll"},{trg:"등산로",src:"hiking trail, mountain path"},{trg:"디스크",src:"disk; slipped disc"}]},
    {type:"match",pairs:[{trg:"디자이너",src:"designer"},{trg:"디자인",src:"design"},{trg:"따라다니다",src:"to follow around, to tag along"},{trg:"따라오다",src:"to follow (toward speaker), to keep up"}]},
    {type:"match",pairs:[{trg:"따로따로",src:"separately, individually, each on their own"},{trg:"따스하다",src:"to be warm, to be cozy"},{trg:"딸아이",src:"daughter (informal/affectionate)"},{trg:"땅바닥",src:"ground surface, floor (outdoor)"}]},
    {type:"match",pairs:[{trg:"땅속",src:"underground, beneath the ground"},{trg:"땅콩",src:"peanut"},{trg:"때때로",src:"sometimes, from time to time"},{trg:"때로",src:"sometimes, at times"}]},
    {type:"match",pairs:[{trg:"때리다",src:"to hit, to strike, to slap"},{trg:"땜",src:"(bound noun: because of, for the sake of)"},{trg:"떠나가다",src:"to leave, to depart, to go away"},{trg:"떠나오다",src:"to come away from, to leave and come"}]},
    {type:"match",pairs:[{trg:"떠들썩하다",src:"to be noisy, to be boisterous"},{trg:"떼",src:"crowd, swarm, group (of animals/people)"},{trg:"뚜껑",src:"lid, cap, cover"},{trg:"뚱뚱하다",src:"to be fat, to be chubby"}]},
    {type:"match",pairs:[{trg:"뛰놀다",src:"to run around playing, to frolic"},{trg:"뛰어가다",src:"to run (going away)"},{trg:"뛰어나가다",src:"to run out, to rush outside"},{trg:"뛰어나오다",src:"to run out (toward speaker), to rush out"}]},
    {type:"match",pairs:[{trg:"뛰어놀다",src:"to run around and play"},{trg:"뛰어다니다",src:"to run around (repeatedly), to dash about"},{trg:"뛰어오다",src:"to come running"},{trg:"뛰어오르다",src:"to jump up, to leap upward"}]},
    {type:"match",pairs:[{trg:"뜯다",src:"to tear off, to pluck, to rip"},{trg:"뜰",src:"yard, garden, courtyard"},{trg:"뜻하다",src:"to mean, to intend"},{trg:"띄다",src:"to be spaced, to be noticeable; to float"}]},
    {type:"match",pairs:[{trg:"띄우다",src:"to float, to send, to space out"},{trg:"라운드",src:"round (in sports/games)"},{trg:"라이터",src:"lighter"},{trg:"라인",src:"line"}]},
    {type:"match",pairs:[{trg:"라켓",src:"racket"},{trg:"레몬",src:"lemon"},{trg:"레이저",src:"laser"},{trg:"레저",src:"leisure"}]},
    {type:"match",pairs:[{trg:"렌즈",src:"lens; contact lens"},{trg:"로봇",src:"robot"},{trg:"로터리",src:"rotary, roundabout, traffic circle"},{trg:"리그",src:"league"}]},
    {type:"match",pairs:[{trg:"리터",src:"liter"},{trg:"마누라",src:"wife (informal/old-fashioned)"},{trg:"마디",src:"word, phrase; joint, segment"},{trg:"마땅하다",src:"to be proper, to be fitting, to be right"}]},
    {type:"match",pairs:[{trg:"마라톤",src:"marathon"},{trg:"마무리",src:"finishing, wrapping up"},{trg:"마사지",src:"massage"},{trg:"마요네즈",src:"mayonnaise"}]},
    {type:"match",pairs:[{trg:"마음먹다",src:"to make up one's mind, to decide"},{trg:"마음씨",src:"disposition, nature, temperament"},{trg:"마이크",src:"microphone"},{trg:"마주치다",src:"to run into, to come face to face with"}]},
