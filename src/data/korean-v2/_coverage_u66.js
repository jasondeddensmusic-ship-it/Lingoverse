...
const COVERAGE_U66 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"수입되다",src:"to be imported"},{trg:"수입품",src:"imported goods"},{trg:"수표",src:"check (bank)"},{trg:"수험생",src:"exam candidate, test-taker"}]},
    {type:"match",pairs:[{trg:"수화기",src:"telephone receiver"},{trg:"수저",src:"spoon and chopsticks"},{trg:"수천",src:"thousands, several thousand"},{trg:"수컷",src:"male animal"}]},
    {type:"match",pairs:[{trg:"숙녀",src:"lady, gentlewoman"},{trg:"순간적",src:"momentary, instantaneous"},{trg:"술자리",src:"drinking gathering"},{trg:"숨기다",src:"to hide, to conceal"}]},
    {type:"match",pairs:[{trg:"숨지다",src:"to die, to pass away (formal)"},{trg:"스승",src:"teacher, mentor"},{trg:"스치다",src:"to brush past, to flash by"},{trg:"스케이트",src:"skates, skating"}]},
    {type:"match",pairs:[{trg:"스케줄",src:"schedule"},{trg:"스키장",src:"ski resort"},{trg:"스튜디오",src:"studio"},{trg:"슬쩍",src:"secretly, stealthily"}]},
    {type:"match",pairs:[{trg:"슬퍼하다",src:"to be sad, to grieve"},{trg:"습기",src:"moisture, humidity"},{trg:"시각",src:"time, point in time; visual sense"},{trg:"시금치",src:"spinach"}]},
    {type:"match",pairs:[{trg:"시기",src:"period, era; jealousy"},{trg:"시끄럽다",src:"to be noisy, to be loud"},{trg:"시나리오",src:"scenario, screenplay"},{trg:"시내버스",src:"city bus, local bus"}]},
    {type:"match",pairs:[{trg:"시대적",src:"of the era, epochal"},{trg:"시들다",src:"to wilt, to wither"},{trg:"시디",src:"CD (compact disc)"},{trg:"시디롬",src:"CD-ROM"}]},
    {type:"match",pairs:[{trg:"시멘트",src:"cement"},{trg:"시선",src:"gaze, line of sight"},{trg:"시스템",src:"system"},{trg:"시야",src:"field of vision, perspective"}]},
    {type:"match",pairs:[{trg:"시외",src:"suburbs, outside the city"},{trg:"시외버스",src:"intercity bus, suburban bus"},{trg:"시위",src:"demonstration, protest"},{trg:"시점",src:"point in time, viewpoint"}]},
    {type:"match",pairs:[{trg:"시중",src:"the market, public circulation"},{trg:"시즌",src:"season (sports/entertainment)"},{trg:"시집",src:"collection of poems; husband's family"},{trg:"시집가다",src:"to get married (for women)"}]},
    {type:"match",pairs:[{trg:"시합",src:"match, game, competition"},{trg:"식다",src:"to cool down, to grow cold"},{trg:"식료품",src:"groceries, foodstuffs"},{trg:"식생활",src:"dietary life, eating habits"}]},
    {type:"match",pairs:[{trg:"식욕",src:"appetite"},{trg:"식품점",src:"grocery store, food shop"},{trg:"식히다",src:"to cool (something) down"},{trg:"신경",src:"nerve; attention, care"}]},
