...
{type:"mc",q:"교통사고 means:",opts:["Traffic jam","Traffic accident","Bus stop","Train station"],ans:"Traffic accident",hint:"교통 = traffic. 사고 = accident."},
...
{type:"mc",q:"환경 문제 means:",opts:["Economic crisis","Social problem","Environmental issue","Political debate"],ans:"Environmental issue",hint:"환경 = environment. 문제 = problem/issue."},
...
{type:"mc",q:"이 책이 많이 읽혔어요 means:",opts:["This book reads a lot","I read this book a lot","This book was read a lot","Read this book a lot"],ans:"This book was read a lot",hint:"읽다 → 읽히다 (passive). The book is the subject being read."},
...
{type:"mc",q:"보이다 can be passive (be seen) or causative (show).\n사진을 보여 줬어요 means:",opts:["Showed the photo (causative)","The photo was seen (passive)","Looked at the photo","Will show the photo"],ans:"Showed the photo (causative)",hint:"Object + showed = causative use."},
...
{id:"kou17l3b",title:"-다가: 먹다가",icon:"🔀",xp:22,board:true,steps:[
  ...
  {type:"mc",q:"TV를 보다가 나갔어요 means:",opts:["I watched TV and went out","While watching TV, I went out","After watching TV, I went out","I watch TV outside"],ans:"While watching TV, I went out",hint:"-다가 = switched actions. Was watching TV, then left."},
  ...
  {type:"mc",q:"비가 오다가 갑자기 멈췄어요 means:",opts:["If it rains, it will stop","Because it rained, it stopped","After raining, it stopped","It was raining, then suddenly stopped"],ans:"It was raining, then suddenly stopped",hint:"-다가 = switched states. Rain stopped mid-action."},
...
{id:"kou17l3c",title:"N밖에: 뉴스밖에",icon:"⚠️",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"한국어를 조금밖에 못 해요 means:",opts:["I can speak a lot of Korean","I can only speak a little Korean","I can't speak Korean at all","I speak Korean well"],ans:"I can only speak a little Korean",hint:"N밖에 못 하다 = can do nothing but N. Only a little."},
...
{type:"mc",q:"뉴스에서 사고가 보도됐어요. This means:",opts:["The news caused an accident","An accident was reported on the news","The accident reported the news","Someone reported to the accident"],ans:"An accident was reported on the news",hint:"보도되다 = passive of 보도하다. The accident was reported."},
...
{type:"mc",q:"한국 영화가 유명해졌잖아요 means:",opts:["Korean movies aren't famous","Did Korean movies become famous?","Korean movies will become famous","Korean movies became famous, you know"],ans:"Korean movies became famous, you know",hint:"-아/어지다 (became) + -잖아요 (you know!). Shared knowledge."},
...
{type:"mc",q:"한국 사회가 빠르게 변했어요 means:",opts:["Korean society is changing slowly","Korean society changed rapidly","Korean society didn't change","Korean society will change"],ans:"Korean society changed rapidly",hint:"변하다 = to change. 빠르게 = rapidly. Past tense."},
