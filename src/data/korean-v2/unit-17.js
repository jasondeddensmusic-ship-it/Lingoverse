...
{type:"teach",nl:"기사",en:"news article",pos:"noun",gender:null,example:"A: 오늘 기사 읽었어요?\nB: 네, 아침에 읽었어요.",exampleEn:"A: Did you read today's article?\nB: Yes, this morning.",funFact:"Sino-Korean compound: 기(record/記) + 사(matter/事)",phonetic:"gi-sa",note:"COMPOUND: 기(record/記) + 사(matter/事).\nRecord-matter = news article.",kind:"noun"},
{type:"teach",nl:"사건",en:"incident, event",pos:"noun",gender:null,example:"A: 어제 무슨 사건 있었어요?\nB: 네, 뉴스에 나왔어요.",exampleEn:"A: Was there an incident yesterday?\nB: Yes, it was in the news.",funFact:"Sino-Korean compound: 사(matter/事) + 건(matter/件)",phonetic:"sa-geon",note:"COMPOUND: 사(matter/事) + 건(matter/件).\nMatter-matter = incident/event.",kind:"noun"},
{type:"teach",nl:"사고",en:"accident",pos:"noun",gender:null,example:"A: 교통 사고 봤어요?\nB: 네, 오는 길에 봤어요.",exampleEn:"A: Did you see the traffic accident?\nB: Yes, on the way here.",funFact:"Sino-Korean compound: 사(matter/事) + 고(event/故)",phonetic:"sa-go",note:"COMPOUND: 사(matter/事) + 고(event/故).\n교통사고 = traffic accident.",kind:"noun"},
{type:"teach",nl:"경제",en:"economy",pos:"noun",gender:null,example:"A: 요즘 경제 어때요?\nB: 조금 어려워요.",exampleEn:"A: How is the economy these days?\nB: A bit tough.",funFact:"From hanja: 經 (manage) + 濟 (help). Managing help = economy.",phonetic:"gyeong-je",note:"COMPOUND: 경(manage/經) + 제(aid/濟).\nManage-aid = economy.",kind:"noun"},
{type:"teach",nl:"정치",en:"politics",pos:"noun",gender:null,example:"A: 정치에 관심 있어요?\nB: 아니요, 별로 없어요.",exampleEn:"A: Are you interested in politics?\nB: No, not really.",funFact:"From hanja: 政 (govern) + 治 (rule). Governing rule = politics.",phonetic:"jeong-chi",note:"COMPOUND: 정(govern/政) + 치(manage/治).\nGovern-manage = politics.",kind:"noun"},
{type:"teach",nl:"사회",en:"society",pos:"noun",gender:null,example:"A: 한국 사회는 어때요?\nB: 빠르게 변하고 있어요.",exampleEn:"A: How is Korean society?\nB: It is changing fast.",funFact:"Sino-Korean compound: 사(company/社) + 회(gather/會)",phonetic:"sa-hoe",note:"COMPOUND: 사(company/社) + 회(gather/會).\nCompany-gather = society.",kind:"noun"},
{type:"teach",nl:"환경",en:"environment",pos:"noun",gender:null,example:"A: 환경이 중요해요?\nB: 네, 아주 중요해요.",exampleEn:"A: Is the environment important?\nB: Yes, very important.",funFact:"From hanja: 環 (ring) + 境 (border). Ring border = environment.",phonetic:"hwan-gyeong",note:"COMPOUND: 환(surround/環) + 경(boundary/境).\nSurround-boundary = environment.",kind:"noun"},
...
{type:"teach",nl:"열리다",en:"to be opened",pos:"verb",gender:null,funFact:"Native Korean passive verb. Derived from 열다 (to open) + passive suffix -리. Compare: 닫히다 (to be closed).",phonetic:"yeol-li-da",example:"A: 문이 왜 열려 있어요? B: 바람 때문에 열린 것 같아요. A: 잠가야 하지 않아요? 위험해요. B: 맞아요. 제가 닫을게요. A: 고마워요. 밤에는 꼭 잠그세요.",exampleEn:"A: Why is the door open? B: I think it opened because of the wind. A: Shouldn't we lock it? It's dangerous. B: You're right. I'll close it. A: Thanks. Make sure to lock it at night.",note:"Passive of 열다 (to open).\n문이 열렸어요 = The door was opened.\nSuffix: -리.",kind:"verb"},
{type:"teach",nl:"잡히다",en:"to be caught",pos:"verb",gender:null,funFact:"Passive of 잡다 (to catch). Passive suffix -히-: 잡다 → 잡히다 (to be caught). Common in crime/safety: 범인이 잡혔어요.",phonetic:"jap-hi-da",example:"A: 그 범인이 잡혔대요? B: 네, 어제 밤에 잡혔어요. A: 어디서 잡혔어요? B: 부산에서 잡혔대요. 도망가다가 잡혔어요. A: 다행이에요. 이제 안심이에요.",exampleEn:"A: Did they say the criminal was caught? B: Yes, they were caught last night. A: Where were they caught? B: They said in Busan. They were caught while fleeing. A: That's a relief. I feel safe now.",note:"Passive of 잡다 (to catch).\n범인이 잡혔어요 = The criminal was caught.\nSuffix: -히.",kind:"verb"},
{type:"teach",nl:"보이다",en:"to be seen, to be visible",pos:"verb",gender:null,funFact:"Passive of 보다 (to see). Passive suffix -이-: 보다 → 보이다 (to be visible). 산이 보여요 (the mountain is visible).",phonetic:"bo-i-da",example:"A: 저기 뭐가 보여요? B: 산이 보여요. 날씨가 맑아서 잘 보여요. A: 정말 예쁘네요. 서울에서는 안 보이잖아요. B: 맞아요. 공기가 깨끗할 때만 보여요. A: 사진 찍어도 돼요?",exampleEn:"A: What do you see over there? B: I can see the mountain. It's clear so it's very visible. A: It's really pretty. You can't see it from Seoul. B: Right. It's only visible when the air is clean. A: Can I take a photo?",note:"Passive of 보다 (to see).\n산이 보여요 = The mountain is visible.\nSuffix: -이.",kind:"verb"},
{type:"teach",nl:"들리다",en:"to be heard",pos:"verb",gender:null,funFact:"Passive of 듣다 (to hear). Passive suffix -리-: 듣다 → 들리다 (to be heard). 노래가 들려요 (music is heard).",phonetic:"deul-li-da",example:"A: 이 노래 들려요? B: 네, 어디서 들리는 거예요? A: 옆집에서 들려요. 매일 밤에 음악이 들려요. B: 시끄럽지 않아요? A: 괜찮아요. 좋은 노래라서요.",exampleEn:"A: Can you hear this song? B: Yes, where is it coming from? A: It's coming from next door. I hear music every night. B: Isn't it noisy? A: It's fine. It's a good song.",note:"Passive of 듣다 (to hear). (ㄷ→ㄹ first)\n소리가 들려요 = A sound is heard.\nSuffix: -리.",kind:"verb"},
...
{type:"teach",nl:"높이다",en:"to raise, to increase",pos:"verb",gender:null,funFact:"Causative of 높다 (to be high). Causative suffix -이-: 높이다 (to raise). 수준을 높이다 (to raise the level/standard).",phonetic:"nop-i-da",example:"A: 우리 제품의 품질을 높여야 해요. B: 맞아요. 고객들이 불만이 많아요. A: 어떻게 하면 좋을까요? B: 먼저 재료의 질을 높이면 좋겠어요. A: 좋은 생각이에요. 비용은 좀 올라도 괜찮아요.",exampleEn:"A: We need to raise our product quality. B: Right. Customers have many complaints. A: What should we do? B: First, I think we should raise the quality of materials. A: Good idea. It's okay even if costs go up a bit.",note:"Causative of 높다 (to be high).\n품질을 높여요 = Raise the quality.\nSuffix: -이.",kind:"verb"},
...
{id:"kou17l3b",title:"-다가: 먹다가",icon:"🔀",xp:22,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"-다가",en:"while doing (then switched to)",pos:"part",gender:null,funFact:"'While doing (then switched to).' Ending that marks interruption of one action by another. 먹다가 나갔어요 (I was eating then went out). Distinct from -(으)면서 which is simultaneous.",example:"밥을 먹다가 전화를 받았어요.",exampleEn:"While eating, I got a phone call.",note:"-다가: while doing A, then B.\n\nVerb stem + 다가.\nAction A interrupted or switched.\nUsually same subject."},
  ...
  {type:"teach",kind:"phrase",nl:"운전하다가 사고가 났어요",en:"while driving, an accident happened",pos:"intj",gender:null,funFact:"-다가 (while / mid-action). News often uses -다가 for incidents: 운전하다가 사고가 났어요 (had an accident while driving). Interruption narrative.",example:"고속도로에서 운전하다가 사고가 났어요.",exampleEn:"While driving on the highway, an accident happened.",note:"News often uses -다가 for incidents.\n운전하다가 = while driving."},
...
{type:"teach",kind:"phrase",nl:"일하다가 쉬었어요",en:"while working, I took a break",pos:"intj",gender:null,funFact:"-다가 implies switching action. 일하다가 쉘었어요 = I was working, then took a break. One action gives way to another mid-sequence.",example:"오후에 일하다가 커피를 마시러 나갔어요.",exampleEn:"In the afternoon, while working, I went out to get coffee.",note:"-다가 for switching activities.\nWork was interrupted by the break."},
...
{id:"kou17l3c",title:"N밖에: 뉴스밖에",icon:"⚠️",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"N밖에 + negative",en:"nothing but / only (emphatic)",pos:"part",gender:null,funFact:"'Nothing but / only' (emphatic). Noun + 밖에 + negative verb. 물밖에 없어요 (there's nothing but water). ALWAYS paired with negative; a fixed rule.",example:"시간이 10분밖에 없어요.",exampleEn:"There are only 10 minutes left.",note:"N밖에: nothing but N.\n\nALWAYS + negative verb.\n없어요, 모르다, 못 하다, 안 하다.\n\nMore emphatic than -만."},
...
{type:"teach",kind:"phrase",nl:"시간밖에 없어요",en:"there is only time (nothing but time)",pos:"intj",gender:null,funFact:"-밖에 (only). Always pairs with a negative verb: 시간밖에 없어요 = only time (nothing but time) remains. Stronger than 만 (only).",example:"오늘은 한 시간밖에 없어요.",exampleEn:"Today I only have one hour.",note:"N밖에 없다: nothing but N exists.\nAlways negative verb after 밖에."},
...
{type:"teach",nl:"발표하다",en:"to announce",pos:"verb",gender:null,example:"A: 회사가 새 제품을 발표했어요?\nB: 네, 어제 발표했어요.",exampleEn:"A: Did the company announce a new product?\nB: Yes, yesterday.",funFact:"Sino-Korean compound: 발(send out/發) + 표(show/表)",phonetic:"bal-pyo-ha-da",note:"COMPOUND: 발(send out/發) + 표(show/表).\nSend-out-show = announce.\nPassive: 발표되다 = be announced.",kind:"verb"},
{type:"teach",nl:"보도하다",en:"to report (news)",pos:"verb",gender:null,example:"A: 그 뉴스 보도했어요?\nB: 네, 아침 뉴스에 보도했어요.",exampleEn:"A: Did they report that news?\nB: Yes, on the morning news.",funFact:"Sino-Korean compound: 보(report/報) + 도(guide/導)",phonetic:"bo-do-ha-da",note:"COMPOUND: 보(report/報) + 도(guide/導).\nReport-guide = news reporting.\nPassive: 보도되다 = be reported.",kind:"verb"},
{type:"teach",nl:"체포하다",en:"to arrest",pos:"verb",gender:null,example:"A: 그 사람 잡혔어요?\nB: 네, 경찰이 체포했어요.",exampleEn:"A: Was that person caught?\nB: Yes, the police arrested him.",funFact:"Sino-Korean compound: 체(body/體) + 포(catch/捕)",phonetic:"che-po-ha-da",note:"COMPOUND: 체(body/體) + 포(catch/捕).\nBody-catch = arrest.\nPassive: 체포되다 = be arrested.",kind:"verb"},
...
{type:"teach",nl:"개최하다",en:"to hold (an event)",pos:"verb",gender:null,example:"A: 올림픽은 어디서 해요?\nB: 파리에서 개최해요.",exampleEn:"A: Where are the Olympics held?\nB: They are held in Paris.",funFact:"Sino-Korean compound: 개(open/開) + 최(gather/催)",phonetic:"gae-choe-ha-da",note:"COMPOUND: 개(open/開) + 최(gather/催).\nOpen-gather = hold an event.\nPassive: 개최되다 = be held.",kind:"verb"},
...
{type:"teach",nl:"실시하다",en:"to implement, to carry out",pos:"verb",gender:null,example:"A: 새 정책 언제 시작해요?\nB: 다음 달부터 실시해요.",exampleEn:"A: When does the new policy start?\nB: It starts next month.",funFact:"Sino-Korean compound: 실(real/實) + 시(carry out/施)",phonetic:"sil-si-ha-da",note:"COMPOUND: 실(real/實) + 시(carry out/施).\nPassive: 실시되다 = be implemented.",kind:"verb"},
...
{type:"teach",nl:"한류",en:"Korean Wave (Hallyu)",pos:"noun",gender:null,example:"A: 한류 좋아해요?\nB: 네, K-팝을 자주 들어요.",exampleEn:"A: Do you like the Korean Wave?\nB: Yes, I often listen to K-pop.",funFact:"Sino-Korean compound: 한(Korea/韓) + 류(flow/流)",phonetic:"hal-lyu",note:"COMPOUND: 한(Korea/韓) + 류(flow/流).\nKorea-flow = Korean cultural wave.\nThe global spread of K-culture.",kind:"noun"},
{type:"teach",nl:"방송",en:"broadcast, TV show",pos:"noun",gender:null,example:"A: 이 방송 인기 있어요?\nB: 네, 아주 인기 많아요.",exampleEn:"A: Is this show popular?\nB: Yes, very popular.",funFact:"Sino-Korean compound: 방(release/放) + 송(send/送)",phonetic:"bang-song",note:"COMPOUND: 방(release/放) + 송(send/送).\nRelease-send = broadcast.",kind:"noun"},
{type:"teach",nl:"인기를 얻다",en:"to gain popularity",pos:"verb",gender:null,funFact:"To gain popularity. Fixed idiom. Opposite: 인기를 잃다 (to lose popularity). Both use 인기 (popularity) + verb.",phonetic:"in-gi-reul eot-da",example:"A: 이 드라마가 요즘 인기를 얻고 있어요. B: 정말요? 어떤 드라마예요? A: 사극이에요. 역사 드라마가 인기를 얻고 있어요. B: 저도 사극 좋아해요. 어디서 볼 수 있어요? A: 넷플릭스에서 볼 수 있어요.",exampleEn:"A: This drama is gaining popularity lately. B: Really? What drama is it? A: It's a historical drama. Historical dramas are gaining popularity. B: I like historical dramas too. Where can I watch it? A: You can watch it on Netflix.",note:"인기(popularity) + 를 + 얻다(to gain).\n인기를 얻었어요 = gained popularity.\nOpposite: 인기를 잃다 = lose popularity.",kind:"phrase"},
...
{type:"mc",q:"기생충\n(Parasite) was significant because:",opts:["First Korean drama on Netflix (in most cases)","First Korean film to win Academy Award for Best Picture","First K-pop song to chart globally (in most cases)","First Korean news broadcast (in most cases) (in most cases)"],ans:"First Korean film to win Academy Award for Best Picture",hint:"봉준호 won the top prize at the 2020 Oscars with 기생충. It was a historic moment for non-English cinema."},
...
{type:"teach",nl:"시청자",en:"viewer, audience",pos:"noun",gender:null,example:"A: 이 프로그램 시청자가 많아요?\nB: 네, 백만 명 이상이에요.",exampleEn:"A: Does this program have many viewers?\nB: Yes, over a million.",funFact:"Sino-Korean compound: 시(see/視) + 청(listen/聴) + 자(person/者)",phonetic:"si-cheong-ja",note:"COMPOUND: 시(see/視) + 청(listen/聴) + 자(person/者).\nSee-listen-person = viewer.",kind:"noun"},
{type:"teach",nl:"출연하다",en:"to appear (on a show)",pos:"verb",gender:null,example:"A: 그 배우 어디에 나와요?\nB: 새 드라마에 출연해요.",exampleEn:"A: Where does that actor appear?\nB: In a new drama.",funFact:"Sino-Korean compound: 출(go out/出) + 연(perform/演)",phonetic:"chul-yeon-ha-da",note:"COMPOUND: 출(go out/出) + 연(perform/演).\nGo-out-perform = appear on show.",kind:"verb"},
...
{type:"teach",kind:"grammar",nl:"에 의해(서)",en:"by (agent in passive)",pos:"part",gender:null,funFact:"By (passive agent). Formal passive marker. 책이 작가에 의해서 쓰였어요 (the book was written by the author). Sino-Korean 依 (depend on) origin.",example:"경찰에 의해 범인이 체포됐어요.",exampleEn:"The criminal was arrested by the police.",note:"에 의해: marks who did the action.\nUsed with passive sentences.\nFormal/written style. Common in news."},
...
{type:"mc",q:"공부했어요 vs 공부했었어요:",opts:["Both mean the same (in most cases) (in most cases) (in most cases)","First: studied (neutral). Second: used to study (not anymore).","First is more emphatic (in most cases) (in most cases)","Second is present tense (in most cases) (in most cases)"],ans:"First: studied (neutral). Second: used to study (not anymore).",hint:"-았/었어요 = simple past. -았/었었어요 = discontinued past."},
...
{type:"mc",q:"이 코미디가 관객을 웃겼어요. 웃기다 here is:",opts:["Active (laughed) (in most cases)","Passive (was laughed at) (in most cases)","Causative (made the audience laugh)","Honorific (respectfully laughed)"],ans:"Causative (made the audience laugh)",hint:"The comedy is the subject making something happen in 관객 (the crowd). Which verb type fits?"},
...
{type:"mc",q:"한국 영화가 유명해졌잖아요 means:",opts:["Korean movies aren't famous (in most cases)","Did Korean movies become famous?","Korean movies will become famous","Korean movies became famous, you know"],ans:"Korean movies became famous, you know",hint:"-아/어지다 + -잖아요. Shared knowledge."},

{type:"teach",nl:"기자",en:"reporter, journalist",pos:"noun",gender:null,example:"A: 직업이 뭐예요?\nB: 저는 기자예요.",exampleEn:"A: What is your job?\nB: I am a reporter.",funFact:"From hanja: 記 (record) + 者 (person). Recording person = journalist.",phonetic:"gi-ja",note:"COMPOUND: 기(record/記) + 자(person/者).\nRecord-person = reporter.",kind:"noun"},
...
{type:"teach",nl:"발전하다",en:"to develop, to advance",pos:"verb",gender:null,example:"A: 한국은 어때요?\nB: 빠르게 발전하고 있어요.",exampleEn:"A: How is Korea?\nB: It is developing quickly.",funFact:"Sino-Korean compound: 발(send out/發) + 전(unfold/展)",phonetic:"bal-jeon-ha-da",note:"COMPOUND: 발(send out/發) + 전(unfold/展).\nSend-out-unfold = develop.\n한국이 빠르게 발전했어요.",kind:"verb"},
{type:"teach",nl:"변하다",en:"to change",pos:"verb",gender:null,funFact:"To make laugh. Causative of 웃다 (to laugh). The -기- causative suffix: 웃다 → 웃기다. Common pattern: 입다 → 입히다 (to make wear), 먹다 → 먹이다 (to feed).",phonetic:"byeon-ha-da",example:"A: 이 동네가 많이 변했어요. B: 그러게요. 예전에는 조용했었는데요. A: 건물도 많이 생기고 사람도 많아졌어요. B: 좋은 점도 있지만 아쉬운 점도 있어요. A: 맞아요. 세상이 빠르게 변하네요.",exampleEn:"A: This neighborhood has changed a lot. B: I know. It used to be quiet. A: Many buildings were built and there are more people. B: There are good things but also things to miss. A: Right. The world changes fast.",note:"변(change/變) + 하다.\n세상이 많이 변했어요.\n= The world has changed a lot.",kind:"verb"},
...
{type:"teach",nl:"성장하다",en:"to grow (economy/person)",pos:"verb",gender:null,example:"A: 회사가 잘 돼요?\nB: 네, 많이 성장했어요.",exampleEn:"A: Is the company doing well?\nB: Yes, it has grown a lot.",funFact:"Sino-Korean compound: 성(become/成) + 장(grow/長)",phonetic:"seong-jang-ha-da",note:"COMPOUND: 성(become/成) + 장(grow/長).\nBecome-grow = growth.",kind:"verb"},
...
{type:"mc",q:"한국에 살았었어요 vs 한국에 살았어요:",opts:["Both mean the same (in most cases)","Used to live (not anymore) vs lived (neutral)","First is present, second is past","First is formal (in most cases) (in most cases)"],ans:"Used to live (not anymore) vs lived (neutral)",hint:"The double form carries extra weight: something has clearly ended. The single form is a plain statement of fact."},
