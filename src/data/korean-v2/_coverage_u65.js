...
const COVERAGE_U65 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"세다",src:"to count, to be strong"},{trg:"세로",src:"vertical, lengthwise"},{trg:"세미나",src:"seminar"},{trg:"세상에",src:"oh my, goodness (exclamation)"}]},
    {type:"match",pairs:[{trg:"세제",src:"detergent, cleaning agent"},{trg:"섹시하다",src:"to be sexy"},{trg:"셈",src:"calculation, intention (bound noun)"},{trg:"소규모",src:"small-scale"}]},
    {type:"match",pairs:[{trg:"소나기",src:"sudden rain shower"},{trg:"소망",src:"wish, hope, aspiration"},{trg:"소매",src:"retail, sleeve"},{trg:"소문나다",src:"to become rumored, to be talked about"}]},
    {type:"match",pairs:[{trg:"소설가",src:"novelist"},{trg:"소속",src:"affiliation, belonging"},{trg:"소수",src:"minority, small number"},{trg:"소시지",src:"sausage"}]},
    {type:"match",pairs:[{trg:"소아과",src:"pediatrics"},{trg:"소요되다",src:"to be required (time/cost)"},{trg:"소위",src:"so-called, what is called"},{trg:"소재",src:"material, subject matter, location"}]},
    {type:"match",pairs:[{trg:"소지품",src:"personal belongings"},{trg:"소질",src:"talent, aptitude"},{trg:"소포",src:"package, parcel"},{trg:"소프트웨어",src:"software"}]},
    {type:"match",pairs:[{trg:"소형",src:"small-sized, compact"},{trg:"소홀히",src:"negligently, carelessly"},{trg:"소화",src:"digestion"},{trg:"소화하다",src:"to digest, to handle/manage"}]},
    {type:"match",pairs:[{trg:"속옷",src:"underwear"},{trg:"손길",src:"touch, hand (figurative)"},{trg:"손녀",src:"granddaughter"},{trg:"손등",src:"back of the hand"}]},
    {type:"match",pairs:[{trg:"손발",src:"hands and feet, coordination"},{trg:"손뼉",src:"palms (for clapping)"},{trg:"손쉽다",src:"to be easy, to be simple"},{trg:"손자",src:"grandson"}]},
    {type:"match",pairs:[{trg:"손잡다",src:"to hold hands, to join hands"},{trg:"손잡이",src:"handle, knob, grip"},{trg:"손질하다",src:"to trim, to groom, to prepare"},{trg:"솟다",src:"to rise, to surge, to spring up"}]},
    {type:"match",pairs:[{trg:"송아지",src:"calf (young cow)"},{trg:"송이",src:"cluster, bunch (counter for mushrooms/flowers)"},{trg:"쇠",src:"iron, metal"},{trg:"쇼",src:"show"}]},
