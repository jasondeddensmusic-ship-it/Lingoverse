...
const COVERAGE_U61 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"밤늦다",src:"to be late at night"},{trg:"밤색",src:"chestnut color, brown"},{trg:"밤중",src:"middle of the night"},{trg:"밤하늘",src:"night sky"}]},
    {type:"match",pairs:[{trg:"밥그릇",src:"rice bowl"},{trg:"밥맛",src:"appetite; annoyance"},{trg:"밥솥",src:"rice cooker"},{trg:"방면",src:"direction, area, field"}]},
    {type:"match",pairs:[{trg:"방바닥",src:"room floor"},{trg:"방송사",src:"broadcasting company"},{trg:"방안",src:"inside a room; plan, solution"},{trg:"방울",src:"drop (of liquid); bell"}]},
    {type:"match",pairs:[{trg:"배구",src:"volleyball"},{trg:"배꼽",src:"belly button, navel"},{trg:"배다",src:"to soak in, to permeate; to be pregnant"},{trg:"배드민턴",src:"badminton"}]},
    {type:"match",pairs:[{trg:"배치",src:"arrangement, placement, deployment"},{trg:"백색",src:"white (color, formal)"},{trg:"백성",src:"the people, subjects (historical)"},{trg:"백인",src:"white person, Caucasian"}]},
    {type:"match",pairs:[{trg:"뱀",src:"snake, serpent"},{trg:"뱃사람",src:"boatman, sailor"},{trg:"버려지다",src:"to be thrown away, to be abandoned"},{trg:"버섯",src:"mushroom"}]},
    {type:"match",pairs:[{trg:"버터",src:"butter"},{trg:"버튼",src:"button"},{trg:"번거롭다",src:"to be bothersome, to be cumbersome"},{trg:"번지",src:"house number, address number"}]},
    {type:"match",pairs:[{trg:"벌",src:"punishment; bee (insect); set/suit (counter)"},{trg:"벌금",src:"fine, penalty (money)"},{trg:"벌떡",src:"with a start, suddenly (getting up)"},{trg:"벌레",src:"insect, bug"}]},
    {type:"match",pairs:[{trg:"범죄",src:"crime"},{trg:"법적",src:"legal (as modifier)"},{trg:"베개",src:"pillow"},{trg:"베다",src:"to cut (with a blade)"}]},
    {type:"match",pairs:[{trg:"벤치",src:"bench"},{trg:"변동",src:"fluctuation, change, shift"},{trg:"변명",src:"excuse, justification"},{trg:"변신",src:"transformation, makeover"}]},
    {type:"match",pairs:[{trg:"변화되다",src:"to be changed, to be transformed"},{trg:"별다르다",src:"to be special, to be different (usually negative)"},{trg:"별일",src:"something out of the ordinary"},{trg:"병들다",src:"to fall ill, to become sick"}]},
