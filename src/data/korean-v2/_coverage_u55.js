...
const COVERAGE_U55 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"골고루",src:"evenly, equally"},{trg:"골목길",src:"alley, narrow lane"},{trg:"골짜기",src:"valley, gorge"},{trg:"골치",src:"headache, trouble (figurative)"}]},
    {type:"match",pairs:[{trg:"골프",src:"golf"},{trg:"골프장",src:"golf course"},{trg:"곰",src:"bear"},{trg:"공격",src:"attack, offense"}]},
    {type:"match",pairs:[{trg:"공격하다",src:"to attack, to assault"},{trg:"공공",src:"public, communal"},{trg:"공식",src:"formula; official"},{trg:"공식적",src:"official, formal"}]},
    {type:"match",pairs:[{trg:"공주",src:"princess"},{trg:"공중",src:"the air, midair; the public"},{trg:"공통되다",src:"to be in common, to be shared"},{trg:"공통적",src:"common, shared (adjectival)"}]},
    {type:"match",pairs:[{trg:"공항버스",src:"airport bus"},{trg:"공해",src:"pollution"},{trg:"과연",src:"indeed, as expected; really"},{trg:"과정",src:"process, course, procedure"}]},
    {type:"match",pairs:[{trg:"관계되다",src:"to be related to, to be involved in"},{trg:"관계자",src:"person concerned, stakeholder"},{trg:"관광버스",src:"tour bus, sightseeing bus"},{trg:"관념",src:"notion, concept, idea"}]},
    {type:"match",pairs:[{trg:"관람",src:"viewing, watching (formal)"},{trg:"관람객",src:"viewer, audience member, spectator"},{trg:"관리하다",src:"to manage, to maintain"},{trg:"관습",src:"custom, convention"}]},
    {type:"match",pairs:[{trg:"관심사",src:"matter of interest, concern"},{trg:"광경",src:"sight, scene, spectacle"},{trg:"괴로워하다",src:"to suffer, to agonize"},{trg:"괴롭다",src:"to be agonizing, to be painful"}]},
    {type:"match",pairs:[{trg:"괴롭히다",src:"to torment, to bully, to harass"},{trg:"굉장하다",src:"to be tremendous, to be amazing"},{trg:"교내",src:"on campus, within the school"},{trg:"교대",src:"shift change; teacher's college"}]},
    {type:"match",pairs:[{trg:"교문",src:"school gate"},{trg:"교시",src:"class period (counter)"},{trg:"교양",src:"culture, liberal arts, refinement"},{trg:"교외",src:"suburbs, outskirts"}]},
    {type:"match",pairs:[{trg:"교육비",src:"education expenses"},{trg:"교육자",src:"educator"},{trg:"교장",src:"school principal"},{trg:"교직",src:"teaching profession"}]},
    {type:"match",pairs:[{trg:"교통사고",src:"traffic accident"},{trg:"교환",src:"exchange, swap"},{trg:"교환하다",src:"to exchange, to swap"},{trg:"구경하다",src:"to look around, to sightsee"}]},
