...
const COVERAGE_U68 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"앉히다",src:"to seat (someone), to make sit"},{trg:"알루미늄",src:"aluminum"},{trg:"알코올",src:"alcohol"},{trg:"암",src:"cancer"}]},
    {type:"match",pairs:[{trg:"암시",src:"hint, implication, suggestion"},{trg:"암컷",src:"female animal"},{trg:"앞길",src:"future path, road ahead"},{trg:"앞날",src:"future, days ahead"}]},
    {type:"match",pairs:[{trg:"앞두다",src:"to have ahead, to be approaching"},{trg:"앞뒤",src:"front and back; context"},{trg:"앞서",src:"ahead, before, previously"},{trg:"앞쪽",src:"the front part, forward direction"}]},
    {type:"match",pairs:[{trg:"애인",src:"lover, significant other"},{trg:"애정",src:"affection, love"},{trg:"액세서리",src:"accessory"},{trg:"액수",src:"amount (of money), sum"}]},
    {type:"match",pairs:[{trg:"앨범",src:"album (music or photo)"},{trg:"야간",src:"nighttime, after dark"},{trg:"야구장",src:"baseball stadium"},{trg:"야단",src:"scolding, reprimand"}]},
    {type:"match",pairs:[{trg:"야채",src:"vegetables"},{trg:"약혼녀",src:"fiancee (female)"},{trg:"약혼자",src:"fiance (gender-neutral)"},{trg:"얕다",src:"to be shallow"}]},
    {type:"match",pairs:[{trg:"어느덧",src:"before one knows it, already"},{trg:"어두워지다",src:"to become dark"},{trg:"어려워지다",src:"to become difficult"},{trg:"어린아이",src:"young child, small child"}]},
    {type:"match",pairs:[{trg:"어린애",src:"kid, little child (informal)"},{trg:"어린이날",src:"Children's Day"},{trg:"어머",src:"oh my (exclamation, feminine)"},{trg:"어저께",src:"yesterday (dialect/colloquial)"}]},
    {type:"match",pairs:[{trg:"어젯밤",src:"last night"},{trg:"어지럽다",src:"to be dizzy; to be messy"},{trg:"어째서",src:"why, for what reason"},{trg:"어쩌다가",src:"by chance, accidentally"}]},
    {type:"match",pairs:[{trg:"어찌",src:"how (literary); in what way"},{trg:"어찌나",src:"so much, how (emphatic surprise)"},{trg:"언덕",src:"hill, slope"},{trg:"얻어먹다",src:"to mooch food, to get a free meal"}]},
