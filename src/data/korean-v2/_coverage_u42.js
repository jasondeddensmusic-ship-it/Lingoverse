...
const COVERAGE_U42 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"연구하다",src:"to research, to study"},{trg:"조사하다",src:"to investigate, to survey"},{trg:"프로그램",src:"program"},{trg:"프로",src:"pro, professional"}]},
    {type:"match",pairs:[{trg:"주제",src:"topic, subject, theme"},{trg:"역사가",src:"historian"},{trg:"역사적",src:"historic, historical"},{trg:"예전",src:"the old days, formerly"}]},
    {type:"match",pairs:[{trg:"오래전",src:"a long time ago"},{trg:"오랜",src:"long (duration), long-standing"},{trg:"이날",src:"this day, that day"},{trg:"지난해",src:"last year"}]},
    {type:"match",pairs:[{trg:"한동안",src:"for a while, for some time"},{trg:"팬",src:"fan, supporter"},{trg:"올림픽",src:"Olympics"},{trg:"행사",src:"event, ceremony"}]},
    {type:"match",pairs:[{trg:"훌륭하다",src:"excellent, magnificent, outstanding"},{trg:"표정",src:"facial expression"},{trg:"추억",src:"memory, remembrance (fond)"},{trg:"참가하다",src:"to participate, to take part"}]},
    {type:"match",pairs:[{trg:"온도",src:"temperature"},{trg:"태양",src:"the sun"},{trg:"햇빛",src:"sunlight"},{trg:"햇살",src:"sunbeams, sun rays"}]},
    {type:"match",pairs:[{trg:"지붕",src:"roof"},{trg:"창밖",src:"outside the window"},{trg:"후춧가루",src:"pepper powder, ground pepper"},{trg:"음료",src:"beverage, drink"}]},
    {type:"match",pairs:[{trg:"피부",src:"skin"},{trg:"현금",src:"cash"},{trg:"재산",src:"property, assets, wealth"},{trg:"이용되다",src:"to be used, to be utilized"}]},
    {type:"match",pairs:[{trg:"예상",src:"expectation, forecast"},{trg:"예정",src:"plan, schedule"},{trg:"활용하다",src:"to make use of, to apply"},{trg:"확대되다",src:"to be expanded, to be enlarged"}]},
