...
const COVERAGE_U63 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"비서",src:"secretary, assistant"},{trg:"비우다",src:"to empty, to vacate"},{trg:"비웃다",src:"to ridicule, to sneer at"},{trg:"비추다",src:"to shine, to illuminate, to suggest"}]},
    {type:"match",pairs:[{trg:"비치다",src:"to be reflected, to show through"},{trg:"비키다",src:"to move aside, to step out of the way"},{trg:"비타민",src:"vitamin"},{trg:"비하다",src:"to be compared to, relative to"}]},
    {type:"match",pairs:[{trg:"비행",src:"flight, flying"},{trg:"비행장",src:"airfield, airport"},{trg:"빌딩",src:"building (tall)"},{trg:"빗방울",src:"raindrop"}]},
    {type:"match",pairs:[{trg:"빛깔",src:"color, hue, tint"},{trg:"빠뜨리다",src:"to drop, to leave out, to omit"},{trg:"빠져나가다",src:"to escape, to slip out"},{trg:"빠져나오다",src:"to come out of, to escape (toward speaker)"}]},
    {type:"match",pairs:[{trg:"빨다",src:"to wash (laundry), to suck"},{trg:"빼놓다",src:"to leave out, to exclude"},{trg:"빼앗기다",src:"to have something taken away"},{trg:"빼앗다",src:"to snatch, to take away by force"}]},
    {type:"match",pairs:[{trg:"뺏다",src:"to rob, to take away"},{trg:"뺨",src:"cheek (of face)"},{trg:"뽑히다",src:"to be selected, to be chosen"},{trg:"뿌리치다",src:"to shake off, to reject firmly"}]},
    {type:"match",pairs:[{trg:"사기",src:"fraud, morale"},{trg:"사나이",src:"man, manly fellow"},{trg:"사냥",src:"hunting"},{trg:"사들이다",src:"to buy up, to purchase in bulk"}]},
    {type:"match",pairs:[{trg:"사립",src:"private (institution)"},{trg:"사망하다",src:"to die, to pass away (formal)"},{trg:"사모님",src:"madam, sir's wife (honorific)"},{trg:"사무",src:"office work, clerical affairs"}]},
    {type:"match",pairs:[{trg:"사무소",src:"office, bureau"},{trg:"사무직",src:"office work, desk job"},{trg:"사방",src:"all directions, all sides"},{trg:"사슴",src:"deer"}]},
    {type:"match",pairs:[{trg:"사업가",src:"entrepreneur, businessperson"},{trg:"사업자",src:"business operator, business entity"},{trg:"사이사이",src:"in between, here and there"},{trg:"사이좋다",src:"to be on good terms, to get along well"}]},
    {type:"match",pairs:[{trg:"사정",src:"circumstances, situation, reason"},{trg:"사진기",src:"camera"},{trg:"사촌",src:"cousin"},{trg:"사춘기",src:"puberty, adolescence"}]},
    {type:"match",pairs:[{trg:"사표",src:"letter of resignation"},{trg:"사회생활",src:"social life, working life"},{trg:"사회자",src:"host, MC, moderator"},{trg:"사회주의",src:"socialism"}]},
    {type:"match",pairs:[{trg:"사회학",src:"sociology"},{trg:"산길",src:"mountain path, trail"},{trg:"산부인과",src:"obstetrics and gynecology"},{trg:"산속",src:"deep in the mountains"}]},
