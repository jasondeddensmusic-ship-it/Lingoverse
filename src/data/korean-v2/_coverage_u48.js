...
const COVERAGE_U48 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"개성",src:"individuality; personality; uniqueness"},{trg:"근거하다",src:"to be based on (evidence)"},{trg:"결과적",src:"consequential; as a result"},{trg:"공통되다",src:"to be common; to be shared"}]},
    {type:"match",pairs:[{trg:"공통적",src:"common; shared; mutual"},{trg:"관계되다",src:"to be related; to be connected to"},{trg:"관계없이",src:"regardless of; irrespective of"},{trg:"검토",src:"review; examination; scrutiny"}]},
    {type:"match",pairs:[{trg:"갈다",src:"to grind; to sharpen; to replace"},{trg:"깁다",src:"to scratch; to scrape"},{trg:"걷다",src:"to walk"},{trg:"괽히다",src:"to bend; to bow"}]},
    {type:"match",pairs:[{trg:"구르다",src:"to roll; to tumble"},{trg:"걸치다",src:"to span; to drape over; to extend over"},{trg:"굸다",src:"to starve; to go hungry"},{trg:"갈아입다",src:"to change clothes"}]},
    {type:"match",pairs:[{trg:"건드리다",src:"to touch; to disturb; to tamper with"},{trg:"건네다",src:"to hand over; to pass to"},{trg:"건네주다",src:"to hand over (to someone); to give across"},{trg:"곧다",src:"to be straight; to be upright"}]},
    {type:"match",pairs:[{trg:"귃속",src:"inside the ear"},{trg:"기법",src:"technique; method; skill"},{trg:"기본적",src:"basic; fundamental; standard"},{trg:"기술자",src:"technician; engineer; skilled worker"}]},
    {type:"match",pairs:[{trg:"기술하다",src:"to describe; to narrate; to document"},{trg:"기혼",src:"married (status)"},{trg:"기호",src:"preference; taste; symbol/mark"},{trg:"기막히다",src:"to be astounding; to be speechless"}]},
    {type:"match",pairs:[{trg:"공기",src:"air; atmosphere"},{trg:"겨울철",src:"winter season; wintertime"},{trg:"가라앙다",src:"to sink; to subside; to calm down"},{trg:"깊숙이",src:"deeply; deep inside"}]},
    {type:"match",pairs:[{trg:"가만",src:"still; quietly; without moving"},{trg:"가만있다",src:"to stay still; to remain quiet"},{trg:"갇히다",src:"to be trapped; to be confined"},{trg:"가령",src:"for example; for instance; suppose"}]},
