...
// ═══════════════════════════════════════════════════════════
 ...
 {type:"mc",q:"안녕하세요 literally means:",opts:["Do you have peace?","Good morning","How are you?","I am well"],ans:"Do you have peace?",hint:"안녕 (peace) + 하세요 (do you have / please do)"},
 ...
 {type:"mc",q:"감사합니다 literally means:",opts:["I am grateful","Good thanks","I do gratitude","Thank you very much"],ans:"I do gratitude",hint:"감사 (gratitude) + 합니다 (do formally)"},
 ...
 {type:"mc",q:"미국 literally means:",opts:["Great country","Big country","Beautiful country","New country"],ans:"Beautiful country",hint:"미 = beautiful"},
 ...
 {type:"mc",q:"이름이 뭐예요? means:",opts:["What is your name?","Where are you from?","How are you?","How old are you?"],ans:"What is your name?",hint:"이름 = name, 뭐 = what"},
 ...
 {type:"teach",kind:"word",nl:"괜찮아요",en:"It's okay / I'm fine",pos:"intj",gender:null,funFact:"Tone and context tell the listener which meaning you intend.",phonetic:"gwaen-chan-a-yo",example:"A: 죄송합니다! B: 괜찮아요! A: 감사합니다.",exampleEn:"A: I'm sorry! B: It's okay! A: Thank you.",note:"Three uses:\n1. 'It's okay' (responding to an apology)\n2. 'I'm fine' (when asked how you are)\n3. 'No thanks' (declining politely)",deepDive:{title:"괜찮다: One Word, Many Situations",text:"괜찮다 is one of the most versatile Korean words.\n\nA: 죄송합니다! → B: 괜찮아요. (It's okay.)\nA: 커피 드릴까요? → B: 괜찮아요. (No thanks.)\nA: 괜찮아요? → B: 네, 괜찮아요. (Yes, I'm fine.)\n\nTone and context tell the listener which meaning you intend."}},
  {type:"mc",q:"잠시만요 means:",opts:["I'm sorry","Just a moment","It's okay","Thank you"],ans:"Just a moment",hint:"잠시 = a moment, 만 = only, 요 = polite ending."},
 ...
 {type:"teach",kind:"grammar",nl:"나이",en:"age",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",phonetic:"na-i",example:"A: 나이가 어떻게 되세요? B: 스물다섯 살이에요.",exampleEn:"A: How old are you? B: I am 25.",note:"In Korea, age shapes every social interaction.\nWho bows deeper, who pours drinks, which speech level you use.",deepDive:{title:"나이",text:"Koreans ask age early. It's NOT rude.\nIt's NECESSARY to know how to speak to you."}},
 ...
 {type:"mc",q:"어디 사람이에요? means:",opts:["Where are you from?","What's your name?","How old are you?","What do you do?"],ans:"Where are you from?",hint:"어디 = where, 사람 = person"},
