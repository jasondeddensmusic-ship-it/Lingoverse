...
// ═══════════════════════════════════════════════════════════
 ...
 {type:"teach",kind:"grammar",nl:"이에요 / 예요",en:"am / is / are",pos:"aux",gender:null,funFact:"Polite copula 'am/is/are.' 이에요 after consonant-ending noun (학생이에요), 예요 after vowel (의사예요). Phonological split; most Korean particles pair this way.",phonetic:"i-e-yo / ye-yo",example:"A: 학생이에요? B: 네, 저는 학생이에요. A: 저는 선생님이에요.",exampleEn:"A: Are you a student? B: Yes, I am a student. A: I am a teacher.",note:"After a consonant ending:\n학생이에요.\n→ I am a student.",deepDive:{title:"The Rule",text:"The verb goes at the END. Always.\n엠마예요.\n→ I am Emma.\n\nThe verb goes at the END. Always. -요 = polite marker."}},
 ...
 {id:"kou1l2b",title:"★ The Verb Engine",icon:"🚂",xp:25,board:true,steps:[
  ...
  {type:"teach",kind:"phrase",nl:"있다 → 있어요",en:"to exist / to have → exists (polite)",pos:"verb",gender:null,funFact:"Both stem vowels are dark (ㅣ dark-leaning) → always takes -어요 ending. Regular pattern.",phonetic:"it-da → i-sseo-yo",example:"A: 커피 있어요? B: 네, 있어요! A: 감사합니다!",exampleEn:"A: Is there coffee? B: Yes, there is! A: Thank you!",note:"Drop the suffix to find the stem.\n\n있다\n→ stem: 있\n→ polite present: 있어요\n→ there is / I have (polite).",deepDive:{title:"Conjugating 있다",text:"없다 → stem: 없\n없 + 어요 = 없어요 (don't have / don't exist) ✓\n\nBoth have dark vowels → always -어요."}},
 ...
 {type:"teach",kind:"grammar",nl:"아니요",en:"No",pos:"part",gender:null,funFact:"'No.' One of the first Korean words a learner encounters. Used as a standalone response. Polite-casual; for casual: 아니. For formal: 아닙니다.",phonetic:"a-ni-yo",example:"A: 선생님이에요? B: 아니요, 학생이에요.",exampleEn:"A: Are you a teacher? B: No, I'm a student.",note:"Polite 'no'.\n아니에요: 'am not / is not'. The negative of 이에요/예요.",deepDive:{title:"아니요 vs 아니에요",text:"아니요: standalone 'no' (answering a yes/no question).\n아니에요: 'am not / is not' (negating identity).\n\n학생이에요? 아니요, 의사예요.\nAre you a student? No, I am a doctor."}},
 ...
 {type:"teach",kind:"grammar",nl:"아니에요",en:"to not be (am/is/are not)",pos:"aux",gender:null,funFact:"Negative copula. 아니다 + -에요. 학생이 아니에요 (I'm not a student). Always requires 이/가 subject-particle on the negated noun; stricter than English.",phonetic:"a-ni-e-yo",example:"A: 의사예요? B: 아니에요, 학생이에요. A: 아, 네!",exampleEn:"A: Are you a doctor? B: No, I'm a student. A: Ah, yes!",note:"아니에요 = am not, is not, are not.\n학생이 아니에요.\n→ (I) am not a student.",deepDive:{title:"The Negative Copula Pattern",text:"Pattern: 의사가 아니에요.\n→ is not a doctor.\n\n학생이 아니에요.\n→ (I) am not a student.\n\n⚡ Note: 이/가 goes before 아니에요, NOT 은/는."}},
 ...
 {type:"teach",kind:"grammar",nl:"안",en:"not (pre-verb negation)",pos:"adv",gender:null,funFact:"Pre-verb negation. Goes IMMEDIATELY before the verb: 안 가요 (don't go). For 하다-verbs: 공부 안 해요 (split). Short and casual; chosen in speech more than writing.",phonetic:"an",example:"A: 카페에 가요? B: 아니요, 안 가요.",exampleEn:"A: Are you going to the cafe? B: No, I'm not going.",note:"안 goes directly BEFORE the verb.\n\n안 가요.\n→ I'm not going.",deepDive:{title:"More Examples",text:"안 먹어요.\n→ I don't eat it. (preference)\n\n안 해요.\n→ I'm not doing it.\n\nSimple rule: 안 + verb = negation."}},
 ...
 {type:"teach",kind:"grammar",nl:"-지 않아요",en:"do not (formal/emphatic negation)",pos:"verb",gender:null,funFact:"Negative formal/emphatic ending. -지 않다 (not to be X). 가지 않아요 (does not go). More formal than short-form 안 가요. Preferred in written Korean.",phonetic:"-ji a-na-yo",example:"A: 커피 먹어요? B: 아니요, 먹지 않아요.",exampleEn:"A: Do you drink coffee? B: No, I do not drink it.",note:"Formal negation pattern. Attach to verb stem.\n\n가지 않아요.\n→ I do not go. (formal)",deepDive:{title:"More Examples",text:"먹지 않아요.\n→ I do not eat.\n\n마시지 않아요.\n→ I do not drink.\n\nSame meaning as 안 + verb, but more formal.\n안 가요 = 가지 않아요. Choose by register."}},
 ...
 {type:"teach",kind:"grammar",nl:"아니요, 아니에요",en:"No, it's not",pos:"aux",gender:null,funFact:"Negative copula. 아니다 + -에요. 학생이 아니에요 (I'm not a student). Always requires 이/가 subject-particle on the negated noun; stricter than English.",phonetic:"a-ni-yo, a-ni-e-yo",example:"A: 택시예요? B: 아니요, 버스예요. A: 아, 버스!",exampleEn:"A: Is it a taxi? B: No, it's a bus. A: Ah, a bus!",note:"아니요 = no (standalone rejection)\n아니에요 = is not (negation inside sentence)\n",deepDive:{title:"아니요, 아니에요",text:"아니요, 학생이에요.\n→ No, I'm a student. (correcting someone)"}},
 ...
 {type:"teach",kind:"grammar",nl:"이름이 뭐예요?",en:"What is your name?",pos:"aux",gender:null,funFact:"'What is your name?' 이름 (name) + 이 (subject particle) + 뭐 (what) + 예요 (is). Name-asking is one of the first Korean phrases; and culturally tied to honorifics: asking older vs younger person differs.",phonetic:"i-reum-i mwo-ye-yo?",example:"A: 이름이 뭐예요? B: 저는 민수예요.",exampleEn:"A: What's your name? B: I'm Minsu.",note:"이름\n→ name (one word)\n\n이름 + 이\n→ the 이 after it is the subject marker\n\n뭐예요\n→ what is?",deepDive:{title:"Asking Names in Korean Culture",text:"Koreans more often use titles than first names.\n\nAt work: position + 님 (김 과장님 = Manager Kim).\nWith friends: 이름 or nickname.\nWith strangers: avoid names entirely.\n\n이름 (name) comes from the verb 이르다 (to tell/name)."}},
