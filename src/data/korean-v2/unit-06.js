...
{id:"kou6l3",title:"(으)로: By and Toward",icon:"🛤️",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"에게 and 한테 are:",opts:["Same meaning, 에게 is formal","에게 is for places","한테 is for things","Different meanings"],ans:"Same meaning, 에게 is formal",hint:"Two forms of the dative particle exist: one formal, one casual. They share meaning."},
]},
...
{id:"kou6l4.1",title:"Directions: Left, Right, Straight",icon:"🧭",xp:18,board:true,steps:[
  ...
  {type:"mc",q:"'Where is the bathroom?' in Korean:",opts:["화장실이 뭐예요?","화장실이 어디에 있어요?","화장실을 가요?","화장실에서 있어요?"],ans:"화장실이 어디에 있어요?",hint:"Ask where a specific facility is located using the location-existence question."},
  ...
  {type:"mc",q:"Correct way to say 'meet at exit 9':",opts:["9번 출구 앞에서 만나요","9번에서 만나요","역에 만나요","9번에 역을 만나요"],ans:"9번 출구 앞에서 만나요",hint:"Arrange to meet at the front of a specific numbered station exit."},
...
{id:"kou6l4.2",title:"Positions: Above, Beside, Between",icon:"📍",xp:18,board:true,steps:[
  ...
  {type:"mc",q:"'Between the bank and the café':",opts:["은행 카페 위에","은행과 카페 옆에","은행과 카페 사이에","은행과 카페 밖에"],ans:"은행과 카페 사이에",hint:"Located between two buildings: one for money, one for coffee."},
...
{id:"kou6l6",title:"Weather Talk",icon:"🌤️",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"'It's raining' in Korean:",opts:["비가 와요","비가 있어요","비가 내려요","비가 해요"],ans:"비가 와요",hint:"In Korean, precipitation uses a movement verb. It 'comes' rather than 'falls.'"},
...
{id:"kou6l6b",title:"옷 (Clothing)",icon:"👔",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"양말을 ___요.\n(I put on socks.)",opts:["입어","써","신어","끼"],ans:"신어",hint:"Put on footwear using the verb specifically for items worn on the feet."},
...
{id:"kou6l6d",title:"방향: 동서남북 (Cardinal Directions)",icon:"🧭",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"남산타워 is on which mountain?",opts:["남산 (South Mountain)","북한산 (North Han Mountain)","동대문 (East Gate area)","서울산 (Seoul Mountain)"],ans:"남산 (South Mountain)",hint:"The iconic mountain in Seoul means 'south' plus a word for elevated terrain."},
...
{id:"kou6l8",title:"Review and Quiz",icon:"📝",xp:30,board:true,steps:[
  ...
  {type:"mc",q:"The polite form of 'to eat' ends in 어요. What is the part before the polite ending?",opts:["먹어","먹","어요","먹어요"],ans:"먹",hint:"Strip 다 from 먹다. Remaining = stem."},
