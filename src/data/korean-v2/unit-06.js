...
{id:"kou6l1",title:"Transport Words",icon:"🚌",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"지하철 decomposes into:",opts:["지 (earth) + 하철 (rail)","지하 (underground) + 철 (iron)","지하 (lower) + 전 (electric)","All one piece"],ans:"지하 (underground) + 철 (iron)",hint:"Underground + iron/rail"},
  {type:"mc",q:"비행기 means 'airplane' because:",opts:["It sounds like English 'fly'","From Chinese characters only","비행 (flying) + 기 (machine)","It's an old native Korean word"],ans:"비행 (flying) + 기 (machine)",hint:"Flying-machine = airplane"},
...
{id:"kou6l3",title:"(으)로: By and Toward",icon:"🛤️",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"(으)로 with transport means:",opts:["by (means of)","from","at","toward"],ans:"by (means of)",hint:"버스로 = by bus. This particle marks the METHOD of travel."},
  ...
  {type:"mc",q:"에게 and 한테 are:",opts:["에게 is for places","Same meaning, 에게 is formal","한테 is for things","Different meanings"],ans:"Same meaning, 에게 is formal",hint:"Two forms of the dative particle exist: one formal, one casual. They share meaning."},
]},
...
{id:"kou6l4.1",title:"Directions: Left, Right, Straight",icon:"🧭",xp:18,board:true,steps:[
  ...
  {type:"mc",q:"쪽 in 왼쪽/오른쪽 means:",opts:["Turn / rotate","Hand / palm","Side / direction","Road / street"],ans:"Side / direction",hint:"쪽 = side/direction suffix. 이쪽, 앞쪽, 뒤쪽 all use it."},
  ...
  {type:"mc",q:"직진 = 직 + 진. What does it mean?",opts:["Go straight","Turn left","Slow down","Go back"],ans:"Go straight",hint:"직 (straight) + 진 (advance)"},
...
{id:"kou6l4.2",title:"Positions: Above, Beside, Between",icon:"📍",xp:18,board:true,steps:[
  ...
  {type:"mc",q:"왼쪽 means:",opts:["Left","Right","Straight","Nearby"],ans:"Left",hint:"왼 = left, 오른 = right"},
  ...
  {type:"mc",q:"역 means:",opts:["Exit","Bus stop","Station","Bridge"],ans:"Station",hint:"역 = subway/train station"},
  ...
  {type:"mc",q:"안 ↔ 밖 means:",opts:["Front ↔ Back","Inside ↔ Outside","Left ↔ Right","Above ↔ Below"],ans:"Inside ↔ Outside",hint:"안 = inside, 밖 = outside"},
...
{id:"kou6l6",title:"Weather Talk",icon:"🌤️",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"오늘 날씨가 어때요?  -  날씨 means:",opts:["Weather","Temperature","Season","Wind"],ans:"Weather",hint:"날씨 = weather. 어때요? = How is it?"},
  ...
  {type:"mc",q:"춥다 → 추워요 is an example of:",opts:["Regular conjugation pattern","ㅂ-irregular (ㅂ becomes 워)","르-irregular pattern type","으-irregular pattern type"],ans:"ㅂ-irregular (ㅂ becomes 워)",hint:"The irregular consonant in this adjective class changes before vowel endings."},
  ...
  {type:"mc",q:"하늘색 = 하늘 + 색. 색 means:",opts:["Sky","Clear","Cloud","Color"],ans:"Color",hint:"하늘 (sky) + 색 (color) = sky-blue color"},
  ...
  {type:"mc",q:"비가 와요 means:",opts:["It is raining","It is snowing","It is sunny","It is windy"],ans:"It is raining",hint:"비 = rain, 오다 = to come → rain is coming = it is raining"},
  {type:"mc",q:"날마다 = 매일. 마다 means:",opts:["Only","Every/each","Also","But"],ans:"Every/each",hint:"마다 = every/each. 날마다 = every day."},
...
{id:"kou6l6b",title:"옷 (Clothing)",icon:"👔",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"Which verb goes with 안경?",opts:["끼다 (hand verb)","입다 (torso verb)","신다 (feet verb)","쓰다 (head verb)"],ans:"쓰다 (head verb)",hint:"Glasses go on your face/head area"},
]},
...
{id:"kou6l6d",title:"방향: 동서남북 (Cardinal Directions)",icon:"🧭",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"남대문 = 남 + 대 + 문. 문 means:",opts:["river","mountain","gate / door","road"],ans:"gate / door",hint:"대문 means great gate. 문 is used for doors and gates."},
  ...
  {type:"mc",q:"남산타워 is on which mountain?",opts:["서울산 (Seoul Mountain)","북한산 (North Han Mountain)","동대문 (East Gate area)","남산 (South Mountain)"],ans:"남산 (South Mountain)",hint:"The iconic mountain in Seoul means 'south' plus a word for elevated terrain."},
...
{id:"kou6l7",title:"Transit Compounds + 한강",icon:"🌉",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"공항 = 공 + 항. 항 means:",opts:["Air","Port","Machine","Road"],ans:"Port",hint:"공 (air) + 항 (port) = airport"},
  ...
  {type:"mc",q:"버스 정류장 = 버스 + 정류 + 장. 장 means:",opts:["Bus","Stop","Line","Place"],ans:"Place",hint:"장 = place. 주차장 (parking place), 시장 (market place)"},
...
{id:"kou6l9.2",title:"Adverbs and Question Words",icon:"📊",xp:18,board:true,steps:[
  ...
  {type:"mc",q:"얼마나 means:",opts:["when","how many","where","how much/long"],ans:"how much/long",hint:"A question word for degree or duration. 얼마나 걸려요? = How long does it take?"},
  ...
  {type:"mc",q:"별로 / 전혀 always pair with:",opts:["Negative sentences (안/못/없어요)","Positive sentences (verb + 요)","Questions only (interrogative)","Past tense only (았/었어요)"],ans:"Negative sentences (안/못/없어요)",hint:"별로 안 좋아요, 전혀 없어요  -  always negative"},
...
{id:"kou6l8",title:"Review and Quiz",icon:"📝",xp:30,board:true,steps:[
  ...
  {type:"mc",q:"지하 means 'underground'. 지하철 therefore means:",opts:["Fast train","Underground train","City bus","Underground tunnel"],ans:"Underground train",hint:"지하 (underground) + 철 (iron/rail) = subway/metro."},
  ...
  {type:"mc",q:"공항 = 공 + 항. 공 means:",opts:["Korean / domestic","Air / public / empty","Machine / device","Port / harbor"],ans:"Air / public / empty",hint:"공 (空): air, public, empty. 공기, 공원, 공항"},
  {type:"mc",q:"비가 와요  -  why 와요 (come) not another verb?",opts:["No reason, just random","와요 sounds nice and soft","Korean sees rain as coming","It is a translation of English"],ans:"Korean sees rain as coming",hint:"비가 오다 = rain comes = it rains. 눈이 오다 = snow comes = it snows."},
  ...
  {type:"mc",q:"지금까지 배운 것으로 할 수 있는 것은?",opts:["회의에서 유창하게 말하기 (Speak fluently in meetings)","한국 소설 읽기 (Read Korean novels)","자막 없이 드라마 보기 (Watch dramas without subs)","기본 생활 한국어 (Handle survival Korean)"],ans:"기본 생활 한국어 (Handle survival Korean)",hint:"At this stage you can navigate, eat, shop, ask directions, handle numbers."},
]},
