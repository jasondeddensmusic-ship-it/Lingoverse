...
{id:"kou6l6c",title:"옷 더 배우기 (More Clothing)",icon:"👗",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"부츠",en:"boots",pos:"noun",gender:null,funFact:"Use 신다 (feet-wear verb). Korean has specific verbs for each body zone: 쓰다 (head), 입다 (torso), 신다 (feet).",phonetic:"bu-cheu",example:"A: 비가 와요! B: 부츠를 신으세요.",exampleEn:"A: It's raining! B: Wear boots.",note:"부츠: boots (Konglish).\nUse 신다 (feet verb).\n겨울 부츠 = winter boots."},
