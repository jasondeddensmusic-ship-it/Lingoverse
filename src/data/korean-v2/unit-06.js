...
{id:"kou6l1",title:"Transport Words",icon:"🚌",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"타다",en:"to ride / take (transport)",pos:"verb",gender:null,funFact:"Subway. Sino-Korean 地下鐵 (underground-iron). Literally 'underground iron (road).' Seoul subway (서울 지하철) is one of the world's most extensive and punctual.",phonetic:"ta-da",example:"A: 뭘 타요? B: 매일 지하철을 타요.",exampleEn:"A: What do you ride? B: I take the subway every day.",note:"타다: universal 'board/ride' verb for transport.\n\n버스를 타다: take the bus",deepDive:{title:"Using 타다",text:"택시를 타다: take a taxi\n자전거를 타다: ride a bicycle\n말을 타다: ride a horse\n\n내리다: to get off (opposite of 타다)."}},
...
{id:"kou6l9.2",title:"Adverbs and Question Words",icon:"📊",xp:18,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"얼마나",en:"how much / how long",pos:"noun",gender:null,funFact:"Why. Question word. Often doubles as exclamation 'Why?!' in emotional speech. Intonation distinguishes: rising tone = question, flat = mild confusion, sharp = reproach.",phonetic:"eol-ma-na",example:"A: 역까지 얼마나 걸려요? B: 걸어서 십 분이에요.",exampleEn:"A: How long to the station? B: 10 minutes on foot.",note:"얼마나: how much / how long.\n얼마나 멀어요? = How far is it?"},
