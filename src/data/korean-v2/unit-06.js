...
{id:"kou6l1",title:"Transport Words",icon:"🚌",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"KTX",en:"bullet train",pos:"noun",gender:null,funFact:"Korea Train eXpress, the bullet train. Reaches 305 km/h. Seoul-Busan in 2.5 hours. Launched 2004; based on French TGV technology.",phonetic:"ke-i-ti-ekseu",example:"A: KTX가 빨라요? B: 네, 아주 빨라요!",exampleEn:"A: Is the KTX fast? B: Yes, very fast!",note:"Korea Train eXpress, the bullet train.\nSeoul to Busan in 2.5 hours."},
  ...
  {type:"teach",kind:"word",nl:"타다",en:"to ride / take (transport)",pos:"verb",gender:null,funFact:"To ride / take (transport). Native Korean verb. 버스를 타다 (take the bus), 택시를 타다 (take a taxi). Core transit vocabulary.",phonetic:"ta-da",example:"A: 뭘 타요? B: 매일 지하철을 타요.",exampleEn:"A: What do you ride? B: I take the subway every day.",note:"타다: universal 'board/ride' verb for transport.\n\n버스를 타다: take the bus",deepDive:{title:"Using 타다",text:"택시를 타다: take a taxi\n자전거를 타다: ride a bicycle\n말을 타다: ride a horse\n\n내리다: to get off (opposite of 타다)."}},
...
{id:"kou6l2",title:"에 vs 에서 Named",icon:"📍",xp:25,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"에서",en:"at / in (action location)",pos:"noun",gender:null,funFact:"Location-of-action particle. Test: Is there an action? Then use 에서. For static existence (있다/없다), use plain 에 instead.",phonetic:"e-seo",example:"A: 어디에서 공부해요? B: 학교에서 공부해요.",exampleEn:"A: Where do you study? B: I study at school.",note:"에서 marks WHERE an ACTION happens.\n\n학교에서 공부해요: study AT school.",deepDive:{title:"Using 에서",text:"카페에서 커피를 마셔요: drink coffee AT the café.\n도서관에서 책을 읽어요: read books AT the library.\n\nTest: Is there an ACTION verb?\nYes → 에서\nNo (just being/going) → 에"}},
...
{id:"kou6l3",title:"(으)로: By and Toward",icon:"🛤️",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"(으)로",en:"by (means) / toward (direction)",pos:"noun",gender:null,funFact:"One particle, two uses: means (by bus/by subway) and direction (toward a place). Context decides; Korean loves economy.",phonetic:"(eu)-ro",example:"A: 어떻게 가요? B: 버스로 가요.",exampleEn:"A: How do you get there? B: I go by bus.",note:"Marks direction or means (by bus, by subway). Attaches after vowel/ㄹ as 로, after other consonants as 으로.",deepDive:{title:"Using (으)로",text:"로: after vowels or ㄹ\n으로: after other consonants\n\n지하철로 (지하철 ends in a consonant → 로)\n버스로 (버스 ends in vowel → 로)\n학교으로 ✗ → 학교로 ✓ (ends in vowel → 로)\n\n왼쪽으로 (왼쪽 ends in consonant ㄱ → 으로)"}},
  {type:"teach",kind:"phrase",nl:"로. transport use",en:"by (vehicle/method)",pos:"intj",gender:null,funFact:"Marks METHOD of transport: 버스로 가요 (I go by bus), 기차로 가요 (by train), 비행기로 가요 (by plane).",phonetic:"ro",example:"A: 기차로 가요? B: 네, 기차로 가요.",exampleEn:"A: Are you going by train? B: Yes, I'm going by train.",note:"Marks the METHOD of transport:\n\n버스로 가요: go by bus",deepDive:{title:"Using 로. transport use",text:"지하철로 가요: go by subway\n비행기로 가요: go by plane\n걸어서 가요: go on foot (걸어서 = by walking)\n\n걸어서: special form. 걷다 (walk) + -어서."}},
  {type:"teach",kind:"phrase",nl:"로. direction use",en:"toward / in the direction of",pos:"intj",gender:null,funFact:"Marks DIRECTION: 학교로 가요 (I go TOWARD school). Contrast with 에 which marks a fixed destination.",phonetic:"ro",example:"A: 어디로 가요? B: 왼쪽으로 가세요.",exampleEn:"A: Which way do I go? B: Please go to the left.",note:"Marks DIRECTION:\n\n왼쪽으로 가세요: go LEFT",deepDive:{title:"Using 로. direction use",text:"오른쪽으로 가세요: go RIGHT\n앞으로 가세요: go FORWARD\n뒤로 가세요: go BACK\n출구 쪽으로 가세요: go toward the exit"}},
  ...
  {type:"teach",kind:"word",nl:"기다리다",en:"to wait",pos:"verb",gender:null,funFact:"Native Korean verb, no hanja. Irregular vowel contraction: 기다리 + -어요 → 기다려요 (ㅣ+ㅓ→ㅕ).",phonetic:"gi-da-ri-da",example:"A: 지금 뭐 해요? B: 버스를 기다려요.",exampleEn:"A: What are you doing now? B: I'm waiting for the bus.",note:"기다리다 → 기다려요 (polite present).\nㅣ+ㅓ contracts to ㅕ.",deepDive:{title:"Common Phrases",text:"여기에서 기다리세요: please wait here.\n잠깐만 기다려요: wait a moment.\n버스를 기다려요: I'm waiting for the bus."}},
  {type:"teach",kind:"word",nl:"찾다",en:"to find / to look for",pos:"verb",gender:null,funFact:"Native Korean verb: to find / to look for. Bright-vowel stem (ㅏ): 찾다 + -아요 → 찾아요. Often used with direction particle: 이걸 찾고 있어요.",phonetic:"chat-da",example:"A: 뭘 찾아요? B: 지하철역을 찾아요.",exampleEn:"A: What are you looking for? B: I'm looking for the subway station.",note:"찾다 → 찾아요 (polite present).\nBright vowel in stem.",deepDive:{title:"Common Uses",text:"길을 찾다: look for the way.\n친구를 찾다: look for a friend.\n지갑을 찾다: look for a wallet.\n\n찾았어요!: I found it!"}},
  {type:"teach",kind:"grammar",nl:"(이)랑",en:"and / with (casual)",pos:"part",gender:null,funFact:"'And / with' (casual). (이) appears after consonant-ending nouns (친구랑 / 책이랑). Casual equivalent of formal 와/과. Feels conversational and warm.",phonetic:"(i)-rang",example:"A: 누구랑 가요? B: 친구랑 같이 가요.",exampleEn:"A: Who are you going with? B: I'm going with a friend.",note:"Casual and/with particle.\n\nAfter vowel: no extra syllable.\nAfter consonant: extra syllable added.",deepDive:{title:"(이)랑",text:"Vowel ending + 랑: 친구랑, 엄마랑\nConsonant ending + 이랑: 선생님이랑, 동생이랑\n\n친구랑 = 친구하고 (same meaning, more casual).\n\n하고: neutral.\n(이)랑: casual/spoken.\n와/과: formal/written."}},
  ...
  {type:"teach",kind:"phrase",nl:"에게 / 한테",en:"to (a person)",pos:"verb",gender:null,funFact:"To / at (destination or static location). Multi-purpose particle. Three jobs: destination (가요 → 에), static location (있다 → 에), time (에). 'One particle, three jobs' isn't unusual.",phonetic:"e-ge / han-te",example:"A: 누구한테 전화해요? B: 엄마한테 전화해요.",exampleEn:"A: Who are you calling? B: I'm calling mom.",note:"에게: to (a person). formal/written.\n한테: to (a person). casual/spoken.",deepDive:{title:"Using 에게 / 한테",text:"친구에게 = 친구한테 (same meaning).\n\n선생님에게 물어봤어요: I asked the teacher.\n엄마한테 전화했어요: I called mom.\n\n에: for places/things.\n에게/한테: for people/animals."}},
...
{id:"kou6l4.1",title:"Directions: Left, Right, Straight",icon:"🧭",xp:18,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"왼쪽",en:"left",pos:"noun",gender:null,funFact:"Left. 왼 (left) + 쪽 (side). 왼 from Old Korean for 'incorrect/weak' (in contrast to 오른 = right/correct). Left-handedness historically carried superstition.",phonetic:"oen-jjok",example:"A: 어디로 가요? B: 왼쪽으로 가세요.",exampleEn:"A: Which way do I go? B: Go to the left.",note:"왼쪽: left (side).\n쪽 = side / direction."},
  {type:"teach",kind:"word",nl:"오른쪽",en:"right",pos:"noun",gender:null,funFact:"Right. 오른 (right) + 쪽 (side). Connected to 옳다 (to be right/correct). Korean equates the right side with correctness; same metaphor across many languages.",phonetic:"o-reun-jjok",example:"A: 카페가 어디에 있어요? B: 오른쪽에 있어요.",exampleEn:"A: Where is the cafe? B: It's on the right.",note:"오른쪽: right (side).\n왼쪽 (left) ↔ 오른쪽 (right)."},
  ...
  {type:"teach",kind:"word",nl:"유턴",en:"U-turn",pos:"noun",gender:null,funFact:"U-turn. English loan, written in hangul. Pronounced 유턴 (yu-teon). Driving vocabulary in Korea is heavily English-borrowed: 핸들 (handle/steering), 백미러 (rear-view mirror).",phonetic:"yu-teon",example:"A: 길을 지나쳤어요. B: 여기서 유턴하세요.",exampleEn:"A: I passed the road. B: Make a U-turn here.",note:"유턴: U-turn (Konglish from English)."},
  {type:"teach",kind:"word",nl:"근처",en:"nearby / in the vicinity",pos:"noun",gender:null,funFact:"Nearby / in the vicinity. Sino-Korean 近處. Compound: 근 (near) + 처 (place). Standard location word, neutral register. More casual: 가까이.",phonetic:"geun-cheo",example:"A: 여기 근처에 카페가 있어요? B: 네, 역 근처에 있어요.",exampleEn:"A: Is there a cafe nearby? B: Yes, there's one near the station.",note:"근처: nearby area.\n근처에: in the vicinity of.",deepDive:{title:"Using 근처",text:"여기 근처에: near here\n학교 근처에: near the school\n역 근처에: near the station\n\n역: (subway/train) station. important word!"}},
  {type:"mc",q:"근처 means:",opts:["Far away","Nearby","Inside","Behind"],ans:"Nearby",hint:"근처 = … area / in the vicinity"},
  {type:"teach",kind:"phrase",nl:"어디에 있어요?",en:"Where is it?",pos:"intj",gender:null,funFact:"'Where is it?' 어디 (where) + 에 (location particle) + 있어요 (to be, for location). Contrast 이에요/예요 (to be, identity). Korean splits location and identity into separate copula verbs.",phonetic:"eo-di-e i-sseo-yo?",example:"A: 화장실이 어디에 있어요? B: 저기 왼쪽에 있어요.",exampleEn:"A: Where is the bathroom? B: Over there on the left.",note:"어디: where (question word).\n어디에 있어요?: 'Where does it exist?'\n= Where is it?",deepDive:{title:"Using 어디에 있어요?",text:"화장실이 어디에 있어요?: Where's the bathroom?\n출구가 어디에 있어요?: Where's the exit?\n지하철역이 어디에 있어요?: Where's the subway station?"}},
  {type:"teach",kind:"word",nl:"역",en:"station (subway/train)",pos:"noun",gender:null,funFact:"Station (subway/train). Sino-Korean 驛. Appears in station names: 서울역, 홍대입구역. Always suffixed to the station name.",phonetic:"yeok",example:"A: 다음 역이 어디예요? B: 서울역이에요.",exampleEn:"A: What's the next station? B: It's Seoul Station.",note:"역: station.\n\n홍대역: Hongdae Station",deepDive:{title:"Using 역",text:"강남역: Gangnam Station\n서울역: Seoul Station\n\n역 근처에: near the station\n몇 번 출구: which numbered exit\n\n번: number counter (for numbering things)."}},
...
{id:"kou6l4.2",title:"Positions: Above, Beside, Between",icon:"📍",xp:18,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"위",en:"above / on top of",pos:"noun",gender:null,funFact:"Above / on top of. Native Korean. Takes 에 for location: 책상 위에 (on the desk). Positional nouns always take locative 에.",phonetic:"wi",example:"A: 책이 어디에 있어요? B: 책상 위에 있어요.",exampleEn:"A: Where is the book? B: It's on top of the desk.",note:"위: above, on top.\n위에: on top of / above (+ 에 for location).",deepDive:{title:"Using 위",text:"책상 위에: on the desk.\n냉장고 위에: on top of the fridge.\n\n위 ↔ 아래/밑: top ↔ bottom."}},
  {type:"teach",kind:"word",nl:"옆",en:"beside / next to",pos:"noun",gender:null,funFact:"Beside / next to. Native Korean. 나 옆에 (beside me). One syllable; compact, unique to Korean.",phonetic:"yeop",example:"A: 은행이 어디에 있어요? B: 학교 옆에 있어요.",exampleEn:"A: Where is the bank? B: It's next to the school.",note:"옆: beside, next to.\n옆에: next to / beside.",deepDive:{title:"Using 옆",text:"학교 옆에: next to the school.\n내 옆에 앉아요: sit next to me.\n\n방향(direction) vs 위치(position):\n왼쪽으로 가세요 (direction) vs 옆에 있어요 (position)."}},
  {type:"mc",q:"왼쪽 means:",opts:["Left","Right","Straight","Nearby"],ans:"Left",hint:"왼 = …, 오른 = right"},
  {type:"teach",kind:"word",nl:"밖",en:"outside",pos:"noun",gender:null,funFact:"Outside. Native Korean. 집 밖에 (outside the house). Also means 'besides / other than' in compound expressions: 그것밖에 없어요 (there's nothing besides that).",phonetic:"bak",example:"A: 고양이가 어디에 있어요? B: 밖에 있어요.",exampleEn:"A: Where is the cat? B: It's outside.",note:"밖: outside.\n밖에: outside of.",deepDive:{title:"Using 밖",text:"안 (inside) ↔ 밖 (outside).\n\n밖에 나가요: go outside.\n문 밖에: outside the door.\n집 밖에: outside the house."}},
  {type:"teach",kind:"word",nl:"사이",en:"between",pos:"noun",gender:null,funFact:"Between. Position noun, used with particle: A와 B 사이에 (between A and B). Also: 관계 사이 (relationship between parties).",phonetic:"sa-i",example:"A: 약국이 어디에 있어요? B: 은행과 카페 사이에 있어요.",exampleEn:"A: Where is the pharmacy? B: It's between the bank and the cafe.",note:"사이: between.\nBetween A and B (position particle).",deepDive:{title:"Using 사이",text:"은행과 카페 사이에: between the bank and café.\n\n사이 also means 'relationship':\n우리 사이: our relationship / between us."}},
  {type:"teach",kind:"word",nl:"아래 / 밑",en:"below / under",pos:"noun",gender:null,funFact:"Below / under. Two synonyms with subtle differences. 아래 is more literal/spatial (under the desk), 밑 can be figurative (under pressure, under someone's leadership).",phonetic:"a-rae / mit",example:"A: 가방이 어디에 있어요? B: 책상 아래에 있어요.",exampleEn:"A: Where is the bag? B: It's under the desk.",note:"아래: below, under.\n밑: under (interchangeable).\n\n위 ↔ 아래: above ↔ below.\n책상 아래에 = under the desk."},
  {type:"teach",kind:"word",nl:"앞",en:"front / in front of",pos:"noun",gender:null,funFact:"Front / in front of. Native Korean. 학교 앞에서 (in front of the school). Also metaphorical: 앞으로 (from now on, forward).",phonetic:"ap",example:"A: 어디에서 만나요? B: 학교 앞에서 만나요.",exampleEn:"A: Where shall we meet? B: Let's meet in front of the school.",note:"앞: front, in front of.\n앞에: in front of (location).\n앞으로: forward (direction).\n\n앞 ↔ 뒤: front ↔ behind."},
  {type:"teach",kind:"word",nl:"뒤",en:"behind / back",pos:"noun",gender:null,funFact:"Behind / back. Native Korean. Paired with 앞 for spatial contrast. 뒤에서 말하다 (to speak behind someone's back); universal metaphor.",phonetic:"dwi",example:"A: 주차장이 어디에 있어요? B: 건물 뒤에 있어요.",exampleEn:"A: Where is the parking lot? B: It's behind the building.",note:"뒤: behind, back.\n뒤에: behind (location).\n뒤로: backward (direction).\n\n앞 ↔ 뒤: front ↔ behind."},
  ...
  {type:"teach",kind:"phrase",nl:"건너다 / 건너가다",en:"to cross",pos:"verb",gender:null,funFact:"Left (in u6 transport context). Reinforces previous learning. Direction vocabulary crucial for navigation Korean.",phonetic:"geon-neo-da",example:"A: 여기에서 어떻게 가요? B: 길을 건너세요.",exampleEn:"A: How do I go from here? B: Cross the street.",note:"건너다: to cross.\n건너가다: to go across.",deepDive:{title:"Using 건너다 / 건너가다",text:"길을 건너다: cross the road.\n다리를 건너다: cross the bridge.\n횡단보도: crosswalk.\n\n건너세요: please cross (polite command)."}},
  {type:"mc",q:"역 means:",opts:["Exit","Bus stop","Station","Bridge"],ans:"Station",hint:"역 = subway/train …"},
  {type:"teach",kind:"phrase",nl:"돌다 / 돌아가다",en:"to turn",pos:"verb",gender:null,funFact:"To turn. 돌다 (to rotate); simple turn. 돌아가다 (to go back, to go around); compound with 가다. Context decides which to use.",phonetic:"dol-da",example:"A: 직진해요? B: 아니요, 왼쪽으로 돌아가세요.",exampleEn:"A: Go straight? B: No, turn left.",note:"돌다: to turn.\n돌아가다: to turn and go.",deepDive:{title:"Using 돌다 / 돌아가다",text:"왼쪽으로 돌아가세요: turn left.\n오른쪽으로 돌아가세요: turn right.\n\n좌회전/우회전: formal signs.\n돌아가세요 = conversational direction."}},
...
{id:"kou6l5",title:"★ Verb Review: Contractions + Irregular Seeds",icon:"🔧",xp:25,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"과거 시제 미리보기",en:"Adding the past tense car",pos:"part",gender:null,funFact:"Past tense preview. Korean past tense is formed with -았/었 infix inserted between stem and ending. Covered systematically in later units.",phonetic:"",example:"A: 어제 뭐 했어요? B: 밥을 먹었어요.",exampleEn:"A: What did you do yesterday? B: I ate a meal.",note:"The past tense adds ONE car between the stem and -요:\n\n가다 → 갔어요 (bright ㅏ → 았어요)",deepDive:{title:"과거 시제 미리보기",text:"먹다 → 먹었어요 (dark ㅓ → 었어요)\n하다 → 했어요 (always)\n\n⚡ Same vowel harmony rule applies to past!\nBright stem → -았어요\nDark stem → -었어요\n하다 → 했어요 (did)\n\nThis is later. You're ready. Just notice the pattern now."}},
  ...
  {type:"teach",kind:"grammar",nl:"읽다 → 읽어요",en:"to read → reads",pos:"verb",gender:null,funFact:"To read. Native Korean. 읽 (stem) + 어요 (vowel harmony: 이 is yin). Past: 읽었어요. Transitive: requires 을/를 object.",phonetic:"ik-da → il-geo-yo",example:"A: 뭐 해요? B: 책을 읽어요.",exampleEn:"A: What are you doing? B: I'm reading a book.",note:"읽다: to read.\n\n읽다 → 읽어요\n→ Dark vowel ㅣ in stem → takes -어요.",deepDive:{title:"Pronunciation Note",text:"읽다 is pronounced [익따]. The ㄹ is silent.\n읽어요 is pronounced [일거요]. The ㄹ reappears before a vowel.\n\nThis is 연음 (liaison). Spelling stays the same."}},
  {type:"teach",kind:"grammar",nl:"쓰다 → 써요 (write/use)",en:"to write / to use → writes / uses",pos:"part",gender:null,funFact:"To write / to use (homophone). 으-irregular. Both senses use the same verb; context decides. 편지를 써요 (I write a letter) vs 컴퓨터를 써요 (I use the computer).",phonetic:"sseu-da → sseo-yo",example:"A: 지금 뭐 해요? B: 편지를 써요.",exampleEn:"A: What are you doing now? B: I'm writing a letter.",note:"쓰다: to write OR to use.\n\n쓰다 → 써요\n→ ㅡ drops, -어요 attaches.",deepDive:{title:"Two Meanings of 쓰다",text:"쓰다 (to write):\n편지를 써요 = I write a letter.\n이름을 써요 = I write a name.\n\n쓰다 (to use):\n이거 써요 = I use this.\n한국어를 써요 = I use Korean.\n\nContext makes it clear."}},
  {type:"teach",kind:"phrase",nl:"일하다 → 일해요",en:"to work → works",pos:"verb",gender:null,funFact:"하다-verb conjugation. 일하다 always becomes 일해요 in polite present. All 하다 verbs follow this pattern irregularly.",phonetic:"il-ha-da → il-hae-yo",example:"A: 어디에서 일해요? B: 회사에서 일해요.",exampleEn:"A: Where do you work? B: I work at a company.",note:"일하다: to work.\n하다 compound: 일 (work) + 하다 (do).\n\n일하다 → 일해요 (always 해요).",deepDive:{title:"일 = Work",text:"일하다 = to work (noun + 하다).\nSame pattern as 공부하다, 운동하다.\n\n회사에서 일해요: I work at a company.\n매일 일해요: I work every day.\n\n일 also means 'day' and 'one' in different contexts."}},
  {type:"teach",kind:"grammar",nl:"주다 → 줘요",en:"to give → gives",pos:"part",gender:null,funFact:"To give. Regular verb, stem 주- + 어요 → 줘요. Important construction: 주다 also forms V+아/어 주다 meaning 'do for someone'; a politeness builder.",phonetic:"ju-da → jweo-yo",example:"A: 누구한테 줘요? B: 친구한테 선물을 줘요.",exampleEn:"A: Who are you giving it to? B: I'm giving a gift to my friend.",note:"주다: to give.\n\n주다 → 줘요\n→ ㅜ + 어 = ㅝ contraction.",deepDive:{title:"주다 in Patterns",text:"주다 alone = to give:\n물 좀 줘요 = give me some water\n\n-아/어 주다 = do FOR someone:\n읽어 줘요 = read it for me\n도와줘요 = help me\n\n⚡ -아/어 주다 (doing-for-someone) gets its own lesson later."}},
  ...
  {type:"teach",kind:"grammar",nl:"자다 → 자요",en:"to sleep → sleeps",pos:"part",gender:null,funFact:"To sleep. Regular contraction: 자 + 아요 → 자요 (the 아 is absorbed). Informal: 자다가 (while sleeping), 잠을 자다 (to sleep sleep, a cognate object).",phonetic:"ja-da → ja-yo",example:"A: 보통 몇 시에 자요? B: 11시에 자요.",exampleEn:"A: What time do you usually sleep? B: I sleep at 11.",note:"자다: to sleep.\n\n자다 → 자요\n→ Bright ㅏ merges with -아요.",deepDive:{title:"Sleep Vocabulary",text:"자다 → 자요: to sleep\n일어나다 → 일어나요: to wake up\n졸리다 → 졸려요: to be sleepy\n\n잘 자요! = Good night!\n잘 잤어요? = Did you sleep well?"}},
  {type:"teach",kind:"grammar",nl:"앉다 → 앉아요",en:"to sit → sits",pos:"verb",gender:null,funFact:"To sit. Native Korean. 앉 + 아요 (vowel harmony). Imperative: 앉으세요 (please sit). Essential classroom/restaurant vocabulary.",phonetic:"an-da → an-ja-yo",example:"A: 어디에 앉아요? B: 여기 앉아요.",exampleEn:"A: Where do I sit? B: Sit here.",note:"앉다: to sit.\n\n앉다 → 앉아요\n→ Bright ㅏ in stem → takes -아요.",deepDive:{title:"앉다 Pronunciation",text:"앉다 (to sit) = [안따]. 앉아요 (sit, polite) = [안자요].\n\n여기 앉으세요 = please sit here.\nOpposite: 서다 → 서요 (to stand)."}},
  {type:"teach",kind:"grammar",nl:"입다 → 입어요",en:"to wear (clothes) → wears",pos:"verb",gender:null,funFact:"To wear (clothes). Native Korean. Specific to putting-on clothes vs 쓰다 (hat), 신다 (shoes), 하다 (accessories). Korean distinguishes body-placement of clothing precisely.",phonetic:"ip-da → i-beo-yo",example:"A: 오늘 뭐 입어요? B: 티셔츠를 입어요.",exampleEn:"A: What are you wearing today? B: I'm wearing a T-shirt.",note:"입다: to wear (clothes).\n\n입다 → 입어요\n→ Dark vowel ㅣ → takes -어요.",deepDive:{title:"Korean 'Wear' Verbs",text:"Korean has DIFFERENT verbs for different items:\n입다: clothes (shirts, pants)\n신다: shoes/socks (feet)\n쓰다: hats/glasses (head)\n끼다: gloves/rings (hands)\n하다: accessories (ties, scarves)\n\nEnglish uses one 'wear' for everything.\nKorean specifies WHERE on the body."}},
...
{id:"kou6l6",title:"Weather Talk",icon:"🌤️",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"날씨",en:"weather",pos:"part",gender:null,funFact:"Weather. Native Korean word (not Sino-Korean). Contrast: 기후 (climate) is Sino-Korean from 氣候. 날씨 covers daily weather; 기후 covers long-term patterns.",phonetic:"nal-ssi",example:"A: 오늘 날씨가 어때요? B: 맑아요!",exampleEn:"A: How's the weather today? B: It's clear!",note:"날씨: weather.\n날: day/weather. 씨: suffix.",deepDive:{title:"Full Pattern",text:"날씨가 어때요?: How's the weather?\n어때요?: 'How is it?'. very useful question pattern."}},
  {type:"teach",kind:"grammar",nl:"덥다 → 더워요",en:"to be hot (weather) → it's hot",pos:"part",gender:null,funFact:"Hot (weather). ㅂ-irregular. Distinction: 덥다 for weather/environment; 뜨겁다 for a hot object (coffee, stove).",phonetic:"deop-da → deo-wo-yo",example:"A: 밖에 더워요? B: 네, 오늘 너무 더워요.",exampleEn:"A: Is it hot outside? B: Yes, it's really hot today.",note:"덥다 → 더워요 (ㅂ-irregular).\nNOT the expected form. Irregular change applies.\nFull pattern in a later lesson.",deepDive:{title:"ㅂ-Irregular Weather Words",text:"덥다 → 더워요 (hot)\n춥다 → 추워요 (cold)\n\nSame ㅂ→워 pattern in both.\nJust remember: 더워요, 추워요."}},
  {type:"teach",kind:"grammar",nl:"춥다 → 추워요",en:"to be cold (weather) → it's cold",pos:"part",gender:null,funFact:"Cold (weather), ㅂ-irregular. Past tense: 추웠어요. Future: 추울 거예요. Full conjugation paradigm of ㅂ-irregulars must be memorized together.",phonetic:"chup-da → chu-wo-yo",example:"A: 겨울에 추워요? B: 네, 너무 추워요.",exampleEn:"A: Is it cold in winter? B: Yes, it's very cold.",note:"춥다 → 추워요 (ㅂ-irregular).\nNOT the expected regular form. Same irregular pattern.",deepDive:{title:"Seasons in Korean",text:"봄\n→ spring\n\n여름\n→ summer\n\n가을\n→ autumn\n\n겨울\n→ winter\n\n여름에 더워요: It's hot in summer.\n겨울에 추워요: It's cold in winter."}},
  {type:"mc",q:"오늘 날씨가 어때요? 날씨 means:",opts:["Weather","Temperature","Season","Wind"],ans:"Weather",hint:"날씨 = …. 어때요? = How is it?"},
  {type:"teach",kind:"grammar",nl:"맑다 → 맑아요",en:"to be clear/sunny → it's clear",pos:"verb",gender:null,funFact:"To be clear / sunny. Native Korean. Weather and water clarity. 하늘이 맑아요 (the sky is clear). Photography-era vocabulary.",phonetic:"mak-da → mal-ga-yo",example:"A: 오늘 날씨가 어때요? B: 날씨가 맑아요.",exampleEn:"A: How's the weather today? B: The weather is clear.",note:"맑다: clear, sunny.\n맑아요: regular! (no irregular change)",deepDive:{title:"How to be clear/sunny Works",text:"날씨가 맑아요: the weather is clear\n하늘이 맑아요: the sky is clear\n\n하늘: sky. 하늘색: sky-blue (하늘 + 색)."}},
  {type:"teach",kind:"phrase",nl:"비가 와요",en:"it's raining",pos:"intj",gender:null,funFact:"Korean thinks of rain, snow as 'coming':.",phonetic:"bi-ga wa-yo",example:"A: 밖에 비가 와요? B: 네, 비가 많이 와요.",exampleEn:"A: Is it raining outside? B: Yes, it's raining a lot.",note:"비: rain.\n와요: comes. 비가 오다 literally means rain comes.",deepDive:{title:"Using 비가 와요",text:"Korean thinks of rain, snow as 'coming':\n비가 와요: rain comes = it rains\n눈이 와요: snow comes = it snows\n\n비가 많이 와요: it rains a lot\n비가 조금 와요: it rains a little"}},
  {type:"teach",kind:"grammar",nl:"흐리다 → 흐려요",en:"to be cloudy → it's cloudy",pos:"part",gender:null,funFact:"Cloudy / murky. Regular ㅣ + 어 → 여 contraction. Also used for cloudy water, cloudy mind. Metaphorically extends from weather.",phonetic:"heu-ri-da → heu-ryeo-yo",example:"A: 날씨가 좋아요? B: 아니요, 오늘 흐려요.",exampleEn:"A: Is the weather nice? B: No, it's cloudy today.",note:"흐리다: cloudy.\n흐려요: it's cloudy (이 + 어 → 여 contraction).",deepDive:{title:"Full Pattern",text:"Same pattern you saw with 마시다 → 마셔요.\n이 + 어 → 여 (vowel contraction)\n\n맑음: clear (weather forecast)\n흐림: cloudy (weather forecast)\n비: rain (weather forecast)"}},
  ...
  {type:"teach",kind:"word",nl:"바람",en:"wind",pos:"noun",gender:null,funFact:"Wind. Native Korean. Also means 'wish/hope' in different context: 바람이 있다 (to have a wish). Two homophones distinguished by context.",phonetic:"ba-ram",example:"A: 밖에 바람이 불어요? B: 네, 바람이 많이 불어요.",exampleEn:"A: Is the wind blowing outside? B: Yes, the wind is blowing a lot.",note:"바람: wind.\n바람이 세요 means the wind is strong."},
  {type:"teach",kind:"word",nl:"산",en:"mountain",pos:"noun",gender:null,funFact:"Mountain. Sino-Korean 山. Korea is ~70% mountainous. Mountains are central to Korean identity: 설악산, 지리산, 한라산. Most have stories and hiking trails.",phonetic:"san",example:"A: 주말에 뭐 해요? B: 산에 가요.",exampleEn:"A: What are you doing this weekend? B: I'm going to the mountain.",note:"산: mountain.\n한라산 = Hallasan (Jeju's famous mountain)."},
  {type:"teach",kind:"word",nl:"바다",en:"sea / ocean",pos:"noun",gender:null,funFact:"Sea / ocean. Native Korean. Contrast Sino-Korean 해양 (oceanography). Korea has 3 coastlines: East Sea, Yellow Sea, South Sea; each with distinct character.",phonetic:"ba-da",example:"A: 산이 좋아요, 바다가 좋아요? B: 바다가 좋아요!",exampleEn:"A: Do you like the mountain or the sea? B: I like the sea!",note:"바다: sea / ocean.\n부산 바다 = Busan's famous beaches."},
...
{id:"kou6l6b",title:"옷 (Clothing)",icon:"👔",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"모자",en:"hat / cap",pos:"noun",gender:null,funFact:"Hat / cap. Use 쓰다 (head-wear verb). Korean has specific verbs for each body zone: 쓰다 (head), 입다 (torso), 신다 (feet).",phonetic:"mo-ja",example:"A: 밖에 해가 강해요. B: 모자를 쓰세요!",exampleEn:"A: The sun is strong outside. B: Wear a hat!",note:"모자: hat/cap.\nUse 쓰다 (head verb).\n\n쓰다 has THREE meanings:\n1. to write\n2. to use\n3. to wear (on head)"},
  {type:"teach",kind:"word",nl:"양말",en:"socks",pos:"noun",gender:null,funFact:"Sino-Korean: 洋襪 (Western-sock). Socks were a Western-introduced garment; 洋 (Western) appears in many modernization-era compounds.",phonetic:"yang-mal",example:"A: 양말을 신었어요? B: 네, 하얀 양말을 신었어요.",exampleEn:"A: Did you put on socks? B: Yes, I put on white socks.",note:"양말: socks.\nUse 신다 (feet verb)."},
  ...
  {type:"teach",kind:"word",nl:"목도리",en:"scarf / muffler",pos:"noun",gender:null,funFact:"Scarf / muffler. Native Korean (목 = neck). Accessories use 하다 as wearing verb: 목도리를 하다 (wear a scarf).",phonetic:"mok-do-ri",example:"A: 목도리를 해요? B: 네, 겨울에 항상 해요.",exampleEn:"A: Do you wear a scarf? B: Yes, I always wear one in winter.",note:"목도리: scarf/muffler.\n목(neck) + 도리(wrap).\nUse 하다 (accessory verb)."},
  {type:"teach",kind:"word",nl:"장갑",en:"gloves",pos:"noun",gender:null,funFact:"Sino-Japanese loan: from Japanese かばん (kaban). Originally Chinese 鏄 (bag/satchel); borrowed into Korean via Japanese.",phonetic:"jang-gap",example:"A: 손이 차가워요! B: 장갑을 끼세요.",exampleEn:"A: My hands are cold! B: Put on gloves.",note:"장갑: gloves.\nUse 끼다 (hand verb)."},
  {type:"teach",kind:"word",nl:"가방",en:"bag",pos:"noun",gender:null,funFact:"Sino-Japanese loan. Japanese かばん (kaban) from Chinese 鏄 (bag/satchel); borrowed into Korean via Japanese.",phonetic:"ga-bang",example:"A: 가방이 무거워요? B: 네, 책이 많아요.",exampleEn:"A: Is your bag heavy? B: Yes, there are many books.",note:"가방: bag/backpack.\nCommon compound: 책가방 (book bag)."},
  ...
  {type:"teach",kind:"word",nl:"구두",en:"dress shoes / formal shoes",pos:"noun",gender:null,funFact:"Use 신다 (feet-wear verb). Korean has specific verbs for each body zone: 쓰다 (head), 입다 (torso), 신다 (feet).",phonetic:"gu-du",example:"A: 구두를 신어요? B: 네, 회사에 갈 때 신어요.",exampleEn:"A: Do you wear dress shoes? B: Yes, when I go to the office.",note:"구두: formal/dress shoes.\nUse 신다 (feet verb)."},
...
{id:"kou6l6c",title:"옷 더 배우기 (More Clothing)",icon:"👗",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"바지",en:"pants / trousers",pos:"noun",gender:null,funFact:"Use 입다 (torso/body-wear verb). Korean has specific verbs for each body zone: 쓰다 (head), 입다 (torso), 신다 (feet).",phonetic:"ba-ji",example:"A: 오늘 뭐 입어요? B: 검은 바지를 입어요.",exampleEn:"A: What are you wearing today? B: I'm wearing black pants.",note:"바지: pants (pure Korean).\nUse 입다 (torso/body verb).\n검은 바지 = black pants."},
  ...
  {type:"teach",kind:"word",nl:"부츠",en:"boots",pos:"noun",gender:null,funFact:"Konglish: 부츠 from English 'boots.' 겨울 부츠 (winter boots) is essential in Seoul winters. Worn with 신다 (feet-wear verb).",phonetic:"bu-cheu",example:"A: 비가 와요! B: 부츠를 신으세요.",exampleEn:"A: It's raining! B: Wear boots.",note:"부츠: boots (Konglish).\nUse 신다 (feet verb).\n겨울 부츠 = winter boots."},
  {type:"mc",q:"부츠를 ___요.\n(I wear boots.)",opts:["입어","신어","써","끼"],ans:"신어",hint:"Boots go on your feet. Which verb is for footwear?"},
  {type:"teach",kind:"word",nl:"벨트 / 허리띠",en:"belt",pos:"noun",gender:null,funFact:"Belt. 벨트 English loan; 허리띠 native Korean (허리 = waist + 띠 = band). Accessories use 하다: 벨트를 하다.",phonetic:"bel-teu / heo-ri-tti",example:"A: 바지가 커요? B: 네, 벨트를 해요.",exampleEn:"A: Are your pants big? B: Yes, I wear a belt.",note:"벨트: belt (Konglish).\n허리띠: belt (native Korean).\n허리(waist) + 띠(band).\nUse 하다 (accessory verb)."},
  {type:"teach",kind:"word",nl:"넥타이",en:"necktie / tie",pos:"noun",gender:null,funFact:"Necktie / tie. English loanword. Accessory uses 하다: 넥타이를 하다 (wear a tie). Business attire vocabulary.",phonetic:"nek-ta-i",example:"A: 회사에 넥타이를 해요? B: 네, 매일 넥타이를 해요.",exampleEn:"A: Do you wear a tie to work? B: Yes, I wear a tie every day.",note:"넥타이: necktie (Konglish).\nUse 하다 (accessory verb).\n넥타이를 매다 also works."},
...
{id:"kou6l6d",title:"방향: 동서남북 (Cardinal Directions)",icon:"🧭",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"동 / 동쪽",en:"east",pos:"noun",gender:null,funFact:"East. 동 is Sino-Korean 東; 동쪽 adds native 쪽 (direction). Used in place names: 동대문 (East Great Gate), 동해 (East Sea).",phonetic:"dong / dong-jjok",example:"A: 해가 어디에서 떠요? B: 동쪽에서 떠요.",exampleEn:"A: Where does the sun rise? B: It rises in the east.",note:"동(東): east.\n동쪽: east side/direction.\n쪽 = side/direction suffix.\n동해 = East Sea."},
  {type:"teach",kind:"word",nl:"서 / 서쪽",en:"west",pos:"noun",gender:null,funFact:"West. Sino-Korean 西. Seen in: 서울 (capital, literally 'western capital' in old name), 서대문, 서해 (West/Yellow Sea).",phonetic:"seo / seo-jjok",example:"A: 해가 어디에서 져요? B: 서쪽에서 져요.",exampleEn:"A: Where does the sun set? B: It sets in the west.",note:"서(西): west.\n서쪽: west side/direction.\n서울: capital city.\n서해: West Sea (Yellow Sea)."},
  {type:"teach",kind:"word",nl:"남 / 남쪽",en:"south",pos:"noun",gender:null,funFact:"South. Sino-Korean 南. 남대문 (South Great Gate), 남한 (South Korea), 남해 (South Sea). Also appears in names (Nam Junhyuk, 남 as surname).",phonetic:"nam / nam-jjok",example:"A: 제주도가 어디에 있어요? B: 한국 남쪽에 있어요.",exampleEn:"A: Where is Jeju Island? B: It's in the south of Korea.",note:"남(南): south.\n남쪽: south side/direction.\n남산: South Mountain (서울).\n남해: South Sea."},
  {type:"teach",kind:"word",nl:"북 / 북쪽",en:"north",pos:"noun",gender:null,funFact:"North. Sino-Korean 北. 북한 (North Korea), 북대문. Note: in 서울, 북 appears in district names. Compass points carry cultural weight beyond geography.",phonetic:"buk / buk-jjok",example:"A: 겨울에 북쪽이 추워요? B: 네, 아주 추워요.",exampleEn:"A: Is it cold in the north in winter? B: Yes, it's very cold.",note:"북(北): north.\n북쪽: north side/direction.\n북한: North Korea.\n북해: North Sea."},
...
{id:"kou6l7",title:"Transit Compounds + 한강",icon:"🌉",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"phrase",nl:"버스 정류장",en:"bus stop",pos:"intj",gender:null,funFact:"Compound: 버스 (bus, loanword) + 정류 (stop/stay, 停留) + 장 (place, 場). Literally 'bus-stopping-place.' Seoul has 20,000+ bus stops.",phonetic:"beo-seu jeong-ryu-jang",example:"A: 버스 정류장이 어디에 있어요? B: 저기 오른쪽에 있어요.",exampleEn:"A: Where is the bus stop? B: Over there on the right.",note:"COMPOUND: 버스 + 정류 + 장.\n정류: stop/stay. 정 (stop/fix) + 류 (flow).\n'Stop the flow' = stopping place.",deepDive:{title:"Using 버스 정류장",text:"장: place.\n\n버스 정류장: 'bus stopping-place'\n주차장: parking lot (주차 + 장: parking place)\n화장실: bathroom (화장 + 실: makeup-clean room)"}},
  ...
  {type:"teach",kind:"word",nl:"출구",en:"exit",pos:"noun",gender:null,funFact:"Sino-Korean: 出口 (exit-mouth = exit/gate). Opposite: 입구 (入口 = entrance). Seoul subway exits are numbered: 3번 출구.",phonetic:"chul-gu",example:"A: 몇 번 출구로 나가요? B: 3번 출구로 나오세요.",exampleEn:"A: Which exit do I go out? B: Please come out exit 3.",note:"SINO-KOREAN: 출 + 구.\n출 (出): to go out. 구 (口): mouth/opening.\n'Going-out opening' = exit.",deepDive:{title:"Using 출구",text:"출 reappears in:\n출근: going to work (출 + 근: out + attendance)\n출발: departure (출 + 발: out + departure)\n\n나오세요: please come out (나오다 + 세요)"}},
  ...
  {type:"teach",kind:"phrase",nl:"T-money 카드",en:"T-money card",pos:"intj",gender:null,funFact:"Rechargeable transit card. Buy at any 편의점 (convenience store). Works on subway, bus, taxi, and for small purchases in 7-Eleven and GS25.",phonetic:"tee-meo-ni ka-deu",example:"A: 어떻게 타요? B: T-money 카드로 타요.",exampleEn:"A: How do you ride? B: I ride using the T-money card.",note:"T-money: Korea's rechargeable transit card.\n\n지하철, 버스, 택시. all accept T-money.",deepDive:{title:"Using T-money 카드",text:"Buy at any 편의점 (convenience store).\nTop up at subway machines.\n\n카드를 찍다: tap the card\n요금: fare (교통 요금: transit fare)"}},
...
{id:"kou6l9.1",title:"못, -지만 and Connectors",icon:"🔗",xp:20,board:true,steps:[
  ...
  // ── 안 vs 못 ──
  {type:"teach",kind:"phrase",nl:"안 vs 못",en:"won't (choice) vs can't (inability)",pos:"part",gender:null,phonetic:"an / mot",funFact:"Won't (choice) vs can't (inability). Fundamental negation distinction. 안 해요 (not doing by choice) vs 못 해요 (unable to do). Korean grammaticalizes intent vs ability.",
  ...
  // ── 그런데 ──
  {type:"teach",kind:"phrase",nl:"그런데 / 근데",en:"but / by the way",pos:"conj",gender:null,phonetic:"geu-reon-de / geun-de",funFact:"But / by the way. 그런데 full form, 근데 casual contraction. Sentence-starting connector; introduces contrast or topic shift.",
  ...
  // ── 그러면 ──
  {type:"teach",kind:"phrase",nl:"그러면 / 그럼",en:"then / in that case",pos:"conj",gender:null,phonetic:"geu-reo-myeon / geu-reom",funFact:"Then / in that case. 그러면 full, 그럼 casual. Conditional-result connector. 비가 오면 그럼 집에 있어요 (if it rains, then I stay home).",
...
{id:"kou6l9.2",title:"Adverbs and Question Words",icon:"📊",xp:18,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"자주",en:"often",pos:"noun",gender:null,funFact:"Native Korean adverb: often / frequently. Contrast: 가끔 (sometimes), 드물게 (rarely).",phonetic:"ja-ju",example:"A: 자주 운동해요? B: 네, 매일 운동해요.",exampleEn:"A: Do you exercise often? B: Yes, I exercise every day.",note:"자주: often / frequently.\nAdverb. goes before the verb."},
  {type:"teach",kind:"word",nl:"가끔",en:"sometimes",pos:"noun",gender:null,funFact:"Sometimes. Native Korean frequency adverb. Middle of the scale: 항상 (always) > 자주 (often) > 가끔 (sometimes) > 별로 (not really) > 전혀 (never).",phonetic:"ga-kkeum",example:"A: 영화를 자주 봐요? B: 아니요, 가끔 봐요.",exampleEn:"A: Do you watch movies often? B: No, I watch sometimes.",note:"가끔: sometimes / occasionally."},
  {type:"teach",kind:"word",nl:"보통",en:"usually",pos:"noun",gender:null,funFact:"Usually / normally. Also means 'average' or 'ordinary.' 보통이에요 = it's ordinary; 보통 9시에 시작해요 = usually starts at 9.",phonetic:"bo-tong",example:"A: 몇 시에 일어나요? B: 보통 8시에 일어나요.",exampleEn:"A: What time do you wake up? B: I usually wake up at 8.",note:"보통: usually / normally.\nAlso means 'average' or 'ordinary.'"},
  {type:"mc",q:"가끔 means:",opts:["sometimes","often","always","never"],ans:"sometimes",hint:"A frequency adverb between 자주 (often) and 전혀 (never)."},

  {type:"teach",kind:"word",nl:"별로",en:"not really",pos:"noun",gender:null,funFact:"Not really / not particularly. Negative intensifier, only used with negative verbs: 별로 안 좋아요 (not particularly good). Cannot be used affirmatively.",phonetic:"byeol-lo",example:"A: 이 영화 좋아요? B: 별로 안 좋아요.",exampleEn:"A: Is this movie good? B: It's not really good.",note:"별로: not really. ALWAYS with a negative.\n별로 안 + verb = not really (verb)."},
  {type:"teach",kind:"word",nl:"전혀",en:"not at all / absolutely not",pos:"noun",gender:null,funFact:"Not at all / absolutely not. Strong negative intensifier. 전혀 모르겠어요 (I have no idea at all). Always paired with negative verbs.",phonetic:"jeon-hyeo",example:"A: 이거 알아요? B: 아니요, 전혀 몰라요.",exampleEn:"A: Do you know this? B: No, I have no idea at all.",note:"전혀: not at all. ALWAYS with a negative.\n전혀 없어요 means there is absolutely none."},

  {type:"teach",kind:"word",nl:"다시",en:"again",pos:"noun",gender:null,funFact:"Native Korean adverb: again / once more. Intensifier: 다시 한번 = one more time. Not Sino-Korean.",phonetic:"da-si",example:"A: 다시 한 번 말해 주세요. B: 네, 천천히 말할게요.",exampleEn:"A: Please say it again. B: Sure, I will speak slowly.",note:"다시: again.\n다시 한 번 means one more time. Very useful phrase."},
  ...
  {type:"teach",kind:"word",nl:"천천히",en:"slowly",pos:"noun",gender:null,funFact:"Slowly. Adverb suffix -히 (like English -ly). Pattern: adjective stem + -히: 천천히 (slowly), 무리히 (by force), 특별히 (especially).",phonetic:"cheon-cheon-hi",example:"A: 너무 빨라요! B: 천천히 말해 주세요.",exampleEn:"A: It's too fast! B: Please speak slowly.",note:"천천히: slowly.\nAdverb suffix (like English -ly)."},
  ...
  {type:"teach",kind:"word",nl:"왜",en:"why",pos:"noun",gender:null,funFact:"Why. Short, common, and direct. Contrast formal written 어째서. Common patterns: 왜 그래요? (why like that?), 왜냐하면 (because).",phonetic:"wae",example:"A: 오늘 안 가요. B: 왜요?",exampleEn:"A: I'm not going today. B: Why?",note:"왜: why.\nShort, common, and direct."},
  {type:"teach",kind:"word",nl:"얼마나",en:"how much / how long",pos:"noun",gender:null,funFact:"How much / how long. Question word for degree, duration, extent: 얼마나 기다렸어요? (how long did you wait?). Different from 얼마 (how much for prices).",phonetic:"eol-ma-na",example:"A: 역까지 얼마나 걸려요? B: 걸어서 십 분이에요.",exampleEn:"A: How long to the station? B: 10 minutes on foot.",note:"얼마나: how much / how long.\n얼마나 멀어요? = How far is it?"},
  ...
  {type:"teach",kind:"word",nl:"가장",en:"the most",pos:"noun",gender:null,funFact:"Sino-Korean: 最 (most). Synonym: 제일 (第一 = number one). 가장 is more formal; 제일 more colloquial.",phonetic:"ga-jang",example:"A: 뭐가 가장 중요해요? B: 건강이 가장 중요해요.",exampleEn:"A: What is most important? B: Health is the most important.",note:"가장: the most. same meaning as 제일.\n제일 is more colloquial, 가장 more formal."},
