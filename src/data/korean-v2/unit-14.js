...
{type:"mc",q:"야근 literally means:",opts:["Extra-work","Night-work","Hard-work","Late-work"],ans:"Night-work",hint:"야 (夜) = night. 근 (勤) = work."},
...
{type:"mc",q:"2차 at a 회식 typically means:",opts:["Second day of work dinner","Second round: bar or karaoke","Ordering a second dish","Going home second"],ans:"Second round: bar or karaoke",hint:"차 = round. 1차 dinner, 2차 bar/karaoke, 3차 more drinks."},
...
{type:"mc",q:"건배 literally means:",opts:["Together-raise","Happy-drink","Dry-cup (empty your glass)","Good-health"],ans:"Dry-cup (empty your glass)",hint:"건(乾) = dry. 배(杯) = cup. Dry your cup = cheers!"},
...
{type:"mc",q:"사진 촬영 금지 means:",opts:["Photo studio","Photography prohibited","Take pictures","Photography allowed"],ans:"Photography prohibited",hint:"촬영 = filming/photographing. 금지 = prohibited."},
...
{type:"mc",q:"주차 금지 means:",opts:["Free parking","Parking lot","No parking","Parking available"],ans:"No parking",hint:"주차 = parking. 금지 = prohibited."},
...
{type:"mc",q:"음식물 반입 금지. 반입 means:",opts:["Buying","Taking out","Eating","Bringing in"],ans:"Bringing in",hint:"반(carry/搬) + 입(enter/入) = carry-in. No bringing in food."},
...
{type:"mc",q:"한국 직장에서 상사에게 반말을 쓰면 안 돼요. This means:",opts:["You should use casual speech with your boss","You must not use casual speech with your boss","Your boss uses casual speech with you","반말 is only for meetings"],ans:"You must not use casual speech with your boss",hint:"-(으)면 안 돼요 = must not. 반말 (casual) to 상사 (boss) is forbidden."},
...
{type:"mc",q:"관공서 means:",opts:["Government office","Private company","University campus","Shopping center"],ans:"Government office",hint:"관(官) = official. 공(公) = public. 서(署) = office. All three characters point to official public functions."},
...
{type:"mc",q:"서류를 제출하다 means:",opts:["To review documents","To submit documents","To sign documents","To lose documents"],ans:"To submit documents",hint:"제출하다 = to submit (was taught in L2 of this unit). 서류 = documents. Put them together."},
