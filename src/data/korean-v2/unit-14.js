...
{id:"kou14l4b",title:"-(으)려면: 승진하려면",icon:"🎯",xp:22,board:true,steps:[
  ...
  {type:"mc",q:"회의에 참석하려면 미리 준비해야 돼요 means:",opts:["While preparing, I attended the meeting","I attended the meeting because I prepared","After attending the meeting, I prepared","If you want to attend the meeting, prepare in advance"],ans:"If you want to attend the meeting, prepare in advance",hint:"-(으)려면 = if you desire to. 참석하다 = …."},
...
{type:"mc",q:"보고서를 내일까지 제출해야 돼요. 그래서 야근하려고 해요. This person:",opts:["Must submit by tomorrow, so plans to work overtime","Wants to submit and leave early","Finished the report already","Doesn't need to submit"],ans:"Must submit by tomorrow, so plans to work overtime",hint:"해야 돼요 states a deadline reality. -(으)려고 해요 reveals the plan in response. What does this person intend?"},
...
{type:"mc",q:"이메일 보내도 돼요? 상사에게 확인하려고요. The speaker:",opts:["Must send email to the boss","Asks permission to send email, to check with the boss","Can't send email","Already sent the email"],ans:"Asks permission to send email, to check with the boss",hint:"-아/어도 돼요? = may I? -(으)려고요 = in order to (shortened)."},
...
{type:"mc",q:"야근하면 안 돼요! 건강이 중요해요. The speaker is saying:",opts:["You may work overtime.","You should work overtime.","You must not work overtime! Health is important.","Working overtime is easy."],ans:"You must not work overtime! Health is important.",hint:"야근하면 안 돼요! is a prohibition. 건강이 중요해요 gives the reason. What is the speaker telling the listener?"},
