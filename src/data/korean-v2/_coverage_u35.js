...
const COVERAGE_U35 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"가스",src:"gas"},{trg:"공기",src:"air"},{trg:"그늘",src:"shade, shadow"},{trg:"날개",src:"wing"}]},
    {type:"match",pairs:[{trg:"농사",src:"farming"},{trg:"깊다",src:"to be deep"},{trg:"깊이",src:"deeply, depth"},{trg:"높이",src:"height"}]},
    {type:"match",pairs:[{trg:"가정",src:"home, household"},{trg:"골목",src:"alley"},{trg:"도로",src:"road"},{trg:"마을",src:"village"}]},
    {type:"match",pairs:[{trg:"구멍",src:"hole"},{trg:"곁",src:"side, beside"},{trg:"겉",src:"surface, outside"},{trg:"너머",src:"other side, beyond"}]},
    {type:"match",pairs:[{trg:"눈앞",src:"before one's eyes"},{trg:"걸음",src:"step, pace"},{trg:"날아가다",src:"to fly away"},{trg:"날아오다",src:"to fly toward, to fly here"}]},
    {type:"match",pairs:[{trg:"넘다",src:"to cross over, to exceed"},{trg:"넘어가다",src:"to go over, to pass"},{trg:"넘어서다",src:"to surpass, to exceed"},{trg:"달려가다",src:"to run toward (away)"}]},
    {type:"match",pairs:[{trg:"달려오다",src:"to run toward (here)"},{trg:"달리다",src:"to run"},{trg:"묐어들다",src:"to jump in, to dive into"},{trg:"다가가다",src:"to approach (away from speaker)"}]},
    {type:"match",pairs:[{trg:"다가오다",src:"to come closer, to approach (here)"},{trg:"들어서다",src:"to step into, to enter"},{trg:"누르다",src:"to press, to push down"},{trg:"던지다",src:"to throw"}]},
    {type:"match",pairs:[{trg:"두드리다",src:"to knock, to tap"},{trg:"만지다",src:"to touch"},{trg:"떼다",src:"to remove, to detach"},{trg:"끄다",src:"to pull, to drag"}]},
    {type:"match",pairs:[{trg:"뒤집다",src:"to flip over, to turn upside down"},{trg:"담그다",src:"to soak, to dip"},{trg:"담기다",src:"to be contained, to be held in"},{trg:"담다",src:"to put in, to hold"}]},
    {type:"match",pairs:[{trg:"꺼내다",src:"to take out, to pull out"},{trg:"갈다",src:"to sharpen, to change, to grind"},{trg:"감다",src:"to close eyes, to wash hair"},{trg:"가리다",src:"to cover, to hide, to be picky"}]},
