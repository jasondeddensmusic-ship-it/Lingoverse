...
const COVERAGE_U44 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"정보",src:"information"},{trg:"자세히",src:"in detail, closely, thoroughly"},{trg:"해석",src:"interpretation, analysis"},{trg:"토론",src:"debate, discussion"}]},
    {type:"match",pairs:[{trg:"피시",src:"PC, personal computer"},{trg:"점",src:"point, dot, score; store/shop"},{trg:"예",src:"example; yes (formal)"},{trg:"위치",src:"location, position"}]},
    {type:"match",pairs:[{trg:"위치하다",src:"to be located, to be situated"},{trg:"주변",src:"surroundings, vicinity, around"},{trg:"코너",src:"corner, section"},{trg:"탑",src:"tower, pagoda"}]},
    {type:"match",pairs:[{trg:"집안",src:"inside the house, family, household"},{trg:"편",src:"side, direction, team (bound noun)"},{trg:"초",src:"second (time); beginning; candle"},{trg:"적",src:"time/occasion when (bound noun)"}]},
    {type:"match",pairs:[{trg:"요구하다",src:"to demand, to require"},{trg:"정하다",src:"to decide, to set, to determine"},{trg:"정해지다",src:"to be decided, to be determined"},{trg:"적용하다",src:"to apply, to put into practice"}]},
    {type:"match",pairs:[{trg:"집다",src:"to pick up, to grab"},{trg:"찌르다",src:"to stab, to poke, to sting"},{trg:"줍다",src:"to pick up (from the ground)"},{trg:"차리다",src:"to set (a table), to come to one's senses"}]},
    {type:"match",pairs:[{trg:"쳐다보다",src:"to stare at, to gaze at, to look up at"},{trg:"향하다",src:"to head toward, to face, to be directed at"},{trg:"지키다",src:"to protect, to keep, to guard"},{trg:"진행되다",src:"to proceed, to be in progress"}]},
    {type:"match",pairs:[{trg:"이루어지다",src:"to be achieved, to come true, to be formed"},{trg:"이뤄지다",src:"to be achieved, to come true (contracted)"},{trg:"이르다",src:"to reach, to arrive at; to be early"},{trg:"잘되다",src:"to go well, to turn out well"}]},
    {type:"match",pairs:[{trg:"지나가다",src:"to pass by, to go past"},{trg:"지나다",src:"to pass, to elapse, to go beyond"},{trg:"이기다",src:"to win, to beat, to overcome"},{trg:"최고",src:"the best, the highest, the greatest"}]},
