...
const COVERAGE_U37 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"너무나",src:"so very, exceedingly"},{trg:"그리",src:"that way, so (with negation)"},{trg:"단지",src:"merely, only"},{trg:"굳이",src:"stubbornly, going out of one's way"}]},
    {type:"match",pairs:[{trg:"과거",src:"the past"},{trg:"년대",src:"decade, era"},{trg:"년도",src:"the year (specific)"},{trg:"그다음",src:"the next, after that"}]},
    {type:"match",pairs:[{trg:"따로",src:"separately, apart"},{trg:"또다시",src:"once again, yet again"},{trg:"늘",src:"always, all the time"},{trg:"공연",src:"performance, show"}]},
    {type:"match",pairs:[{trg:"그림자",src:"shadow"},{trg:"리듬",src:"rhythm"},{trg:"도중",src:"in the middle of, during"},{trg:"그중",src:"among them"}]},
    {type:"match",pairs:[{trg:"대단하다",src:"to be great, remarkable"},{trg:"다양하다",src:"to be diverse, varied"},{trg:"당연하다",src:"to be natural, obvious"},{trg:"떨다",src:"to tremble, to shiver"}]},
    {type:"match",pairs:[{trg:"떨리다",src:"to be trembling, to feel shaky"},{trg:"떨어지다",src:"to fall, to drop, to run out"},{trg:"떨어뜨리다",src:"to drop something"},{trg:"멈추다",src:"to stop, to halt"}]},
