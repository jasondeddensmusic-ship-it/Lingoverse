...
const COVERAGE_U38 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"가늘다",src:"to be thin, slender, fine"},{trg:"검다",src:"to be black, dark-colored"},{trg:"곱다",src:"to be fine, beautiful, gentle"},{trg:"굵다",src:"to be thick, coarse"}]},
    {type:"match",pairs:[{trg:"둥글다",src:"to be round, circular"},{trg:"부드럽다",src:"to be soft, gentle, smooth"},{trg:"겉",src:"surface, exterior, outside"},{trg:"깊이",src:"deeply, depth"}]},
    {type:"match",pairs:[{trg:"끓이다",src:"to boil (something)"},{trg:"섞다",src:"to mix, to stir together"},{trg:"섞이다",src:"to be mixed, to blend"},{trg:"썰다",src:"to chop, to slice"}]},
    {type:"match",pairs:[{trg:"담기다",src:"to be contained, to be held in"},{trg:"달걀",src:"egg"},{trg:"건너다",src:"to cross"},{trg:"넘다",src:"to cross over, to exceed"}]},
    {type:"match",pairs:[{trg:"넘어가다",src:"to go over, to pass to the other side"},{trg:"넘어서다",src:"to surpass, to go beyond"},{trg:"다가가다",src:"to approach, to go closer"},{trg:"달려오다",src:"to run over (toward speaker)"}]},
    {type:"match",pairs:[{trg:"날아가다",src:"to fly away"},{trg:"날아오다",src:"to fly toward (the speaker)"},{trg:"돌다",src:"to turn, to spin, to go around"},{trg:"돌아보다",src:"to look back, to reflect"}]},
    {type:"match",pairs:[{trg:"돌아서다",src:"to turn around"},{trg:"서두르다",src:"to hurry, to rush"},{trg:"만지다",src:"to touch, to handle"},{trg:"누르다",src:"to press, to push down"}]},
    {type:"match",pairs:[{trg:"밟다",src:"to step on, to tread on"},{trg:"던지다",src:"to throw"},{trg:"쏘다",src:"to shoot"},{trg:"쏟다",src:"to spill, to pour out"}]},
