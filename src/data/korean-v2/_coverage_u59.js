...
const COVERAGE_U59 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"맘",src:"heart, mind (casual form)"},{trg:"맘대로",src:"as one pleases, at will"},{trg:"맛보다",src:"to taste, to sample"},{trg:"망원경",src:"telescope"}]},
    {type:"match",pairs:[{trg:"망치다",src:"to ruin, to mess up"},{trg:"맞은편",src:"the opposite side, across from"},{trg:"매너",src:"manners, etiquette"},{trg:"매다",src:"to tie, to fasten"}]},
    {type:"match",pairs:[{trg:"매달",src:"every month"},{trg:"매달다",src:"to hang, to suspend"},{trg:"매달리다",src:"to cling to, to hang from"},{trg:"매번",src:"every time, each time"}]},
    {type:"match",pairs:[{trg:"매스컴",src:"mass media, mass communication"},{trg:"매장",src:"store, shop; burial"},{trg:"머리말",src:"preface, foreword"},{trg:"머리칼",src:"hair (on the head)"}]},
    {type:"match",pairs:[{trg:"머물다",src:"to stay, to remain, to linger"},{trg:"먹이",src:"feed, food (for animals)"},{trg:"먹히다",src:"to be eaten; to work, to be effective"},{trg:"멀어지다",src:"to become distant, to drift apart"}]},
    {type:"match",pairs:[{trg:"멋있다",src:"to be cool, to be handsome/stylish"},{trg:"멍멍",src:"woof woof, bow wow"},{trg:"멎다",src:"to stop, to cease"},{trg:"면적",src:"area, surface area"}]},
    {type:"match",pairs:[{trg:"면하다",src:"to avoid, to be exempt from"},{trg:"멸치",src:"anchovy"},{trg:"명단",src:"name list, roster"},{trg:"명령어",src:"command (computing)"}]},
    {type:"match",pairs:[{trg:"명의",src:"registered name, name on record"},{trg:"명칭",src:"name, title, designation"},{trg:"몇십",src:"several tens, tens of"},{trg:"모금",src:"a sip; fundraising"}]},
    {type:"match",pairs:[{trg:"모기",src:"mosquito"},{trg:"모레",src:"the day after tomorrow"},{trg:"모범",src:"model, example, exemplary"},{trg:"모여들다",src:"to flock, to gather together"}]},
    {type:"match",pairs:[{trg:"모처럼",src:"for the first time in a while, after a long time"},{trg:"모퉁이",src:"corner (of a street)"},{trg:"목걸이",src:"necklace"},{trg:"목록",src:"list, catalog"}]},
    {type:"match",pairs:[{trg:"목욕탕",src:"bathhouse, public bath"},{trg:"몰려들다",src:"to rush in, to flock to"},{trg:"몰려오다",src:"to come rushing, to surge toward"},{trg:"몸매",src:"body figure, physique"}]},
    {type:"match",pairs:[{trg:"몸무게",src:"body weight"},{trg:"몸속",src:"inside the body"},{trg:"몸짓",src:"gesture, body movement"},{trg:"몸통",src:"torso, trunk of the body"}]},
