...
const COVERAGE_U62 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"복숭아",src:"peach"},{trg:"볶음",src:"stir-fry, something stir-fried"},{trg:"볶음밥",src:"fried rice"},{trg:"본질",src:"essence, fundamental nature"}]},
    {type:"match",pairs:[{trg:"볼",src:"cheek"},{trg:"볼일",src:"errand, business to attend to"},{trg:"뵈다",src:"to see, to meet (humble)"},{trg:"뵙다",src:"to meet (very humble)"}]},
    {type:"match",pairs:[{trg:"부대",src:"military unit, troops"},{trg:"부딪히다",src:"to bump into, to collide with"},{trg:"부러워하다",src:"to envy, to be jealous of"},{trg:"부러지다",src:"to break, to snap"}]},
    {type:"match",pairs:[{trg:"부문",src:"sector, field, category"},{trg:"부분적",src:"partial"},{trg:"부서",src:"department, division"},{trg:"부서지다",src:"to shatter, to break apart"}]},
    {type:"match",pairs:[{trg:"부위",src:"part, area (of body or meat)"},{trg:"부자",src:"rich person, wealthy person"},{trg:"부잣집",src:"wealthy household"},{trg:"부정하다",src:"to deny, to negate"}]},
    {type:"match",pairs:[{trg:"부지런하다",src:"to be diligent, to be hardworking"},{trg:"부채",src:"debt, liability"},{trg:"부치다",src:"to send, to mail"},{trg:"부친",src:"father (formal)"}]},
    {type:"match",pairs:[{trg:"부품",src:"component, part"},{trg:"부회장",src:"vice president (of an organization)"},{trg:"북",src:"drum"},{trg:"북부",src:"northern part, the north"}]},
    {type:"match",pairs:[{trg:"분명하다",src:"to be clear, to be obvious"},{trg:"분명해지다",src:"to become clear"},{trg:"분주하다",src:"to be busy, to be bustling"},{trg:"분포하다",src:"to be distributed, to be spread out"}]},
    {type:"match",pairs:[{trg:"분필",src:"chalk"},{trg:"불가피하다",src:"to be unavoidable, to be inevitable"},{trg:"불과",src:"only, merely, no more than"},{trg:"불과하다",src:"to be merely, to be nothing more than"}]},
    {type:"match",pairs:[{trg:"불구하다",src:"despite, regardless (used as -에도 불구하고)"},{trg:"불러일으키다",src:"to arouse, to provoke, to stir up"},{trg:"불리하다",src:"to be disadvantageous, to be unfavorable"},{trg:"불쌍하다",src:"to be pitiful, to be pathetic"}]},
    {type:"match",pairs:[{trg:"불어오다",src:"to blow in (wind)"},{trg:"불완전하다",src:"to be incomplete, to be imperfect"},{trg:"불이익",src:"disadvantage, penalty"},{trg:"불필요하다",src:"to be unnecessary"}]},
