...
{id:"kou11l1",title:"여행 준비",icon:"✈️",xp:22,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"여행하다",en:"to travel",pos:"verb",gender:null,funFact:"Sino-Korean: 旅行 (travel-go) + 하다. 여행을 가다 = go on a trip; 해외여행 = overseas travel.",example:"A: 주말에 뭐 했어요? B: 부산에서 여행했어요. A: 재미있었어요? B: 네, 해운대에 갔는데 바다가 정말 예뻤어요. A: 저도 부산에 가고 싶어요!",exampleEn:"A: What did you do on the weekend? B: I traveled in Busan. A: Was it fun? B: Yes, I went to Haeundae and the sea was really pretty. A: I want to go to Busan too!",note:"여행하다: to travel.\n여행 + 하다 = noun + do."},
  ...
  {type:"teach",kind:"word",nl:"비행기",en:"airplane",pos:"noun",gender:null,funFact:"비행기 타다 = take a plane. 기내식 (in-flight meal) is often 비빔밥 on Korean airlines.",phonetic:"bi-haeng-gi",example:"비행기로 제주도에 가요.",exampleEn:"I go to Jeju by airplane.",note:"비행기 (飛行機): airplane.\nCOMPOUND: 비 (fly) + 행 (go) + 기 (machine).",deepDive:{title:"Travel Transport Words",text:"비행기: airplane.\n기차: train.\n버스: bus.\n택시: taxi.\n배: ship/boat.\n\n비행기표: plane ticket.\n탑승권: boarding pass."}},
  ...
  {type:"teach",kind:"word",nl:"짐",en:"luggage / baggage",pos:"noun",gender:null,funFact:"Luggage / baggage. Native Korean. Also figurative: 마음의 짐 (burden on the mind). Short, native, emotionally versatile.",example:"A: 짐 다 쌌어요? B: 아직이요. 옷을 더 넣어야 해요. A: 빨리 싸세요. 비행기 시간이 얼마 안 남았어요. B: 알겠어요! 지금 싸고 있어요.",exampleEn:"A: Did you finish packing? B: Not yet. I need to put in more clothes. A: Pack quickly. There's not much time before the flight. B: Got it! I'm packing right now.",note:"짐: luggage, baggage, things to carry.\n짐을 싸다: to pack.\n짐을 풀다: to unpack."},
...
{id:"kou11l2",title:"KTX와 교통",icon:"🚄",xp:22,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"기차",en:"train",pos:"noun",gender:null,funFact:"새마을호 (Saemaeul), 무궁화호 (Mugunghwa): slower scenic lines named after villages and flowers.",phonetic:"gi-cha",example:"기차로 부산에 가요.",exampleEn:"I go to Busan by train.",note:"기차 (汽車): train.\nCOMPOUND: 기 (steam) + 차 (vehicle)."},
  ...
  {type:"teach",kind:"word",nl:"표",en:"ticket",pos:"noun",gender:null,funFact:"Ticket (in u11 transport context). Same as u9, reinforced. 편도표 (one-way ticket), 왕복표 (round-trip ticket).",example:"A: 부산까지 표 두 장 주세요. B: KTX요? 무궁화호요? A: KTX로 주세요. 얼마예요? B: 한 장에 5만 9천 원이에요. A: 카드로 결제할게요.",exampleEn:"A: Two tickets to Busan, please. B: KTX or Mugunghwa? A: KTX, please. How much is it? B: 59,000 won per ticket. A: I'll pay by card.",note:"표 (票): ticket.\n기차표: train ticket.\n비행기표: plane ticket."},
  ...
  {type:"teach",kind:"word",nl:"지하철",en:"subway",pos:"noun",gender:null,funFact:"T-money card works on 지하철 and 버스 nationwide. Transfer discounts are applied automatically.",phonetic:"ji-ha-cheol",example:"지하철로 강남에 가요.",exampleEn:"I go to Gangnam by subway.",note:"지하철 (地下鐵): subway.\nCOMPOUND: 지하 (underground) + 철 (iron/rail)."},
...
{id:"kou11l3",title:"-아/어 봤어요",icon:"🌏",xp:24,board:true,steps:[
  ...
  {type:"teach",kind:"phrase",nl:"네, 가 봤어요 / 아니요, 안 가 봤어요",en:"Yes, I have / No, I haven't",pos:"intj",gender:null,funFact:"Experience answer pair. Positive: 가 봤어요 (have been). Negative: 안 가 봤어요 (have not been). -아/어 봐다 = have tried.",example:"A: 제주도에 가 봤어요? B: 네, 작년에 가 봤어요.",exampleEn:"A: Have you been to Jeju? B: Yes, I went last year.",note:"Positive: 가 봤어요 (have been).\nNegative: 안 가 봤어요 (haven't been).\n\nOr: 못 가 봤어요 (haven't been able to)."},
  ...
  {type:"teach",kind:"phrase",nl:"해 봤어요",en:"have tried doing",pos:"intj",gender:null,funFact:"Have tried doing. All 하다 verbs follow this: 운동해 봤어요 (tried exercising), 요리해 봤어요 (tried cooking).",example:"A: 스키를 해 봤어요? B: 아니요, 안 해 봤어요.",exampleEn:"A: Have you tried skiing? B: No, I haven't.",note:"하다 → 해 봤어요.\n\nAll 하다 verbs follow this:\n운동해 봤어요: have tried exercising.\n요리해 봤어요: have tried cooking."},
  ...
  {type:"teach",kind:"phrase",nl:"한번도 안 -아/어 봤어요",en:"have never (not even once)",pos:"intj",gender:null,funFact:"한번도 (not even once) + negative. Strong negation for experience: 한번도 안 가 봤어요 (have never been). Reinforces absolute never.",example:"A: 스키를 타 봤어요? B: 아니요, 한번도 안 타 봤어요. A: 진짜요? 재미있는데! 같이 가 볼래요? B: 좋아요! 한번 해 보고 싶었어요.",exampleEn:"A: Have you tried skiing? B: No, I've never tried it. A: Really? It's fun! Do you want to go together? B: Sure! I've been wanting to try it.",note:"한번도 = not even once.\n한번도 + 안 + -아/어 봤어요 = have never.\n\nStrong negation for experience."},
...
{id:"kou11l4",title:"★ -고 있다: 진행",icon:"🔄",xp:24,board:true,steps:[
  ...
  {type:"teach",kind:"phrase",nl:"뭐 하고 있어요?",en:"What are you doing?",pos:"pron",gender:null,funFact:"The go-to check-in question: what are you doing? Common text/phone opener. Response pattern: -고 있어요 (I'm doing X).",example:"A: 뭐 하고 있어요? B: 영화를 보고 있어요.",exampleEn:"A: What are you doing? B: I'm watching a movie.",note:"뭐 하고 있어요?: what are you doing (right now)?\n\nThe go-to check-in question."},
...
{id:"kou11l5",title:"제주도 여행",icon:"🏝️",xp:22,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"렌터카",en:"rental car",pos:"noun",gender:null,funFact:"Rental car. Jeju Island has no subway; renting a car is essential for tourists. Popular for 제주도 여행 (Jeju trips).",example:"A: 제주도에서 어떻게 이동해요? B: 렌터카를 빌렸어요. 지하철이 없어서요. A: 운전할 줄 알아요? B: 네, 면허가 있어요. 렌터카가 제일 편해요. A: 얼마예요? B: 하루에 5만 원 정도예요.",exampleEn:"A: How do you get around in Jeju? B: I rented a car. There's no subway. A: Do you know how to drive? B: Yes, I have a license. A rental car is the most convenient. A: How much is it? B: About 50,000 won per day.",note:"렌터카: rental car (Konglish).\n빌리다: to rent/borrow.\n\nJeju has no subway. Cars are essential."},
...
{id:"kou11l5b",title:"-(으)ㄴ 후에: 도착한 후에",icon:"⏭️",xp:22,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"-(으)ㄴ 후에",en:"after doing",pos:"part",gender:null,funFact:"After doing (u11 context). Reinforces u10 learning. 체크인한 후에 (after checking in); common in travel scenarios.",example:"A: 공항에 도착한 후에 뭐 했어요? B: 짐을 찾은 후에 택시를 탔어요. A: 호텔까지 얼마나 걸렸어요? B: 30분 정도 걸렸어요. 도착한 후에 바로 쉬었어요. A: 피곤했겠어요!",exampleEn:"A: What did you do after arriving at the airport? B: After getting my luggage, I took a taxi. A: How long did it take to the hotel? B: About 30 minutes. After arriving, I rested right away. A: You must have been tired!",note:"-(으)ㄴ 후에: after doing.\n\nConsonant: stem + 은 후에.\nVowel: stem + ㄴ 후에.\n하다 → 한 후에."},
  {type:"teach",kind:"phrase",nl:"밥을 먹은 후에",en:"after eating",pos:"intj",gender:null,funFact:"Temporal: after doing. Consonant stem + 은 후에: 먹다 → 먹은 후에 (after eating). Vowel stem + ㄴ 후에: 가다 → 간 후에.",example:"A: 점심 먹은 후에 뭐 할 거예요? B: 카페에 가서 커피를 마실 거예요. A: 저도 같이 가도 돼요? B: 그럼요! 밥 먹은 후에 같이 가요. A: 좋아요!",exampleEn:"A: What are you going to do after lunch? B: I'm going to go to a cafe and drink coffee. A: Can I come along too? B: Of course! Let's go together after eating. A: Sounds good!",note:"먹다 → 먹은 후에.\nConsonant stem: add 은 후에."},
  ...
  {type:"teach",kind:"phrase",nl:"체크인한 후에",en:"after checking in",pos:"intj",gender:null,funFact:"'After checking in.' -(으)ㄴ 후에 (after doing). 체크인하다 → 체크인한 후에. 후 (Sino-Korean 後, 'after') + 에 (time particle).",example:"A: 호텔에 도착했어요? B: 네, 방금 체크인한 후에 방에 올라왔어요. A: 방이 어때요? B: 넓고 깨끗해요! 창문에서 바다가 보여요. A: 좋겠다! 쉬고 나서 연락해요.",exampleEn:"A: Did you arrive at the hotel? B: Yes, I just checked in and came up to the room. A: How's the room? B: It's spacious and clean! I can see the ocean from the window. A: Lucky you! Contact me after you rest.",note:"체크인하다 → 체크인한 후에.\n하다 verbs: just add ㄴ 후에."},
...
{id:"kou11l7",title:"여행 대화",icon:"💬",xp:22,board:true,steps:[
  ...
  {type:"teach",kind:"phrase",nl:"방이 있어요?",en:"Do you have a room?",pos:"intj",gender:null,funFact:"'Do you have a room?' 방 (room) + 이 (subject particle) + 있다 (to exist). Hotel formula. Response: 네, 있어요 (yes we do) or 아니요, 없어요 (no we don't).",example:"A: 방이 있어요? B: 네, 있어요. 1박에 8만 원이에요.",exampleEn:"A: Do you have a room? B: Yes. 80,000 won per night.",note:"방이 있어요?: Do you have a room?\n1박 (一泊): one night's stay.\n박 = overnight stay counter."},
  {type:"teach",kind:"word",nl:"1박 2일",en:"1 night 2 days",pos:"num",gender:null,funFact:"1 night 2 days. Common trip format in Korea. Short domestic getaways: 1박 2일 여행, 2박 3일 (2 nights 3 days), etc.",phonetic:"il-bak i-il",example:"A: 이번 주말에 경주에 갈까요? B: 좋아요! 1박 2일로 갈까요? A: 네, 토요일에 출발해서 일요일에 돌아와요. B: 숙소는 어디로 예약할까요? A: 한옥 게스트하우스가 좋겠어요!",exampleEn:"A: Shall we go to Gyeongju this weekend? B: Sure! Shall we go for 1 night 2 days? A: Yes, we leave Saturday and come back Sunday. B: Where should we book accommodation? A: A hanok guesthouse would be nice!",note:"1박 2일: one night, two days.\n박 (泊) = overnight stay.\n\nCommon trip format in Korea."},
  {type:"teach",kind:"phrase",nl:"체크인/체크아웃",en:"check-in / check-out",pos:"intj",gender:null,funFact:"Check-in / check-out. English loanwords in Korean script. Hotel-industry vocabulary is heavily English-borrowed; true globally since hospitality standardized early.",example:"A: 체크인하고 싶은데요. B: 네, 예약하셨어요? A: 네, 김민수로 예약했어요. B: 확인했습니다. 체크아웃은 11시까지예요. A: 알겠습니다. 감사합니다!",exampleEn:"A: I'd like to check in. B: Yes, did you make a reservation? A: Yes, I reserved under Kim Minsu. B: Confirmed. Check-out is by 11 AM. A: Understood. Thank you!",note:"체크인: check-in (Konglish).\n체크아웃: check-out.\n\n-부터: from (time). -까지: until."},
  ...
  {type:"teach",kind:"phrase",nl:"길을 잃었어요",en:"I'm lost",pos:"pron",gender:null,funFact:"'I'm lost.' Literally 'I lost the road.' 길 (road) + 을 + 잃다 (to lose). Korean expresses lost-ness as having lost the path; active-voice, not passive.",example:"A: 죄송합니다, 길을 잃었어요. 서울역이 어디에 있어요? B: 여기서 직진해서 왼쪽으로 가세요. A: 걸어서 얼마나 걸려요? B: 10분 정도 걸려요. A: 감사합니다! 많이 도와주셨어요.",exampleEn:"A: Excuse me, I'm lost. Where is Seoul Station? B: Go straight from here and turn left. A: How long does it take on foot? B: About 10 minutes. A: Thank you! You've helped me a lot.",note:"길 = road/way.\n잃다 = to lose.\n길을 잃다 = to lose one's way = to be lost."},
  {type:"teach",kind:"phrase",nl:"여기서 얼마나 걸려요?",en:"How long does it take from here?",pos:"intj",gender:null,funFact:"'How long does it take from here?' 여기 (here) + 서 (from-contracted 에서). Travel-essential phrase; taxis, public transit, directions.",example:"A: 역까지 얼마나 걸려요? B: 10분 정도 걸려요.",exampleEn:"A: How long to the station? B: About 10 minutes.",note:"얼마나: how much/long.\n걸리다: to take (time).\n정도: about/approximately."},
...
{id:"kou11l9",title:"★ ㅎ 불규칙",icon:"🎨",xp:24,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"노랗다",en:"to be yellow",pos:"verb",gender:null,funFact:"To be yellow. ㅎ-irregular color verb. 노랗 + 아요 → 노래요. Irregular contraction like 빨갛다→빨개요.",phonetic:"no-ra-ta",example:"A: 이 바나나 색이 어때요? B: 노래요. 잘 익었어요. A: 그러면 먹어도 돼요? B: 네, 노란 바나나가 제일 맛있어요. A: 맞아요, 저도 노란 바나나를 좋아해요.",exampleEn:"A: How's the color of this banana? B: It's yellow. It's ripe. A: Then can I eat it? B: Yes, yellow bananas are the tastiest. A: Right, I like yellow bananas too.",note:"노랗다 → 노래요 (ㅎ-irregular).\n노란 바나나: yellow banana (modifier)."},
  {type:"teach",kind:"word",nl:"빨갛다",en:"to be red",pos:"verb",gender:null,funFact:"Travel / trip. Sino-Korean 旅行. Compounds: 여행가다 (to go travel), 배낭여행 (backpacking), 신혼여행 (honeymoon). Korean travel vocab is rich.",phonetic:"ppal-ga-ta",example:"A: 이 사과 색이 정말 빨개요. B: 네, 빨간 사과가 달아요. A: 초록색 사과도 있어요? B: 네, 있는데 빨간 사과가 더 맛있어요. A: 그러면 빨간 사과로 주세요!",exampleEn:"A: This apple is really red. B: Yes, red apples are sweet. A: Are there green apples too? B: Yes, but red apples taste better. A: Then give me red apples please!",note:"빨갛다 → 빨개요 (ㅎ-irregular).\n빨간 사과: red apple (modifier)."},
  {type:"teach",kind:"word",nl:"까맣다",en:"to be black",pos:"verb",gender:null,funFact:"To be red. ㅎ-irregular. 빨갛 + 아요 → 빨개요 (irregular contraction). Color words are descriptive verbs in Korean, not adjectives like English.",phonetic:"kka-ma-ta",example:"A: 저 고양이 봐요! 너무 귀여워요. B: 어디요? 아, 까만 고양이요? A: 네! 눈이 까매서 예뻐요. B: 맞아요. 까만 고양이가 귀여워요. A: 사진 찍어도 될까요?",exampleEn:"A: Look at that cat! It's so cute. B: Where? Oh, the black cat? A: Yes! Its eyes are black and pretty. B: Right. Black cats are cute. A: Can I take a photo?",note:"까맣다 → 까매요 (ㅎ-irregular).\n까만 머리: black hair (modifier)."},
  {type:"teach",kind:"word",nl:"하얗다",en:"to be white",pos:"verb",gender:null,funFact:"To be black. ㅎ-irregular. 까맣 + 아요 → 까매요. One of Korean's 5 core ㅎ-irregular color verbs. Same conjugation pattern across colors.",phonetic:"ha-ya-ta",example:"A: 밖에 눈이 와요! B: 정말요? 하얀 눈이 정말 예뻐요. A: 맞아요. 밖이 다 하얘요. B: 눈사람 만들러 나갈래요? A: 좋아요! 빨리 나가요!",exampleEn:"A: It's snowing outside! B: Really? White snow is really pretty. A: Right. Everything outside is white. B: Want to go out and make a snowman? A: Sure! Let's go quickly!",note:"하얗다 → 하얘요 (ㅎ-irregular).\n하얀 눈: white snow (modifier)."},
  {type:"teach",kind:"word",nl:"파랗다",en:"to be blue",pos:"verb",gender:null,funFact:"To be white. ㅎ-irregular. 하얗 + 아요 → 하얘요. Culturally: white is traditionally associated with mourning in Korea. Cultural-color mapping differs from Western norms.",phonetic:"pa-ra-ta",example:"A: 오늘 하늘이 정말 파래요! B: 네, 구름도 없어서 더 파래 보여요. A: 제주도 바다도 이렇게 파랬어요? B: 네, 파란 바다가 정말 예뻤어요. A: 저도 파란 바다를 보고 싶어요!",exampleEn:"A: The sky is really blue today! B: Yes, there are no clouds so it looks even bluer. A: Was the Jeju sea this blue too? B: Yes, the blue sea was really beautiful. A: I want to see the blue sea too!",note:"파랗다 → 파래요 (ㅎ-irregular).\n파란 하늘: blue sky (modifier)."},
