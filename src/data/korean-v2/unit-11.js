...
{id:"kou11l1",title:"여행 준비",icon:"✈️",xp:22,board:true,steps:[
  ...
  {type:"mc",q:"예약하다 means:",opts:["To cancel","To reserve","To pack","To arrive"],ans:"To reserve",hint:"예 (beforehand) + 약 (promise) = reservation. 예약하다 = to reserve."},
  {type:"mc",q:"비행기 = 비 + 행 + 기. 비 means:",opts:["Fast","Big","Fly","High"],ans:"Fly",hint:"비 (飛) = fly. 비행기 = fly + go + machine = airplane."},
...
{id:"kou11l2",title:"KTX와 교통",icon:"🚄",xp:22,board:true,steps:[
  ...
  {type:"mc",q:"기차역 = 기차 + 역. 역 means:",opts:["Station","Train","Road","City"],ans:"Station",hint:"역 (驛) = station. 서울역, 부산역, 기차역."},
  ...
  {type:"teach",kind:"grammar",nl:"-로/-으로 (교통수단)",en:"by (transport method)",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",example:"A: 부산에 뭐로 가요? B: KTX로 가요. 비행기는 너무 비싸요. A: 서울역에서 출발해요? B: 네, 서울역에서 출발해요. 2시간 반 걸려요. A: 빠르네요!",exampleEn:"A: How are you getting to Busan? B: I'm going by KTX. Planes are too expensive. A: Do you depart from Seoul Station? B: Yes, I depart from Seoul Station. It takes 2.5 hours. A: That's fast!",note:"-로/-으로: by (means of transport).\n\nAfter vowel or ㄹ: -로 (비행기로).\nAfter consonant: -으로 (버스으로 → 버스로).",deepDive:{title:"Transport + -로 Examples",text:"비행기로: by plane.\n기차로: by train.\n버스로: by bus.\n택시로: by taxi.\n지하철로: by subway.\n\n뭐로 가요? = How are you getting there?\n(literally: by what are you going?)"}},
  ...
  {type:"mc",q:"지하철 = 지하 + 철. 지하 means:",opts:["City","Train","Fast","Underground"],ans:"Underground",hint:"지하 (地下) = underground. 철 (鐵) = iron/rail."},
  ...
  {type:"mc",q:"창가 좌석 means:",opts:["Window seat","Aisle seat","First class seat","Standing ticket"],ans:"Window seat",hint:"창가 = by the window. 좌석 = seat. Window seat."},
...
{id:"kou11l3",title:"-아/어 봤어요",icon:"🌏",xp:24,board:true,steps:[
  ...
  {type:"mc",q:"한번도 안 먹어 봤어요 means:",opts:["I ate it once","I want to try it","I tried it many times","I have never tried it"],ans:"I have never tried it",hint:"한번도 = not even once. 안 먹어 봤어요 = haven't tried eating."},
...
{id:"kou11l5",title:"제주도 여행",icon:"🏝️",xp:22,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"바다",en:"sea / ocean",pos:"noun",gender:null,funFact:"Korean nouns don't have plural forms or articles. Context and particles do the job.",example:"A: 제주도 바다가 정말 예뻐요! B: 맞아요. 물이 정말 깨끗해요. A: 바닷가에서 뭐 했어요? B: 수영도 하고 사진도 많이 찍었어요. A: 좋겠다! 저도 바다에 가고 싶어요.",exampleEn:"A: The Jeju sea is really pretty! B: That's right. The water is really clean. A: What did you do at the beach? B: I swam and took lots of photos. A: I'm jealous! I want to go to the sea too.",note:"바다: sea, ocean.\n바닷가: seaside, beach.\n해수욕장: swimming beach."},
  ...
  {type:"mc",q:"제주도 = 제주 + 도. 도 means:",opts:["Island","City","Province","Mountain"],ans:"Island",hint:"도 (島) = island. 제주도 = Jeju Island."},
  ...
  {type:"mc",q:"관광지 means:",opts:["Airport","Hotel","Tourist spot","Restaurant"],ans:"Tourist spot",hint:"관광 (sightseeing) + 지 (地: place) = tourist spot."},
...
{id:"kou11l5b",title:"-(으)ㄴ 후에: 도착한 후에",icon:"⏭️",xp:22,board:true,steps:[
  ...
  {type:"mc",q:"도착한 후에 전화했어요 means:",opts:["After arriving, I called","Before arriving, I called","While arriving, I called","I arrived and I'm calling"],ans:"After arriving, I called",hint:"The speaker arrived first, then called. Which order does 후에 indicate?"},
...
{id:"kou11l5c",title:"-(으)러 가다/오다",icon:"🚶",xp:22,board:true,steps:[
  ...
  {type:"mc",q:"놀러 가요 means:",opts:["Go play by yourself","I'm playing now","Let's go hang out","I came to play"],ans:"Let's go hang out",hint:"놀다 → 놀러 가다. Go to play/hang out."},
  ...
  {type:"mc",q:"부산에 해운대 해수욕장 보러 왔어요. This means:",opts:["Haeundae Beach came to Busan","I saw Haeundae Beach in Busan","I will go to Haeundae Beach","I came to Busan to see Haeundae Beach"],ans:"I came to Busan to see Haeundae Beach",hint:"-(으)러 오다 = come to do. Came to see the beach."},
...
{id:"kou11l6",title:"-(으)ㄹ 줄 알다",icon:"🎯",xp:24,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"-(으)ㄹ 줄 알다",en:"know how to",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",example:"A: 한국어를 읽을 줄 알아요? B: 네, 읽을 줄 알아요. 한글을 배웠어요. A: 대단하네요! 쓸 줄도 알아요? B: 조금요. 아직 연습하고 있어요. A: 열심히 하고 있네요!",exampleEn:"A: Do you know how to read Korean? B: Yes, I know how to read it. I learned Hangul. A: That's impressive! Do you also know how to write? B: A little. I'm still practicing. A: You're working hard!",note:"-(으)ㄹ 줄 알다: know how to.\n\nConsonant stem + 을 줄 알다.\nVowel stem + ㄹ 줄 알다.",deepDive:{title:"Conjugation Examples",text:"읽다 → 읽을 줄 알아요 (know how to read).\n만들다 → 만들 줄 알아요 (know how to make).\n하다 → 할 줄 알아요 (know how to do).\n타다 → 탈 줄 알아요 (know how to ride).\n\nNegative: 줄 모르다\n읽을 줄 몰라요 (don't know how to read).\n\n⚠️ 모르다 past = 몰랐어요 (not 모랐어요)."}},
  {type:"mc",q:"운전할 줄 알아요 means:",opts:["I know how to drive (learned skill)","I can drive (it's possible)","I want to drive","I am driving"],ans:"I know how to drive (learned skill)",hint:"줄 = way/method. 알다 = to understand. This pattern expresses mastery through practice."},
  {type:"teach",kind:"grammar",nl:"-(으)ㄹ 줄 모르다",en:"don't know how to",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",example:"A: 같이 수영하러 갈래요? B: 미안해요, 수영할 줄 몰라요. A: 진짜요? 배워 보고 싶어요? B: 네, 배우고 싶은데 시간이 없어요. A: 다음에 같이 수영장에 가요. 제가 가르쳐 줄게요!",exampleEn:"A: Want to go swimming together? B: Sorry, I don't know how to swim. A: Really? Do you want to learn? B: Yes, I want to learn but I don't have time. A: Let's go to the pool together next time. I'll teach you!",note:"-(으)ㄹ 줄 모르다: don't know how to.\n\n줄 모르다 is the negative of 줄 알다.\n모르다 → 몰라요 (irregular)."},
  {type:"mc",q:"수영할 줄 몰라요 means:",opts:["I can't swim (no pool)","I don't know how to swim","I don't want to swim","I didn't swim"],ans:"I don't know how to swim",hint:"줄 모르다 = lacking the method. This person has never practiced or been taught to swim."},
  ...
  {type:"mc",q:"비가 올 줄 몰랐어요 means:",opts:["I know it will rain","I want it to rain","It's not raining","I didn't know it would rain"],ans:"I didn't know it would rain",hint:"줄 몰랐어요 = didn't know/expect."},
  ...
  {type:"mc",q:"피아노를 칠 줄 알아요? asks:",opts:["Do you know how to play piano? (learned skill)","Can you play piano? (is it possible now)","Do you want to play piano?","Did you play piano?"],ans:"Do you know how to play piano? (learned skill)",hint:"줄 알다 = have mastered the way. Is this asking about possibility or acquired ability?"},
...
{id:"kou11l7",title:"여행 대화",icon:"💬",xp:22,board:true,steps:[
  ...
  {type:"mc",q:"걸어서 10분 정도 걸려요 means:",opts:["I can walk in 10 minutes","The walk is 10 minutes away","I walked for 10 minutes","It takes about 10 minutes walking"],ans:"It takes about 10 minutes walking",hint:"걸어서 = by walking. 10분 정도 = about 10 min. 걸려요 = it takes."},
...
{id:"kou11l8",title:"한국 여행 문화",icon:"🌏",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"국내 = 국 + 내. 내 means:",opts:["Inside","Outside","Country","Travel"],ans:"Inside",hint:"내 (內) = inside. 국내 = inside the country."},
  ...
  {type:"mc",q:"해외 = 해 + 외. 외 means:",opts:["Sea","Outside","Inside","Far"],ans:"Outside",hint:"외 (外) = outside. 해외 = outside the sea = overseas."},
...
{id:"kou11l10",title:"복습 + 퀴즈",icon:"📝",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"버스로 30분쯤 걸려요 means:",opts:["I rode the bus for 30 minutes","The bus costs 30 won","It takes about 30 minutes by bus","The bus stop is 30 minutes away"],ans:"It takes about 30 minutes by bus",hint:"버스로 = by bus. 쯤 = about. 걸려요 = it takes (duration)."},
