...
{id:"kou11l9",title:"★ ㅎ 불규칙",icon:"🎨",xp:24,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"노랗다",en:"to be yellow",pos:"verb",gender:null,funFact:"Subway. Sino-Korean 地下鐵 (underground-iron). Literally 'underground iron (road).' Seoul subway (서울 지하철) is one of the world's most extensive and punctual.",phonetic:"no-ra-ta",example:"A: 이 바나나 색이 어때요? B: 노래요. 잘 익었어요. A: 그러면 먹어도 돼요? B: 네, 노란 바나나가 제일 맛있어요. A: 맞아요, 저도 노란 바나나를 좋아해요.",exampleEn:"A: How's the color of this banana? B: It's yellow. It's ripe. A: Then can I eat it? B: Yes, yellow bananas are the tastiest. A: Right, I like yellow bananas too.",note:"노랗다 → 노래요 (ㅎ-irregular).\n노란 바나나: yellow banana (modifier)."},
