...
const COVERAGE_U58 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"개방되다",src:"to be opened, to be liberalized"},{trg:"개방하다",src:"to open up, to liberalize"},{trg:"개별",src:"individual, separate"},{trg:"개선되다",src:"to be improved, to get better"}]},
    {type:"match",pairs:[{trg:"개성",src:"individuality, personality"},{trg:"거대하다",src:"to be enormous, to be colossal"},{trg:"거두다",src:"to harvest, to collect, to achieve"},{trg:"거들다",src:"to help, to assist, to lend a hand"}]},
    {type:"match",pairs:[{trg:"거듭",src:"repeatedly, again and again"},{trg:"거칠다",src:"to be rough, to be coarse"},{trg:"거품",src:"foam, bubbles, froth"},{trg:"걱정되다",src:"to be worried, to feel anxious"}]},
    {type:"match",pairs:[{trg:"걱정스럽다",src:"to look worrisome, to seem concerning"},{trg:"건넌방",src:"the room across the hall"},{trg:"건네다",src:"to hand over, to pass (something)"},{trg:"건네주다",src:"to hand over to someone"}]},
    {type:"match",pairs:[{trg:"건드리다",src:"to touch, to mess with, to provoke"},{trg:"건설되다",src:"to be constructed, to be built"},{trg:"걷기",src:"walking (as activity)"},{trg:"걷다",src:"to walk"}]},
    {type:"match",pairs:[{trg:"검정색",src:"black (color)"},{trg:"검토",src:"review, examination"},{trg:"겁나다",src:"to be scared, to feel afraid"},{trg:"게으르다",src:"to be lazy"}]},
    {type:"match",pairs:[{trg:"겨울철",src:"wintertime, winter season"},{trg:"겨자",src:"mustard"},{trg:"겪다",src:"to experience, to go through"},{trg:"견해",src:"viewpoint, opinion"}]},
    {type:"match",pairs:[{trg:"결과적",src:"resultant, consequential (as modifier)"},{trg:"결석",src:"absence (from school/meeting)"},{trg:"결석하다",src:"to be absent from"},{trg:"결승",src:"finals (of a competition)"}]},
    {type:"match",pairs:[{trg:"결심",src:"determination, resolution"},{trg:"결심하다",src:"to make up one's mind, to resolve"},{trg:"경쟁력",src:"competitiveness"},{trg:"경제력",src:"economic power"}]},
    {type:"match",pairs:[{trg:"경제학",src:"economics (academic field)"},{trg:"계곡",src:"valley, gorge"},{trg:"계산기",src:"calculator"},{trg:"계층",src:"class, stratum, layer"}]},
    {type:"match",pairs:[{trg:"고교",src:"high school (abbreviation)"},{trg:"고구마",src:"sweet potato"},{trg:"고궁",src:"ancient palace"},{trg:"고급스럽다",src:"to look luxurious, to seem high-class"}]},
    {type:"match",pairs:[{trg:"고모부",src:"paternal aunt's husband"},{trg:"고무신",src:"rubber shoes"},{trg:"고속",src:"high speed"},{trg:"고속도로",src:"highway, expressway"}]},
