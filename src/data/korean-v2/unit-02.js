...
{id:"kou2l1",title:"직업 (Jobs)",icon:"💼",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"프리랜서",en:"freelancer",pos:"noun",gender:null,funFact:"From English freelancer.",phonetic:"peu-ri-laen-seo",example:"A: 회사원이에요? B: 아니요, 프리랜서예요.",exampleEn:"A: Are you an office worker? B: No, I'm a freelancer.",note:"From English freelancer.\nVery common job in Korea.\nEnds in a vowel sound, so use the vowel form."},
  ...
  {type:"mc",q:"학생 분해: 학 + 생. 학 means:",opts:["Person","School","Study","Teacher"],ans:"Study",hint:"Study-person = student"},
...
{id:"kou2l2",title:"있어요 / 없어요",icon:"📦",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"없어요",en:"there isn't / I don't have",pos:"noun",gender:null,funFact:"Pair them in your memory.",phonetic:"eop-seo-yo",example:"A: 시간이 있어요? B: 아니요, 시간이 없어요.",exampleEn:"A: Do you have time? B: No, I don't have time.",note:"없다 = to not exist / to not have.\n없어요 = polite present form.\n",deepDive:{title:"Using 없어요",text:"있어요\n→ there is / I have\n\n없어요\n→ there is not / I don't have\n\nExact opposites. Pair them in your memory."}},
  ...
  {type:"teach",kind:"word",nl:"물",en:"water",pos:"noun",gender:null,funFact:"One of the most common Korean nouns.",phonetic:"mul",example:"A: 물이 있어요? B: 네, 물이 있어요.",exampleEn:"A: Is there water? B: Yes, there is water.",note:"One of the most common Korean nouns."},
  ...
  {type:"mc",q:"질문이 있어요 means:",opts:["I have a question","I have an answer","There is no question","I don't understand"],ans:"I have a question",hint:"질문 = question, 있어요 = have/exist"},
]},
...
{id:"kou2l2b",title:"★ Vowel Harmony: Why -아요 vs -어요",icon:"⚡",xp:25,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"가다",en:"to go",pos:"verb",gender:null,funFact:"From hanja: 家 (home/house) + 多 (many).",phonetic:"ga-da",example:"A: 어디에 가요? B: 학교에 가요.",exampleEn:"A: Where are you going? B: I'm going to school.",note:"Bright vowel in the stem.\nSame vowel merges in the ending.\n\n가다 → 가요 (to go → I go)",deepDive:{title:"The Simplest Contraction",text:"가 + 아요: the two ㅏ sounds merge into one.\nResult: 가요 (not 가아요)."}},

  {type:"teach",kind:"word",nl:"오다",en:"to come",pos:"verb",gender:null,funFact:"Result: 와요 (not 오아요).",phonetic:"o-da",example:"A: 누가 와요? B: 친구가 와요.",exampleEn:"A: Who is coming? B: A friend is coming.",note:"Bright vowel in the stem.\nTwo vowels contract.\n\n오다 → 와요 (to come → I come)",deepDive:{title:"The ㅘ Contraction",text:"오 + 아요: ㅗ and ㅏ merge into ㅘ.\nResult: 와요 (not 오아요)."}},

  {type:"teach",kind:"grammar",nl:"보다",en:"to see / to watch",pos:"part",gender:null,funFact:"From hanja: 保 (protect) + 多 (many).",phonetic:"bo-da",example:"A: 뭐 봐요? B: 영화를 봐요.",exampleEn:"A: What are you watching? B: I'm watching a movie.",note:"Same bright vowel contraction.\n\n보다 → 봐요 (to see → I see)",deepDive:{title:"Same Contraction",text:"보 + 아요: ㅗ+ㅏ = ㅘ.\nResult: 봐요 (not 보아요).\n\nSame pattern as 오다 → 와요."}},
  ...
  {type:"teach",kind:"grammar",nl:"먹다",en:"to eat",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",phonetic:"meok-da",example:"A: 뭐 먹어요? B: 밥을 먹어요.",exampleEn:"A: What are you eating? B: I'm eating rice.",note:"먹다: stem 먹.\nThe vowel in the stem is dark (not ㅏ or ㅗ).\n먹다 → 먹어요 (to eat → I eat).",deepDive:{title:"먹다",text:"Consonant stems: the ending just attaches."}},

  {type:"teach",kind:"word",nl:"마시다",en:"to drink",pos:"verb",gender:null,funFact:"Same contraction as 가르치다 → 가르쳐요.",phonetic:"ma-si-da",example:"A: 뭐 마셔요? B: 커피를 마셔요.",exampleEn:"A: What are you drinking? B: I'm drinking coffee.",note:"마시다: stem 마시.\nLast vowel ㅣ is dark.\n마시다 → 마셔요 (ㅣ+ㅓ contracts).",deepDive:{title:"Contraction",text:"마시 + 어요: mouth naturally says 마셔요.\nSame contraction as 가르치다 → 가르쳐요."}},
  ...
  {type:"teach",kind:"word",nl:"배우다",en:"to learn",pos:"verb",gender:null,funFact:"The stem vowel ㅜ is dark.",phonetic:"bae-u-da",example:"A: 뭐 배워요? B: 한국어를 배워요.",exampleEn:"A: What are you learning? B: I'm learning Korean.",note:"배우다: stem 배우.\nThe stem vowel ㅜ is dark."},
  {type:"teach",kind:"word",nl:"살다",en:"to live",pos:"verb",gender:null,funFact:"The stem vowel ㅏ is bright.",phonetic:"sal-da",example:"A: 어디에 살아요? B: 서울에 살아요.",exampleEn:"A: Where do you live? B: I live in Seoul.",note:"살다: stem 살.\nThe stem vowel ㅏ is bright."},
  {type:"teach",kind:"word",nl:"서다",en:"to stand",pos:"verb",gender:null,funFact:"From hanja: 西 (west) + 多 (many).",phonetic:"seo-da",example:"A: 어디에 서요? B: 여기에 서요.",exampleEn:"A: Where do you stand? B: I stand here.",note:"서다: stem 서.\nThe stem vowel ㅓ is dark."},
  {type:"teach",kind:"word",nl:"놀다",en:"to play / to hang out",pos:"verb",gender:null,funFact:"The stem vowel ㅗ is bright.",phonetic:"nol-da",example:"A: 같이 놀아요! B: 네, 좋아요!",exampleEn:"A: Let's hang out! B: Yes, sounds good!",note:"놀다: stem 놀.\nThe stem vowel ㅗ is bright."},
  ...
  {type:"teach",kind:"grammar",nl:"좋다 → 좋아요",en:"to be good / to like → is good / (I) like",pos:"verb",gender:null,funFact:"The polite informal ending. Used in ~80% of daily Korean conversation. Safe with almost everyone.",phonetic:"jo-ta → jo-a-yo",example:"A: 한국 음식이 좋아요? B: 네, 좋아요!",exampleEn:"A: Do you like Korean food? B: Yes, I like it!",note:"좋다: to be good, to like (feeling).\n\n좋다 → 좋아요\n→ Bright ㅗ in stem → takes -아요.",deepDive:{title:"좋다: Korea's Essential Word",text:"좋다 does DOUBLE duty:\n\n1. 'Is good':\n날씨가 좋아요 = The weather is good.\n\n2. 'I like' (feeling, with 이/가):\n커피가 좋아요 = I like coffee.\n\nThe subject marker 이/가 marks what you like.\nNOT 을/를. That's for 좋아하다.\n\nOpposite: 싫다 → 싫어요 (to dislike)."}},
  {type:"teach",kind:"grammar",nl:"좋아하다 → 좋아해요",en:"to like (action) → likes",pos:"verb",gender:null,funFact:"The polite informal ending. Used in ~80% of daily Korean conversation. Safe with almost everyone.",phonetic:"jo-a-ha-da → jo-a-hae-yo",example:"A: 뭐 좋아해요? B: 저는 한국 음식을 좋아해요.",exampleEn:"A: What do you like? B: I like Korean food.",note:"좋아하다: to like (as action verb).\n하다 compound: 좋아 (liking) + 하다 (do).\n\n좋아하다 → 좋아해요 (always 해요).",deepDive:{title:"좋다 vs 좋아하다",text:"좋다 = feeling (uses 이/가):\n커피가 좋아요 = Coffee is pleasing to me.\n\n좋아하다 = action (uses 을/를):\n커피를 좋아해요 = I like coffee (actively).\n\nBoth mean 'I like coffee' in English.\nBut the PARTICLES change.\nFor now: both are fine. Koreans use both."}},
...
{id:"kou2l2c",title:"을/를: Object Marker",icon:"🎯",xp:25,board:true,steps:[
 ...
 // ── Teach: the rule ──
 {type:"teach",kind:"grammar",nl:"을 or 를?",en:"Check the last letter.",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",phonetic:"",example:"A: 뭐 먹어요? B: 밥을 먹어요.",exampleEn:"A: What are you eating? B: I'm eating rice.",note:"Last letter has a consonant (받침)?\n→ add 을\n\nLast letter is a vowel (no 받침)?\n→ add 를",deepDive:{title:"The Rule In Full",text:"밥 → ㅂ (consonant) → 밥을\n커피 → ㅣ (vowel) → 커피를\n택시 → ㅣ (vowel) → 택시를\n물 → ㄹ (consonant) → 물을\n\nSame test every time. One glance at the final letter."}},
 // ── Teach: particle trio preview ──
 {type:"teach",kind:"grammar",nl:"은/는, 이/가, 을/를",en:"The three core particles",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",phonetic:"",example:"A: 저는 커피를 마셔요. B: 저도요!",exampleEn:"A: I drink coffee. B: Me too!",note:"You now know the three CORE particles:\n\n은/는\n→ TOPIC: 'as for X...'\n\n이/가\n→ SUBJECT: the doer / what exists\n\n을/를\n→ OBJECT: what the verb acts on",deepDive:{title:"How They Build a Sentence",text:"저는 커피를 마셔요 (I drink coffee):\n\n저는 → 'as for me' (topic)\n커피를 → coffee (object: what I drink)\n마셔요 → drink (verb: always last)\n\nKorean sentence = topic + object + verb.\nParticles tell you WHO does WHAT."}},
 // ── MC quizzes ──
...
{id:"kou2l3",title:"이것 / 그것 / 저것",icon:"👆",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"이것",en:"this (near me)",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",phonetic:"i-geot",example:"A: 이것은 뭐예요? B: 이것은 커피예요.",exampleEn:"A: What is this? B: This is coffee.",note:"이: near ME (the speaker).\n것: thing.\n이것: this thing.",deepDive:{title:"Full Pattern",text:"이 prefix rule: near the SPEAKER."}},
  {type:"teach",kind:"word",nl:"그것",en:"that (near you)",pos:"pron",gender:null,funFact:"Also used for things just mentioned:.",phonetic:"geu-geot",example:"A: 그것은 뭐예요? B: 그것은 물이에요.",exampleEn:"A: What is that? B: That is water.",note:"그: near YOU (the listener).\n그것: that thing near you.\n",deepDive:{title:"Using 그것",text:"Also used for things just mentioned:\n'그 사람' = 'that person' (already mentioned)."}},
  {type:"teach",kind:"word",nl:"저것",en:"that (far from both)",pos:"pron",gender:null,funFact:"The full three-level system:.",phonetic:"jeo-geot",example:"A: 저것이 뭐예요? B: 학교예요.",exampleEn:"A: What is that over there? B: It's a school.",note:"저: far from BOTH of us.\n저것: that thing way over there.\n",deepDive:{title:"Using 저것",text:"The full three-level system:\n\n이\n→ near ME\n\n그\n→ near YOU\n\n저\n→ far from BOTH."}},
  ...
  {type:"teach",kind:"grammar",nl:"이 / 그 / 저 + noun",en:"this / that / that (far) + noun",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",phonetic:"i / geu / jeo",example:"A: 이 가방은 뭐예요? B: 제 가방이에요.",exampleEn:"A: What is this bag? B: It's my bag.",note:"The prefix attaches directly to a noun:\n이것 → 이 가방 (this bag)\n그것 → 그 책 (that book)",deepDive:{title:"Prefix + Noun Pattern",text:"저것 → 저 건물 (that building)\n\nSame 이/그/저 logic, just with a specific noun."}},
  ...
  {type:"mc",q:"이것 = 이 + 것. 것 means:",opts:["Place","Person","Time","Thing"],ans:"Thing",hint:"것 = thing/stuff"},
  ...
  {type:"teach",kind:"grammar",nl:"보다",en:"to see / to watch",pos:"part",gender:null,funFact:"From hanja: 保 (protect) + 多 (many).",phonetic:"bo-da",example:"A: 이거 봐요! B: 뭐예요?",exampleEn:"A: Look at this! B: What is it?",note:"보다: to see, to watch, to look.\n\nOne of the 5 most common Korean verbs.",deepDive:{title:"보다",text:"보다 → 봐요 (polite present: ㅗ+ㅏ = ㅘ contraction).\n\n영화를 봐요: I watch a movie.\n텔레비전을 봐요: I watch TV.\n이거 봐요!: Look at this!\n\n보다 appears EVERYWHERE in Korean.\nYou'll use it every day."}},
  {type:"teach",kind:"word",nl:"말하다",en:"to speak / to say",pos:"verb",gender:null,funFact:"From hanja: 末 (end) + 下 (below/under) + 多 (many).",phonetic:"mal-ha-da",example:"A: 한국어로 말해요? B: 네, 한국어로 말해요!",exampleEn:"A: Do you speak in Korean? B: Yes, I speak in Korean!",note:"말하다: to speak, to say.\n말 (speech/words) + 하다 (do).\n",deepDive:{title:"말하다 in Korean Culture",text:"말하다 → 말해요 (하다 verb: always 해요).\n\n한국어로 말해요: I speak in Korean.\n영어로 말해요: I speak in English.\n천천히 말해 주세요: Please speak slowly.\n\n-(으)로 말하다: speak IN [language]."}},
  {type:"mc",q:"보다 → polite present:",opts:["봐요","보아요","보요","봅니다"],ans:"봐요",hint:"보: ㅗ+ㅏ contracts to ㅘ. ...."},
  {type:"mc",q:"한국어로 말해요 means:",opts:["I write Korean","I speak Korean","I read Korean","I study Korean"],ans:"I speak Korean",hint:"말하다 = to speak. 한국어로 = in Korean."},
]},
...
{id:"kou2l4",title:"여기 / 거기 / 저기",icon:"📍",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"이쪽 / 그쪽 / 저쪽",en:"this way / that way / that way (far)",pos:"part",gender:null,funFact:"Korean particles attach after nouns to mark their role. No equivalent in English.",phonetic:"i-jjok / geu-jjok / jeo-jjok",example:"A: 어디로 가요? B: 이쪽으로 오세요.",exampleEn:"A: Which way do I go? B: Come this way.",note:"쪽: direction/side.\n이쪽: this direction (toward me).\n그쪽: that direction (toward you).",deepDive:{title:"이쪽 / 그쪽 / 저쪽",text:"저쪽: that direction (far).\n\n이쪽으로: this way → (으)로 = direction particle ."}},
  ...
  {type:"mc",q:"이쪽으로 오세요 means:",opts:["Go over there","Look that direction","Come this way","Stay there"],ans:"Come this way",hint:"이쪽 = this direction (toward speaker), 오세요 = please come"},
]},
...
{id:"kou2l5",title:"Family Preview",icon:"👨‍👩‍👧‍👦",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"grammar",nl:"아빠 / 아버지",en:"dad / father",pos:"part",gender:null,funFact:"\"Try doing.\" 먹어 보세요 = please try eating it. Common recommendation pattern.",phonetic:"a-ppa / a-beo-ji",example:"A: 아빠가 어디에 있어요? B: 집에 있어요.",exampleEn:"A: Where is dad? B: He's at home.",note:"아빠: casual (dad).\n아버지: formal (father).\n",deepDive:{title:"아빠 / 아버지",text:"The double ㅃ in 아빠 is a tense consonant.\nAudio tip: it sounds clipped and forceful."}},
  ...
  {type:"teach",kind:"word",nl:"동생",en:"younger sibling",pos:"noun",gender:null,funFact:"From hanja: 東 (east) + 生 (life/person).",phonetic:"dong-saeng",example:"A: 동생이 있어요? B: 네, 남동생이 있어요.",exampleEn:"A: Do you have a younger sibling? B: Yes, I have a younger brother.",note:"동생: younger sibling.\n남동생: younger BROTHER.\n여동생: younger SISTER.\n남 = male, 여 = female.",deepDive:{title:"Using 동생",text:"Good news: no speaker-gender split for younger siblings.\nDifference only for OLDER siblings."}},
...
{id:"kou2l6",title:"Sino-Korean Cluster",icon:"🏛️",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"학교 = 학 + 교. 교 means:",opts:["Study","Teach","School","Place"],ans:"Teach",hint:"Study + Teach = school"},
  {type:"mc",q:"도서관 = 도서 + 관. 관 means:",opts:["Book","Room","Building","Library"],ans:"Building",hint:"관 = building/hall (영화관, 미술관)"},
  {type:"mc",q:"교실 and 화장실 both share 실. 실 means:",opts:["School","Teach","Place","Room"],ans:"Room",hint:"교실 = teach-room, 화장실 = wash-room"},
  {type:"mc",q:"병원 = 병 + 원. 병 means:",opts:["Illness","Place","Doctor","Medicine"],ans:"Illness",hint:"Illness-place = hospital"},
...
{id:"kou2l7",title:"도 (also / too)",icon:"➕",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"저도 몰라요 means:",opts:["I don't know either","I know too","I also want to know","Me too!"],ans:"I don't know either",hint:"도 + negative = neither / don't either"},
...
{id:"kou2l8",title:"[place]에 있어요",icon:"📍",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"집",en:"home / house",pos:"noun",gender:null,funFact:"Native Korean word (not Sino-Korean).",phonetic:"jip",example:"A: 지금 어디에 있어요? B: 집에 있어요.",exampleEn:"A: Where are you now? B: I'm at home.",note:"집: home/house.\n집에 있어요: 'I'm at home' / 'It's at home'.\n",deepDive:{title:"집 in Korean Culture",text:"Native Korean word (not Sino-Korean).\n집에 가요: 'going home' (에 as destination  -  preview of U6!)"}},
  ...
  {type:"teach",kind:"word",nl:"지금",en:"now / right now",pos:"noun",gender:null,funFact:"SINO-KOREAN: 지 (this) + 금 (now).",phonetic:"ji-geum",example:"A: 지금 어디에 있어요? B: 카페에 있어요.",exampleEn:"A: Where are you right now? B: I'm at the cafe.",note:"지금: now.\n지금 어디에 있어요?: 'Where are you right now?'\n",deepDive:{title:"Using 지금",text:"SINO-KOREAN: 지 (this) + 금 (now).\nVery common time word."}},
  ...
  {type:"mc",q:"집에 있어요. 집 means:",opts:["Home","Café","School","Library"],ans:"Home",hint:"집 = home/house"},
...
{id:"kou2l9",title:"알아요 / 몰라요",icon:"💡",xp:20,board:true,steps:[
  ...
  {type:"teach",kind:"word",nl:"맞아요",en:"That's right / Correct",pos:"pron",gender:null,funFact:"Very common in conversation.",phonetic:"ma-ja-yo",example:"A: 학생이에요? B: 네, 맞아요!",exampleEn:"A: Are you a student? B: Yes, that's right!",note:"맞다: to be correct/right.\n맞아요: polite form. 'That's correct.'\n",deepDive:{title:"Using 맞아요",text:"맞아요 is used to confirm someone is right.\n틀려요: 'That's wrong.' (opposite)\n\nVery common in conversation."}},
  {type:"mc",q:"몰라요 means:",opts:["I don't know","That's right","I'm not sure","I know"],ans:"I don't know",hint:"모르다 is the opposite of 알다 (to know). What is the negative?"},
  {type:"teach",kind:"word",nl:"정말요?",en:"Really?",pos:"noun",gender:null,funFact:"Korean nouns don't have plural forms or articles. Context and particles do the job.",phonetic:"jeong-mal-yo",example:"A: 저는 의사예요. B: 정말요?",exampleEn:"A: I'm a doctor. B: Really?",note:"정말: really / truly.\n정말요?: 'Really?' (surprised/interested reaction)\n",deepDive:{title:"Using 정말요?",text:"정말요 = 정말 (really) + 요 (polite).\n\n진짜요?: same meaning, more casual.\n(진짜 = real/true, more emphatic than 정말)"}},
...
{id:"kou2l9b",title:"누구? 왜? 어떻게?",icon:"❓",xp:20,board:true,steps:[
  ...
  {type:"mc",q:"왜 한국어를 배워요? means:",opts:["How do you learn Korean?","Why do you learn Korean?","What do you learn?","When do you learn Korean?"],ans:"Why do you learn Korean?",hint:"왜 = why"},
  ...
  {type:"mc",q:"어떤 음악 좋아해요? means:",opts:["What kind of music do you like?","How is the music?","Where is the music?","When do you listen to music?"],ans:"What kind of music do you like?",hint:"어떤 = what kind of. Asking about preferences."},
