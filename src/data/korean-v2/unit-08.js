...
export default {n:8,lang:"ko",srcLang:"en",track:"v2",title:"아프면 쉬세요",sub:"Health, Conditional & Ability",icon:"🏥",level:"A2.1",color:"#E74C3C",lessons:[
  ...
  {id:"kou8l1.2",title:"Limbs and Back",icon:"💪",xp:16,board:true,steps:[
        ...
        {type:"mc",q:"머리 means both:",opts:["Head and hair","Head and hand","Eye and nose","Neck and throat"],ans:"Head and hair",hint:"머리 = ___ / ___. 머리카락 = ___ strands specifically."},
  ...
  {id:"kou8l1.3",title:"More Body Parts",icon:"🦵",xp:18,board:true,steps:[
        ...
        {type:"mc",q:"손가락 and 발가락 share the element:",opts:["가락 (digit/stick)","손 (hand)","발 (foot)","락 (fall)"],ans:"가락 (digit/stick)",hint:"손 + 가락 = finger. 발 + 가락 = toe. 가락 = the ___"},
  ...
  {id:"kou8l2",title:"아프다 + 이/가",icon:"🤒",xp:22,board:true,steps:[
        ...
        {type:"mc",q:"콧물 = 코 + ㅅ + 물. What is 물?",opts:["Water","Nose","Cold","Sick"],ans:"Water",hint:"You already know 물 (___). 콧물 literally = nose + ___."},
  ...
  {id:"kou8l4",title:"할 수 있어요!",icon:"💪",xp:25,board:true,steps:[
        ...
        {type:"mc",q:"먹다 → 'can eat':",opts:["먹을 수 있어요","먹는 수 있어요","먹은 수 있어요","먹어 수 있어요"],ans:"먹을 수 있어요",hint:"Consonant stem + 을 수 있다. 먹 + 을 수 ___."},
        ...
        {type:"mc",q:"수영할 수 있어요?  -  Translation:",opts:["Do you swim?","Can you swim?","Did you swim?","Will you swim?"],ans:"Can you swim?",hint:"-(으)ㄹ 수 있다 = ability. 수영하다 = to ___. Asking about ability."},
  ...
  {id:"kou8l5",title:"-지 마세요",icon:"🚫",xp:22,board:true,steps:[
        ...
        {type:"mc",q:"먹다 → 'please don't eat':",opts:["먹지 마세요","먹을 마세요","안 먹세요","먹으마세요"],ans:"먹지 마세요",hint:"Stem + 지 ___. 먹 + 지 ___."},
        ...
        {type:"mc",q:"아프면 ___.\n(If you're sick, don't overdo it.)",opts:["무리하세요","무리하지 마세요","무리해요","무리하지 않아요"],ans:"무리하지 마세요",hint:"-지 ___ = please don't. Advice: don't overdo it."},
        ...
        {type:"mc",q:"How does -(으)면 combine with -지 마세요?",opts:["아프면 무리하지 마세요","아파면 무리지 마세요","아프면지 마세요","아프으면 마세요"],ans:"아프면 무리하지 마세요",hint:"-(으)면 on first clause, -지 ___ on second: if sick, don't overdo."},
  ...
  {id:"kou8l6",title:"병원과 약국",icon:"💊",xp:22,board:true,steps:[
        ...
        {type:"mc",q:"병 appears in 병원 (hospital) and 병 (sickness). What does the morpheme 병 mean?",opts:["Place / location","Doctor / physician","Illness / disease","Medicine / remedy"],ans:"Illness / disease",hint:"병 (病) = ___. 병원 = ___ + institution."},
        ...
        {type:"mc",q:"한의원 specializes in:",opts:["Western surgical medicine","Traditional Korean medicine","Dental care practice","Eye care treatment"],ans:"Traditional Korean medicine",hint:"한의원 = ___ (한) + ___ (의) + clinic (원)."},
  ...
  {id:"kou8l7",title:"부터/까지/동안",icon:"⏱️",xp:25,board:true,steps:[
        ...
        {type:"mc",q:"서울에서부터 부산까지  -  에서부터 combines:",opts:["Location + from","Action + until","Time + during","Direction + to"],ans:"Location + from",hint:"에서 (___) + 부터 (from) = from [place]."},
        ...
        {type:"mc",q:"약을 3일 동안 드세요. Translation:",opts:["Take medicine 3 times","Take medicine for 3 days","Take medicine until the 3rd","Take medicine from the 3rd"],ans:"Take medicine for 3 days",hint:"3일 동안 = for 3 ___. 드세요 = please ___ (honorific of 먹다)."}
  ]},
  {id:"kou8l8",title:"날씨가 좋은데...",icon:"🌱",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"날씨가 좋은데 같이 나갈까요?  -  -은데 here functions as:",opts:["Marks past tense only","Sets background then suggests","Makes sentence more formal","Only used in questions"],ans:"Sets background then suggests",hint:"-는데/-은데 ___ up ___ → suggestion follows."},
        {type:"mc",q:"배가 고픈데...  -  What does this imply?",opts:["Nothing, it is just unfinished","Speaker hints at wanting food","The speaker is not hungry","Speaker asks about food prices"],ans:"Speaker hints at wanting food",hint:"-는데 ___ and invites response. 'I'm hungry, so...' implies 'let's eat.'"},
        {type:"mc",q:"배가 고픈데 뭐 먹을까요? has how many parts?",opts:["One statement","Background + suggestion","Question + answer","Two unrelated sentences"],ans:"Background + suggestion",hint:"배가 고픈데 = ___ (I'm hungry). 뭐 먹을까요 = ___ (shall we eat?)."},
        ...
        {type:"mc",q:"Which uses -는데 to set background?",opts:["어제 비가 왔어요","좋은데 같이 나갈까요?","고파서 밥 먹었어요","아프면 쉬세요"],ans:"좋은데 같이 나갈까요?",hint:"-는데/-은데 sets background. ___ = nice + so/and..."},
  ...
  {id:"kou8l9",title:"복습 + 퀴즈",icon:"📝",xp:30,board:true,steps:[
        ...
        {type:"mc",q:"읽다 → 'can read':",opts:["읽을 수 있어요","읽는 수 있어요","읽어 수 있어요","읽을 수 해요"],ans:"읽을 수 있어요",hint:"Consonant stem + 을 수 ___."},
        {type:"mc",q:"'Don't worry' in Korean:",opts:["걱정하세요","걱정하지 마세요","걱정 없어요","걱정해요"],ans:"걱정하지 마세요",hint:"Stem + 지 ___ = please don't. ...."},
        ...
        {type:"mc",q:"배가 고픈데 뭐 먹을까요? -는데 here:",opts:["Expresses anger","Sets background and hints","Asks a direct question","Means 'because'"],ans:"Sets background and hints",hint:"-는데 ___ ___ → softly suggests."},
  ...
  {id:"kou8l9c",title:"건강",icon:"🏥",xp:20,board:true,steps:[
        ...
        {type:"mc",q:"두통 is made of which Sino-Korean parts?",opts:["head + medicine","head + pain","sick + cold","pain + fever"],ans:"head + pain",hint:"두 = ___ (頭), 통 = ___ (痛). A compound describing where it hurts."}
  ]}
]};
