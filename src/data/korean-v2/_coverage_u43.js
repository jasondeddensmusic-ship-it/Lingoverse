...
const COVERAGE_U43 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"자기",src:"oneself, self (informal)"},{trg:"자신",src:"oneself, self (formal)"},{trg:"자체",src:"itself, the thing itself"},{trg:"자연스럽다",src:"natural, unforced"}]},
    {type:"match",pairs:[{trg:"자유",src:"freedom, liberty"},{trg:"자유롭다",src:"to be free, to be unrestrained"},{trg:"이성",src:"reason, rationality; the opposite sex"},{trg:"성격",src:"personality, character, temperament"}]},
    {type:"match",pairs:[{trg:"콤플렉스",src:"complex (insecurity)"},{trg:"이상하다",src:"strange, weird, odd"},{trg:"평범하다",src:"ordinary, average, common"},{trg:"욕심",src:"greed, desire, ambition"}]},
    {type:"match",pairs:[{trg:"잘못하다",src:"to do wrong, to make a mistake"},{trg:"틀림없다",src:"certain, without doubt, unmistakable"},{trg:"정확히",src:"exactly, precisely"},{trg:"충분히",src:"sufficiently, enough, fully"}]},
    {type:"match",pairs:[{trg:"적당하다",src:"appropriate, moderate, suitable"},{trg:"적당히",src:"moderately, appropriately"},{trg:"위반",src:"violation, breach, infringement"},{trg:"질서",src:"order, discipline"}]},
    {type:"match",pairs:[{trg:"질",src:"quality"},{trg:"전통",src:"tradition"},{trg:"전통적",src:"traditional"},{trg:"조상",src:"ancestor"}]},
    {type:"match",pairs:[{trg:"절",src:"Buddhist temple; bow"},{trg:"장군",src:"general (military)"},{trg:"일반",src:"general, ordinary, common"},{trg:"일반적",src:"general, typical, common"}]},
    {type:"match",pairs:[{trg:"주요",src:"major, main, key"},{trg:"젊다",src:"young"},{trg:"편리하다",src:"convenient, handy"},{trg:"특별하다",src:"special, exceptional"}]},
    {type:"match",pairs:[{trg:"특별히",src:"especially, particularly, specially"},{trg:"특별",src:"special (as noun/modifier)"},{trg:"조심스럽다",src:"cautious, careful, delicate"},{trg:"청소년",src:"teenager, adolescent"}]},
    {type:"match",pairs:[{trg:"젊은이",src:"young person, youth"},{trg:"형님",src:"older brother (male's, honorific)"},{trg:"형제",src:"brothers, siblings"},{trg:"자랑하다",src:"to boast, to show off, to be proud of"}]},
