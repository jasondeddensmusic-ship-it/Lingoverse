...
const COVERAGE_U41 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"신체",src:"body, physique"},{trg:"손바닥",src:"palm (of the hand)"},{trg:"앓다",src:"to be ill, to suffer from"},{trg:"숙이다",src:"to lower, to bow (one's head)"}]},
    {type:"match",pairs:[{trg:"약하다",src:"to be weak, to be faint"},{trg:"어리다",src:"to be young, to be childish"},{trg:"아무렇다",src:"to be of any kind, however"},{trg:"새로",src:"newly, anew, afresh"}]},
    {type:"match",pairs:[{trg:"어느새",src:"before one knows it, already"},{trg:"어쩌면",src:"perhaps, possibly, maybe"},{trg:"내밀다",src:"to stick out, to extend, to thrust forward"},{trg:"달다",src:"to attach, to hang, to install"}]},
    {type:"match",pairs:[{trg:"들르다",src:"to drop by, to stop by"},{trg:"벌이다",src:"to start, to undertake, to set up"},{trg:"바르다",src:"to apply, to spread, to smear"},{trg:"반하다",src:"to fall for, to be charmed by"}]},
    {type:"match",pairs:[{trg:"생각나다",src:"to come to mind, to recall"},{trg:"생각되다",src:"to be thought, to seem, to be considered"},{trg:"어쩌다",src:"to happen by chance, accidentally"},{trg:"본래",src:"originally, inherently, by nature"}]},
