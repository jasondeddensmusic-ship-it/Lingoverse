...
const UNIT_32 = {
  ...
  lessons:[
    ...
    ,{type:"match",pairs:[{trg:"il commercio internazionale",src:"the international trade"},{trg:"la catena di fornitura",src:"the supply chain"},{trg:"il patrimonio culturale",src:"the cultural heritage"},{trg:"la cittadinanza globale",src:"the global citizenship"}]},{type:"mc",q:"How do you say \"welcome / reception\" in Italian?",opts:["la sfida globale","lo scambio culturale","l'interdipendenza","l'accoglienza"],ans:"l'accoglienza",hint:"Recall the Italian vocabulary word taught in this lesson."}]}
  ,
  BATCH8_L1,
  BATCH7_L1,
  BATCH6_L1,
