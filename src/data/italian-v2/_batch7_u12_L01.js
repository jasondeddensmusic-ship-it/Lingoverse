...
,{type:"match",pairs:[{trg:"il Ferragosto",src:"August holiday (Aug 15)"},{trg:"la processione",src:"the procession"},{trg:"i coriandoli",src:"confetti (paper)"},{trg:"il brindisi di mezzanotte",src:"midnight toast"}]},{type:"mc",q:"How do you say \"firework\" in Italian?",opts:["il Carnevale","la maschera","il Ferragosto","il fuoco d'artificio"],ans:"il fuoco d'artificio",hint:"Recall the Italian vocabulary word taught in this lesson."}]};
