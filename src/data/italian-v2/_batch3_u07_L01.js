...
const BATCH3_U07_L1 = {
  ...
  ,{type:"match",pairs:[{trg:"alla griglia",src:"grilled"},{trg:"la ricetta",src:"the recipe"},{trg:"condire",src:"to season / to dress"},{trg:"tagliare",src:"to cut / to slice"},{trg:"il cucchiaio",src:"the spoon"},{trg:"la forchetta",src:"the fork"}]},{type:"mc",q:"How do you say \"ingredient\" in Italian?",opts:["l'ingrediente","arrosto","alla griglia","fritto"],ans:"l'ingrediente",hint:"Recall the Italian vocabulary word taught in this lesson."}]
};
