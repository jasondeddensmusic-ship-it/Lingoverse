...
,{type:"match",pairs:[{trg:"la corsa",src:"the run / running"},{trg:"in forma",src:"in shape / fit"}]},{type:"mc",q:"How do you say \"exercise\" in Italian?",opts:["la corsa","sudare","il muscolo","l'esercizio"],ans:"l'esercizio",hint:"Recall the Italian vocabulary word taught in this lesson."}]};
