...
const BATCH2_U15_L1 = {
  ...
  ,{type:"match",pairs:[{trg:"il riscaldamento autonomo",src:"independent heating"},{trg:"la ristrutturazione",src:"the renovation"}]},{type:"mc",q:"How do you say \"connection\" in Italian?",opts:["l'allacciamento","l'impianto elettrico","l'impianto idraulico","la presa"],ans:"l'allacciamento",hint:"Recall the Italian vocabulary word taught in this lesson."}]
};
