...
const LESSON_6 = {id:"itv2_u9l6", title:"Pronto soccorso", icon:"\uD83D\uDE91", xp:15, board:true, steps:[
  ...
  {type:"mc", q:"What does 'svenire' literally mean?",
   ...
   hint:"From 's-' (un-) + 'venire' (to come). The person 'un-arrives' from awareness."},
  ...
  {type:"mc", q:"What does 'puntura' mean in Italian?",
   ...
   hint:"From 'pungere' (to prick/sting). Context tells you whether it is a bug or a doctor."},
  ...
  {type:"mc", q:"What does 'codice rosso' mean in an Italian ER?",
   ...
   hint:"The color triage system uses red for the most urgent cases. These patients are seen immediately."},
