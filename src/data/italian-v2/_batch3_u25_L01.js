...
const BATCH3_L_1 = {
  ...
  ,{type:"match",pairs:[{trg:"il PIL pro capite",src:"the GDP per capita"},{trg:"il contratto",src:"the contract"},{trg:"la produttivita",src:"the productivity"},{trg:"la previsione",src:"the forecast / prediction"},{trg:"lo stipendio",src:"the salary"}]},{type:"mc",q:"How do you say \"employment\" in Italian?",opts:["il dazio","il PIL pro capite","la manodopera","l'occupazione"],ans:"l'occupazione",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"import\" in Italian?",opts:["l'importazione","il dazio","il PIL pro capite","l'occupazione"],ans:"l'importazione",hint:"Recall the Italian vocabulary word taught in this lesson."},
