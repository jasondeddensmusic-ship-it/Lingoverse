...
const BATCH3_U09_L2 = {
  ...
  ,{type:"match",pairs:[{trg:"svenire",src:"to faint / to pass out"},{trg:"la bruciatura",src:"the burn"},{trg:"respirare",src:"to breathe"},{trg:"cadere",src:"to fall"},{trg:"la stampella",src:"the crutch"}]},{type:"mc",q:"How do you say \"ambulance\" in Italian?",opts:["l'ambulanza","il pronto soccorso","la ferita","la frattura"],ans:"l'ambulanza",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"insurance\" in Italian?",opts:["il pronto soccorso","l'assicurazione","l'ambulanza","la ferita"],ans:"l'assicurazione",hint:"Recall the Italian vocabulary word taught in this lesson."}]
};
