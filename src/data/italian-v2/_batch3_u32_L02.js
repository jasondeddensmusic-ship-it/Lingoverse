...
const BATCH3_L_2 = {
  ...
  ,{type:"match",pairs:[{trg:"la contaminazione culturale",src:"cultural cross-pollination"},{trg:"il protocollo",src:"the protocol / agreement"},{trg:"la transizione energetica",src:"the energy transition"},{trg:"la decrescita",src:"degrowth"},{trg:"la resilienza urbana",src:"urban resilience"}]},{type:"mc",q:"How do you say \"ecological footprint\" in Italian?",opts:["l'omologazione","la contaminazione culturale","il consumismo","l'impronta ecologica"],ans:"l'impronta ecologica",hint:"Recall the Italian vocabulary word taught in this lesson."},
