...
const BATCH3_L_2 = {
  ...
  ,{type:"match",pairs:[{trg:"la casa editrice",src:"the publishing house"},{trg:"il premio letterario",src:"the literary prize"},{trg:"la ristampa",src:"the reprint"},{trg:"il bestseller",src:"the bestseller"},{trg:"la libreria",src:"the bookshop"},{trg:"la prefazione",src:"the preface / foreword"}]},{type:"mc",q:"How do you say \"anthology\" in Italian?",opts:["la casa editrice","la traduzione","il premio letterario","l'antologia"],ans:"l'antologia",hint:"Recall the Italian vocabulary word taught in this lesson."},
