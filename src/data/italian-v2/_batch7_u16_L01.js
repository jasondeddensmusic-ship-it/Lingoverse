...
,{type:"match",pairs:[{trg:"il calcio (minerale)",src:"calcium"},{trg:"il peso forma",src:"ideal weight"},{trg:"equilibrato",src:"balanced"}]},{type:"mc",q:"How do you say \"nutrition / diet\" in Italian?",opts:["le proteine","i carboidrati","i grassi","l'alimentazione"],ans:"l'alimentazione",hint:"Recall the Italian vocabulary word taught in this lesson."}]};
