...
const BATCH3_L_1 = {
  ...
  ,{type:"match",pairs:[{trg:"il settimanale",src:"the weekly magazine"},{trg:"il servizio",src:"the report / news segment"},{trg:"la tiratura",src:"the circulation (newspapers)"},{trg:"il servizio pubblico",src:"the public broadcasting service"}]},{type:"mc",q:"How do you say \"subscription\" in Italian?",opts:["il quotidiano","il settimanale","il palinsesto","l'abbonamento"],ans:"l'abbonamento",hint:"Recall the Italian vocabulary word taught in this lesson."},
