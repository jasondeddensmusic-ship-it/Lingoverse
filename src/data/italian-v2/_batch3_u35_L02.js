...
const BATCH3_L_2 = {
  ...
  ,{type:"match",pairs:[{trg:"la mobilita sostenibile",src:"sustainable mobility"},{trg:"il superbonus",src:"the superbonus (building incentive)"},{trg:"la startup green",src:"the green startup"},{trg:"il brevetto verde",src:"the green patent"}]},{type:"mc",q:"How do you say \"knowledge economy\" in Italian?",opts:["il pannello solare","la mobilita sostenibile","l'idrogeno verde","l'economia della conoscenza"],ans:"l'economia della conoscenza",hint:"Recall the Italian vocabulary word taught in this lesson."},
