...
,{type:"match",pairs:[{trg:"il sogno",src:"the dream"},{trg:"la proposta",src:"the proposal / suggestion"},{trg:"accontentarsi",src:"to settle for / to be content with"}]},{type:"mc",q:"How do you say \"aspiration / ambition\" in Italian?",opts:["desiderare","il favore","il sogno","l'aspirazione"],ans:"l'aspirazione",hint:"Recall the Italian vocabulary word taught in this lesson."}]};
