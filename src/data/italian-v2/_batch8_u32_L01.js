...
,{type:"match",pairs:[{trg:"il meticciato",src:"the cultural mixing / mestizaje"},{trg:"la seconda generazione",src:"the second generation"}]},{type:"mc",q:"How do you say \"immigration\" in Italian?",opts:["il rifugiato","l'integrazione","la convivenza","l'immigrazione"],ans:"l'immigrazione",hint:"Recall the Italian vocabulary word taught in this lesson."}]};
