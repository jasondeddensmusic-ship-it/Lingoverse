...
,{type:"match",pairs:[{trg:"il titolo",src:"the headline / title"},{trg:"il palinsesto",src:"the programming schedule"},{trg:"il comunicato stampa",src:"the press release"}]},{type:"mc",q:"How do you say \"correspondent / reporter\" in Italian?",opts:["la redazione","il titolo","la fonte","l'inviato"],ans:"l'inviato",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"interview\" in Italian?",opts:["l'intervista","la redazione","l'inviato","il titolo"],ans:"l'intervista",hint:"Recall the Italian vocabulary word taught in this lesson."}]};
