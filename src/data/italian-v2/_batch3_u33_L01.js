...
const BATCH3_L_1 = {
  ...
  ,{type:"match",pairs:[{trg:"il determinismo",src:"determinism"},{trg:"la democrazia",src:"democracy"},{trg:"il pragmatismo",src:"pragmatism"},{trg:"il nichilismo",src:"nihilism"}]},{type:"mc",q:"How do you say \"utilitarianism\" in Italian?",opts:["la giustizia","il determinismo","la democrazia","l'utilitarismo"],ans:"l'utilitarismo",hint:"Recall the Italian vocabulary word taught in this lesson."},
