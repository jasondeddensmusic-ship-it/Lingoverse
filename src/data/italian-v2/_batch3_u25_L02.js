...
const BATCH3_L_2 = {
  ...
  ,{type:"match",pairs:[{trg:"la banca centrale",src:"the central bank"},{trg:"il patrimonio",src:"the wealth / assets / estate"},{trg:"il risparmio",src:"the savings"},{trg:"il titolo di Stato",src:"the government bond"},{trg:"il fallimento bancario",src:"the bank failure"}]},{type:"mc",q:"How do you say \"tax evasion\" in Italian?",opts:["la banca centrale","il mutuo","l'IVA","l'evasione fiscale"],ans:"l'evasione fiscale",hint:"Recall the Italian vocabulary word taught in this lesson."},
