...
const BATCH3_L_1 = {
  ...
  ,{type:"match",pairs:[{trg:"il bias algoritmico",src:"algorithmic bias"},{trg:"la trasparenza",src:"transparency"},{trg:"la robotica",src:"robotics"}]},{type:"mc",q:"How do you say \"Internet of Things\" in Italian?",opts:["il deepfake","il bias algoritmico","la trasparenza","l'internet delle cose"],ans:"l'internet delle cose",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"planned obsolescence\" in Italian?",opts:["l'obsolescenza programmata","il deepfake","il bias algoritmico","la trasparenza"],ans:"l'obsolescenza programmata",hint:"Recall the Italian vocabulary word taught in this lesson."},
