...
const LESSON_6 = {id:"itv2_u10l6", title:"Fare il turista", icon:"\uD83D\uDCF8", xp:15, board:true, steps:[
  ...
  {type:"mc", q:"What dress code applies in Italian churches?",
   ...
   hint:"These are places of worship. Bare shoulders and shorts above the knee are not permitted inside."},
  ...
  {type:"mc", q:"What is the 'passeggiata'?",
   ...
   hint:"Between 5-8 PM, Italians walk the main streets, socialize, and enjoy gelato. It is a daily ritual."},
  ...
  {type:"mc", q:"What are Rome's 'nasoni'?",
   ...
   hint:"'Nasone' means big nose. These small fountains throughout Rome provide clean, free drinking water."},
