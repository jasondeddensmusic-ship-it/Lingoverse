...
import BATCH3_L02 from './_batch3_u30_L02.js';
import BATCH3_L01 from './_batch3_u30_L01.js';
...
const UNIT_30 = {
  ...
  lessons:[
    ...
    {id:"itv2_u30l3", title:"Congiunzioni concessive", icon:"⚡", xp:15, board:true, steps:[
      ...
      {type:"tip", title:"Gerundio & Infinitive Constructions",
       text:"Italian uses two non-finite verb forms in ways that differ from English.\n\nThe gerundio (gerund) goes beyond stare + gerundio. It can replace entire clauses:\n'Studiando, ho capito tutto.' = By studying, I understood everything.\n'Camminando per il centro, ho visto Marco.' = While walking through the center, I saw Marco.\n'Non sapendo la risposta, mi sono alzato.' = Not knowing the answer, I stood up.\n\nThe past gerundio (avendo/essendo + past participle) shows an action before the main verb:\n'Avendo finito il lavoro, sono uscito.' = Having finished work, I went out.\n'Essendo arrivata tardi, non ha visto lo spettacolo.' = Having arrived late, she did not see the show.\n\nThe infinitive is used after prepositions. Italian never uses the gerundio after a preposition:\nprima di + infinitive: 'prima di partire' (before leaving)\ndopo + compound infinitive: 'dopo aver mangiato' (after eating)\nsenza + infinitive: 'senza dire niente' (without saying anything)\ninvece di + infinitive: 'invece di studiare' (instead of studying)",
       icon:"💡",
       deepDive:{title:"The key rule: infinitive after prepositions, never gerundio", text:"English speakers often want to use the gerundio after 'without', 'before', 'instead of.' In Italian, this is always wrong. Prepositions take infinitives, not gerunds.\n\nCorrect: 'Sono uscito senza dire niente.' (I left without saying anything.)\nWrong: 'Sono uscito senza dicendo niente.'\n\nCorrect: 'Prima di partire, chiama.' (Before leaving, call.)\nWrong: 'Prima di partendo, chiama.'\n\nThe gerundio appears freely without a preposition, but the moment you add a preposition like 'senza' or 'prima di', switch to the infinitive. This single rule eliminates the most common learner error with gerunds."}},
