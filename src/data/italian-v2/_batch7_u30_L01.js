...
{type:"teach", trg:"sebbene", src:"although / even though", pos:"conj", gender:null,
 ...
 funFact:"'Sebbene' is the most formal way to say 'although.' The hierarchy: 'sebbene' (very formal) > 'benché' (formal) > 'nonostante' (standard) > 'anche se' (informal, no subjunctive needed)."},

{type:"teach", trg:"benché", src:"although / even though", pos:"conj", gender:null,
...
{type:"teach", trg:"affinché", src:"in order that / so that", pos:"conj", gender:null,
 ...
 funFact:"'Affinche' is the formal version of 'perché' (when it means 'so that'). In academic writing, 'affinché' signals sophistication. In speech, most Italians use 'perché' or 'in modo che.'"},
...
{type:"teach", trg:"in quanto", src:"since / because / as", pos:"conj", gender:null,
 note:"Conjunction. More formal than 'perché.'\n'In quanto cittadino' = as a citizen.",
