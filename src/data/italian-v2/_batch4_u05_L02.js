...
const BATCH4_U05_L2 = {
  ...
  ,{type:"match",pairs:[{trg:"il bucato",src:"the laundry"},{trg:"la lavatrice",src:"the washing machine"},{trg:"pulito",src:"clean"},{trg:"ordinato",src:"tidy / organized"},{trg:"la spazzatura",src:"the garbage / trash"},{trg:"sistemare",src:"to tidy up / to fix / to arrange"}]},{type:"mc",q:"How do you say \"vacuum cleaner\" in Italian?",opts:["l'aspirapolvere","pulire","lavare","cucinare"],ans:"l'aspirapolvere",hint:"Recall the Italian vocabulary word taught in this lesson."}]
};
