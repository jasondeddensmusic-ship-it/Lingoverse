...
import BATCH5_L02 from './_batch5_u16_L02.js';
import BATCH5_L01 from './_batch5_u16_L01.js';
  ...
  lessons:[
    {id:"itv2_u16l1", title:"Dal dottore", icon:"🩺", xp:15, board:true, steps:[
      ...
      {type:"teach", trg:"la diagnosi", src:"the diagnosis", pos:"noun", gender:"f",
       ...
       example:"A: Qual e la diagnosi?\nB: Il dottore dice che e solo un'influenza.\nA: Devi prendere dei farmaci?\nB: Si, antibiotici per cinque giorni e tanto riposo.",
       exampleSrc:"A: What is the diagnosis?\nB: The doctor says it is just the flu.\nA: Do you have to take any medication?\nB: Yes, antibiotics for five days and lots of rest.",
      ...
      {type:"teach", trg:"l'intervento", src:"the surgery / operation", pos:"noun", gender:"m",
       ...
       example:"A: Mia nonna ha avuto un intervento al ginocchio.\nB: Come sta adesso?\nA: L'intervento e andato bene?\nB: Si, i medici sono molto soddisfatti.",
       exampleSrc:"A: My grandmother had knee surgery.\nB: How is she now?\nA: Did the surgery go well?\nB: Yes, the doctors are very satisfied.",
...
{type:"match",pairs:[{trg:"la diagnosi",src:"the diagnosis"},{trg:"la terapia",src:"the therapy / treatment"},{trg:"l'intervento",src:"the surgery / operation"},{trg:"il ricovero",src:"the hospitalization"}]},
    ...
    {id:"itv2_u16l2", title:"Malattie e infortuni", icon:"🤕", xp:15, board:true, steps:[
      ...
      {type:"teach", trg:"l'allergia", src:"the allergy", pos:"noun", gender:"f",
       ...
       example:"A: Hai qualche allergia?\nB: Si, sono allergico al polline.\nA: Prendi qualcosa per l'allergia?\nB: Si, un antistaminico ogni mattina in primavera.",
       exampleSrc:"A: Do you have any allergies?\nB: Yes, I am allergic to pollen.\nA: Do you take anything for the allergy?\nB: Yes, an antihistamine every morning in spring.",
      ...
      {type:"teach", trg:"la febbre", src:"the fever", pos:"noun", gender:"f",
       ...
       example:"A: Hai la febbre?\nB: Si, trentotto e cinque.\nA: Hai preso qualcosa?\nB: Si, una tachipirina un'ora fa. Spero che scenda.",
       exampleSrc:"A: Do you have a fever?\nB: Yes, thirty-eight point five.\nA: Did you take anything?\nB: Yes, a paracetamol an hour ago. I hope it goes down.",
...
{type:"match",pairs:[{trg:"la frattura",src:"the fracture / break"},{trg:"l'infezione",src:"the infection"},{trg:"l'infiammazione",src:"the inflammation"},{trg:"la febbre",src:"the fever"}]},
      ...
      {type:"teach", trg:"la ferita", src:"the wound / injury", pos:"noun", gender:"f",
       ...
       example:"A: La ferita e profonda?\nB: No, e solo un graffio. Metti un cerotto.\nA: Bisogna andare al pronto soccorso?\nB: No, basta disinfettare e mettere un cerotto.",
       exampleSrc:"A: Is the wound deep?\nB: No, it is just a scratch. Put on a bandaid.\nA: Do we need to go to the emergency room?\nB: No, just disinfect it and put on a bandaid.",
      ...
      {type:"teach", trg:"il farmaco", src:"the medicine / drug", pos:"noun", gender:"m",
       ...
       example:"A: Che farmaci prendi?\nB: Solo un antidolorifico per il mal di schiena.\nA: Li prendi da molto tempo?\nB: Solo da una settimana. Il dottore vuole rivedermi lunedi.",
       exampleSrc:"A: What medicines do you take?\nB: Just a painkiller for my back pain.\nA: Have you been taking them for long?\nB: Only for a week. The doctor wants to see me again on Monday.",
    ...
    {id:"itv2_u16l3", title:"Guarire e curarsi", icon:"💊", xp:15, board:true, steps:[
      ...
      {type:"teach", trg:"migliorare", src:"to improve / to get better", pos:"verb", gender:null,
       ...
       example:"A: Come sta il paziente?\nB: Sta migliorando giorno dopo giorno.\nA: Quando potra tornare a casa?\nB: Forse la settimana prossima, se continua cosi.",
       exampleSrc:"A: How is the patient?\nB: He is improving day by day.\nA: When will he be able to go home?\nB: Perhaps next week, if he keeps improving.",
...
{type:"match",pairs:[{trg:"peggiorare",src:"to worsen / to get worse"},{trg:"migliorare",src:"to improve / to get better"},{trg:"operare",src:"to operate (surgery)"},{trg:"prescrivere",src:"to prescribe"}]},
      ...
      {type:"teach", trg:"il paziente", src:"the patient", pos:"noun", gender:"m",
       ...
       example:"A: Il paziente sta meglio?\nB: Si, la cura funziona bene.\nA: Ha ancora bisogno di assistenza?\nB: Un po', ma ogni giorno diventa piu autonomo.",
       exampleSrc:"A: Is the patient better?\nB: Yes, the treatment is working well.\nA: Does he still need assistance?\nB: A little, but every day he becomes more independent.",
