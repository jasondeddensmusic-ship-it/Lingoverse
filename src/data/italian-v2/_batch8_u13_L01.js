...
,{type:"match",pairs:[{trg:"ammettere",src:"to admit / to acknowledge"},{trg:"la convinzione",src:"the belief / conviction"},{trg:"presumere",src:"to presume / to assume"}]},{type:"mc",q:"How do you say \"hypothesis\" in Italian?",opts:["supporre","il dubbio","ammettere","l'ipotesi"],ans:"l'ipotesi",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"appearance / semblance\" in Italian?",opts:["l'apparenza","supporre","il dubbio","l'ipotesi"],ans:"l'apparenza",hint:"Recall the Italian vocabulary word taught in this lesson."}]};
