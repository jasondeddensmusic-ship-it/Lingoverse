...
{type:"fb",s:"La {1} e vietata da tutte le convenzioni internazionali.",a:["la tortura"],opts:["la tortura","il genocidio","il cessate il fuoco","la sicurezza collettiva"],hint:"Official protection granted to someone fleeing persecution in their home country.",sSrc:"The refugee requested {1} in the neighbouring country."},
{type:"fb",s:"{1} sono protetti dalla Dichiarazione Universale dell'ONU.",a:["i diritti umani"],opts:["i diritti umani","il genocidio","la tortura","lo sfollato"],hint:"Fundamental rights that every person is entitled to regardless of nationality.",sSrc:"Human {1} are protected by the UN Universal Declaration."}]
};
