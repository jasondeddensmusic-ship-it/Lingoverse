...
const BATCH3_L_1 = {
  ...
  ,{type:"match",pairs:[{trg:"il debito estero",src:"the foreign debt"},{trg:"la microfinanza",src:"microfinance"},{trg:"la zona franca",src:"the free trade zone"},{trg:"la crescita demografica",src:"population growth"}]},{type:"mc",q:"How do you say \"World Trade Organization\" in Italian?",opts:["la delocalizzazione","il debito estero","il fondo monetario","l'organizzazione mondiale del commercio"],ans:"l'organizzazione mondiale del commercio",hint:"Recall the Italian vocabulary word taught in this lesson."},
