...
const COVERAGE_U29 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"l'abitudine",src:"the habit"},{trg:"sopravvalutare",src:"to overestimate"},{trg:"il capro espiatorio",src:"the scapegoat"},{trg:"l'effetto spettatore",src:"the bystander effect"}]},
    {type:"match",pairs:[{trg:"la leadership situazionale",src:"situational leadership"},{trg:"la psicologia della folla",src:"crowd psychology"},{trg:"la neuroplasticita",src:"neuroplasticity"},{trg:"l'effetto Dunning-Kruger",src:"the Dunning-Kruger effect"}]},
