...
const BATCH3_L_2 = {
  ...
  ,{type:"match",pairs:[{trg:"lo sviluppo cognitivo",src:"cognitive development"},{trg:"la socializzazione",src:"socialization"}]},{type:"mc",q:"How do you say \"adolescence\" in Italian?",opts:["lo sviluppo cognitivo","l'apprendimento","il conformismo","l'adolescenza"],ans:"l'adolescenza",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"identity\" in Italian?",opts:["l'identità","lo sviluppo cognitivo","l'apprendimento","l'adolescenza"],ans:"l'identità",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"emotional intelligence\" in Italian?",opts:["lo sviluppo cognitivo","l'intelligenza emotiva","l'apprendimento","l'adolescenza"],ans:"l'intelligenza emotiva",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"introversion\" in Italian?",opts:["lo sviluppo cognitivo","l'apprendimento","l'introversione","l'adolescenza"],ans:"l'introversione",hint:"Recall the Italian vocabulary word taught in this lesson."},{type:"mc",q:"How do you say \"emulation / imitation\" in Italian?",opts:["lo sviluppo cognitivo","l'apprendimento","l'adolescenza","l'emulazione"],ans:"l'emulazione",hint:"Recall the Italian vocabulary word taught in this lesson."},
