  ...
  de: {
    ...
    packs: [
      ...
      { ...WORDTYPE_PACK },
      {
        ...
        desc: "Highlights prepositions and articles. Case-specific colors coming soon.",
        colorMap: {
          preposition: { color: "#6366F1", dk: "#818CF8" },
          article: { color: "#22C55E", dk: "#4ADE80" },
          article_m: { color: "#22C55E", dk: "#4ADE80" },
          article_f: { color: "#22C55E", dk: "#4ADE80" },
          article_n: { color: "#22C55E", dk: "#4ADE80" },
          article_pl: { color: "#22C55E", dk: "#4ADE80" },
          article_indef: { color: "#22C55E", dk: "#4ADE80" },
          pronoun: { color: "#8B5CF6", dk: "#A78BFA" },
          pronoun_dat: { color: "#A855F7", dk: "#C084FC" },
          pronoun_refl: { color: "#A855F7", dk: "#C084FC" },
          pronoun_rel: { color: "#A855F7", dk: "#C084FC" },
        },
        legend: [
