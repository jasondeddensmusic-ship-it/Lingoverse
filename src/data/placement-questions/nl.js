...
export const DUTCH_PLACEMENT = [
  ...
  { id:"nl-b11-2", level:"B1.1", stem:"Ik weet dat hij ___.", stemSrc:"I know that he is coming.", q:"Verb position", opts:["komt","komt hij","hij komt","kome"], ans:"komt", category:"subordinate" },
  ...
  { id:"nl-b12-2", level:"B1.2", stem:"Het boek ___ ik gelezen heb, is geweldig.", stemSrc:"The book I read is great.", q:"Relative pronoun", opts:["die","dat","wat","welk"], ans:"dat", category:"relative-pronoun" },
  ...
  { id:"nl-b22-4", level:"B2.2", stem:"Hoe vaak hij het ook probeert, hij mislukt.", q:"What does 'ook' signal here?", opts:["addition","concession","contrast","reason"], ans:"concession", category:"discourse" },
