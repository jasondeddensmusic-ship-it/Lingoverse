...
export const RUSSIAN_PLACEMENT = [
  ...
  { id:"ru-a11-2", level:"A1.1", stem:"Я ___ студент.", stemSrc:"I am a student.", q:"Present tense 'to be' in Russian is:", opts:["есть (often omitted)","являюсь","буду","был"], ans:"есть (often omitted)", category:"copula" },
  ...
  { id:"ru-a11-5", level:"A1.1", stem:"Меня зовут Мария.", q:"What does this mean?", opts:["I want Maria","My name is Maria","I see Maria","I know Maria"], ans:"My name is Maria", category:"intro" },

  // A1.1 reinforcement pool
  { id:"ru-a11-6", level:"A1.1", stem:"Спасибо", q:"What does this mean?", opts:["Hello","Goodbye","Thank you","Excuse me"], ans:"Thank you", category:"greetings" },
  { id:"ru-a11-7", level:"A1.1", stem:"Как дела?", q:"What does this mean?", opts:["What is your name?","How are you?","Where are you from?","How old are you?"], ans:"How are you?", category:"greetings" },

  // ═══ A1.2 : present tense conjugation, nominative/accusative, pronouns ═══
  { id:"ru-a12-1", level:"A1.2", stem:"Мы ___ в Москве.", stemSrc:"We live in Moscow.", q:"Correct form of жить:", opts:["живу","живёшь","живёт","живём"], ans:"живём", category:"present-tense" },
  ...
  { id:"ru-a12-4", level:"A1.2", stem:"Он ___ много кофе.", stemSrc:"He drinks a lot of coffee.", q:"Пить:", opts:["пью","пьёшь","пьёт","пьём"], ans:"пьёт", category:"present-tense" },
  ...
  { id:"ru-a12-6", level:"A1.2", stem:"Сколько вам лет?", q:"What does this mean?", opts:["Where are you from?","How old are you?","What is your name?","What do you do?"], ans:"How old are you?", category:"expressions" },
  { id:"ru-a12-7", level:"A1.2", stem:"Ей двадцать пять лет.", q:"Age uses which case after 21+?", opts:["nominative","genitive","dative","accusative"], ans:"genitive", category:"age-case" },

  // ═══ A2.1 : past tense, aspect intro, basic prepositions ═══
  { id:"ru-a21-1", level:"A2.1", stem:"Вчера я ___ в кино.", stemSrc:"Yesterday I went to the cinema.", q:"Masculine past:", opts:["иду","шёл","шла","шли"], ans:"шёл", category:"past-tense" },
  { id:"ru-a21-2", level:"A2.1", stem:"Я никогда не ___ мясо.", stemSrc:"I never eat meat.", q:"Present:", opts:["ем","ел","буду есть","ела"], ans:"ем", category:"negation" },
  ...
  { id:"ru-a21-4", level:"A2.1", stem:"Он ___ домашнее задание.", stemSrc:"He did his homework.", q:"Perfective past masculine:", opts:["делает","делал","сделал","сделала"], ans:"сделал", category:"past-tense" },
  ...
  { id:"ru-a21-6", level:"A2.1", stem:"Они ___ в Санкт-Петербурге в прошлом году.", stemSrc:"They lived in St. Petersburg last year.", q:"Imperfective past plural:", opts:["живут","жили","жило","жила"], ans:"жили", category:"past-tense" },
  ...
  { id:"ru-a22-1", level:"A2.2", stem:"Если бы у меня было время, я бы ___.", stemSrc:"If I had time, I would come.", q:"Conditional:", opts:["пришёл","прихожу","прийду","приходил"], ans:"пришёл", category:"conditional" },
  { id:"ru-a22-2", level:"A2.2", stem:"Мария ___ Ивана.", stemSrc:"Maria is taller than Ivan.", q:"Comparative:", opts:["высокая, чем","выше, чем","самая высокая из","высока из"], ans:"выше, чем", category:"comparative" },
  ...
  { id:"ru-a22-4", level:"A2.2", stem:"Книга ___ на столе.", stemSrc:"The book is on the table.", q:"Verb:", opts:["есть","лежит","стоит","сидит"], ans:"лежит", category:"position-verbs" },
  ...
  { id:"ru-b11-2", level:"B1.1", stem:"Я знаю, что он ___.", stemSrc:"I know that he is coming.", q:"Verb:", opts:["приходит","прийдёт","пришёл","приходил"], ans:"приходит", category:"complex-sentence" },
  ...
  { id:"ru-b11-4", level:"B1.1", stem:"Хотя он был болен, он всё равно пришёл.", q:"'хотя' expresses:", opts:["reason","concession","condition","purpose"], ans:"concession", category:"conjunctions" },
  ...
  { id:"ru-b12-1", level:"B1.2", stem:"В этом году я ___ три страны.", stemSrc:"This year I have visited three countries.", q:"Perfective past:", opts:["посещаю","посетил","посещал","буду посещать"], ans:"посетил", category:"past-tense" },
  { id:"ru-b12-2", level:"B1.2", q:"Genitive plural of 'книга' (book):", opts:["книги","книге","книгу","книг"], ans:"книг", category:"genitive-plural" },
  { id:"ru-b12-3", level:"B1.2", stem:"Он сказал, что ___ устал.", stemSrc:"He said he was tired.", q:"Reported speech:", opts:["он есть","он был","он будет","он устал"], ans:"он устал", category:"reported-speech" },
  ...
  { id:"ru-b12-5", level:"B1.2", stem:"Она спала, когда позвонил телефон.", q:"Что expresses the relationship?", opts:["two simultaneous completed actions","ongoing + sudden completed","habitual actions","future plan"], ans:"ongoing + sudden completed", category:"aspect-narrative" },
  ...
  { id:"ru-b21-4", level:"B2.1", stem:"Несмотря на дождь, мы пошли гулять.", q:"'несмотря на' expresses:", opts:["reason","concession","addition","purpose"], ans:"concession", category:"advanced-prepositions" },
  ...
  { id:"ru-b22-3", level:"B2.2", stem:"Невзирая на его усилия, он потерпел неудачу.", q:"'невзирая на' expresses:", opts:["reason","concession","addition","purpose"], ans:"concession", category:"discourse" },
  ...
  { id:"ru-b22-5", level:"B2.2", stem:"Сколько бы он ни пытался, у него не получается.", q:"What does 'сколько бы ни' express?", opts:["reason","concessive generalization","condition","purpose"], ans:"concessive generalization", category:"discourse" },
];
