...
const UNIT_02 = {n:2,lang:"pt",srcLang:"en",track:"v2",title:"Quantos anos você tem?",sub:"Numbers and Age",icon:"🔢",level:"A1.1",color:"#7B5EE8",lessons:[
  {id:"ptv2_u2l1",title:"Numbers 0 to 5",icon:"5️⃣",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"zero",src:"zero",pos:"num",gender:null,note:"Identical spelling to English. Pronunciation stresses the first syllable: ZEH-roo.",example:"A: Quantos anos?\nB: Zero. Obrigado.",exampleSrc:"A: How many years?\nB: Zero. Thank you.",funFact:"Both Portuguese and English borrowed zero from Arabic 'sifr', via Italian 'zero'."},
    {type:"teach",trg:"um",src:"one",pos:"num",gender:"m",note:"Masculine form. Also means 'a' or 'an' before masculine nouns.",example:"A: Quantos anos?\nB: Um ano.",exampleSrc:"A: How many years?\nB: One year.",funFact:"Um has a feminine form 'uma' used before feminine nouns: uma casa (one house)."},
    {type:"teach",trg:"dois",src:"two",pos:"num",gender:"m",note:"Masculine. Becomes 'duas' before feminine nouns. Pronounced 'doys'.",example:"A: Quantos anos?\nB: Dois anos.",exampleSrc:"A: How many years?\nB: Two years.",funFact:"Portuguese is one of the few languages that genders the number two: dois for masculine, duas for feminine."},
    {type:"teach",trg:"três",src:"three",pos:"num",gender:null,note:"One form for both genders. Pronounced 'trehs' with an open vowel.",example:"A: Quantos anos?\nB: Três anos.",exampleSrc:"A: How many years?\nB: Three years.",funFact:"Três and English three share the same Indo-European root, along with Spanish tres and French trois."},
  ...
  {id:"ptv2_u2l2",title:"Numbers 6 to 10",icon:"🔟",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"seis",src:"six",pos:"num",gender:null,note:"Pronounced 'says'. One form for both genders.",example:"A: Quantos anos?\nB: Seis anos.",exampleSrc:"A: How many years?\nB: Six years.",funFact:"In Brazil, to avoid confusion with três on the phone, people sometimes say 'meia' (half) for six, from meia dúzia (half dozen)."},
    {type:"teach",trg:"sete",src:"seven",pos:"num",gender:null,note:"Pronounced 'SEH-chee' in Brazil. The final -te sounds like 'chee'.",example:"A: Quantos anos?\nB: Sete anos.",exampleSrc:"A: How many years?\nB: Seven years.",funFact:"Brazilian Portuguese palatalizes 'te' and 'di'. Sete sounds like 'SEH-chee' in most of Brazil."},
    {type:"teach",trg:"oito",src:"eight",pos:"num",gender:null,note:"Pronounced 'OY-too'. One form for both genders.",example:"A: Quantos anos?\nB: Oito anos.",exampleSrc:"A: How many years?\nB: Eight years.",funFact:"Oito comes from Latin octo, the same root as October, which used to be the eighth month."},
    {type:"teach",trg:"nove",src:"nine",pos:"num",gender:null,note:"Pronounced 'NOH-vee'. One form for both genders.",example:"A: Quantos anos?\nB: Nove anos.",exampleSrc:"A: How many years?\nB: Nine years.",funFact:"Nove shares roots with novo (new). Nine was seen as a 'new' number beyond the usual count in some ancient languages."},
    {type:"teach",trg:"dez",src:"ten",pos:"num",gender:null,note:"Short and sharp. Pronounced 'dehs'. The final -z sounds like 's'.",example:"A: Quantos anos?\nB: Dez anos.",exampleSrc:"A: How many years?\nB: Ten years.",funFact:"Dez is the root for década (decade) and dezembro (December, once the tenth month)."},
  ...
  {id:"ptv2_u2l3",title:"Asking age",icon:"🎂",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"ter",src:"to have",pos:"verb",gender:null,note:"Basic verb for possession. Also used for age: eu tenho 25 anos means I am 25 years old.",example:"A: Você tem um número?\nB: Sim, eu tenho.",exampleSrc:"A: Do you have a number?\nB: Yes, I have one.",funFact:"Portuguese, Spanish, and French all use 'have' for age, unlike English 'be'."},
    ...
    {type:"teach",trg:"idade",src:"age",pos:"noun",gender:"f",note:"Feminine noun. The general word for age.",example:"A: Qual é a idade de João?\nB: A idade é dez anos.",exampleSrc:"A: What is João's age?\nB: The age is ten years.",funFact:"More formal way to ask age. Everyday speech uses 'Quantos anos você tem?' much more often."},
