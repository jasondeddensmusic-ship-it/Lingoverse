...
{id:"ptv2_u26l_f11_resolve",title:"Resolver Conflitos",icon:"🤝",xp:15,board:true,steps:[
{type:"intro",title:"Resolving Disputes",desc:"B2 Portuguese for mediating conflicts diplomatically: naming disputes, proposing compromises, apologizing, and forgiving. Essential for CELPE-Bras speaking at B2.",goals:["Name and describe conflicts","Propose compromises","Apologize and forgive diplomatically"]},
{type:"teach",trg:"o conflito",src:"conflict",pos:"noun",gender:"m",
 note:"Masculine noun. Plural: os conflitos.\nUsed for disputes, disagreements, wars.\nUm conflito pessoal = a personal conflict.",
 example:"A: Existe um conflito entre os dois amigos?\nB: Sim, há duas semanas.",
 exampleSrc:"A: Is there a conflict between the two friends?\nB: Yes, for two weeks.",
 funFact:"Conflito comes from Latin 'conflictus' (collision). Brazilian workplace culture values harmony, so 'evitar conflitos' (to avoid conflicts) is a common phrase."},
{type:"teach",trg:"o mal-entendido",src:"misunderstanding",pos:"noun",gender:"m",
 note:"Masculine compound noun. Hyphenated.\nPlural: os mal-entendidos.\nLiterally: mal (badly) + entendido (understood).",
 example:"A: Foi um mal-entendido?\nB: Sim, um simples mal-entendido.",
 exampleSrc:"A: Was it a misunderstanding?\nB: Yes, a simple misunderstanding.",
 funFact:"O mal-entendido is one of the most frequently cited causes of social friction in Brazilian Portuguese. The culture values face-to-face conversation to 'desfazer o mal-entendido' (undo the misunderstanding)."},
{type:"teach",trg:"o acordo",src:"agreement / accord",pos:"noun",gender:"m",
 note:"Masculine noun. Plural: os acordos.\nChegar a um acordo = to reach an agreement.\nFazer um acordo = to make a deal.",
 example:"A: Vocês chegaram a um acordo?\nB: Sim, um bom acordo para todos.",
 exampleSrc:"A: Did you reach an agreement?\nB: Yes, a good agreement for everyone.",
 funFact:"Acordo comes from Latin 'ad cor' (to the heart). In Brazilian business, 'chegar a um acordo' is the standard phrase for sealing a deal."},
{type:"teach",trg:"mediar",src:"to mediate",pos:"verb",gender:null,
 note:"Regular -ar verb. Eu medio, você media.\nMediar um conflito = to mediate a conflict.",
 example:"A: Você pode mediar o conflito?\nB: Sim, eu vou mediar.",
 exampleSrc:"A: Can you mediate the conflict?\nB: Yes, I will mediate.",
 funFact:"Mediar shares its Latin root with 'mediator.' Brazilian labor law requires a 'mediador' (mediator) at union negotiations to facilitate resolution."},
{type:"teach",trg:"desculpar-se",src:"to apologize",pos:"verb",gender:null,
 note:"Reflexive verb: -se at the end.\nEu me desculpo, você se desculpa.\nAlso: pedir desculpa (simpler phrase).",
 example:"A: Você vai se desculpar?\nB: Sim, eu me desculpo.",
 exampleSrc:"A: Will you apologize?\nB: Yes, I apologize.",
 funFact:"Desculpar-se is the reflexive form. Brazilians often prefer the simpler 'pedir desculpa' (literally: to ask forgiveness) in everyday speech."},
{type:"teach",trg:"perdoar",src:"to forgive",pos:"verb",gender:null,
 note:"Regular -ar verb. Eu perdoo, você perdoa.\nPerdoar alguém = to forgive someone.",
 example:"A: Você me perdoa?\nB: Sim, eu te perdoo.",
 exampleSrc:"A: Do you forgive me?\nB: Yes, I forgive you.",
 funFact:"Perdoar shares its Latin root with 'pardon.' 'Perdoar e esquecer' (to forgive and forget) is a Brazilian phrase about moving on."},
{type:"teach",trg:"a solução",src:"the solution",pos:"noun",gender:"f",
 note:"Feminine. Words ending in -ção are always feminine.\nPlural: as soluções.\nEncontrar uma solução = to find a solution.",
 example:"A: Qual é a solução?\nB: A solução é simples.",
...
{type:"mc",q:"Qual palavra significa 'conflict'?",
 opts:["o conflito","o mal-entendido","o acordo","a solução"],
 ans:"o conflito",
 hint:"Masculine noun from Latin 'conflictus' (collision)."},
{type:"mc",q:"Qual verbo significa 'to mediate'?",
 opts:["perdoar","mediar","desculpar-se","resolver"],
 ans:"mediar",
 hint:"Regular -ar verb sharing Latin root with the English equivalent."},
{type:"fb",opts:["conflito","acordo","mal-entendido","solução"],
 hint:"Masculine compound noun meaning 'misunderstanding.'",
...
{type:"fb",opts:["solução","problema","conflito","mal-entendido"],
 hint:"Feminine -ção noun for 'the way out' of a problem.",
 s:"A {1} é simples.",a:"solução",sSrc:"The {1} is simple."},
{type:"match",pairs:[
  {trg:"o conflito",src:"conflict"},
  {trg:"o mal-entendido",src:"misunderstanding"},
  {trg:"o acordo",src:"agreement"},
  {trg:"a solução",src:"solution"}
]},
{type:"match",pairs:[
  {trg:"mediar",src:"to mediate"},
  {trg:"desculpar-se",src:"to apologize"},
  {trg:"perdoar",src:"to forgive"}
]}
]}
