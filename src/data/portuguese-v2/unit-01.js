...
const UNIT_01 = {n:1,lang:"pt",srcLang:"en",track:"v2",title:"Olá! Como vai?",sub:"First Greetings",icon:"👋",level:"A1.1",color:"#7B5EE8",lessons:[
  {id:"ptv2_u1l1",title:"Bom dia!",icon:"☀️",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"boa tarde",src:"good afternoon",pos:"intj",gender:null,note:"Used from noon until sunset. Boa is feminine because tarde is feminine.",example:"A: Boa tarde, senhor!\nB: Boa tarde!",exampleSrc:"A: Good afternoon, sir!\nB: Good afternoon!",funFact:"The switch from bom to boa is your first taste of Portuguese gender agreement."},
    {type:"teach",trg:"boa noite",src:"good evening / good night",pos:"intj",gender:null,note:"Used from sunset onward. Covers both hello at night and farewell before bed.",example:"A: Boa noite! Até amanhã.\nB: Boa noite!",exampleSrc:"A: Good night! Until tomorrow.\nB: Good night!",funFact:"Noite is feminine, so it takes boa. In Portugal, the cutoff feels earlier than in Brazil."},
  ...
  {id:"ptv2_u1l2",title:"Eu, você, ele, ela",icon:"👥",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"você",src:"you",pos:"pron",gender:null,note:"Brazilian default for you. Works in most situations, formal and informal.",example:"A: Você fala inglês?\nB: Sim, eu falo.",exampleSrc:"A: Do you speak English?\nB: Yes, I do.",funFact:"Você came from vossa mercê (your mercy), a respectful form that became the everyday you."},
    {type:"teach",trg:"ele",src:"he",pos:"pron",gender:null,note:"Used for males and male-gendered nouns. Pronounced like 'EH-lee'.",example:"A: Onde está o João?\nB: Ele está em casa.",exampleSrc:"A: Where is João?\nB: He is at home.",funFact:"Ele also replaces masculine objects, not just people. Portuguese is very gender-aware."},
    {type:"teach",trg:"ela",src:"she",pos:"pron",gender:null,note:"Used for females and female-gendered nouns. Pronounced like 'EH-lah'.",example:"A: Onde está a Ana?\nB: Ela está no trabalho.",exampleSrc:"A: Where is Ana?\nB: She is at work.",funFact:"The only difference between ele and ela is the final vowel. Masculine -e, feminine -a."},
  ...
  {id:"ptv2_u1l3",title:"Ser e estar",icon:"⚖️",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"ser",src:"to be (permanent)",pos:"verb",gender:null,note:"Used for identity, profession, origin, permanent traits. Who or what something is.",example:"A: Eu sou brasileiro.\nB: Eu sou professor.",exampleSrc:"A: I am Brazilian.\nB: I am a teacher.",funFact:"Ser comes from Latin 'esse', the same root as English 'essence'. It is about what something essentially IS."},
    {type:"teach",trg:"estar",src:"to be (temporary)",pos:"verb",gender:null,note:"Used for location, moods, current states, temporary conditions. How something is right now.",example:"A: Eu estou em casa.\nB: Eu estou feliz hoje.",exampleSrc:"A: I am at home.\nB: I am happy today.",funFact:"Estar comes from Latin 'stare', meaning to stand. It points to a current position or state."},
    ...
    {type:"teach",trg:"estou",src:"I am (temporary)",pos:"verb",gender:null,note:"First-person singular of estar. Used for states that can change.",example:"A: Eu estou bem.\nB: Eu estou em casa.",exampleSrc:"A: I am fine.\nB: I am at home.",funFact:"Brazilians often shorten estou to 'tô' in casual speech: 'Tô bem!'"},
  ...
  {id:"ptv2_u1l4",title:"Me chamo...",icon:"🤝",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"me chamo",src:"my name is",pos:"verb",gender:null,note:"Literally 'I call myself'. Most natural way to give your name.",example:"A: Oi! Me chamo Ana.\nB: Muito prazer, Ana!",exampleSrc:"A: Hi! My name is Ana.\nB: Very nice, Ana!",funFact:"You can also say 'Meu nome é Ana' (My name is Ana), but me chamo is more natural in Brazil."},
    {type:"teach",trg:"sim",src:"yes",pos:"adv",gender:null,note:"Simple affirmative. Nasal sound at the end.",example:"A: Você é brasileiro?\nB: Sim, eu sou.",exampleSrc:"A: Are you Brazilian?\nB: Yes, I am.",funFact:"Brazilians often answer questions by repeating the verb instead of just sim: 'Sou!' for 'Yes (I am)'."},
    {type:"teach",trg:"não",src:"no",pos:"adv",gender:null,note:"Simple negative. Nasal ão sound. Also used before verbs to make them negative.",example:"A: Você fala francês?\nB: Não, eu não falo.",exampleSrc:"A: Do you speak French?\nB: No, I don't speak.",funFact:"Não doubles as both 'no' and 'not'. Put it before a verb to negate: 'Não sou' means 'I am not'."},
    {type:"teach",trg:"obrigado",src:"thank you (male speaker)",pos:"intj",gender:"m",note:"Used when a man says thanks. Agrees with the speaker's gender.",example:"A: Aqui está seu café.\nB: Obrigado!",exampleSrc:"A: Here is your coffee.\nB: Thank you!",funFact:"Obrigado literally means 'obliged'. You are acknowledging an obligation for the favor."},
    {type:"teach",trg:"obrigada",src:"thank you (female speaker)",pos:"intj",gender:"f",note:"Used when a woman says thanks. The -a ending matches feminine.",example:"A: Aqui está seu livro.\nB: Obrigada!",exampleSrc:"A: Here is your book.\nB: Thank you!",funFact:"The speaker's gender decides the ending, not the person being thanked. A woman always says obrigada."},
