...
const UNIT_01 = {n:1,lang:"pt",srcLang:"en",track:"v2",title:"Olá! Como vai?",sub:"First Greetings",icon:"👋",level:"A1.1",color:"#7B5EE8",lessons:[
  {id:"ptv2_u1l1",title:"Bom dia!",icon:"☀️",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"olá",src:"hello",pos:"intj",gender:null,note:"Universal greeting. Works any time of day, in any situation.",example:"A: Olá, Ana!\nB: Olá, João!",exampleSrc:"A: Hello, Ana!\nB: Hello, João!",funFact:"Portuguese has about 260 million speakers worldwide. Brazil alone has over 210 million."},
    {type:"teach",trg:"oi",src:"hi",pos:"intj",gender:null,note:"Informal and warm. The go-to greeting in Brazil among friends.",example:"A: Oi, Pedro!\nB: Oi, Maria!",exampleSrc:"A: Hi, Pedro!\nB: Hi, Maria!",funFact:"Brazilians use oi much more than olá in daily life. It is the default friendly hello."},
  ...
  {id:"ptv2_u1l3",title:"Ser e estar",icon:"⚖️",xp:15,board:true,steps:[
    ...
    {type:"teach",trg:"estou",src:"I am (temporary)",pos:"verb",gender:null,note:"First-person singular of estar. Used for states that can change.",example:"A: Onde você está?\nB: Eu estou em Brasília.",exampleSrc:"A: Where are you?\nB: I am in Brasília.",funFact:"Brazilians often shorten estou to 'tô' in casual speech: 'Tô bem!'"},
