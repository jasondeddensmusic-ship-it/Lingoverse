...
{id:"ptv2_u13l_a2_abstract_everyday",title:"Palavras do Dia a Dia A2",icon:"🧭",xp:15,board:true,steps:[
{type:"intro",title:"Everyday Abstract Nouns",desc:"Nine A2/B1 core nouns for space, time, and manner.",goals:["Use o caminho, o lugar, o espaço for space","Describe time with o momento, a época","Say 'the way' with a maneira, o jeito"]},
{type:"teach", trg:"o caminho", src:"the path / way",pos:"noun",gender:"m",
 note:"Masculine. Plural: os caminhos.\nFigurative: 'no caminho certo' = on the right path.",
 example:"A: Qual caminho você faz?\nB: Eu faço o caminho curto.",
 exampleSrc:"A: Which way do you take?\nB: I take the short way.",
 funFact:"Caminho gave rise to the route name 'Camino de Santiago.' The Portuguese word covers both a physical path and a life direction."},
{type:"teach", trg:"o lugar", src:"the place",pos:"noun",gender:"m",
 note:"Masculine. Plural: os lugares.\nem lugar de = instead of.",
 example:"A: É um lugar bonito?\nB: Sim, muito bonito.",
 exampleSrc:"A: Is it a beautiful place?\nB: Yes, very beautiful.",
 funFact:"Lugar shares its Latin root with English 'locus.' In Brazilian Portuguese, 'de qualquer lugar' (from anywhere) is a common phrase."},
{type:"teach", trg:"o espaço", src:"the space",pos:"noun",gender:"m",
 note:"Masculine. Plural: os espaços.\nPhysical space + figurative room.",
 example:"A: Tem espaço para mais?\nB: Não, não tem.",
 exampleSrc:"A: Is there space for more?\nB: No, there is not.",
 funFact:"Espaço shares its Latin root with English 'space.' In Brazilian public debate, 'dar espaço' (to give space) is a common phrase."},
{type:"teach", trg:"o momento", src:"the moment",pos:"noun",gender:"m",
 note:"Masculine. Plural: os momentos.\num momento = a moment.",
 example:"A: Só um momento, por favor.\nB: Tudo bem.",
 exampleSrc:"A: Just a moment, please.\nB: All right.",
 funFact:"Momento entered Portuguese from Latin 'momentum' (movement, impulse). 'Momento difícil' is a soft way to reference a hard time."},
{type:"teach", trg:"a época", src:"the era / period of time",pos:"noun",gender:"f",
 note:"Feminine. Plural: as épocas.\nnaquela época = back then.",
 example:"A: Gosto muito dessa época.\nB: Eu também.",
 exampleSrc:"A: I like this period of time a lot.\nB: Me too.",
 funFact:"Época comes from Greek 'epoche' (pause). Brazilian music loves 'naquela época' (in those days) as a nostalgic phrase."},
{type:"teach", trg:"a maneira", src:"the way / manner",pos:"noun",gender:"f",
 note:"Feminine. Plural: as maneiras.\nFormal register.\nde qualquer maneira = anyway.",
 example:"A: Que maneira é essa?\nB: É a minha maneira.",
 exampleSrc:"A: What way is that?\nB: It is my way.",
 funFact:"Maneira comes from Latin 'manuaria' (way of working with hands). Used in writing and formal speech."},
{type:"teach", trg:"o jeito", src:"the way / knack",pos:"noun",gender:"m",
 note:"Masculine. Plural: os jeitos.\nColloquial register.\ndar um jeito = to find a way.",
 example:"A: É o jeito dele.\nB: Eu entendo.",
 exampleSrc:"A: It is his way.\nB: I understand.",
 funFact:"'O jeitinho brasileiro' describes the Brazilian talent for finding a flexible, creative solution to any problem."},
{type:"teach", trg:"a forma", src:"the shape / form",pos:"noun",gender:"f",
 note:"Feminine. Plural: as formas.\nPhysical shape + abstract form.",
 example:"A: Qual é a forma?\nB: A forma é redonda.",
 exampleSrc:"A: What is the shape?\nB: The shape is round.",
 funFact:"Forma covers physical shape and abstract form. Academic writing uses it heavily."},
{type:"teach", trg:"a coisa", src:"the thing",pos:"noun",gender:"f",
 note:"Feminine. Plural: as coisas.\nGeneric noun for any object or matter.",
 example:"A: Que coisa!\nB: É verdade.",
