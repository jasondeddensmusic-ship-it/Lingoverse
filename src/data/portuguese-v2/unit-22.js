  ...
  lessons:[
    {
      ...
      steps:[
        ...
        {type:"mc", q:"'Fale mais alto' uses which imperative form?", opts:["tu informal","você (subjunctive)","future tense","infinitive"], ans:"você (subjunctive)", hint:"Built from the present subjunctive. The você command."},
