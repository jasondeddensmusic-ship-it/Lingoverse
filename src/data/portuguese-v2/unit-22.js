  ...
  lessons:[
    ...
    },
    {
      ...
      steps:[
        ...
        {type:"teach", trg:"não fale!", src:"don't speak!", pos:"verb", gender:null, note:"All negative commands use the subjunctive, even with tu.", example:"A: Não fale assim comigo.\nB: Desculpe, me excedi.", exampleSrc:"A: Don't speak to me like that.\nB: Sorry, I went too far.", funFact:"In negative commands, Portuguese abandons the tu/você split entirely. Everyone uses the subjunctive form."},
        ...
        {type:"teach", trg:"calma!", src:"stay calm! / easy!", pos:"intj", gender:null, note:"Not a verb, but functions like an imperative interjection.", example:"A: Calma, vamos resolver isso.\nB: Tá, me desculpe.", exampleSrc:"A: Stay calm, we'll sort this out.\nB: Okay, I'm sorry.", funFact:"Calma! is arguably the most-used one-word command in Brazilian Portuguese, from parents to taxi drivers."}
      ]
    },
    {
