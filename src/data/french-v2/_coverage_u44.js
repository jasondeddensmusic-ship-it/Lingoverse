...
const COVERAGE_U44 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"le confederalisme",src:"the confederalism"},{trg:"le conformisme",src:"the conformism"},{trg:"un confrere",src:"a colleague (in a profession)"},{trg:"ducal",src:"ducal, of a duke"}]},
    {type:"match",pairs:[{trg:"affectivement",src:"emotionally, affectively"},{trg:"l'amateurisme",src:"the amateurism"},{trg:"attarde",src:"backward, slow-witted"},{trg:"derouter",src:"to disconcert, to confuse"}]},
