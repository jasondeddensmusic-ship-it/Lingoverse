...
const COVERAGE_U41 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"l'artère",src:"the artery, the main road"},{trg:"le bercail",src:"the fold, home base"},{trg:"le contour",src:"the outline, the contour"},{trg:"dentaire",src:"dental"}]},
    {type:"match",pairs:[{trg:"l'anesthésie",src:"the anesthesia"},{trg:"la contraction",src:"the contraction"},{trg:"l'atrocité",src:"the atrocity"},{trg:"chevelu",src:"long-haired, hairy"}]},
    {type:"match",pairs:[{trg:"un aspirant",src:"an officer cadet, an aspirant"},{trg:"l'altération",src:"the deterioration"},{trg:"l'affirmation",src:"the assertion, the statement"},{trg:"l'administrateur",src:"the administrator"}]},
