...
const COVERAGE_U34 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"l'archéologie",src:"the archaeology"},{trg:"l'athlétisme",src:"track and field, athletics"},{trg:"athlétique",src:"athletic"},{trg:"antique",src:"ancient, antique"}]},
    {type:"match",pairs:[{trg:"l'attraction",src:"the attraction, the ride"},{trg:"l'allure",src:"the look, the pace"},{trg:"l'agrément",src:"the approval, the pleasure"},{trg:"assurer",src:"to ensure, to insure"}]},
    {type:"match",pairs:[{trg:"l'abandon",src:"the abandonment"},{trg:"l'attachement",src:"the attachment"},{trg:"l'acharnement",src:"the relentlessness, the determination"},{trg:"africain",src:"African"}]},
    {type:"match",pairs:[{trg:"australien",src:"Australian"},{trg:"autrichien",src:"Austrian"},{trg:"l'atlantique",src:"the Atlantic"},{trg:"l'anthropologie",src:"the anthropology"}]},
    {type:"match",pairs:[{trg:"l'agitation",src:"the agitation, the unrest"},{trg:"l'attractif",src:"attractive, appealing"},{trg:"l'amour",src:"the love"},{trg:"l'amitié",src:"the friendship"}]},
