...
const COVERAGE_U59 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"s'abonner",src:"to subscribe"},{trg:"une affirmation",src:"an assertion, a statement"},{trg:"s'absenter",src:"to be absent, to leave temporarily"},{trg:"l'agressivité",src:"the aggressiveness"}]},
    {type:"match",pairs:[{trg:"l'accélération",src:"the acceleration"},{trg:"l'alphabet",src:"the alphabet"},{trg:"la désobéissance",src:"the disobedience"},{trg:"la justification",src:"the justification"}]},
    {type:"match",pairs:[{trg:"le déclassement",src:"the downgrading, the social decline"},{trg:"la déduction",src:"the deduction"},{trg:"le décimètre",src:"the decimeter"},{trg:"la grossièreté",src:"the rudeness, the coarseness"}]},
    {type:"match",pairs:[{trg:"la division",src:"the division, the split"},{trg:"l'incapacité",src:"the inability, the incapacity"},{trg:"l'intensification",src:"the intensification"},{trg:"l'interaction",src:"the interaction"}]},
