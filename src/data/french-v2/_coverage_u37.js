...
const COVERAGE_U37 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"l'anthologie",src:"anthology"},{trg:"l'astronome",src:"astronomer"},{trg:"l'aléa",src:"hazard, risk, unpredictable event"},{trg:"l'apanage",src:"prerogative, exclusive privilege"}]},
    {type:"match",pairs:[{trg:"l'arabesque",src:"arabesque"},{trg:"s'attabler",src:"to sit down at a table"},{trg:"articuler",src:"to articulate, to pronounce clearly"},{trg:"assouplir",src:"to make supple, to relax (rules)"}]},
    {type:"match",pairs:[{trg:"amputer",src:"to amputate, to cut off"},{trg:"l'amusement",src:"amusement, entertainment"},{trg:"l'applaudissement",src:"applause, clapping"},{trg:"s'approprier",src:"to appropriate, to make one's own"}]},
    {type:"match",pairs:[{trg:"l'après-guerre",src:"postwar period"},{trg:"l'apparenté",src:"related, connected"},{trg:"l'aubergiste",src:"innkeeper"},{trg:"l'aménageur",src:"developer, urban planner"}]},
    {type:"match",pairs:[{trg:"anormalement",src:"abnormally, unusually"},{trg:"l'acrobatie",src:"acrobatics"},{trg:"l'agressif",src:"aggressive"},{trg:"l'adoptif",src:"adoptive, adopted"}]},
