...
const COVERAGE_U25 = {
  id:"frv2_u25_coverage_review", title:"Révision : couverture lexicale", icon:"🎯", xp:10, board:true,
  steps:[
    ...
    {type:"match",pairs:[{trg:"Je doute qu'elle termine à temps.",src:"I doubt she will finish on time."}]}
  ]
};
