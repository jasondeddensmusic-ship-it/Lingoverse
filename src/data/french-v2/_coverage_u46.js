...
const COVERAGE_U46 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"l'effectif",src:"the workforce, the headcount"},{trg:"le bibliothecaire",src:"the librarian"},{trg:"un accrochage",src:"a clash, a confrontation"},{trg:"le stagiaire",src:"the intern, the trainee"}]},
    {type:"match",pairs:[{trg:"la negociation",src:"the negotiation"},{trg:"l'eldorado",src:"the Eldorado, the promised land"},{trg:"l'embrun",src:"the sea spray"},{trg:"la traversee",src:"the crossing"}]},
