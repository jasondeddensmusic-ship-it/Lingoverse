...
const COVERAGE_U77 = {
  ...
  steps:[
    ...
    {type:"fb",s:"Le temoin a demande {1}.",a:["l'anonymat"],opts:["un indigene","l'encombre","l'exclamation","l'anonymat"],hint:"Type the target-language form. Meaning shown below.",sSrc:"The witness requested {1}."},
    {type:"fb",s:"{1}",a:["l'integration"],opts:["l'integration","un indigene","l'encombre","l'exclamation"],hint:"Type the target-language form. Meaning shown below.",sSrc:"integration"},
    {type:"fb",s:"{1}",a:["l'emancipation"],opts:["l'exclamation","l'emancipation","un indigene","l'encombre"],hint:"Type the target-language form. Meaning shown below.",sSrc:"emancipation"},
    {type:"fb",s:"Cette sauce est trop {1}e pour moi.",a:["piquant"],opts:["l'encombre","l'exclamation","piquant","un indigene"],hint:"Type the target-language form. Meaning shown below.",sSrc:"This sauce is too spicy for me."},
    {type:"fb",s:"J'adore ce coucher de soleil {1}.",a:["orange"],opts:["un indigene","l'encombre","l'exclamation","orange"],hint:"Type the target-language form. Meaning shown below.",sSrc:"I love this orange sunset."}
  ]
};
