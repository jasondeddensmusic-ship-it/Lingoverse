...
const COVERAGE_U35 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"l'adoration",src:"adoration, worship"},{trg:"l'affront",src:"insult, affront"},{trg:"s'abstenir",src:"to abstain, to refrain"},{trg:"s'acharner",src:"to persist fiercely, to be relentless"}]},
    {type:"match",pairs:[{trg:"abondamment",src:"abundantly, copiously"},{trg:"amplifier",src:"to amplify, to increase"},{trg:"l'appréciation",src:"appreciation, assessment"},{trg:"l'accomplissement",src:"accomplishment, fulfillment"}]},
