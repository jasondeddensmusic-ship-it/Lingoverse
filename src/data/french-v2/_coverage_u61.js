...
const COVERAGE_U61 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"un arrière-grand-parent",src:"a great-grandparent"},{trg:"le demi-tour",src:"the U-turn, the about-face"},{trg:"le cabinets",src:"the restroom, the toilet"},{trg:"la béarnaise",src:"Bearnaise (sauce)"}]},
