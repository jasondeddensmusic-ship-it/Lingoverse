...
const COVERAGE_U61 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la bordure",src:"the border, the edge"},{trg:"la griffe",src:"the claw, the scratch mark"},{trg:"licencieux",src:"licentious, lewd"},{trg:"licencié",src:"dismissed, laid off (or degree holder)"}]},
    {type:"match",pairs:[{trg:"mafieux",src:"mafia-related, corrupt"},{trg:"attardé",src:"delayed, backward"},{trg:"la cleptomanie",src:"kleptomania"},{trg:"un cleptomane",src:"a kleptomaniac"}]},
    {type:"match",pairs:[{trg:"la guise",src:"the way, the fashion (in 'à sa guise')"},{trg:"l'exhibitionnisme",src:"exhibitionism"},{trg:"l'intériorisation",src:"the internalization"},{trg:"la lèse-majesté",src:"lese-majesty (offense against the sovereign)"}]},
    {type:"match",pairs:[{trg:"le business",src:"business"},{trg:"le best-seller",src:"the bestseller"},{trg:"un garde-chasse",src:"a gamekeeper"},{trg:"un coupe-papier",src:"a letter opener"}]},
    {type:"match",pairs:[{trg:"un arrière-grand-parent",src:"a great-grandparent"},{trg:"le demi-tour",src:"the U-turn, the about-face"},{trg:"le cabinets",src:"the restroom, the toilet"},{trg:"le béarnaise",src:"Bearnaise (sauce)"}]},
    {type:"match",pairs:[{trg:"l'incrustation",src:"the inlay, the overlay"},{trg:"le café-concert",src:"the music cafe"},{trg:"la crème",src:"the cream (also: the best)"},{trg:"la déscolarisation",src:"the dropping out of school"}]},
