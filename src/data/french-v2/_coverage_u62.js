...
const COVERAGE_U62 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"coulisser",src:"to slide (in a groove)"},{trg:"désosser",src:"to bone (remove bones from meat)"},{trg:"extasier",src:"to go into ecstasy, to be thrilled"},{trg:"léser",src:"to harm, to wrong (someone's rights)"}]},
    {type:"match",pairs:[{trg:"lettrer",src:"to letter, to inscribe letters on"},{trg:"bisquer",src:"to be annoyed, to fume"},{trg:"s'insurger",src:"to rebel, to protest strongly"},{trg:"récuser",src:"to challenge, to reject (a judge)"}]},
    {type:"match",pairs:[{trg:"la résignation",src:"the resignation, the acceptance"},{trg:"l'organigramme",src:"the organizational chart"},{trg:"la hiérarchie",src:"the hierarchy"},{trg:"le dispositif",src:"the device, the system, the arrangement"}]},
    {type:"match",pairs:[{trg:"le mécanisme",src:"the mechanism"},{trg:"l'échéance",src:"the deadline, the due date"},{trg:"le protocole",src:"the protocol, the procedure"},{trg:"l'infrastructure",src:"the infrastructure"}]},
