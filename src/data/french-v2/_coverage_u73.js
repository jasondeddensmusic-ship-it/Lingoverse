...
const COVERAGE_U73 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"l'adolescence",src:"adolescence"},{trg:"l'oral",src:"oral exam, spoken test"},{trg:"l'intériorisation",src:"internalization"},{trg:"le pire",src:"the worst"}]},
    {type:"match",pairs:[{trg:"autour de soi",src:"around oneself"},{trg:"la globalité",src:"entirety, whole picture"},{trg:"la détonation",src:"detonation, blast"},{trg:"la mégafusion",src:"mega-merger"}]},
    {type:"match",pairs:[{trg:"l'incrustation",src:"inlay, encrustation"},{trg:"le frisbee",src:"frisbee"},{trg:"le pilier",src:"pillar, post"},{trg:"la chronobiologie",src:"chronobiology"}]},
