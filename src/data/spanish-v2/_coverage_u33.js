...
const COVERAGE_U33 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la barra",src:"the bar (counter), loaf"},{trg:"el baratillo",src:"the flea market, bargain shop"},{trg:"la bollería",src:"the pastries, bakery goods"},{trg:"el artículo",src:"the article, item"}]},
    {type:"match",pairs:[{trg:"la autorización",src:"the authorization"},{trg:"autorizar",src:"to authorize"},{trg:"la alternativa",src:"the alternative"},{trg:"artístico",src:"artistic"}]},
    {type:"match",pairs:[{trg:"el arquitecto",src:"the architect"},{trg:"la animación",src:"animation"},{trg:"animar",src:"to encourage, to cheer up"},{trg:"el aniversario",src:"the anniversary"}]},
    {type:"match",pairs:[{trg:"la banda",src:"the band"},{trg:"bilingüe",src:"bilingual"},{trg:"artificial",src:"artificial"},{trg:"auténtico",src:"authentic, genuine"}]},
    {type:"match",pairs:[{trg:"la bola",src:"the ball"},{trg:"el argot",src:"slang"},{trg:"el apellido",src:"the surname, last name"},{trg:"la abreviatura",src:"the abbreviation"}]},
    {type:"match",pairs:[{trg:"agradecer",src:"to thank, to be grateful"},{trg:"así",src:"like this, so, thus"},{trg:"la audiencia",src:"the audience"},{trg:"el adjetivo",src:"the adjective"}]},
    {type:"match",pairs:[{trg:"acostar",src:"to put to bed"},{trg:"acostumbrar",src:"to be used to, to usually do"},{trg:"anticipar",src:"to anticipate, to bring forward"},{trg:"anual",src:"annual, yearly"}]},
