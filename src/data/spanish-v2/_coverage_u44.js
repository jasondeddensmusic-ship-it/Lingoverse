...
const COVERAGE_U44 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"calculador",src:"calculating / scheming"},{trg:"el agobio",src:"the stress / overwhelming feeling"},{trg:"la delicadeza",src:"the delicacy / gentleness"},{trg:"angelical",src:"angelic"}]},
    {type:"match",pairs:[{trg:"contundente",src:"forceful / overwhelming"},{trg:"admirable",src:"admirable"},{trg:"creíble",src:"credible / believable"},{trg:"el cucharón",src:"the ladle"}]},
    {type:"match",pairs:[{trg:"la cartulina",src:"the cardboard / card stock"},{trg:"la cajetilla",src:"the pack (of cigarettes)"},{trg:"el arcón",src:"the large chest / coffer"},{trg:"la cabecera",src:"the headboard / bedside"}]},
    {type:"match",pairs:[{trg:"la alberca",src:"the water tank / pool"},{trg:"la carpintería",src:"the carpentry / carpenter's workshop"},{trg:"el carpintero",src:"the carpenter"},{trg:"el barrendero",src:"the street sweeper"}]},
    {type:"match",pairs:[{trg:"el basurero",src:"the garbage collector / dump"},{trg:"la bolita",src:"the small ball / marble"},{trg:"el batiente",src:"the door frame / leaf (of a door)"},{trg:"la coincidencia",src:"the coincidence"}]},
    {type:"match",pairs:[{trg:"la confusión",src:"the confusion"},{trg:"la consistencia",src:"the consistency"},{trg:"la contemplación",src:"the contemplation"},{trg:"el convencimiento",src:"the conviction / belief"}]},
    {type:"match",pairs:[{trg:"la correspondencia",src:"the correspondence / mail"},{trg:"la abstracción",src:"the abstraction"},{trg:"la adecuación",src:"the suitability / adaptation"},{trg:"la cabida",src:"the capacity / room"}]},
    {type:"match",pairs:[{trg:"la cualificación",src:"the qualification"},{trg:"la autenticidad",src:"the authenticity"},{trg:"la constatación",src:"the verification / confirmation"},{trg:"acarrear",src:"to carry / to cause (problems)"}]},
    {type:"match",pairs:[{trg:"acoplar",src:"to couple / to fit together"},{trg:"agravar",src:"to aggravate / to worsen"},{trg:"alarmar",src:"to alarm / to worry"},{trg:"apaciguar",src:"to pacify / to calm down"}]},
    {type:"match",pairs:[{trg:"argumentar",src:"to argue (a point) / to reason"},{trg:"arrebatar",src:"to snatch / to seize"},{trg:"arrimar",src:"to move closer / to bring near"},{trg:"arropar",src:"to wrap up / to tuck in"}]},
    {type:"match",pairs:[{trg:"calificar",src:"to grade / to describe as"},{trg:"capacitar",src:"to train / to qualify"},{trg:"curvar",src:"to curve / to bend"},{trg:"el atraso",src:"the delay / backwardness"}]},
