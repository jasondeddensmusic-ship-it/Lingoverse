...
const COVERAGE_U43 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"arrestar",src:"to arrest"},{trg:"el decreto",src:"the decree"},{trg:"corromper",src:"to corrupt"},{trg:"el agresor",src:"the aggressor / attacker"}]},
    {type:"match",pairs:[{trg:"arbitrario",src:"arbitrary"},{trg:"defectuoso",src:"defective / faulty"},{trg:"defensivo",src:"defensive"},{trg:"la demagogia",src:"the demagoguery"}]},
    {type:"match",pairs:[{trg:"el demócrata",src:"the democrat"},{trg:"el denominador",src:"the denominator"},{trg:"alcista",src:"bullish / upward-trending"},{trg:"costear",src:"to finance / to cover the cost"}]},
    {type:"match",pairs:[{trg:"costoso",src:"costly / expensive"},{trg:"contabilizar",src:"to account for / to record"},{trg:"la contratación",src:"the hiring / contracting"},{trg:"la competitividad",src:"the competitiveness"}]},
    {type:"match",pairs:[{trg:"corporativo",src:"corporate"},{trg:"el conglomerado",src:"the conglomerate"},{trg:"biodegradable",src:"biodegradable"},{trg:"brotar",src:"to sprout / to spring forth"}]},
    {type:"match",pairs:[{trg:"boscoso",src:"wooded / forested"},{trg:"la cigarra",src:"the cicada"},{trg:"la alimaña",src:"the vermin / pest animal"},{trg:"el cimiento",src:"the foundation"}]},
    {type:"match",pairs:[{trg:"bovino",src:"bovine / cattle-related"},{trg:"la barranca",src:"the ravine / gorge"},{trg:"la agronomía",src:"the agronomy"},{trg:"asfixiar",src:"to suffocate / to asphyxiate"}]},
    {type:"match",pairs:[{trg:"adiposo",src:"adipose / fatty"},{trg:"capilar",src:"capillary / hair-related"},{trg:"el cutis",src:"the complexion / skin"},{trg:"el cadáver",src:"the corpse / body"}]},
    {type:"match",pairs:[{trg:"la absorción",src:"the absorption"},{trg:"la cólera",src:"the cholera / rage"},{trg:"acústico",src:"acoustic"},{trg:"cremoso",src:"creamy"}]},
