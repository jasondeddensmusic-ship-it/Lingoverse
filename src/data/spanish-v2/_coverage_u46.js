...
const COVERAGE_U46 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"adyacente",src:"adjacent / next to"},{trg:"cónico",src:"conical / cone-shaped"},{trg:"anglosajón",src:"Anglo-Saxon"},{trg:"arancelario",src:"tariff-related"}]},
    {type:"match",pairs:[{trg:"comarcal",src:"regional / district-level"},{trg:"el brasileño",src:"the Brazilian"},{trg:"el compatriota",src:"the compatriot"},{trg:"el anglófono",src:"the English speaker"}]},
    {type:"match",pairs:[{trg:"el asta",src:"the flagpole / antler"},{trg:"la crin",src:"the mane (of a horse)"},{trg:"el chato",src:"the snub-nosed person / small glass"},{trg:"la audacia",src:"the boldness / audacity"}]},
    {type:"match",pairs:[{trg:"la delicadeza",src:"the delicacy / sensitivity"},{trg:"el convencimiento",src:"the conviction / firm belief"},{trg:"la confusión",src:"the confusion"},{trg:"la coincidencia",src:"the coincidence"}]},
    {type:"match",pairs:[{trg:"la contemplación",src:"the contemplation"},{trg:"creíble",src:"credible / believable"},{trg:"admirable",src:"admirable / praiseworthy"},{trg:"angelical",src:"angelic"}]},
    {type:"match",pairs:[{trg:"apuesto",src:"handsome / good-looking"},{trg:"arbitrario",src:"arbitrary"},{trg:"armonioso",src:"harmonious / well-balanced"},{trg:"la articulación",src:"the joint / articulation"}]},
    {type:"match",pairs:[{trg:"la consistencia",src:"the consistency / texture"},{trg:"el acorazado",src:"the battleship / armored"},{trg:"el arcabuz",src:"the arquebus (early firearm)"},{trg:"la cartulina",src:"the card stock / poster board"}]},
    {type:"match",pairs:[{trg:"la absorción",src:"the absorption"},{trg:"la adecuación",src:"the suitability / adaptation"},{trg:"la autenticidad",src:"the authenticity"},{trg:"la cuantía",src:"the amount / sum (formal)"}]},
    {type:"match",pairs:[{trg:"decrecer",src:"to decrease / to shrink"},{trg:"degenerar",src:"to degenerate / to worsen"},{trg:"debilitar",src:"to weaken"},{trg:"agravar",src:"to aggravate / to make worse"}]},
    {type:"match",pairs:[{trg:"corromper",src:"to corrupt / to spoil"},{trg:"alarmar",src:"to alarm / to frighten"},{trg:"acoplar",src:"to couple / to connect"},{trg:"captar",src:"to capture / to attract"}]},
    {type:"match",pairs:[{trg:"calificar",src:"to grade / to describe as"},{trg:"apaciguar",src:"to pacify / to calm"},{trg:"arrebatar",src:"to snatch / to captivate"},{trg:"accionar",src:"to activate / to trigger"}]},
