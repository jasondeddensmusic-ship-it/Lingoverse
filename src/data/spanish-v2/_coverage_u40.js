...
const COVERAGE_U40 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la alimaña",src:"the vermin / pest"},{trg:"la barranca",src:"the ravine / gorge"},{trg:"el cañizal",src:"the reed bed"},{trg:"el boj",src:"the boxwood"}]},
    {type:"match",pairs:[{trg:"la agronomía",src:"the agronomy"},{trg:"agrario",src:"agrarian / agricultural"},{trg:"el ajedrecista",src:"the chess player"},{trg:"el artista",src:"the artist"}]},
    {type:"match",pairs:[{trg:"el anagrama",src:"the anagram"},{trg:"el asterisco",src:"the asterisk"},{trg:"clasicista",src:"classicist"},{trg:"cognitivo",src:"cognitive"}]},
    {type:"match",pairs:[{trg:"el academicismo",src:"the academicism"},{trg:"el americanismo",src:"the Americanism"},{trg:"el arabismo",src:"the Arabism (Arabic loanword)"},{trg:"acopiar",src:"to stock up / to gather"}]},
    {type:"match",pairs:[{trg:"adscribir",src:"to assign / to attach"},{trg:"agilidad",src:"the agility"},{trg:"aglomerar",src:"to crowd together / to agglomerate"},{trg:"alisar",src:"to smooth / to straighten"}]},
    {type:"match",pairs:[{trg:"alternar",src:"to alternate / to socialize"},{trg:"anexionar",src:"to annex"},{trg:"apenar",src:"to sadden / to cause sorrow"},{trg:"atormentar",src:"to torment"}]},
    {type:"match",pairs:[{trg:"asemejar",src:"to resemble / to liken"},{trg:"asimilar",src:"to assimilate / to absorb"},{trg:"la congregación",src:"the congregation"},{trg:"conforme",src:"in agreement / as"}]},
