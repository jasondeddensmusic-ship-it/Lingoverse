...
const COVERAGE_U53 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la conformidad",src:"the compliance / conformity"},{trg:"el concursante",src:"the contestant / competitor"},{trg:"el conductor",src:"the driver / host (TV)"},{trg:"la consideración",src:"the consideration"}]},
    {type:"match",pairs:[{trg:"la consistencia",src:"the consistency"},{trg:"el causante",src:"the cause / the person responsible"},{trg:"la carpintería",src:"the carpentry / carpenter's workshop"},{trg:"la contraprestación",src:"the compensation / consideration (legal)"}]},
    {type:"match",pairs:[{trg:"el descontrol",src:"the lack of control / chaos"},{trg:"el desperfecto",src:"the damage / defect"},{trg:"encarcelar",src:"to imprison"},{trg:"la encomienda",src:"the commission / colonial land grant"}]},
    {type:"match",pairs:[{trg:"el desajuste",src:"the imbalance / mismatch"},{trg:"deshumanizar",src:"to dehumanize"},{trg:"entristecer",src:"to sadden"},{trg:"la congregación",src:"the congregation / gathering"}]},
    {type:"match",pairs:[{trg:"encumbrar",src:"to elevate / to raise to a high position"},{trg:"la crin",src:"the mane (of a horse)"},{trg:"desperdigar",src:"to scatter / to spread"},{trg:"emanar",src:"to emanate / to emit"}]},
    {type:"match",pairs:[{trg:"enlosar",src:"to pave with tiles / flagstones"},{trg:"el boj",src:"the boxwood"},{trg:"engrosar",src:"to swell / to thicken / to increase"},{trg:"el americanismo",src:"the Americanism (Latin American word)"}]},
