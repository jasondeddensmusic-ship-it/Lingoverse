...
const COVERAGE_U38 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"antártico",src:"Antarctic"},{trg:"el bálsamo",src:"the balm, balsam"},{trg:"el acaso",src:"perhaps, by chance"},{trg:"la aversión",src:"the aversion, dislike"}]},
    {type:"match",pairs:[{trg:"el asco",src:"the disgust, revulsion"},{trg:"el aseo",src:"the cleanliness, washroom"},{trg:"azucarar",src:"to add sugar to, to sweeten"},{trg:"el acero",src:"the steel"}]},
    {type:"match",pairs:[{trg:"la cafeína",src:"the caffeine"},{trg:"el alcoholismo",src:"the alcoholism"},{trg:"el asesino",src:"the murderer, killer"},{trg:"la agresividad",src:"the aggressiveness"}]},
    {type:"match",pairs:[{trg:"el aporte",src:"the contribution, input"},{trg:"el adelgazamiento",src:"the weight loss, slimming"},{trg:"el atracador",src:"the robber, mugger"},{trg:"agonizar",src:"to be dying, to agonize"}]},
    {type:"match",pairs:[{trg:"aterrorizar",src:"to terrorize"},{trg:"aniquilar",src:"to annihilate, to destroy"},{trg:"azorar",src:"to embarrass, to fluster"},{trg:"adueñar",src:"to take ownership, to seize"}]},
    {type:"match",pairs:[{trg:"agredir",src:"to assault, to attack"},{trg:"amnistiar",src:"to grant amnesty"},{trg:"el autismo",src:"the autism"},{trg:"el automatismo",src:"the automatism"}]},
