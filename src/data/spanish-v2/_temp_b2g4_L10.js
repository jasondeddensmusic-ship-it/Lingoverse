...
{type:"mc",q:"Una página web 'estática' es aquella que:",opts:["No cambia sin intervención humana","Se actualiza constantemente","Tiene muchas animaciones","No funciona correctamente"],ans:"No cambia sin intervención humana",hint:"Think about a webpage whose content stays the same until someone manually edits it."},
...
{type:"mc",q:"'Etiquetar' en redes sociales significa:",opts:["Marcar a alguien en una publicación","Bloquear a un usuario","Borrar un comentario","Publicar una foto"],ans:"Marcar a alguien en una publicación",hint:"Think about the action of tagging a friend in a social media post."},
