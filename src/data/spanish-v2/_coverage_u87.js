...
const COVERAGE_U87 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el aumento de sueldo",src:"pay raise"},{trg:"la consideración",src:"the consideration / regard"},{trg:"la obrera",src:"the female worker / laborer"},{trg:"el peletero",src:"the furrier"}]},
