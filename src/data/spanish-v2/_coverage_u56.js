...
const COVERAGE_U56 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la Edad Antigua",src:"the Ancient Age / Antiquity"},{trg:"el homínido",src:"the hominid"},{trg:"grecorromano",src:"Greco-Roman"},{trg:"el coordinador",src:"the coordinator"}]},
    {type:"match",pairs:[{trg:"el conductor",src:"the driver / host / presenter"},{trg:"la congregación",src:"the congregation / assembly"},{trg:"el entrevistador",src:"the interviewer"},{trg:"el hacendado",src:"the landowner / estate owner"}]},
    {type:"match",pairs:[{trg:"el hidrocarburo",src:"the hydrocarbon"},{trg:"la absorción",src:"the absorption"},{trg:"la fluctuación",src:"the fluctuation"},{trg:"fluido",src:"fluid / flowing"}]},
