...
const LESSON_20 = {id:"esv2_b2g3_l20", title:"Adjetivos avanzados", icon:"🎨", xp:15, board:true, steps:[
  ...
  {type:"mc", q:"'No estar en sus cabales' significa...", opts:["Estar muy cansado","No estar pensando con claridad","Estar muy contento","Estar en buena forma física"], ans:"No estar pensando con claridad", hint:"Cabal means sound/exact. If someone is NOT in their cabales, their thinking is off."},
  ...
  {type:"mc", q:"'Destartalado' describe algo que...", opts:["Está pintado de muchos colores","Es extremadamente caro","Está en mal estado y cayéndose a pedazos","Es muy moderno y nuevo"], ans:"Está en mal estado y cayéndose a pedazos", hint:"Think of an old building or vehicle that's falling apart from lack of maintenance."},
