...
const COVERAGE_U68 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la carpintería",src:"the carpentry / carpenter's workshop"},{trg:"el fierro",src:"the iron (material)"},{trg:"el manual",src:"the manual / handbook"},{trg:"incompetente",src:"incompetent"}]},
    {type:"match",pairs:[{trg:"la infelicidad",src:"the unhappiness"},{trg:"la indisciplina",src:"the indiscipline / unruliness"},{trg:"la individualidad",src:"the individuality"},{trg:"la llaneza",src:"the simplicity / frankness"}]},
    {type:"match",pairs:[{trg:"el comunismo",src:"the communism"},{trg:"el magnate",src:"the magnate / tycoon"},{trg:"el gueto",src:"the ghetto"},{trg:"imperante",src:"prevailing / dominant"}]},
