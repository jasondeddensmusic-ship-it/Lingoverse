...
const COVERAGE_U59 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el departamento de marketing",src:"the marketing department"},{trg:"la directora ejecutiva",src:"the executive director (f.)"},{trg:"el jefe de producción",src:"the production manager"},{trg:"el jefe de ventas",src:"the sales manager"}]},
    {type:"match",pairs:[{trg:"el coordinador",src:"the coordinator"},{trg:"el empleo estatal",src:"state employment / public sector job"},{trg:"la comunicación empresarial",src:"corporate communication"},{trg:"la coproducción",src:"the co-production"}]},
    {type:"match",pairs:[{trg:"la dirección comercial",src:"the commercial management / sales direction"},{trg:"la definición",src:"the definition"},{trg:"la exageración",src:"the exaggeration"},{trg:"el glúteo",src:"the gluteus / buttock muscle"}]},
