...
const COVERAGE_U67 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el departamento de marketing",src:"the marketing department"},{trg:"la logística",src:"the logistics"},{trg:"el jefe de producción",src:"the production manager"},{trg:"la jefa de equipo",src:"the team leader (f)"}]},
    {type:"match",pairs:[{trg:"el concursante",src:"the contestant / candidate"},{trg:"el diario digital",src:"the online newspaper"},{trg:"la comunicación empresarial",src:"the corporate communication"},{trg:"el listado",src:"the listing / list"}]},
