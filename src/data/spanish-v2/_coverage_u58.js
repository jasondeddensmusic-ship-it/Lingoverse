...
const COVERAGE_U58 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el escaque",src:"the square (on a chessboard)"},{trg:"fragmentar",src:"to fragment / to break into pieces"},{trg:"fraccionar",src:"to divide into fractions / to split"},{trg:"el descontrol",src:"the lack of control / chaos"}]},
    {type:"match",pairs:[{trg:"la adecuación",src:"the adaptation / suitability"},{trg:"el acondicionamiento",src:"the conditioning / fitting out"},{trg:"el desajuste",src:"the mismatch / imbalance"},{trg:"la constatación",src:"the verification / ascertainment"}]},
    {type:"match",pairs:[{trg:"el fortalecimiento",src:"the strengthening / reinforcement"},{trg:"la finalización",src:"the completion / finalization"},{trg:"la calza",src:"the stocking / wedge / chock"},{trg:"el arcabuz",src:"the arquebus (old firearm)"}]},
    {type:"match",pairs:[{trg:"el bolillo",src:"the bobbin / bread roll"},{trg:"el fierro",src:"the iron / branding iron"},{trg:"la cobra",src:"the cobra"},{trg:"el acupuntor",src:"the acupuncturist"}]},
