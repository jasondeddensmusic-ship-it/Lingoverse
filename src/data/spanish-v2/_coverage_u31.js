...
const COVERAGE_U31 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el artista",src:"the artist"},{trg:"el autor",src:"the author"},{trg:"el atleta",src:"the athlete"},{trg:"el agente",src:"the agent"}]},
    {type:"match",pairs:[{trg:"amable",src:"kind, friendly"},{trg:"el aficionado",src:"the fan, enthusiast"},{trg:"el amante",src:"the lover"},{trg:"amar",src:"to love"}]},
    {type:"match",pairs:[{trg:"besar",src:"to kiss"},{trg:"el amanecer",src:"the dawn, sunrise"},{trg:"la admiración",src:"admiration"},{trg:"admirar",src:"to admire"}]},
    {type:"match",pairs:[{trg:"acompañar",src:"to accompany"},{trg:"aconsejar",src:"to advise"},{trg:"acariciar",src:"to caress, to stroke"},{trg:"apasionar",src:"to be passionate about"}]},
    {type:"match",pairs:[{trg:"la bañera",src:"the bathtub"},{trg:"amueblar",src:"to furnish"},{trg:"el alojamiento",src:"the accommodation"},{trg:"alojar",src:"to lodge, to accommodate"}]},
    {type:"match",pairs:[{trg:"el albergue",src:"the hostel"},{trg:"la azotea",src:"the rooftop terrace"},{trg:"el aparcamiento",src:"the parking lot"},{trg:"la aceituna",src:"the olive"}]},
    {type:"match",pairs:[{trg:"el aguacate",src:"the avocado"},{trg:"el bacalao",src:"the cod"},{trg:"la albóndiga",src:"the meatball"},{trg:"la almendra",src:"the almond"}]},
