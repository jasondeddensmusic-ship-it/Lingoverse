...
export default {n:10,lang:"es",srcLang:"en",track:"v2",title:"Historias",sub:"Past Tense: Irregular Verbs",icon:"📖",level:"A2.1",color:"#7B5EE8",lessons:[
  ...
  {id:"esv2_u10l_essential_a2",title:"En el restaurante y en la salud",icon:"🍽️",xp:15,board:true,steps:[
    ...
    {type:"mc",q:"What is 'el dolor de cabeza' in English?",opts:["stomach ache","fever","headache","disease"],ans:"headache",hint:"Cabeza means head"},
    ...
    {type:"mc",q:"¿Cuál es el primer ___ del día? ¿La sopa o la ensalada?",opts:["plato","menú","cena","descuento"],ans:"plato",hint:"A course in a meal is called this"},
    ...
    {type:"mc",q:"'La enfermedad' means:",opts:["the pain","the medicine","the illness","the hospital"],ans:"the illness",hint:"Think of the adjective 'enfermo' (sick) — same root"},
