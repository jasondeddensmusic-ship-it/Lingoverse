...
const COVERAGE_U69 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la evangelización",src:"the evangelization"},{trg:"el descendimiento",src:"the descent (from the cross)"},{trg:"el acorazado",src:"the battleship / armored ship"},{trg:"la incursión",src:"the raid / incursion"}]},
    {type:"match",pairs:[{trg:"la mercadería",src:"the merchandise / goods"},{trg:"la intermediación",src:"the intermediation / brokerage"},{trg:"la contraprestación",src:"the compensation / consideration (in a contract)"},{trg:"la base",src:"the base / basis"}]},
    {type:"match",pairs:[{trg:"el lineamiento",src:"the guideline / directive"},{trg:"la inconveniencia",src:"the inconvenience / impropriety"},{trg:"lerdo",src:"slow-witted / clumsy"},{trg:"la materialidad",src:"the materiality / physicality"}]},
    ...
    {type:"match",pairs:[{trg:"el contragolpe",src:"the counterattack / backlash"},{trg:"la complementación",src:"the complementation / supplementation"},{trg:"la congregación",src:"the congregation / gathering"},{trg:"la imposibilidad",src:"the impossibility"}]},
