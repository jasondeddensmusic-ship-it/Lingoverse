...
const COVERAGE_U54 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el bolillo",src:"the bread roll / bobbin"},{trg:"el brócoli",src:"the broccoli"},{trg:"la caneca",src:"the trash can / bottle (regional)"},{trg:"el carbonato",src:"the carbonate"}]},
    {type:"match",pairs:[{trg:"el amoníaco",src:"the ammonia"},{trg:"la calza",src:"the stocking / wedge"},{trg:"el cadáver",src:"the corpse / dead body"},{trg:"el artista",src:"the artist"}]},
    {type:"match",pairs:[{trg:"expresionista",src:"expressionist"},{trg:"el diario digital",src:"the online newspaper"},{trg:"enmascarar",src:"to mask / to disguise"},{trg:"la exageración",src:"the exaggeration"}]},
    {type:"match",pairs:[{trg:"espirar",src:"to exhale / to breathe out"},{trg:"la devoción",src:"the devotion"},{trg:"dignar",src:"to deign / to condescend"},{trg:"excusar",src:"to excuse / to avoid"}]},
    {type:"match",pairs:[{trg:"la espiritualidad",src:"the spirituality"},{trg:"el bienaventurado",src:"the blessed one"},{trg:"deportivo",src:"sporty / sportive"},{trg:"la dermis",src:"the dermis"}]},
