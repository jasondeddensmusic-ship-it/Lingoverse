...
const COVERAGE_U45 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el brécol",src:"the broccoli"},{trg:"el cabrito",src:"the young goat / kid"},{trg:"el amasijo",src:"the dough / jumble"},{trg:"el azucarero",src:"the sugar bowl"}]},
    {type:"match",pairs:[{trg:"el acetato",src:"the acetate"},{trg:"el carbonato",src:"the carbonate"},{trg:"el cuenco",src:"the bowl"},{trg:"el bolillo",src:"the bread roll / bobbin"}]},
    {type:"match",pairs:[{trg:"el amoníaco",src:"the ammonia"},{trg:"la cuchillada",src:"the knife wound / slash"},{trg:"el bautismo",src:"the baptism"},{trg:"la base",src:"the base / basis"}]},
    {type:"match",pairs:[{trg:"el currículo",src:"the curriculum / CV"},{trg:"la cualificación",src:"the qualification"},{trg:"el conductor",src:"the driver / presenter"},{trg:"la acreditación",src:"the accreditation / credentials"}]},
    {type:"match",pairs:[{trg:"el ajedrecista",src:"the chess player"},{trg:"el agente",src:"the agent"},{trg:"el concursante",src:"the contestant"},{trg:"el causante",src:"the person responsible / cause"}]},
    {type:"match",pairs:[{trg:"el compatriota",src:"the compatriot"},{trg:"el adulto",src:"the adult"},{trg:"la aprobación",src:"the approval"},{trg:"la centralización",src:"the centralization"}]},
    {type:"match",pairs:[{trg:"el comunismo",src:"the communism"},{trg:"la conformidad",src:"the conformity / agreement"},{trg:"la convivencia",src:"the coexistence / living together"},{trg:"cooperativo",src:"cooperative"}]},
    {type:"match",pairs:[{trg:"la congregación",src:"the congregation / gathering"},{trg:"la contraprestación",src:"the consideration / payment in return"},{trg:"la consideración",src:"the consideration / regard"},{trg:"la confusión",src:"the confusion"}]},
    {type:"match",pairs:[{trg:"la correspondencia",src:"the correspondence / mail"},{trg:"aritmético",src:"arithmetic / arithmetical"},{trg:"la autoevaluación",src:"the self-assessment"},{trg:"la autocrítica",src:"the self-criticism"}]},
    {type:"match",pairs:[{trg:"la accesibilidad",src:"the accessibility"},{trg:"el computador",src:"the computer"},{trg:"el condicional",src:"the conditional (tense)"},{trg:"el antecesor",src:"the predecessor / ancestor"}]},
