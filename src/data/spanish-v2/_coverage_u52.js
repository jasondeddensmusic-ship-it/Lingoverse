...
const COVERAGE_U52 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el entrevistador",src:"the interviewer"},{trg:"el adulto",src:"the adult"},{trg:"el escribano",src:"the notary / scribe"},{trg:"esforzar",src:"to make an effort"}]},
    {type:"match",pairs:[{trg:"espabilar",src:"to wake up / to get moving"},{trg:"el acondicionamiento",src:"the conditioning / fitting out"},{trg:"embellecer",src:"to beautify / to embellish"},{trg:"el estampido",src:"the bang / blast"}]},
