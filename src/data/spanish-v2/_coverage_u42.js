...
const COVERAGE_U42 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"el adulto",src:"the adult"},{trg:"el ateo",src:"the atheist"},{trg:"el cochero",src:"the coachman / driver"},{trg:"el brasileño",src:"the Brazilian"}]},
    {type:"match",pairs:[{trg:"el anglosajón",src:"the Anglo-Saxon"},{trg:"el anglófono",src:"the English speaker"},{trg:"el católico",src:"the Catholic"},{trg:"el cimiento",src:"the foundation / basis"}]},
    {type:"match",pairs:[{trg:"el chorro",src:"the stream / jet"},{trg:"la borda",src:"the gunwale / ship's rail"},{trg:"comarcal",src:"regional / district-level"},{trg:"asistencial",src:"welfare / care-related"}]},
    {type:"match",pairs:[{trg:"asociativo",src:"associative / community-based"},{trg:"competer",src:"to be the responsibility of"},{trg:"complacer",src:"to please / to satisfy"},{trg:"conminar",src:"to urge / to threaten with consequences"}]},
    {type:"match",pairs:[{trg:"el accidentado",src:"the accident victim / injured person"},{trg:"la coincidencia",src:"the coincidence"},{trg:"beneficioso",src:"beneficial"},{trg:"báltico",src:"Baltic"}]},
    {type:"match",pairs:[{trg:"cantor",src:"singing / singer (literary)"},{trg:"afilador",src:"knife-sharpening / sharp"},{trg:"clavadista",src:"diver (from heights)"},{trg:"chacarero",src:"farmer / ranch-related"}]},
    {type:"match",pairs:[{trg:"aeronáutico",src:"aeronautical"},{trg:"la apocalipsis",src:"the apocalypse"},{trg:"apoderar",src:"to empower / to authorize"},{trg:"autodefinir",src:"to self-define"}]},
    {type:"match",pairs:[{trg:"avocar",src:"to take jurisdiction / to claim authority"},{trg:"azular",src:"to turn blue / to make blue"},{trg:"compenetrar",src:"to be in sync / to understand deeply"},{trg:"el accidentar",src:"to cause an accident (to)"}]},
