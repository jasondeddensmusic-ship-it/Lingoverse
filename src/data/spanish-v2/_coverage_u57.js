...
const COVERAGE_U57 = {
  ...
  steps:[
    ...
    {type:"match",pairs:[{trg:"la desnudez",src:"the nakedness / nudity"},{trg:"la extrañeza",src:"the strangeness / surprise"},{trg:"el enriquecimiento",src:"the enrichment"},{trg:"la fineza",src:"the refinement / delicate gesture"}]},
    {type:"match",pairs:[{trg:"el hada madrina",src:"the fairy godmother"},{trg:"la hilera",src:"the row / line / file"},{trg:"el diario digital",src:"the online newspaper"},{trg:"la constatación",src:"the verification / confirmation"}]},
    {type:"match",pairs:[{trg:"la comunicación empresarial",src:"the corporate communication"},{trg:"la dirección comercial",src:"the commercial management / business address"},{trg:"ideológico",src:"ideological"},{trg:"idear",src:"to devise / to come up with"}]},
    {type:"match",pairs:[{trg:"el batiente",src:"the door frame / leaf of a door"},{trg:"el elevador",src:"the elevator / lift"},{trg:"desamueblar",src:"to unfurnish / to strip of furniture"},{trg:"hotelero",src:"hotel-related / hotelier"}]},
