...
{type:"mc", q:"A farmer sat by a tree stump waiting for another rabbit. Which chengyu?",
 opts:["半途而废(bàntú'érfèi)","守株待兔(shǒuzhūdàitù)","对牛弹琴(duìniútánqín)","画蛇添足(huàshétiānzú)"],
...
{type:"mc", q:"刻舟求剑(kèzhōuqiújiàn) criticizes someone who:",
 opts:["Talks to the wrong person","Fails to adapt to changing circumstances","Gives up too easily","Works too slowly"],
...
{type:"mc", q:"Which chengyu would you use when visiting a foreign country and respecting local customs?",
 opts:["自相矛盾(zìxiāngmáodùn)","举一反三(jǔyīfǎnsān)","入乡随俗(rùxiāngsuísú)","亡羊补牢(wángyángbǔláo)"],
...
{type:"mc", q:"Which word means widespread or universal?",
 opts:["普遍(pǔbiàn)","巨大(jùdà)","相当(xiāngdāng)","明确(míngquè)"],
 ans:"普遍(pǔbiàn)",
 hint:"Compound of 'general' plus 'everywhere' characters."},
{type:"mc", q:"In '这本书的_很清楚', which word fits?",
 opts:["标准(biāozhǔn)","结构(jiégòu)","程度(chéngdù)","数量(shùliàng)"],
 ans:"结构(jiégòu)",
