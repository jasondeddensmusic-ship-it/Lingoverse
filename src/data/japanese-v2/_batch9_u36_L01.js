...
const BATCH9_L1 = {
  ...
  steps:[
    ...
    {type:"teach", trg:"革新(かくしん)", src:"innovation", pos:"noun", gender:null,
     note:"革(かく) to change + 新(しん) new.\nReform or breakthrough innovation.",
     ...
     funFact:"革(かく) (to change) + 新(しん) (new). Japanese innovation policy emphasizes 破壊的(はかいてき)革新(かくしん) (disruptive innovation) to exit the lost decades. 革新(かくしん)都市(とし) (innovation city) initiatives target Kyoto, Fukuoka, Tsukuba."},

    {type:"teach", trg:"スタートアップ", src:"startup", pos:"noun", gender:null,
     note:"English loanword.\nJapan pledged 10 trillion yen support through 2027.",
     ...
     funFact:"Imported English. Japan's スタートアップ ecosystem was historically weak but has grown rapidly since 2020. The government pledged 10 trillion yen スタートアップ support through 2027 under the new capitalism framework."},

    {type:"teach", trg:"地方創生(ちほうそうせい)", src:"regional creation", pos:"noun", gender:null,
     note:"地方(ちほう) regional + 創生(そうせい) creation.\n2014 initiative to revitalize rural Japan.",
     ...
     funFact:"地方(ちほう) (regional) + 創生(そうせい) (creation). A 2014 initiative to revitalize depopulating rural areas via subsidies, tax incentives, and 移住(いじゅう) (migration) programs. Results are mixed but initiatives continue."},

    {type:"teach", trg:"働(はたら)き方改革(かたかいかく)", src:"work style reform", pos:"noun", gender:null,
     note:"働き方 (work style) + 改革(かいかく) reform.\n2019 law reshapes Japanese labor practices.",
     ...
     funFact:"働(はたら)く (to work) + 方(かた) (way) + 改革(かいかく) (reform). Since 2019, overtime caps, paid leave rules, and 同一労働同一賃金(どういつろうどうどういつちんぎん) (equal pay for equal work) reshape Japanese labor law."},

    {type:"teach", trg:"子育(こそだ)て支援(しえん)", src:"childcare support", pos:"noun", gender:null,
     note:"子育て childcare + 支援(しえん) support.\nMajor policy focus due to low birth rate.",
     ...
     funFact:"子育(こそだ)て (childcare) + 支援(しえん) (support). Japan's declining birth rate (TFR 1.26 in 2022) drives aggressive 子育(こそだ)て支援(しえん) expansion: universal preschool, paid parental leave, cash allowances."},

    {type:"teach", trg:"インバウンド", src:"inbound tourism", pos:"noun", gender:null,
     note:"English loanword.\nPost-pandemic records driven by weak yen.",
     ...
     funFact:"Imported English. Japan's インバウンド strategy aimed for 40M annual tourists pre-COVID (hit 31.9M in 2019). Post-pandemic recovery hit records in 2024, driven by weak yen and UNESCO heritage sites."},

    {type:"teach", trg:"ソサエティ", src:"Society 5.0", pos:"noun", gender:null,
     note:"English loanword.\nJapan's 5.0 super-smart society vision integrates IoT and AI.",
     ...
     funFact:"Imported English. ソサエティ5.0 is Japan's vision for a super-smart society integrating IoT, AI, and robotics. Preceded by 1.0 hunter-gatherer, 2.0 agricultural, 3.0 industrial, 4.0 information."},

    {type:"teach", trg:"未来像(みらいぞう)", src:"vision of the future", pos:"noun", gender:null,
     note:"未来(みらい) future + 像(ぞう) image.\nCore term in Japanese long-term strategy.",
     ...
     funFact:"未来(みらい) (future) + 像(ぞう) (image). 2050 未来像(みらいぞう) is a standard prompt in Japanese corporate and government strategic planning. Long-term visioning is culturally valued."},
