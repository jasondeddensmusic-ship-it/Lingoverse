...
const BATCH8_L1 = {
  ...
  ,{type:"fb", s:"視力(しりょく)が悪(わる)いので{1}をかけています。",
     a:["眼鏡(めがね)"],
     opts:["眼鏡(めがね)","帽子(ぼうし)","マフラー","ベルト"],
     hint:"Your eyesight is poor so you wear these on your face to help you see. This noun refers to corrective lenses in a frame.",
     sSrc:"I have poor eyesight so I wear {1}."}
