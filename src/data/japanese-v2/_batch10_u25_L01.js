...
const BATCH10_L1 = {
  ...
  steps:[
    ...
    {type:"teach", trg:"議題(ぎだい)", src:"agenda item", pos:"noun", gender:null,
     note:"From 議(ぎ) discussion + 題(だい) topic.\nAlways circulated before formal meetings.",
    ...
    {type:"teach", trg:"議事録(ぎじろく)", src:"meeting minutes", pos:"noun", gender:null,
     note:"議事(ぎじ) meeting matters + 録(ろく) record.\nThe written summary of a meeting.",
    ...
    {type:"teach", trg:"結論(けつろん)", src:"conclusion", pos:"noun", gender:null,
     note:"結(けつ) to tie + 論(ろん) argument.\nTraditionally placed at the end in Japanese.",
    ...
    {type:"teach", trg:"合意(ごうい)", src:"agreement", pos:"noun", gender:null,
     note:"合(ごう) fit together + 意(い) intention.\nMutual agreement, a core Japanese management idea.",
    ...
    {type:"teach", trg:"司会(しかい)", src:"moderator", pos:"noun", gender:null,
     note:"司(し) to preside + 会(かい) meeting.\nThe moderator or emcee of a formal event.",
