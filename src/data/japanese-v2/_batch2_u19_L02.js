// Unit 19 Batch 2 Lesson 2: 条件(じょうけん)の使(つか)い分(わ)け (Choosing the Right Conditional)
const BATCH2_L_2 = {
  id:"jav2_u19l_b2_2", title:"条件(じょうけん)の使(つか)い分(わ)け", icon:"⚖️", xp:15, board:true,
  steps:[
    {type:"intro", title:"条件(じょうけん)の使(つか)い分(わ)け",
    ...
    {type:"teach", trg:"〜としたら", src:"if we assume that ~ / supposing that ~", pos:"part", gender:null,
     ...
     example:"A: 転勤(てんきん)するとしたらどこに住(す)みたいですか？\nB: 京都(きょうと)に住(す)みたいです。\nA: 誰(だれ)と行(い)きましたか？\nB: 友達(ともだち)と一緒(いっしょ)に行(い)きました。",
     exampleSrc:"A: If you were to be transferred, where would you want to live?\nB: I would want to live in Kyoto.\nA: Who did you go with?\nB: I went with a friend.",
     funFact:"としたら adds 'if we suppose' to create a frame for discussion. It is less definite than もし + たら because it explicitly marks the scenario as hypothetical framing. Business meetings and planning discussions use this pattern: もし地震(じしん)が起(お)きたとしたら (supposing an earthquake occurred)."},

    {type:"teach", trg:"〜ようなら", src:"if it seems like ~ / if it looks like ~", pos:"part", gender:null,
     note:"よう (appearance) + なら (if). Conditional based on observation.\n熱(ねつ)があるようなら = if it looks like you have a fever.",
     example:"A: 熱(ねつ)があるようなら休(やす)んでください。\nB: はい、気(き)をつけます。\nA: それは大変(たいへん)でしたね。\nB: はい、でもいい勉強(べんきょう)になりました。",
    ...
    {type:"teach", trg:"〜ないと", src:"if (you) don't ~ / unless ~", pos:"part", gender:null,
     ...
     example:"A: 早(はや)く行(い)かないと間(ま)に合(あ)いません。\nB: 急(いそ)ぎましょう！\nA: 本当(ほんとう)ですか？すごいですね。\nB: ありがとうございます。頑張(がんば)りました。",
    ...
    {type:"teach", trg:"〜としても", src:"even if ~ / even assuming that ~", pos:"part", gender:null,
     note:"と + しても = even if we assume. Concessive conditional.\n頑張(がんば)ったとしても難(むずか)しい = even if you try hard, it is difficult.",
     example:"A: 今(いま)から頑張(がんば)ったとしても難(むずか)しいです。\nB: でもやってみなければわかりません。\nA: 私(わたし)も興味(きょうみ)があります。\nB: じゃあ、今度(こんど)一緒(いっしょ)にどうですか？",
    ...
    {type:"teach", trg:"熱(ねつ)", src:"fever / heat", pos:"noun", gender:null,
     note:"Kanji: 熱. 熱(ねつ)がある = to have a fever. 熱(ねつ)が下(さ)がる = fever goes down.\nAlso means enthusiasm: 熱意(ねつい) (passion).",
     example:"A: 熱(ねつ)が38度(ど)あります。\nB: 病院(びょういん)に行(い)ったほうがいいですよ。\nA: どんな感(かん)じでしたか？\nB: 想像(そうぞう)していたよりずっと良(よ)かったです。",
     exampleSrc:"A: I have a 38-degree fever.\nB: You should go to the hospital.\nA: What was it like?\nB: It was much better than I imagined.",
     funFact:"熱 covers both physical heat and fever. Japanese people measure temperature in Celsius, so 38度(ど) is a significant fever. Having a 熱(ねつ) is one of the most common reasons for taking sick leave. Schools require students to stay home if their temperature exceeds 37.5 degrees."},

    {type:"teach", trg:"実際(じっさい)に", src:"actually / in reality / in practice", pos:"adv", gender:null,
     note:"Kanji: 実際に. 実際(じっさい) = reality/actuality.\nContrasts with theory or assumption.",
     example:"A: 理論(りろん)では簡単(かんたん)ですが、実際(じっさい)には難(むずか)しいです。\nB: やってみなければわかりません。\nA: 何(なに)を食(た)べましたか？\nB: 地元(じもと)の名物(めいぶつ)を食(た)べました。",
     exampleSrc:"A: In theory it is easy, but in practice it is difficult.\nB: You won't know unless you try.\nA: What did you eat?\nB: I ate the local specialty.",
     funFact:"実際に is the bridge between hypothesis and reality. It often appears after conditional discussions to ground things: としたら... but 実際(じっさい)に is... (supposing X, but in reality...). This contrast between 理論(りろん) (riron, theory) and 実際(じっさい) (jissai, reality) is a common rhetorical structure in Japanese presentations."},

    {type:"fb", s:"早(はや)く行(い)か{1}間(ま)に合(あ)いません。\n(If we don't go quickly, we won't make it.)", a:"ないと", opts:["ないと","なくて","なければ","ないで"], sSrc:"If we don't go quickly, we won't make it.",
    ...
    {type:"teach", trg:"たとえ〜ても", src:"even if ~ / no matter how much ~", pos:"part", gender:null,
     ...
     funFact:"たとえ...ても is the strongest concessive conditional. たとえ signals 'even supposing the worst case,' and ても adds 'even so.' It expresses unwavering determination: たとえ雨(あめ)でも行(い)く (even if it rains, I will go). This pattern appears in motivational speeches and personal declarations."},

    {type:"teach", trg:"諦(あきら)める", src:"to give up / to abandon", pos:"verb", gender:null,
     note:"Group 2 verb. Kanji: 諦める. 諦(あきら)めないで = do not give up.\nA key concept in Japanese motivational culture.",
     example:"A: 難(むずか)しいですが諦(あきら)めません。\nB: その調子(ちょうし)でがんばってください。\nA: いい思(おも)い出(で)ですね。\nB: はい、一生(いっしょう)忘(わす)れません。",
     exampleSrc:"A: It is difficult but I will not give up.\nB: Keep going at that pace.\nA: That is a nice memory.\nB: Yes, I will never forget it.",
     funFact:"諦める has Buddhist origins: the kanji 諦 means 'truth/enlightenment' in Buddhism, suggesting that giving up is accepting reality. However, modern Japanese culture celebrates not giving up (諦(あきら)めない). Anime, sports, and business culture emphasize ganbaru (persevere) and akiramenai (never give up) as core virtues."},

    {type:"teach", trg:"理論(りろん)", src:"theory", pos:"noun", gender:null,
     note:"Kanji: 理論. り (reason/logic) + ろん (argument/theory).\n理論的(りろんてき) = theoretical.",
     example:"A: 理論(りろん)はわかりましたが実践(じっせん)が難(むずか)しいです。\nB: 練習(れんしゅう)が必要(ひつよう)ですね。\nA: どうでしたか？\nB: とても良(よ)かったです。",
     exampleSrc:"A: I understand the theory but practice is difficult.\nB: Practice is needed.\nA: How was it?\nB: It was very good.",
     funFact:"理論 is the academic word for theory. Japanese education emphasizes both 理論(りろん) (theory) and 実践(じっせん) (jissen, practice). The gap between knowing and doing (分(わ)かる vs できる, understanding vs ability) is a recognized challenge. Many Japanese learning methods focus on bridging this gap through repetition."},

    {type:"mc", q:"たとえ失敗(しっぱい)しても諦(あきら)めません means:", opts:["If I fail, I will give up","Even if I fail, I will not give up","I failed and gave up","I never fail"], ans:"Even if I fail, I will not give up",
    ...
    {type:"fb", s:"たとえ失敗(しっぱい)しても{1}ません。\n(Even if I fail, I will not give up.)", a:"諦(あきら)め", opts:["諦(あきら)め","諦(あきら)めて","諦(あきら)めた","諦(あきら)める"], sSrc:"Even if I fail, I will not give up.",
     hint:"The negative masu-stem of 諦(あきら)める (to give up) before ません."},
