...
{type:"match",pairs:[{trg:"退院(たいいん)する",src:"to leave the hospital / to be discharged"},{trg:"急(いそ)ぐ",src:"to hurry / to rush"},{trg:"大切(たいせつ)にする",src:"to cherish / to take care of"}]},
  {type:"fb", s:"{1}の春(はる)に大学(だいがく)を卒業(そつぎょう)する予定(よてい)です。", a:["来年(らいねん)"], opts:["来年(らいねん)","来月(らいげつ)","来週(らいしゅう)","今年(ことし)"], hint:"The year that follows the current one.", sSrc:"I am scheduled to graduate from university in the spring of {1}."}
]};
