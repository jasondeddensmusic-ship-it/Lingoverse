...
const BATCH10_L1 = {
  ...
  steps:[
    ...
    {type:"teach", trg:"歌舞伎(かぶき)", src:"kabuki theater", pos:"noun", gender:null,
     note:"歌(か) song + 舞(ぶ) dance + 伎(き) skill.\nUNESCO Intangible Cultural Heritage.",
    ...
    {type:"teach", trg:"能(のう)", src:"noh theater", pos:"noun", gender:null,
     note:"From 能力(のうりょく) (ability).\nMasked, stylized 14th-century theater.",
    ...
    {type:"teach", trg:"落語(らくご)", src:"comic storytelling", pos:"noun", gender:null,
     note:"落(らく) fall + 語(ご) tale.\nSingle-performer comic monologues; punchline is called 落ち.",
    ...
    {type:"teach", trg:"書道(しょどう)", src:"calligraphy", pos:"noun", gender:null,
     note:"書(しょ) writing + 道(どう) way.\nMore than handwriting: a disciplined art.",
    ...
    {type:"teach", trg:"生(い)け花(ばな)", src:"flower arrangement", pos:"noun", gender:null,
     note:"生(い)ける to arrange + 花(はな) flowers.\nCelebrates empty space (間, ma).",
    ...
    {type:"teach", trg:"茶道(さどう)", src:"tea ceremony", pos:"noun", gender:null,
     note:"茶(さ) tea + 道(どう) way.\nAlso read ちゃどう. Codified by Sen no Rikyu.",
    ...
    {type:"teach", trg:"浮世絵(うきよえ)", src:"ukiyo-e prints", pos:"noun", gender:null,
     note:"浮世(うきよ) floating world + 絵(え) picture.\nEdo-period woodblock prints.",
    ...
    {type:"teach", trg:"人間国宝(にんげんこくほう)", src:"living national treasure", pos:"noun", gender:null,
     note:"人間(にんげん) human + 国宝(こくほう) national treasure.\nOfficial title for master artists.",
