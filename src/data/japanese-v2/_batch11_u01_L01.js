...
const BATCH11_L1 = {
  id:"jav2_u01l_b11_1", title:"しつもんのことば", icon:"❓", xp:15, board:true,
  steps:[
    {type:"intro", title:"しつもんのことば",
    ...
    {type:"teach", trg:"どう", src:"how / in what way", pos:"adv", gender:null,
     ...
     example:"A: にほんごのべんきょうはどうですか？\nB: たのしいですが、かんじがむずかしいです。",
    ...
    {type:"teach", trg:"どれ", src:"which one (of three or more)", pos:"pron", gender:null,
     ...
     funFact:"The difference between どれ (which one) and どの (which + noun) trips up many learners. どれ stands alone: どれがいい？ (Which is good?). どの needs a noun: どのほんがいい？ (Which book is good?). Think of どれ as a pronoun and どの as an adjective."},

    {type:"teach", trg:"どんな", src:"what kind of", pos:"adj", gender:null,
     note:"Always followed by a noun: どんな + noun.\nどんなひと = what kind of person.",
    ...
    {type:"mc", q:"「なに」が「なん」になるのはどのばあいですか？",
    ...
    {type:"mc", q:"ふたつのものからえらぶとき、どのことばをつかいますか？",
     opts:["どちら","どれ","どこ","どの"],
     ans:"どちら",
