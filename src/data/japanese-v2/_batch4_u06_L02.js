...
const BATCH4_L_2 = {
  ...
  steps:[
    ...
    {type:"match", pairs:[
      ...
      {trg:"靴(くつ)", src:"shoes"},
      {trg:"コート", src:"coat"}
    ,{trg:"似合(にあ)う",src:"to suit / to look good on"}]},
  ...
  ,{type:"match",pairs:[{trg:"服(ふく)",src:"clothes / clothing"},{trg:"スカート",src:"skirt"},{trg:"靴下(くつした)",src:"socks"},{trg:"帽子(ぼうし)",src:"hat / cap"},{trg:"ネクタイ",src:"necktie"},{trg:"脱(ぬ)ぐ",src:"to take off (clothing)"}]},
