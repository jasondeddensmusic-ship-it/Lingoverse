...
const BATCH8_L1 = {
  ...
  steps:[
    ...
    {type:"teach", trg:"おひさしぶりです", src:"it has been a long time", pos:"intj", gender:null,
     ...
     funFact:"ひさしぶり uses the kanji 久 (long time). There is no fixed rule for how long counts as ひさしぶり. Some people say it after two weeks, others after months. Adding お at the start makes it polite enough for business."},

    {type:"teach", trg:"おめでとうございます", src:"congratulations", pos:"intj", gender:null,
     note:"Used for birthdays, New Year, weddings, graduations.\nCasual: おめでとう.",
     example:"A: たんじょうびおめでとうございます！\nB: ありがとうございます！",
     exampleSrc:"A: Happy birthday!\nB: Thank you!",
     funFact:"おめでとう comes from めでたい (auspicious/joyful). On New Year, everyone says あけましておめでとうございます. Japanese culture has many おめでとう occasions: shichi-go-san (ages 3, 5, 7), coming of age (20), and even passing exams."},
    ...
    {type:"teach", trg:"おだいじに", src:"take care / get well soon", pos:"intj", gender:null,
     ...
     example:"A: かぜをひいてしまいました。\nB: おだいじに。はやくよくなってください。",
     exampleSrc:"A: I caught a cold.\nB: Take care. Please get well soon.",
     funFact:"おだいじに literally means 'please treat yourself as important.' Doctors and pharmacists always say it to patients. It is also used when someone mentions feeling unwell, even casually. Adding なさってください makes it even more formal."},
    ...
    {type:"teach", trg:"ごぶさたしております", src:"I apologize for not being in touch", pos:"intj", gender:null,
     ...
     funFact:"ごぶさた (御無沙汰) combines 無 (without) and 沙汰 (communication). It places the blame on yourself for the gap in contact, which is a polite move. In business, using this shows awareness that maintaining relationships requires effort."},
    ...
    {type:"teach", trg:"おそれいります", src:"I appreciate it / I am sorry to trouble you", pos:"intj", gender:null,
     ...
     example:"A: こちらのしりょうをどうぞ。\nB: おそれいります。たすかります。",
     exampleSrc:"A: Here are the documents.\nB: I appreciate it. That helps a lot.",
     funFact:"おそれいります literally means 'I am in awe.' It is the gold standard of polite business phrases, combining gratitude with humility. Service staff at high-end hotels and department stores use it frequently to express deep appreciation."},
