// Unit 24 Batch 5 Lesson 2: ろんりのつなぎ (Cause, Condition & Logical Connectors)
const BATCH5_L_2 = {
  id:"jav2_u24l_b5_2", title:"ろんりのつなぎ", icon:"🧩", xp:15, board:true,
  steps:[
    {type:"intro", title:"ろんりのつなぎ",
    ...
    {type:"teach", trg:"そのため", src:"for that reason / therefore / because of that", pos:"conj", gender:null,
     ...
     example:"A: ことしはあめがすくなかったです。そのため、すいどうすいがふそくしています。\nB: みずのせつやくがひつようですね。\nA: どうでしたか？\nB: とても良(よ)かったです。",
    ...
    {type:"teach", trg:"そこで", src:"so / therefore / that being the case", pos:"conj", gender:null,
     ...
     example:"A: でんしゃがとまりました。そこで、タクシーでいくことにしました。\nB: けんめいなはんだんですね。\nA: いつですか？\nB: 去年(きょねん)の夏(なつ)でした。",
    ...
    {type:"teach", trg:"〜にともなって", src:"along with / accompanying / as ~ changes", pos:"part", gender:null,
     note:"Noun/verb + にともなって. Formal pattern for correlated changes.\nKanji: に伴って. Two things change together.",
     example:"A: じんこうのぞうかにともなって、じゅうたくもんだいがしんこくになっています。\nB: とかいではとくにそうですね。\nA: また行(い)きたいですか？\nB: はい、ぜひ行(い)きたいです。",
     ...
     funFact:"に伴って is formal academic and news language. 伴 means 'accompany,' so the pattern means 'accompanying X, Y also changes.' It describes correlated phenomena: ぎじゅつのしんぽにともなって (along with technological progress), こうれいかにともなって (accompanying population aging). It appears frequently in JLPT N2 reading passages about social trends."},

    {type:"teach", trg:"〜にしたがって", src:"as ~ / in accordance with / following", pos:"part", gender:null,
     note:"Verb dictionary/noun + にしたがって. Proportional change.\nKanji: に従って. As X increases, Y increases.",
     example:"A: きおんがあがるにしたがってアイスクリームのうりあげがふえます。\nB: なつはアイスがいちばんうれますね。\nA: どのくらいかかりましたか？\nB: だいたい二時間(にじかん)ぐらいです。",
     exampleSrc:"A: As the temperature rises, ice cream sales increase.\nB: Summer is when ice cream sells best.\nA: How long did it take?\nB: About two hours.",
     funFact:"に従って uses したがう (to follow/obey). As a grammar pattern, it describes proportional changes: as one thing changes, another follows suit. It is the pattern for trend descriptions: にほんごがうまくなるにしたがって (as Japanese improves), ねんれいがあがるにしたがって (as age increases). JLPT loves testing this pattern in reading comprehension."},

    {type:"teach", trg:"けんめい", src:"wise / sensible / prudent", pos:"adj", gender:null,
     note:"な-adjective. Kanji: 賢明. けんめいなはんだん = wise decision.\nけんめいなせんたく = sensible choice.",
     example:"A: じたいがかわるまでまつのがけんめいです。\nB: あせってもいいけっかにはなりませんね。\nA: 難(むずか)しかったですか？\nB: 最初(さいしょ)は難(むずか)しかったですが、慣(な)れました。",
     exampleSrc:"A: It is wise to wait until the situation changes.\nB: Rushing will not produce good results.\nA: Was it difficult?\nB: It was difficult at first, but I got used to it.",
     funFact:"賢明 combines 賢 (wise/clever) and 明 (bright/clear). It describes decisions made with good judgment. In Japanese business, being けんめい is more valued than being bold or creative. Conservative, well-reasoned choices are praised as けんめい. The phrase けんめいなはんだん (wise decision) is the highest compliment for decision-making in professional contexts."},
