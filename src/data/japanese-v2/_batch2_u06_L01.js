...
const BATCH2_L_1 = {
  id:"jav2_u06l_b2_1", title:"かぞくをしょうかいする", icon:"👨‍👩‍👦", xp:15, board:true,
  steps:[
  {type:"intro", title:"かぞくをしょうかいする",
  ...
  {type:"teach", trg:"おっと", src:"husband (my own, humble)", pos:"noun", gender:null,
   note:"Humble form for YOUR husband. ごしゅじん is the honorific for someone else's.\nKanji: 夫.",
   example:"A: おっとはかいしゃいんです。\nB: どこのかいしゃですか？",
  ...
  {type:"teach", trg:"つま", src:"wife (my own, humble)", pos:"noun", gender:null,
  ...
  {type:"teach", trg:"こども", src:"child / children", pos:"noun", gender:null,
   note:"General word for child(ren). おこさん is the polite form for others' children.\nKanji: 子供 or 子ども.",
   example:"A: こどもはなんにんいますか？\nB: ふたりいます。むすことむすめです。",
  ...
  {type:"teach", trg:"むすこ", src:"son (my own, humble)", pos:"noun", gender:null,
   note:"Humble form for YOUR son. むすこさん is polite for someone else's.\nKanji: 息子.",
   example:"A: むすこはことしだいがくにはいりました。\nB: おめでとうございます！",
  ...
  {type:"teach", trg:"むすめ", src:"daughter (my own, humble)", pos:"noun", gender:null,
   note:"Humble form for YOUR daughter. おじょうさん is polite for someone else's.\nKanji: 娘.",
   example:"A: むすめはまだこうこうせいです。\nB: なんねんせいですか？",
  ...
  {type:"fb", s:"{1}はかいしゃいんです。\n(My husband is a company employee.)", a:"おっと", opts:["おっと","ごしゅじん","おとうさん","ちち"], sSrc:"My husband is a company employee.",
   hint:"The humble form used when referring to YOUR own husband."},

  {type:"teach", trg:"ろくにん", src:"six people", pos:"num", gender:null,
   note:"Regular: roku (six) + nin (people counter). No sound changes.\nKanji: 六人.",
   example:"A: かぞくはろくにんです。\nB: にぎやかですね！",
  ...
  {type:"teach", trg:"しちにん", src:"seven people", pos:"num", gender:null,
   note:"Uses しち (not なな): しちにん. Also read ななにん in some contexts.\nKanji: 七人.",
   example:"A: パーティーにしちにんきます。\nB: たくさんですね！",
   exampleSrc:"A: Seven people are coming to the party.\nB: That is a lot!",
   funFact:"Seven people is famously associated with the film 七人の侍 (Seven Samurai) by Kurosawa Akira, one of the most influential films ever made. Both しちにん and ななにん are used, but しちにん is more traditional."},
  ...
  {type:"teach", trg:"にぎやか", src:"lively / bustling", pos:"adj", gender:null,
   ...
   funFact:"にぎやか is always positive in Japanese, unlike 'noisy' which can be negative. For negative loudness, use うるさい. A にぎやかなまち is a lively, fun neighborhood. A うるさいまち is an annoyingly loud one. The distinction matters."},

  {type:"mc", q:"つま is used when talking about:", opts:["someone else's wife","your own wife","your mother","someone else's mother"], ans:"your own wife",
   hint:"This is the h... form for referring to YOUR spouse in polite conversation."},

  {type:"match", pairs:[{trg:"おじさん",src:"uncle"},{trg:"おばさん",src:"aunt"},{trg:"いとこ",src:"cousin"},{trg:"まご",src:"grandchild"}]},

  {type:"match", pairs:[{trg:"おっと",src:"my husband"},{trg:"つま",src:"my wife"},{trg:"むすこ",src:"my son"},{trg:"むすめ",src:"my daughter"}]},

  {type:"fb", s:"こどもは{1}います。\n(I have two children.)", a:"ふたり", opts:["ふたり","ににん","ふたつ","にひき"], sSrc:"I have two children.",
  ...
  {type:"mc", q:"むすこ means:", opts:["my daughter","someone's son","my son","someone's daughter"], ans:"my son",
   hint:"The humble form for YOUR own male child."},

  {type:"fb", s:"{1}はなんにんいますか？\n(How many cousins do you have?)", a:"いとこ", opts:["いとこ","きょうだい","こども","まご"], sSrc:"How many cousins do you have?",
