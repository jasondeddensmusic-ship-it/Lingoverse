...
const BATCH10_L1 = {
  ...
  steps:[
    ...
    {type:"teach", trg:"推論(すいろん)", src:"reasoning", pos:"noun", gender:null,
     note:"推(すい) to infer + 論(ろん) argument.\nLogical inference, key in law and AI.",
    ...
    {type:"teach", trg:"仮説(かせつ)", src:"hypothesis", pos:"noun", gender:null,
     note:"仮(か) provisional + 説(せつ) theory.\nA testable proposal awaiting evidence.",
    ...
    {type:"teach", trg:"証明(しょうめい)", src:"proof", pos:"noun", gender:null,
     note:"証(しょう) proof + 明(めい) clear.\nDemonstration by evidence.",
    ...
    {type:"teach", trg:"前提(ぜんてい)", src:"premise", pos:"noun", gender:null,
     note:"前(ぜん) before + 提(てい) to present.\nThe starting assumption of an argument.",
    ...
    {type:"teach", trg:"機能(きのう)する", src:"to function", pos:"verb", gender:null,
     note:"機(き) mechanism + 能(のう) ability.\nNeutral verb for working as intended.",
    ...
    {type:"teach", trg:"客観的(きゃっかんてき)", src:"objective", pos:"adj", gender:null,
     note:"客観(きゃっかん) object-view + 的(てき) -ive.\nContrasts with 主観的 (subjective).",
    ...
    {type:"teach", trg:"主観的(しゅかんてき)", src:"subjective", pos:"adj", gender:null,
     note:"主観(しゅかん) subject-view + 的(てき) -ive.\nPersonal, experience-based viewpoint.",
    ...
    {type:"teach", trg:"傾向(けいこう)", src:"tendency", pos:"noun", gender:null,
     note:"傾(かたむ)く to lean + 向(む)く to face.\nA directional trend or inclination.",
