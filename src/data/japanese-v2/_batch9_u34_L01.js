...
const BATCH9_L1 = {
  ...
  steps:[
    ...
    {type:"teach", trg:"外交官(がいこうかん)", src:"diplomat", pos:"noun", gender:null,
     note:"外交(がいこう) diplomacy + 官(かん) official.\nMOFA career professional.",
    ...
    {type:"teach", trg:"条約(じょうやく)", src:"treaty", pos:"noun", gender:null,
     note:"条(じょう) article + 約(やく) agreement.\nRequires Diet ratification.",
    ...
    {type:"teach", trg:"多国間(たこくかん)", src:"multilateral", pos:"adj", gender:null,
     note:"多(た) many + 国(こく) country + 間(かん) between.\nG7, G20, APEC framework.",
    ...
    {type:"teach", trg:"協力(きょうりょく)", src:"cooperation", pos:"noun", gender:null,
     note:"協(きょう) together + 力(りょく) power.\nJICA is Japan's key cooperation agency.",
    ...
    {type:"teach", trg:"緊張(きんちょう)", src:"tension", pos:"noun", gender:null,
     note:"緊(きん) tight + 張(ちょう) to stretch.\nBoth diplomatic tension and personal nerves.",
    ...
    {type:"teach", trg:"制裁(せいさい)", src:"sanctions", pos:"noun", gender:null,
     note:"制(せい) to control + 裁(さい) to judge.\nEconomic or diplomatic punishment.",
    ...
    {type:"teach", trg:"紛争(ふんそう)", src:"conflict", pos:"noun", gender:null,
     note:"紛(ふん) disorder + 争(そう) conflict.\nArmed or political conflict.",
