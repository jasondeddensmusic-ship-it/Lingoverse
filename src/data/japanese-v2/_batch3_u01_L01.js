...
const BATCH3_L_1 = {
  id:"jav2_u1l_b3_1", title:"ていねいなことば", icon:"🙏", xp:15, board:true,
  steps:[
    ...
    {type:"teach", trg:"ちょっとまってください", src:"please wait a moment", pos:"verb", gender:null,
     note:"Polite request to wait. Casual: ちょっとまって.\nLiterally: please wait a little.",
     example:"A: ちょっとまってください。じゅんびします。\nB: はい、わかりました。",
    ...
    {type:"teach", trg:"もういちど", src:"one more time / again", pos:"adv", gender:null,
     note:"Essential classroom phrase. Used before ゆっくり for 'slowly one more time.'",
     example:"A: もういちどいってください。\nB: はい。こんにちは！",
    ...
    {type:"teach", trg:"ゆっくり", src:"slowly / at a leisurely pace", pos:"adv", gender:null,
     note:"A magic word for language learners. Combine with もういちど for best results.",
     example:"A: ゆっくりはなしてください。\nB: はい、もちろんです。",
    ...
    {type:"fb", s:"{1}はなしてください。(Please speak slowly.)",
     a:"ゆっくり",
    ...
    {type:"teach", trg:"しつもん", src:"question", pos:"noun", gender:null,
     note:"Used when asking to ask something: しつもんがあります (I have a question).\nKanji: 質問.",
     example:"A: しつもんがあります。\nB: はい、どうぞ。",
    ...
    {type:"teach", trg:"せいかい", src:"correct answer / right!", pos:"noun", gender:null,
     note:"What a teacher says for a correct answer. Opposite: ちがいます (incorrect).\nKanji: 正解.",
     example:"A: こたえはにほんですか？\nB: せいかいです！よくできました！",
    ...
    {type:"mc", q:"Which phrase would you use to ask a teacher to repeat something?",
     opts:["もういちどいってください","どうぞ","わかりました","せいかいです"],
     ans:"もういちどいってください",
    ...
    {type:"teach", trg:"どうぞよろしく", src:"pleased to meet you (casual)", pos:"intj", gender:null,
     note:"Casual version of よろしくお願いします. Used among peers and in informal settings.",
    ...
    {type:"teach", trg:"おねがいします", src:"I humbly request / please (requesting a person)", pos:"verb", gender:null,
     note:"Slightly different nuance from お願いします for objects. Directed at a person when asking for help or a favor.",
     example:"A: さとうさん、てつだってください。\nB: はい、おねがいします？なにをしますか？",
    ...
    {type:"fb", s:"しつもんが{1}。(I have a question.)",
     a:"あります",
    ...
    {type:"match", pairs:[
      ...
      {trg:"こたえ", src:"answer"},
      {trg:"せいかい", src:"correct answer"},
      {trg:"どうぞ", src:"go ahead / here you go"}
    ]},

    {type:"mc", q:"せいかい means:", opts:["question","correct answer","please wait","I understand"],
     ans:"correct answer",
