...
const BATCH3_L_1 = {
  id:"jav2_u4l_b3_1", title:"みせとおかいもの", icon:"🏪", xp:15, board:true,
  steps:[
    {type:"intro", title:"みせとおかいもの",
    ...
    {type:"teach", trg:"みせ", src:"shop / store", pos:"noun", gender:null,
     note:"General word for any shop or store. Can combine with items: パンや (bread shop).\nKanji: 店.",
    ...
    {type:"teach", trg:"ほんや", src:"bookstore", pos:"noun", gender:null,
     note:"ほん (book) + や (shop). One of the most common shop-name patterns in Japanese.\nKanji: 本屋.",
     example:"A: ちかくにほんやはありますか？\nB: はい、えきのとなりにあります。",
    ...
    {type:"teach", trg:"くすりや", src:"pharmacy / drugstore", pos:"noun", gender:null,
     note:"くすり (medicine) + や (shop). Also called ドラッグストア (drug store).\nKanji: 薬屋.",
     example:"A: くすりやはどこにありますか？\nB: スーパーのとなりです。",
    ...
    {type:"fb", s:"{1}でたまごをかいます。(I will buy eggs at the supermarket.)",
     a:"スーパー",
     opts:["スーパー","コンビニ","デパート","ほんや"],
    ...
    {type:"teach", trg:"おつり", src:"change (money returned)", pos:"noun", gender:null,
     ...
     example:"A: せんえんをわたすと、おつりはいくらですか？\nB: ごひゃくえんです。",
    ...
    {type:"mc", q:"おつり means:", opts:["receipt","credit card","discount","change (money returned)"],
    ...
    {type:"teach", trg:"しめて", src:"total / grand total", pos:"verb", gender:null,
     note:"What a cashier says before giving you the total amount. From 締める (to total up).",
     example:"A: しめて、せんはっぴゃくえんです。\nB: はい。",
