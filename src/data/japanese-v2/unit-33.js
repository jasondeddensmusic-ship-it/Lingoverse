...
{id:"jav2_u33l1", title:"Literary Vocabulary", icon:"✍️", xp:15, board:true, steps:[
  ...
  {type:"teach", trg:"文学(ぶんがく)", src:"literature", pos:"noun", gender:null,
   note:"Kanji: 文学. 文学作品(ぶんがくさくひん) = literary work.\n文学史(ぶんがくし) = literary history.",
   example:"A: 日本文学(にほんぶんがく)で一番(いちばん)有名(ゆうめい)な作品(さくひん)は何(なん)ですか？\nB: 源氏物語(げんじものがたり)は世界最古(せかいさいこ)の長編小説(ちょうへんしょうせつ)と呼(よ)ばれています。\nA: その分野(ぶんや)についてどのくらいご存(ぞん)じですか？\nB: 専門(せんもん)ではありませんが、基本的(きほんてき)な知識(ちしき)はあります。\nA: もっと詳(くわ)しく知(し)りたい場合(ばあい)は、どうすればいいですか？\nB: 専門家(せんもんか)に相談(そうだん)するか、関連(かんれん)の書籍(しょせき)を読(よ)むことをお勧(すす)めします。",
  ...
  {type:"teach", trg:"作家(さっか)", src:"author / writer", pos:"noun", gender:null,
  ...
  {type:"teach", trg:"小説(しょうせつ)", src:"novel / fiction", pos:"noun", gender:null,
   note:"Kanji: 小説. 短編小説(たんぺんしょうせつ) = short story.\n長編小説(ちょうへんしょうせつ) = full-length novel.",
   example:"A: この小説(しょうせつ)は実話(じつわ)に基(もと)づいています。\nB: ノンフィクションのような小説(しょうせつ)ですね。\nA: 具体的(ぐたいてき)にはどういうことですか？\nB: つまり、状況(じょうきょう)に応(おう)じて対応(たいおう)を変(か)える必要(ひつよう)があるということです。\nA: なるほど。それは確(たし)かにそうですね。\nB: ええ、柔軟(じゅうなん)な対応(たいおう)が大切(たいせつ)だと思(おも)います。",
  ...
  {type:"mc", q:"長編小説(ちょうへんしょうせつ) means:", opts:["full-length novel","short story","poem collection","essay"], ans:"full-length novel",
  ...
  {type:"teach", trg:"詩(し)", src:"poem / poetry", pos:"noun", gender:null,
   note:"Kanji: 詩. 詩人(しじん) = poet. 詩歌(しか) = poetry (the art).\nDistinct from 俳句(はいく) (haiku) and 短歌(たんか) (tanka).",
   example:"A: 日本(にほん)の詩(し)は自然(しぜん)をテーマにしたものが多(おお)いです。\nB: 俳句(はいく)も短歌(たんか)も季節(きせつ)の言葉(ことば)が大事(だいじ)ですよね。\nA: それについてもう少(すこ)し詳(くわ)しく教(おし)えてください。\nB: 例(たと)えば、最近(さいきん)の事例(じれい)を見(み)ると、変化(へんか)が激(はげ)しいです。\nA: そうですか。どう対処(たいしょ)すればいいでしょうか。\nB: まず現状(げんじょう)を把握(はあく)してから、計画(けいかく)を立(た)てましょう。",
   ...
   funFact:"詩 uses 言 (words) and 寺 (temple), suggesting sacred or elevated words. Japanese poetic forms include 俳句(はいく) (5-7-5 syllables), 短歌(たんか) (5-7-5-7-7), and modern free verse (自由詩(じゆうし)). The 季語 (きご, seasonal word) is mandatory in traditional haiku, connecting each poem to the natural world."},

  {type:"teach", trg:"表現(ひょうげん)", src:"expression / way of expressing", pos:"noun", gender:null,
   note:"Kanji: 表現. 表現(ひょうげん)する = to express.\n表現力(ひょうげんりょく) = expressive ability.",
   example:"A: この作家(さっか)の表現(ひょうげん)はとても豊(ゆた)かです。\nB: 言葉(ことば)の選(えら)び方(かた)が美(うつく)しいですよね。\nA: どのような方法(ほうほう)がありますか？\nB: いくつかの選択肢(せんたくし)があります。一番(いちばん)効果的(こうかてき)なのは実践(じっせん)です。\nA: 実践(じっせん)というのは、具体的(ぐたいてき)に何(なに)をすればいいですか？\nB: 毎日(まいにち)少(すこ)しずつ取(と)り組(く)むことが重要(じゅうよう)です。",
  ...
  {type:"teach", trg:"古典(こてん)", src:"classic / classical work", pos:"noun", gender:null,
   ...
   example:"A: 古典文学(こてんぶんがく)を読(よ)むのは難(むずか)しいですか？\nB: 言葉(ことば)が古(ふる)いので最初(さいしょ)は大変(たいへん)ですが、慣(な)れれば楽(たの)しいです。\nA: 何(なに)か問題(もんだい)はありませんでしたか？\nB: いくつか課題(かだい)がありましたが、解決(かいけつ)しました。\nA: どのように解決(かいけつ)したのですか？\nB: チーム全体(ぜんたい)で話(はな)し合(あ)って、最善(さいぜん)の方法(ほうほう)を見(み)つけました。",
  ...
  {type:"match", pairs:[{trg:"作家(さっか)",src:"author"},{trg:"小説(しょうせつ)",src:"novel"},{trg:"詩(し)",src:"poem"},{trg:"物語(ものがたり)",src:"tale/narrative"}]},

  {type:"fb", s:"日本文学(にほんぶんがく)の{1}をおすすめしてください。\n(Please recommend a masterpiece of Japanese literature.)", a:"名作(めいさく)", opts:["名作(めいさく)","古典(こてん)","文学(ぶんがく)","小説(しょうせつ)"], sSrc:"Please recommend a masterpiece of Japanese literature.",
...
{id:"jav2_u33l2", title:"Narrative & Criticism", icon:"📝", xp:15, board:true, steps:[
  ...
  {type:"teach", trg:"主題(しゅだい)", src:"theme / subject / motif", pos:"noun", gender:null,
   ...
   example:"A: この小説(しょうせつ)の主題(しゅだい)は何(なん)だと思(おも)いますか？\nB: 人間(にんげん)の孤独(こどく)とつながりだと思(おも)います。\nA: 他(ほか)に何(なに)か気(き)をつけることはありますか？\nB: はい、期限(きげん)を守(まも)ることが一番(いちばん)大切(たいせつ)です。\nA: 期限(きげん)に間(ま)に合(あ)わない場合(ばあい)はどうしますか？\nB: 早(はや)めに上司(じょうし)に相談(そうだん)して、調整(ちょうせい)をお願(ねが)いします。",
   ...
   funFact:"主題 uses 主 (main/master) and 題 (topic/title). In Japanese literary analysis, identifying the 主題(しゅだい) is the first step in understanding a work. Many famous Japanese novels explore themes of isolation (孤独(こどく)), impermanence (無常(むじょう)), and the tension between duty (義理(ぎり)) and personal feeling (人情(にんじょう))."},
  ...
  {type:"teach", trg:"主人公(しゅじんこう)", src:"protagonist / main character", pos:"noun", gender:null,
   ...
   funFact:"主人公 breaks down as 主人 (master/owner) and 公 (public/lord). In Japanese storytelling tradition, the 主人公(しゅじんこう) often starts from a humble or ordinary position. The concept of the 'reluctant hero' is especially common in Japanese narratives, from folk tales like 桃太郎(ももたろう) to modern anime protagonists."},

  {type:"teach", trg:"伏線(ふくせん)", src:"foreshadowing / plot setup", pos:"noun", gender:null,
   note:"Kanji: 伏線. 伏線(ふくせん)を張(は)る = to plant foreshadowing.\n伏線回収(ふくせんかいしゅう) = resolving foreshadowing.",
   example:"A: 最初(さいしょ)の章(しょう)にあった伏線(ふくせん)が最後(さいご)に回収(かいしゅう)されました。\nB: 見事(みごと)なストーリーテリングですね。\nA: 以前(いぜん)と比(くら)べてどう変(か)わりましたか？\nB: かなり改善(かいぜん)されました。効率(こうりつ)が上(あ)がりました。\nA: その改善(かいぜん)の要因(よういん)は何(なん)ですか？\nB: 新(あたら)しいシステムの導入(どうにゅう)が大(おお)きかったです。",
   ...
   funFact:"伏線 uses 伏 (lie hidden/prostrate) and 線 (line/thread). Foreshadowing is a 'hidden thread' running through the story. In manga and anime culture, 伏線回収(ふくせんかいしゅう) (resolving foreshadowing) is extremely valued. Fans eagerly discuss how early plot details connect to later revelations. Oda Eiichiro's One Piece is famous for 伏線(ふくせん) planted decades earlier."},

  {type:"mc", q:"伏線(ふくせん)を張(は)る means:", opts:["to plant foreshadowing","to resolve a conflict","to introduce a character","to write a conclusion"], ans:"to plant foreshadowing",
  ...
  {type:"teach", trg:"展開(てんかい)", src:"development / unfolding (of a plot)", pos:"noun", gender:null,
   ...
   funFact:"展開 uses 展 (exhibit/spread) and 開 (open). A story 'spreads open.' Japanese narrative structure often follows 起承転結(きしょうてんけつ) (起承転結): introduction (起), development (承), twist (転), and conclusion (結). This four-part structure comes from Chinese poetry but has been adapted for all forms of Japanese storytelling."},

  {type:"teach", trg:"視角(しかく)", src:"point of view / perspective (narrative)", pos:"noun", gender:null,
   note:"Kanji: 視角. Also: 視点(してん) (視点, viewpoint).\n一人称視点(いちにんしょうしてん) = first-person perspective.",
   example:"A: この小説(しょうせつ)は誰(だれ)の視角(しかく)で語(かた)られていますか？\nB: 主人公(しゅじんこう)の一人称視点(いちにんしょうしてん)です。\nA: 何(なに)か良(よ)い方法(ほうほう)はありませんか？\nB: 一(ひと)つ提案(ていあん)があります。段階的(だんかいてき)に進(すす)めてはどうでしょうか。\nA: 段階的(だんかいてき)に、というのはどういうことですか？\nB: まず小規模(しょうきぼ)で試(ため)してから、徐々(じょじょ)に拡大(かくだい)するということです。",
  ...
  {type:"teach", trg:"孤独(こどく)", src:"loneliness / solitude / isolation", pos:"noun", gender:null,
   ...
   funFact:"孤独 uses 孤 (orphan/alone) and 独 (solitary/single). Both characters emphasize being alone. 孤独(こどく) is one of the most explored themes in Japanese literature, from Natsume Soseki's こころ (Kokoro) to Murakami Haruki's works. The modern phenomenon of 孤独死(こどくし) (solitary death) has also become a subject of contemporary fiction."},
  ...
  {type:"teach", trg:"批評(ひひょう)", src:"criticism / critique / review", pos:"noun", gender:null,
   note:"Kanji: 批評. 批評家(ひひょうか) = critic / reviewer.\n文学批評(ぶんがくひひょう) = literary criticism.",
   example:"A: この作品(さくひん)に対(たい)する批評(ひひょう)はさまざまです。\nB: 批評家(ひひょうか)によって評価(ひょうか)が分(わ)かれていますね。\nA: それは興味深(きょうみぶか)いですね。\nB: ええ、日本(にほん)ならではの特徴(とくちょう)だと思(おも)います。\nA: 海外(かいがい)ではどうなのでしょうか？\nB: 国(くに)によって異(こと)なりますが、共通(きょうつう)する部分(ぶぶん)もあります。",
  ...
  {type:"teach", trg:"作品(さくひん)", src:"work (of art/literature)", pos:"noun", gender:null,
   note:"Kanji: 作品. 代表作(だいひょうさく) = representative work.\nUsed for novels, art, music, film.",
   ...
   funFact:"作品 combines 作 (make) and 品 (article/goods). In Japanese literary culture, an author's 代表作(だいひょうさく) (representative work) defines their legacy. Kawabata Yasunari's 雪国(ゆきぐに) (Snow Country), which opens with one of the most famous sentences in Japanese literature, was cited in his Nobel Prize selection."},
  ...
  {type:"match", pairs:[{trg:"主題(しゅだい)",src:"theme"},{trg:"主人公(しゅじんこう)",src:"protagonist"},{trg:"伏線(ふくせん)",src:"foreshadowing"},{trg:"展開(てんかい)",src:"plot development"}]},

  {type:"fb", s:"この作家(さっか)の{1}は何(なん)ですか？\n(What is this author's representative work?)", a:"代表作(だいひょうさく)", opts:["代表作(だいひょうさく)","主題(しゅだい)","批評(ひひょう)","名作(めいさく)"], sSrc:"What is this author's representative work?",
