...
{id:"jav2_u16l2", title:"ために", icon:"🏁", xp:15, board:true, steps:[
  ...
  {type:"match", pairs:[{trg:"ために",src:"in order to"},{trg:"夢(ゆめ)",src:"dream"},{trg:"将来(しょうらい)",src:"future"},{trg:"になる",src:"to become"},{trg:"必要(ひつよう)",src:"necessary / needed"}]},
