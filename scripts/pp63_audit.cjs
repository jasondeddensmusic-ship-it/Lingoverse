...
const FUNCTION_WORDS = {
  ...
  'ru': new Set([
    ...
    'это','этот','эта','эту','эти','этого','этой','этому','этим','этих','этими','этом',
    ...
    // друг (friend) — taught unit-03; nominative + all case forms
    'друг','друга','другу','другом','друге','друзей','друзьям','друзьями','друзьях',
    // подруга (female friend) — taught unit-03; case forms
    'подруги','подруге','подругу','подругой','подруг',
    // сосед (neighbor m) — taught unit-03; case forms
    'сосед','соседа','соседу','соседом','соседе','соседей','соседям','соседями','соседях','соседка','соседки','соседке','соседку','соседкой',
    // человек (person) — taught unit-03; case forms (plural: люди — whitelisted separately)
    'человека','человеку','человеком','человеке','люди','людей','людям','людьми','людях',
    // мужчина (man) — taught unit-03; case forms
    'мужчины','мужчине','мужчину','мужчиной','мужчин','мужчинам','мужчинами','мужчинах',
    // женщина (woman) — taught unit-03; case forms
    'женщины','женщине','женщину','женщиной','женщин','женщинам','женщинами','женщинах',
    // знакомый (acquaintance m) — taught unit-03; case forms
    'знакомого','знакомому','знакомым','знакомом','знакомая','знакомой','знакомую','знакомых','знакомым','знакомыми',
