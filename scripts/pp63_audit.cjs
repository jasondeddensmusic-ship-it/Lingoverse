...
const FUNCTION_WORDS = {
  ...
  'ja': new Set([
    // -- Core particles & copula --
    'は','が','を','に','で','と','の','も','か','へ','や','から','まで','より','こそ',
    'さえ','だけ','しか','です','ます','だ','である','ない','ある','いる','する','なる',
    'できる','この','その','あの','どの','これ','それ','あれ','どれ','ここ','そこ',
    'あそこ','どこ','いつ','なに','なん','だれ','どう','なぜ','どうして',
    // -- Extended particles / conjunctions / discourse markers --
    'けど','けれど','けれども','ので','のに','ても','でも','しかし','または','あるいは',
    'たり','ながら','について','として','ために','によって','において','にとって',
    'という','といっても','というか','ていう','って','とか','など','とも','ほど',
    'さらに','また','そして','したがって','つまり','なお','ただし','すなわち',
    'ところで','ちなみに','それで','それでも','それなのに','そのため','そこで',
    'ところが','まず','次に','最後に','さて','では','じゃあ','じゃ',
    'ええ','ああ','うん','うーん','ええと','そうですね','そうですか',
    // -- Common verbs (inflected forms) --
    'います','いました','いません','いましたか','いますか','いましょう',
    'いて','いても','いれば','いない','いなかった',
    'します','しました','しません','しましたか','しますか','しましょう','した',
    'して','しても','すれば','しない','しなかった','している','していた',
    'しています','していました',
    'あります','ありました','ありません','ありましたか','ありますか',
    'あって','あれば','なかった',
    'きます','きました','きません','きましたか','きますか','きましょう',
    'きて','きても','くれば','こない','こなかった',
    'いきます','いきました','いきません','いきましたか','いきますか','いきましょう',
    'いって','いっても','いけば','いかない','いかなかった',
    'たべます','たべました','たべません','たべましたか','たべますか','たべましょう',
    'たべて','たべても','たべれば','たべない','たべなかった',
    'のみます','のみました','のみません','のみましたか','のみますか','のみましょう',
    'のんで','のんでも','のめば','のまない','のまなかった',
    'みます','みました','みません','みましたか','みますか','みましょう',
    'みて','みても','みれば','みない','みなかった',
    'ききます','ききました','ききません','ききましたか','ききますか','ききましょう',
    'きいて','きいても','きけば','きかない','きかなかった',
    'はなします','はなしました','はなせません','はなせますか','はなせます',
    'よみます','よみました','よめます','よめません',
    'かきます','かきました','かけます','かけません',
    'かいます','かいました','かってきました','かいましょう',
    'つかいます','つかいました','つかえます','つかえません',
    'おしえます','おしえました','おしえてください',
    'べんきょうします','べんきょうしました','べんきょうしましょう',
    'はたらきます','はたらきました','はたらいています','はたらいていました',
    'はじめます','はじめました','はじめましょう',
    'おわります','おわりました','おわりましょう','おわりましたか',
    'かえります','かえりました','かえりましょう','かえりますか',
    'まちます','まちました','まちましょう','まってください',
    'わかります','わかりました','わかりません','わかりましたか',
    'おぼえます','おぼえました','おぼえていますか',
    'わすれます','わすれました',
    'かんがえます','かんがえました','かんがえましょう','かんがえていますか',
    'おもいます','おもいました','おもいますか',
    'しっています','しりました','しりません','しっていますか',
    'もちます','もちました','もっています','もっていますか',
    'はいります','はいりました','はいりましょう',
    'でます','でました','でましょう',
    'あいます','あいました','あいましょう',
    'つくります','つくりました','つくりましょう',
    'のります','のりました','のりましょう',
    'おります','おりました','おりましょう',
    'よびます','よびました','よびましょう',
    'おくります','おくりました',
    'がんばります','がんばりました','がんばりましょう','がんばってください',
    'がんばって','がんばっています',
    'しつれいします','しつれいしました',
    'よろしくおねがいします','よろしくおねがいいたします',
    // -- Common i-adjective forms --
    'いい','よい','いいです','よかった','よくない','よくなかった',
    'おおきい','おおきな','おおきく','おおきくない','おおきかった',
    'ちいさい','ちいさな','ちいさく','ちいさくない','ちいさかった',
    'あたらしい','あたらしく','あたらしかった',
    'ふるい','ふるく','ふるかった',
    'おおい','おおく','おおかった',
    'すくない','すくなく','すくなかった',
    ...
    'たいせつ','たいせつな','たいせつに','たいせつです',
    'だいじ','だいじな','だいじに','だいじです',
    'ふくざつ','ふくざつな','ふくざつに','ふくざつです',
    'かんたん','かんたんな','かんたんに','かんたんです',
    'べんり','べんりな','べんりに','べんりです',
    'ふべん','ふべんな','ふべんに',
    'ひつよう','ひつような','ひつように','ひつようです',
    'じゅうよう','じゅうような','じゅうように','じゅうようです',
    'たいへん','たいへんな','たいへんに','たいへんです',
    'しんぱい','しんぱいな','しんぱいに','しんぱいです',
    'ざんねん','ざんねんな','ざんねんに','ざんねんです',
    'あんぜん','あんぜんな','あんぜんに','あんぜんです',
    'きけん','きけんな','きけんに','きけんです',
    'ゆうめい','ゆうめいな','ゆうめいに','ゆうめいです',
    'とくべつ','とくべつな','とくべつに','とくべつです',
    'ふつう','ふつうの','ふつうに','ふつうです',
    'じゅうぶん','じゅうぶんな','じゅうぶんに',
    'じょうず','じょうずな','じょうずに','じょうずです',
    'げんき','げんきな','げんきに','げんきです',
    'きれい','きれいな','きれいに','きれいです',
    'しずか','しずかな','しずかに','しずかです',
    'にぎやか','にぎやかな','にぎやかに',
    'しあわせ','しあわせな','しあわせに','しあわせです',
    'むり','むりな','むりに','むりです',
    'だめ','だめな','だめです',
    'だいじょうぶ','だいじょうぶな','だいじょうぶです',
    'すき','すきな','すきです','きらい','きらいな','きらいです',
    'じゆう','じゆうな','じゆうに',
    // -- -teki adjectives --
    'ぐたいてき','ぐたいてきな','ぐたいてきに',
    'ぜんたいてき','ぜんたいてきな','ぜんたいてきに',
    'きほんてき','きほんてきな','きほんてきに',
    'せんもんてき','せんもんてきな','せんもんてきに',
    'こうかてき','こうかてきな','こうかてきに',
    'だんかいてき','だんかいてきな','だんかいてきに',
    'りろんてき','りろんてきな','りろんてきに',
    'ろんりてき','ろんりてきな','ろんりてきに',
    'せかいてき','せかいてきな','せかいてきに',
    'りんりてき','りんりてきな','りんりてきに',
    'しゃかいてき','しゃかいてきな','しゃかいてきに',
    'けいざいてき','けいざいてきな','けいざいてきに',
    'せいじてき','せいじてきな','せいじてきに',
    'どくそうてき','どくそうてきな','どくそうてきに',
    'そうぞうてき','そうぞうてきな','そうぞうてきに',
    // -- Common adverbs and discourse markers --
    'もう','まだ','もっと','ずっと','もちろん','やはり','やっぱり',
    'ちょっと','すこし','すこしずつ','たくさん','あまり','ぜんぜん',
    'よく','いつも','ときどき','たまに','すぐ','すでに','そのあと',
    'ひとり','ふたり','みんな','いつか','いつでも','どんな','どんなに',
    'とても','すごく','かなり','なかなか','ほとんど','だいたい','たしか',
    'ぜひ','きっと','おそらく','たぶん','もしかして','やっと','ようやく',
    'どうぞ','どうか','さすが','なるほど','なんと',
    'ほんとう','ほんとうに','ほんとうですか',
    'なんとか','まあ','まあまあ','とにかく',
    // -- Time words --
    'きょう','あした','あさって','きのう','おととい','あさ','ひる','よる','ばん',
    'いま','さっき','あとで','まいにち','まいあさ',
    'まいばん','まいとし','まいしゅう','こんしゅう','らいしゅう','せんしゅう',
    'こんげつ','らいげつ','せんげつ','ことし','らいねん','きょねん',
    'こんど','このあいだ','さいきん','しょうらい','しばらく','まもなく',
    'もうすぐ','ついさっき','こんしゅうちゅう',
    // -- Common response / greeting expressions --
    'そうですね','そうですか','そうです','ありがとうございます','ありがとう',
    'どうぞよろしく','すみません','もうしわけありません','おねがいします',
    'どうぞ','はい','いいえ','なるほど','わかりました',
    'かしこまりました','しょうちしました','りょうかいしました',
    // -- Common nouns --
    'もの','こと','とき','ところ','ひと','かた','なか','まえ','あと','うえ','した',
    'みぎ','ひだり','となり','ちかく','とおく','あいだ','ほか','べつ',
    'おかあさん','おとうさん','かぞく','かあさん','とうさん','おにいさん','おねえさん',
    'おとうと','いもうと','そぼ','そふ','おばあさん','おじいさん','ともだち',
    'まち','くに','うみ','やま','かわ','こうえん','えき','みせ',
    'いえ','うち','かいしゃ','がっこう','びょういん',
    'しごと','べんきょう','りょこう','かいもの','りょうり','スポーツ','おんがく',
    'えいが','ほん','しんぶん','ざっし','テレビ','でんわ',
    'きゅうか','やすみ','しゅうまつ','けいかく','よてい','もくひょう',
    'もんだい','かいけつ','けっか','りゆう','もくてき','ほうほう','じかん',
    'ばあい','ちがい','えいきょう','へんか','はったつ','じょうきょう','かんきょう',
    'しゃかい','けいざい','せいじ','ぶんか','れきし','ぎじゅつ','かがく',
    'きょういく','いりょう','けんこう','しぜん','ちきゅう','せかい',
    // -- Auxiliary/modal expression patterns --
    'てください','てもいいですか','てもいい','なければなりません',
    'なくてはなりません','なくてもいい','ようにしています','ようにしましょう',
    'ことができます','ことができません','ことができました','ことができましたか',
    'ことになりました','ことになっています','ことにしました','ことにしています',
    'ていただけますか','ていただければ',
    'ていただきました','てもらいました','てあげました','てあげます',
    'てしまいました','てしまいます','てしまって','てしまった',
    'てみました','てみます','てみましょう','てみてください',
    'ておきます','ておきました','ておいてください',
    'ておく','ている','ていた','ていて','ていない','ていなかった',
    'てから','たあとで','てすぐ',
    'たことがあります','たことがありません','たことがありますか',
    'ているところです','たところです',
    'そうです','らしいです','ようです','みたいです','はずです',
    'でしょう','だろう','だろうか','かもしれません','かもしれない',
    'にちがいありません','にちがいない','はずがない','わけがない',
    // -- Verb-ending fragment tokens --
    'えましょう','きましょう','しましょう','めましょう','りましょう',
    'ちましょう','びましょう','いましょう','てましょう','れましょう',
    'えませんか','きませんか','しませんか','めませんか','りませんか',
    'ちませんか','びませんか','いませんか',
    'えますか','きますか','しますか','めますか','りますか','ちますか','びますか',
    'りました','きました','しました','えました','びました',
    'れました','めました','ちました','いました',
    'りません','きません','しません','えません','びません',
    'れません','めません','ちません','いません',
    'りましたか','きましたか','しましたか','えましたか','びましたか',
    'れましたか','めましたか','ちましたか','いましたか',
    'でしたか','でしたね','ましたか',
    // -- Furigana readings of common kanji+furigana vocab --
    'せんせい','がくせい','かいしゃいん','にほんご','べんごし','だいがくせい',
    'だいがく','なまえ','でんしゃ','ひこうき','しんかんせん',
    'ゆうびんきょく','ちかてつ','こうさてん','しんごう',
    // -- Numbers and counters --
    'いち','さん','よん','ろく','なな','しち','はち','きゅう','じゅう',
    'ひゃく','せん','まん','おく','いくら','なんえん','なんじ','なんぷん',
    'なんにん','なんまい','なんほん','なんさい','なんかい','なんかげつ','なんねん',
    'ひとつ','ふたつ','みっつ','よっつ','いつつ','むっつ','ななつ','やっつ',
    'ここのつ','とお','いっさつ','にさつ','さんさつ','にかい','さんかい',
    'いっぱい','にはい','さんばい','いっこ','にこ','さんこ','よんこ',
    'いちにち','ふつか','みっか','よっか','むいか','なのか','ようか',
    'ここのか','とおか','じゅうよっか','はつか','にじゅうよっか','ついたち',
    'いちじかん','にじかん','さんじかん','よじかん','ごじかん',
    'いっぷん','ごふん','じゅっぷん','ろくじ','しちじ','はちじ','くじ','じゅうじ',
    'じゅういちじ','じゅうにじ','いちじ','にじ','さんじ','よじ','ごじ',
    'いちまい','にまい','さんまい','よんまい','ごまい',
    'いちまん','にまん','さんまん','ひゃくまん','いちおく',
    // -- Proper nouns frequently used in examples --
    'たなか','すずき','さとう','やまだ','やまもと','いとう','わたなべ','なかむら',
    'おかもと','よしだ','まつもと','きむら','はやし','さかもと','いのうえ',
    'にほん','ちゅうごく','かんこく',
    'とうきょう','おおさか','きょうと','なごや','さっぽろ','ふくおか',
    'よこはま','こうべ','ひろしま','ほっかいどう','おきなわ',
    'ふじさん','しぶや','はらじゅく','うえの','あきはばら','ぎんざ',
    // -- Top offenders from audit (5+ occurrences) --
    'だいじ','こんご','じゅうよう','ともだち','たいへん','きょねん',
    'いちばん','いっしょう','きょうみ','じもと','ほんとう','あした',
    'ぶんや','ぜんいん','じゅんちょう','よそうがい','かんりょう',
    'じれい','きげん','いっかい','ぐたいてき','きょうみぶか','せんたくし',
    'じぜん','ぜんたいてき','せんもん','すうねんまえ','めいぶつ',
    'だいじょうぶ','いぜん','かせいただけますか','せつめい','かいがい',
    'しゃかいぜんたい','こうかてき','いちぶ',
    'よういん','ちょうせい','とくちょう',
    'よそう','じぶん','じっせん','けっか',
    'ほうほう','かんけいしゃ',
    ...
    'べんり','ちゅうもく','かくほ','けいかく',
    'うつく','どうでしたか','せいど','じだい',
    'たいせつ','かいぜん','ごがくりょく','こうじょう',
    'おもしろ','りょうほう','りかい',
    'ひんしつ','でんわ','ちしき','じょうず','じゅうなん',
    'くるま','おこな','りましたね','みましょう',
    'まれました','ないよう','どうこう','つうじょう','だいす',
    'じゅんび','さいしょ','もちろん','しんぽ','しゅうまつ','こころ',
    'こうれいしゃ','かんきょうもんだい','かつよう',
    'じゅっぷん','ちゅうい','ばしょ',
    'もっと','よかった','よやく','ゆうき','まいとし',
    'せいかく','こども','こちらこそ','おとな','えいご','えいが','あんぜんせい',
    'きほんてき','きほん','かんきょう',
    'こんしゅうちゅう','かんけいしゃ','こうちょう',
    'かいがい',
    'せいど','じだい','ばあい','ないよう','ほうほう','じもと','めいぶつ',
    'ぶんや','せんもん','ゆうめい','だいじょうぶ','りかい',
    'しんぽ','こころ','さいしょ','かつよう','おこな','いましたか',
    // -- Kanji+kana compound tokens produced by tokenizer --
    'が必要','が大切','が大事','が重要','が上手','が有名','が課題','が問題',
    '具体的','全体的','基本的','効果的','段階的','社会全体','チーム全体',
    'チーム全員','解決策','語学力','関係者','今週中','数年前','洗濯物',
    '大丈夫','富士山','環境問題','契約書','支持率','失業率','裁判所',
    '源氏物語','村上春樹','平和的','iPS細胞',
    // -- Compound context strings from tokenizer --
    'ぜひ行','また行','よく行','ぐらい行','ぜひ試','ぜひ参加',
    'とても良','とても楽','いい経験','いい思','いい友達','いい方法','いい影響',
    'じゃあ、今度','ええ、日本',
    'がありましたか','がありましたが','がありました','がありますか',
    'ことがわかった','ことができた','ことになった','ことにした',
    'むと思','だと思','のと思',
    'し検討','し説明','しく教','すると予想',
    'をお聞','をお願',
    'かせいただけますか','ていただけますか',
    'かを学','かを考','かを確認','かを把握',
    'える必要','ある必要','する必要',
    'な知識','な対応','な問題','な社会','な判断','な協力','な準備',
    'きな影響','きな課題','きな問題','きな変化',
    'い影響','い方法','い方向','い機会','い経験','い思',
    'わない場合','ない場合',
    'と計画','と予定',
    'して対応','じて対応','して準備','じて準備',
    'を向上','を改善','を達成','を確認','を把握',
    'を削減','を増加','を維持','を推進',
    'に対応','に対して','に関して','について','において',
    'まず現状','まず小規模','まず一つ','まず基本',
    'っていきましょう','っていこう',
    'かなり改善','かなりよく',
    'でもいい勉強','でもいい経験','でもいい機会',
    'も興味','らしい結果','ご意見','な問題',
    'を大切','を向上','をどう思',
    'をします','をしました','をしましょう','をしてください',
    'をつけます','をつけましょう','をつけてね',
    'だいいっぽ','こくみん','せんご','せいひん',
    'しょくりょうひん','しょくば','しょうがっこう',
    'ごふん','こども',
    'えいきょう','ぶぶん',
    'よやく','へいわてき','ふじゅうぶん',
    'ないよう','なんばんせん','てがみ','つくえ',
    ...
    'むすこ','むすめ','きょうだい',
    'どちら','どちらか','どちらの','どちらも',
    'しんこく','じょうしょう','しつぎょうりつ','しじりつ',
    'さいかどう','じゅうみん','せいたいけい','たようせい',
    'ほぜん','はいき','かだい','とりくむ','しょうひしゃ',
    'きせい','じょうやく','もくひょう','たっせい','ふかけつ',
    'こくさいきょうりょく','こうけん',
    'じっけん','さいげんせい','かせつ',
    'えがく','せつない','もののあわれ','はかない',
    'きんり','にちぎん','えんやす','えんだか','きんゆう','かわせ','ふあんてい',
    'ざいせい','ぜいきん','こくさい','こよう','きゅうじん','けいきしげき','ろうどうりょく',
    'こうれいか','ぼうえき','きょうてい','かんぜい','こんらん',
    'きょうそうりょく','ぶひん','はんどうたい',
    'きこうへんどう','さいせいかのうエネルギー','はいしゅつりょう','たいようこう','さくげん',
    'げんしりょく','じぞくかのう',
    'たんきてき','げんいん','ちょうさ','しんちょう','せっきょくてき',
    'さいきん',
    'だいたい二時間','だいたい一時間','と一緒','と一緒に',
    // -- Second batch: remaining high-frequency tokens --
    'かんが','が一番','か問題','しずつ取','もっと詳','べましたか','つ提案',
    'べました','なりますが','と異文化理解','ていど','する部分','を検討',
    'わりましたか','つけました','じでしたか','まず情報収集','じょうほうしゅうしゅう',
    'が不可欠','がりました','しく知','しょうきぼ','と人員','かくだい',
    'いぶんかりかい','りたい場合','す必要','じんいん','専門家','たいしょ',
    'じょうし','こうりつ','きょうつう','一週間','いっしゅうかん','を勉強',
    'せんもんか','じんざい','じょじょ','をしますか','べます','ぶんせき',
    'するか','を目指','どうなると思','かりました','べてどう変','どんな感',
    'どう対処','でお願','てんぼう','が急務','いくつか課題','たいおう',
    'どりょく','そうだん','しんちょく','えます','まります','で一番',
    'そうぞう','しなければなりません','けます','お名前','お仕事','れます',
    'られました','ましょう','ました','べますか','びょうき','ちます','せだい',
    'げます','けんとう','が深刻','が期待','まりましたか','じんせい','した方',
    'けました','けて悔','くなりました','何番線','を請求','を分析','れますね',
    'れてしまいました','もそう思','ますか','べましょう','へいわしゅぎ',
    'びます','ない国','できますよ','でおねがいします','せます','する人',
    'すぎます','しますね','しましたね','けますか','けしき','きょうか','が心配',
    'ができますか','いっこく',
    // -- Kanji compound tokens from tokenizer (second batch) --
    '高齢者','電気代','金閣寺','誕生日','日本文学','平和主義','安全性',
    '専門家','を説明','を理解','を拝見','を尊重','をもらいましたか','をお持',
    'わりあい','ろくがつ','るかもしれません','りょうこく','りますね','りが近',
    'ゆうしゅう','も残業','も大切','まりません','まちが','ぶんしょう','ぶちょう',
    'ぶそく','ふたん','ふくすう','ひなんじょ','ばんごう','ばれました','な権利',
    'どくとく','と自然','と栄養','と旅行','で学校','で保障','でんきだい',
    'できますか','てつづ','てってい','づいて判断','ってくれました',
    'ってくれてありがとう','っていきます','ちょっと相談','たんじょうび',
    'せんえん','せますか','せいちょう','せいこう','すごい','じょうげん',
    'じゅぎょう','じゅうねん','じゅうじつ','じつげん','しんせい','しょくじ',
    'しょくご','しゅくだい','しゅうり','しえん','ご注文','こんなん','ぎます',
    'ぎましょう','きんようび','きんかくじ','きたぐち','きく変','が社会',
    'が発表','が発生','が増加','が原因','が不十分','ができました','がします',
    'がありません','かんじ','かくぐんしゅく','お元気','えますね','えいよう',
    'い世代','いりょうひ','いと思','いたしました','いじょう','あたま',
    '避難所','通勤時間','論理的','経済的','現代社会','歴史的','核軍縮',
    '日本国憲法','従業員','小学校','外国人','国際的','十五日','十一時',
    '免疫力','一時間','高齢者','電気代','金閣寺',
    'を見直','を掃除','を徹底','を主張','をしましたか','をおねがいします',
    'をあげましたか','わりますね','わります','わりましたね','わくぐ','れますか',
    'る権利','ると思','りょうこくかん','られますか','らす必要','や文化',
    'も重要','も必要','も大事','めんえきりょく','めなければなりません',
    'めいじじだい','むかし','みんしゅしゅぎ','まりますね','まりますか','ますね',
    'ひよう','ひがい','ねぎを切','な解決','な視点','な根拠','な意見','な人材',
    'なっとう','と長崎','とても面白','とても似合','としました','で散歩',
    'で勉強','でやりましょう','でも楽','できません','できますね','できました',
    'できない問題','ていねい','てあら','つかりました','つお願','つうきんじかん',
    'ってみます','ってしまいました','ってきました','ちりょうほう','ちょきん',
    'ちょうせん','ちゅうしん','ちますね','ちが大事','だいきゅうじょう',
    'たとえ失敗','そう信','ぜんたい','ぜんじんるい','せいてい','する習慣',
    'する可能性','する予定','すてき','すうがく','すいみん','すいしん',
    'じょうたつ','じゅっ','じゅうぎょういん','じぎょう','し頑張','しんじゅく',
    'しんしゅつ','しよう','しょるい','しょとく','しょうひぜい','しょうしょう',
    'しゅと','しゅうちゅう','しましょうか','しで線','しずつ貯金','しくなりますね',
    'しが必要','しがつ','しい政策','しい仕事','しい法律','しい服','しあわ',
    'されました','ごせんえん','こんや','こそだ','こくみんしゅけん','こうつう',
    'げんだいしゃかい','げんそく','げんじつ','げますか','けんしゅう','けますね',
    'けましょう','けてくれてありがとう','けっこう','くなります','くと懐',
    'きゅうそく','きかい','が注目','が来月','が得意','が世界','が一人',
    'がかかりますね','がかかります','がいこくじん','があると思','がありましたね',
    'かんしん','かれました','かります','かつやく','かいふく','かいけつさく',
    'お支払','お寿司','えましたが','えていただけますか','う予定','うしな',
    'いろいろ考','いましょうか','いい考','いい習慣','ありがとうございました','あと少',
    'りたい場合','りたい場合…','いぶんかりかい…',
    // -- Additional verb suffix fragments --
    'りますね','りが近','ります','まります','まりますか','まりますね',
    'えますね','えますか','せます','せますか','げます','げますか',
    'ちます','ちますね','ちますか','けます','けますね','けますか',
    'れますね','れますか','れてしまいました','くなります','くなりました',
    'っていきます','ってきました','ってみます','ってしまいました',
    'ってくれました','ってくれてありがとう',
    'できません','できますね','できました','できますか','できますよ',
    'できない問題',
    // -- Common compound preposition/conjunction fragments --
    'なりますが','なりますが…','するか','するか…','する人','する習慣',
    'する可能性','する予定','する部分','す必要','らす必要',
    'ると思','ると思います','るかもしれません','る権利','る予定',
    'も重要','も必要','も大事','も大切','も残業',
    'に対応','が不可欠','が深刻','が期待','が心配','が急務',
    'が社会','が発表','が発生','が増加','が原因','が不十分',
    'が一番','が注目','が来月','が得意','が世界','が一人',
    'がかかります','がかかりますね','がいこくじん','があると思','がありましたね',
    'な権利','な解決','な視点','な根拠','な意見','な人材',
    'と異文化理解','と人員','と自然','と栄養','と旅行','と長崎',
    'で学校','で保障','で散歩','で勉強','でやりましょう','でも楽','で一番',
    'を検討','を分析','を理解','を説明','を主張','を拝見','を尊重',
    'を見直','を掃除','を徹底','をしましたか','をお持','をもらいましたか',
    'をおねがいします','をあげましたか','をしますか',
    // -- Additional specific tokens seen in audit --
    'ていど','いぶんかりかい','かくだい','じんいん','こうりつ','きょうつう',
    'じんざい','じょじょ','ぶんせき','てんぼう','いっしゅうかん','ていねい',
    'ちょうせん','ちゅうしん','ちりょうほう','ちょきん','ちょっと相談',
    'たんじょうび','せいちょう','せいこう','すごい','せんもんか',
    'しんちょく','しょくじ','しょくご','しゅくだい','しゅうり','しえん',
    'せいてい','する習慣','すてき','すうがく','すいみん','すいしん',
    'じょうたつ','じゅうじつ','じつげん','しんせい','こんなん',
    'こうつう','げんだいしゃかい','げんそく','げんじつ','けんしゅう',
    'けっこう','きゅうそく','きかい','かんしん','かります','かつやく',
    'かいふく','かいけつさく','うしな','そうだん','どりょく',
    'ゆうしゅう','りょうこく','りょうこくかん','ばんごう','ばれました',
    'ふくすう','ふたん','ぶそく','ぶちょう','ぶんしょう','まちが',
    'ひなんじょ','ひよう','ひがい','ねぎを切','むかし','みんしゅしゅぎ',
    'めいじじだい','めんえきりょく','なっとう','どくとく','いっこく',
    'しんじゅく','しんしゅつ','しよう','しょるい','しょとく','しょうひぜい',
    'しょうしょう','しゅと','しゅうちゅう','じぎょう','こそだ','こんや',
    'こくみんしゅけん','げますか','ごせんえん','ろくがつ','わりあい',
    'わくぐ','や文化','へいわしゅぎ','えいよう','いりょうひ','あたま',
    'お元気','お支払','お寿司','けしき','きたぐち','きんかくじ','きんようび',
    'きく変','じょうげん','じゅぎょう','じゅうねん','え方',
    // -- Third batch: all 2+ occurrence tokens --
    'かんれん','しょせき','めします','いつごろ原因',
    'やくわり','せってい',
    '食料品','請求書','被災地','被告側','花火大会','総務省','直感的','発電所',
    '生活費','環境保護','株式市場','松尾芭蕉','最終的','日米同盟','日本国',
    '日曜日','排出量','怪我人','弁護側','平和的解決','工事中','大学生',
    '国際社会','国民主権','卒業論文','十年前','十二時','医療費','労働者',
    '健康的','倫理的','何年生','会議室','今週末','二酸化炭素','二年間',
    '二年生','二割引','両国間','世代間','三千円','七時半','一年間','一万円',
    'レンジで温','リボンもおつけしますか','メールを送','ボールを投',
    'ボランティア活動','ペットが死','パーセントを超','デジタル教育',
    'テレビを見','テレビで見','セールで買','サービスを利用',
    'コミュニケーション不足','ケーキを全部','グローバル化','グッズを準備',
    'インフラ整備','インターネット時代',
    'を間違','を起訴','を解決','を発表','を申請','を特定','を片付',
    'を派遣','を有効','を支持','を提案','を手伝','を復活','を実現',
    'を変更','を報告','を卒業','を区別','を不服','を一日','をひいてしまいました',
    'をご覧','をかけている人','われました','わたくしがご案内','わたくし',
    'わせしましょう','わが社','れませんでした','れますよ','れましたが',
    'れば間','れないでね','れていらいらします','る必要','る可能性',
    'りんしょうしけん','りよう','りょうしゃ','りょうけい','りしましたか',
    'られましたか','らしい経験','よそく','ようそ','ようい','ゆっくり休',
    'ゆしゅつひん','ゆうぼう','ゆうべ','ゆうこう','も設定','も義務','も素敵',
    'も期待','も尊重','も効果的','もっと頑張','もっと自信','もっと勉強',
    'める社会','められますね','められました','めいじん','むらかみ','みんなで考',
    'みなみぐち','まれますね','まれた国','まりましたね','まつおばしょう','まいかい',
    'ほんだな','べんごがわ','べられますか','べてしまいました','へんじ',
    'へいわてきかいけつ','へいきん','ふるいけ','ふめい','ふまん','ふふく',
    'ふとん','ふきん','ふきゅう','びましょうか','びてすっきりしました','びいしき',
    'ひょうげん','ひょうか','ひゃくえん','ひひょうか','ひこくがわ','ばれますよ',
    'ばめん','な量刑','な輸出品','な資産','な証拠','な背景','な美意識',
    'な生活','な情報','な役割','な外交','な作品','なんばん','なんねんせい',
    'なんじかん','なんがつ','なら空','なつめそうせき','ながねん','どくじ',
    'どくしゃ','どうぞ召','と風力','と郵便局','と約束','と礼金','と映画',
    'と文化','と散歩','と意見','とても怖','とても元気','とつぜん','とし物',
    'とうぜん','で開催','で野菜','で遭難','で財布','で罰金','で紛争',
    'で確認','で相談','で洪水','で残業','で東京','で手続','で取材',
    'で予約','で世界','で一時間','でんとうてき','でも面白','でも病院',
    'でも活躍','でも一度','でします','でお寺','て支援','てました',
    'てつがくしゃ','ていきてき','づいた主張','つかれた','って行動',
    'ってもらいました','ってみましょう','ってね','ってあげましょうか',
    'ちょっかんてき','ちょうへんしょうせつ','ちょういん','ちほう','ちしますね',
    'ちします','ちいき','だんらく','だんせい','だけ見','だけでなく',
    'だいいち','たんか','たりを左','たちば','たいわ','たいさく','そんな気',
    'そつぎょうろんぶん','そうむしょう','そうたいてき','そうします','せんねん',
    'せんそう','せんしゅ','せつやく','せだいかん','せいび','せいきゅうしょ',
    'せいかつひ','すれば大丈夫','すれば合格','すると','すばらしい','すうじ',
    'すいようび','すいてい','じんけんそんちょう','じる人','じょせい','じょうこう',
    'じゅうだい','じゅうしょ','じます','じました','じっせいかつ','じっこう',
    'じっか','じた刑罰','じたい','じくらい大切','じきゅうりつ','し回復',
    'しわかります','しりょう','しょうひん','しょうち','しょうげん','しゅよう',
    'しゅうしゅう','しゅうかん','しゃたく','しますよ','しましたが','しつもん',
    'しつない','しちがつ','したかいがありましたね','しぜんしげん','しする予定',
    'しくなりました','しお電話','しい靴下','しい表現','しい薬','しい生活',
    'しい治療法','しい人','しいけど楽','しいお兄','ざんぎょうじかん','さんぽ',
    'さいふ','さいぜん','ご迷惑','ご予約','ごふんご','こんしゅうまつ','こてい',
    'こす予定','ここで写真','こくさいか','こきゃく','こえます','こうへい',
    'こうばん','こうどう','こうとう','こうつうじこ','こうじちゅう','こうこく',
    'こうこうせい','げんてん','げんち','げましょう','げました','けんちく',
    'けんこうてき','ければ便利','けつだん','けしますか','けいこく','く評価',
    'くを輸入','くなりますね','くなりますか','くじを買','ぎりぎり間','ぎました',
    'きんろう','きをします','きょうじゅ','きょういくかいかく','きますよ','きますね',
    'きましょうか','きぼう','きほんげんそく','きな挑戦','きな地震','きな作家',
    'きな事件','きでお願','きじゅん','きく貢献','きかん','きかいきんとう',
    'が逮捕','が責任','が議論','が裁判','が素晴','が目印','が現地','が無事',
    'が満足','が有望','が改善','が大幅','が基本','が可能','が人気','が中心',
    'が不足','が下手','が上昇','がわくわくします','がわかりますか','がります',
    'がなくなる不安','ができます','がつきます','がかかりますが','がいしゅつ',
    'がいいと思','か目印','かんそう','かんぜん','かんせんしょう','かんじょう',
    'かんじゃ','かんきょうほご','かれます','かりますか','かぶしきしじょう',
    'かふん','かてい','かそく','かげつ','かける前','かけますか','かくち',
    'かがくてき','かかりますか','かかります','かいしょう','かいしゅう',
    'かいぎしつ','かいぎ','かあったら連絡','お客様','お大事','おかし',
    'えられました','えましたね','えなければなりませんね','えなければなりません',
    'えてきました','うんよう','うんどう','い記事','い文化','い分野',
    'いを理解','いを断','いを尊重','いを大切','いやりを持','いでんしちりょう',
    'いて十分','いてみましょう','いていましたね','いていました','いていた',
    'いつ結婚','いっぱんてき','いっぱん','いっしょうけんめい','いちまんえん',
    'いちねんかん','いちがつ','いただきます','いくせい','いが大事','いえいえ',
    'いい匂','いい先生','あんぜんほしょうりじかい','あかじ','あいて',
    // -- More fragment patterns --
    'わりました','わりますね','わります','わりましたね','わりましたか',
    'りますね','りが近','りよう','りしましたか','られましたか','られますか',
    'めします','めましたが','めいじん','めいじじだい',
    'せますか','せんねん','せんそう','せんしゅ','せつやく',
    'じます','じました','じる人','じょせい','じょうこう',
    'ぎます','ぎました','ぎましょう','げます','げましょう','げました','げますか',
    'きますよ','きますね','きましょうか','きます',
    'えます','えますね','えますか','えられました','えましたね',
    'できます','できませんね','できますね','できましたか','できてるよ',
    'できる人','できる日','できる方',
    'ちます','ちますね','ちましたか','ちします','ちしますね',
    // -- Batch 4: comprehensive remaining tokens --
    'Just…','and…','claps','eating','finishing','half','hands','iPS細胞',
    'meal','message','nCustomer','nStaff','needed','nみんな','reads','reply',
    'rest','return','store','the','together','あきら','あげます','あしたじゅう',
    'あしもと','あせらないで','あそこです','あそこにありますよ','あたら','あっか','あったら','あつか',
    'あとで片付','あとで連絡','あと何分','あなたを信','あぶら','あまやど','あまり得意','あらゆる差別',
    'あらわ','あるきます','あると思','あんていせい','いいきっかけでしたね','いいたします','いいたしま��','いいと思',
    'いいゆめを','いいよ','いいアイデアが出','いいアドバイスがもらえますよ','いい上司','いい写真','いい変化','いい天気',
    'いい家庭','いい機会','いい決定','いい決断','いい親','いい計画','いかけたが','いかけましたか',
    'いが最','いけんぶん','いこういこう','いご飯','いしけってい','いする予定','いたしましょうか','いたっ',
    'いたと思','いたよ','いた後','いた額','いた���ます','いだす考','いだと感','いちきょくだけうたえます',
    'いちこく','いちごいちえ','いちご味','いちしみん','いちじる','いちねん','いちば','いちまんごせんえん',
    'いっかん','いっさい','いったいか','いっち','いっちょういったん','いっぱいおねがいします','いっぽん','いつかなければなりません',
    'いつか登','いつも助','いつも気遣','いつ可決','いつ帰','いつ日本','いつ桜','いつ返',
    'いていただきました','いています','いている同盟','いてじーんとしました','いてもらえますか','いて三分','いて五分','いて十',
    'いて悲','いて理解','いて目','いて行','いできますか','いで疑','いと批判','いと指摘',
    'いなか','いながら考','いなく','いませんでした','いまちょうど出','いまとめます','いまもひけますか','いま��',
    'いりますか','いりょうせいど','いりょうたいせい','いりょうぶんや','いりょうりんり','いろいろな問題','いろいろな文化','いろいろな経験',
    'いろいろな魅力','いろいろ心配','いろいろ説明','いろがみ','いをしました','いを快','いを直','いを認',
    'いんしょう','いバナナを買','いボタンを押','いポストが目印','い交渉','い仮説','い作家','い判断',
    'い努力','い医療費','い問題','い変化','い女性','い孔雀','い対応','い建物',
    'い怪我','い意志','い教師','い映画','い時間','い条件','い条例','い条約',
    'い熨斗','い眼鏡','い知識','い結果','い計画','い責任','い質問','い道標',
    'い選手','い部屋','い鉛筆','い���す','うかが','うかが大事','うけど','うたしゅう',
    'うった','うと思','うと感','うと著作権','うんきゅう','う努力','う方法','う気持',
    'う約束','う結果','えが一致','えが変','えが見','えざるを得','えしかねます','えすぎだったかも',
    'えすぎてもしかたがない','えた人','えつらんすう','えてあげました','えていただきました','えていません','えておきましょう','えてくれました',
    'えてしまいました','えてみませんか','えてもらいました','えてもらえますか','えて家具','えない価値','えなければ','えばよかったと後悔',
    'えびを除','えましょうか','えますが','えませんでした','えも認','えられます','えられますね','えられません',
    'えるだけで','えると','えると全体','えると違','えるべきだと思','えるスピーチでした','える勇気','える技術',
    'える方法','えんかくいりょう','えんちょう','えんぴつ','おうきゅうがいらい','おうとしたが','おうふく','おうりょう',
    'おおがた','おおて','おおどお','おおも','おおりょう','おげんきでしたか','おしろ','おじゃまします',
    'おせちを食','おとこ','おとず','おばけ屋敷','おみくじも引','おみくじを引','おもちゃを片付','およげますか',
    'おりません','おんせんりょかん','おんど','おんな','お勘定','お医者','お名刺','お手洗',
    'お手紙','お月見','お気持','お気遣','お祖母','お窓際','お花見','お荷物',
    'お返事','お饅頭','かいお茶','かいがいりょこう','かいがんせん','かいぎょう','かいけい','かいけいねんど',
    'かいごぶんや','かいごほけんせいど','かいごりしょく','かいじょう','かいそう','かいたく','かいちゅうでんとう','かいやくきん',
    'かかく','かが説明','かが閉','かき氷','かくご','かくじゅう','かくてい','かくぶしょ',
    'かくぶぶん','かくべつ','かくめい','かくめん','かく切','かけい','かけいぼ','かけつ',
    'かけて指導','かけましょう','かけ中','かご質問','かしい気持','かした仕事','かしましょう','かしゅう',
    'かせました','かぜをひきました','かそちいき','かだけどすごい能力','かち合','かっかざん','かっき','かったと思',
    'かったらコートを着','かってほっとしました','かって嬉','かって歩','かでいい場所','かでん','かという問','かという問題',
    'かないと間','かない部分','かな場所','かな子','かびますね','かぶか','かぶとむし','かめい',
    'かめましょう','かもく','かもしれませんね','かも変','かようび','かりましたね','かれていました','かれて眠',
    'かれて議論','かれましたか','かわず','かんかく','かんきゃく','かんきょうせいさく','かんけいかいぜん','かんけいせい',
    'かんげい','かんこう','かんこうきゃく','かんしんごと','かんせい','かんづめ','かんどう','かんよ',
    'かんわ','か動物','か原因','か対策','か意見','か果物','か楽器','か無罪',
    'か計画','か��す','がSNSで炎上','があった場合','があっても家族','がありませんか','がありませんでした','があると迷',
    'があるようなら休','がいこうかんけい','がいこうてきかいけつ','がいこうもくひょう','がいしょく','がいなくて寂','がいります','がおりました',
    'がお弁当','がかかりました','がかなり違','がかゆくて鼻水','がきっかけでしたね','がくせいしょう','がくもん','がけましょう',
    'がしますか','がずいぶん変','がそう思','がっき','がった人','がっていませんか','がってきましたね','がってくだ��い',
    'がないかぎり','がないと間','がなかなか上達','がなければなりません','がなければ大丈夫','がなければ有罪','がなければ起訴','がもっと上手',
    'がりが早','がりが気','がりましたね','がりますか','がり続','がると','がると駅','がれて困',
    'がれて眠','がわかってきました','がわかりません','がんば','がんばって覚','がんばろう','がスマートフォンで操作','がテレビで報道',
    'がネット上','がベンチャーを買収','が一般的','が不安定','が不明','が不景気','が中心的','が九十九度',
    'が今日','が今月','が任命','が会計年度','が何本','が便利','が保釈','が充実',
    'が全体','が全国','が共存','が判断','が判決','が利息','が制裁','が前年',
    'が効果','が効果的','が十分','が卒業','が協定書','が参加','が収録','が各地',
    'が回復','が国際的','が地域','が変化','が大変','が大好','が大学','が完璧',
    'が実用化','が宿題','が審議','が対立','が専門家','が小学校','が希望','が年々',
    'が強化','が影響','が復旧','が復活','が急増','が急落','が急騰','が悪化',
    'が意識','が感染症','が憲法','が技術','が投下','が担当','が捜査','が捜査中',
    'が控訴','が撤廃','が改正','が救助','が施行','が日本','が日本語','が曖昧',
    'が最優先','が最後','が最適','が本質的','が欠航','が正確','が毎年','が氾濫',
    'が決定的','が派遣','が海外','が混乱','が無難','が特徴','が犯人','が独特',
    'が生態系','が留学','が疑問','が発動','が発行','が発見','が目的','が目立',
    'が相場','が禁止','が第一','が簡単','が結果','が総合的','が義務化','が育休',
    'が自分','が苦手','が衝突','が記者会見','が許可','が認定','が警察','が資料',
    'が連鎖的','が進化','が運休','が運営','が達成','が金利','が開発','が間違',
    'きい丸','きい交番','きい家族','きい建物','きい鍋','きおく','きおん','きがる',
    'きが広','きが心配','きく下','きく報道','きく左右','きく影響','きく異','きげんぎ',
    'きこもりがいると推定','きしょう','きずな','きせいかんわ','きせつ','きそく','きたい','きたらまず顔',
    'きちゅう','きって','きっぽいね','きつえん','きつける書','きているかぎり','きでした','きと伝',
    'きながら勉強','きながら話','きな人','きな価値','きな四字熟語','きな季節','きな時間','きな森',
    'きな科目','きな色','きな論争','きばん','きぶん','きゃくそう','きゃっかんせい','きゃっかんてき',
    'きゅうえん','きゅうかん','きゅうげき','きゅうじつ','きゅうじゅう','きゅうじゅうきゅうど','きゅうとう','きゅうらく',
    'きょういくもんだい','きょうかしょ','きょうしつ','きょうちょう','きょうもがんばろう','きょうりょく','きょくたん','きる習慣',
    'きれいな本','きれいな海','きれいな色','きれいな髪','きればよかった','きろく','きをつけてね','きを加速',
    'きんえん','きんぎょ','きんじょ','きんだいか','きんちょう','きんちょうかん','き方改革','ぎおんご',
    'ぎじゅつかくしん','ぎじゅつきょうりょく','ぎじゅつりょく','ぎじろく','ぎてしまいました','ぎましたか','ぎむか','ぎもん',
    'ぎょうかい','ぎょうむ','ぎりぎりでしたね','くいき','くうかん','くうこう','くお詫','くかえってきてね',
    'くがつ','くしなきゃ','くしましょう','くじゃく','くちべた','くても良','くてドキドキしました','くて新',
    'くで事件','くと突','くなってきました','くなってきましたね','くなりましたね','くろう','くろおび','く宿題',
    'く復興','く犯人','く目的','く習慣','く関係','ぐらい撮','けいえい','けいけんしゃ',
    'けいげん','けいさつ','けいざいこうか','けいざいせいちょう','けいそく','けいねんれっか','けが怖','けた努力',
    'けっこう急','けっこんしき','けっこんしました','けっていてき','けていただいたお礼','けてくれませんか','けてしまいました','けてみませんか',
    'けてもらえますか','けて証拠','けない強靭','けますよ','けません','けられました','けられましたね','けられます',
    'けられますね','けると早','ける力','ける権利','ける能力','ければ買','けを出','けんかしたけど仲直',
    'けんきゅう','けんこうほけんしょう','けんしゅつ','けんしょう','けんせつ','けんぽうじょう','げが増','げが求',
    'げが減少','げつまつ','げつようび','げていましたね','げば間','げますが','げられていましたね','げられました',
    'げられます','げられますか','げるかもしれません','げる必要','げを十','げんきんしゅぎ','げんざい','げんだいごやく',
    'げんどうりょく','こうか','こうがくぶ','こうぎ','こうこう','こうしき','こうじ','こうそくりょく',
    'こうそしん','こうね','こうやく','こうよう','こうりつか','こうりつてき','こうりゅう','こう考',
    'こえますか','こくさいてき','こくせき','こくない','こくみんけんこうほけん','こくれんあんぽり','ここでたばこを吸','ここで諦',
    'こころづよ','ここを押','こだい','こてんぶんがく','こどくかん','こようしゃ','こわいけど','こんかい',
    'こんぶ','こんぽんてき','ごうい','ごおり','ごかい','ごがつ','ごじゅうえん','ごじゅっ',
    'ごぜんちゅう','ごにん','ごねんかん','ごひゃく','ごひゃくえん','ごほん','ごまん','ごまんえん',
    'ごめん','ご不明','ご家族','ご感想','ご説明','ご近所','さいこう','さくや',
    'されましたか','されますか','さんがつ','さんぜん','さんぜんえん','さんも日本語','ざいこぎ','ざいりゅう',
    'ざかな','ざつよう','しいお母','しいけど諦','しいけれど儚','しいといえます','しいところ','しいと思',
    'しいアパートを探','しいサービスを可能','しいスキルを身','しいスタッフを指導','しいスタッフを雇','しいマンガを買','しいルールが適用','しい上司',
    'しい中','しい主張','しい事業','しい傾向','しい先生','しい先輩','しい内容','しい判断',
    'しい制度','しい前提','しい勤務','しい哲学的','しい問題','しい多国間協定','しい大臣','しい定義',
    'しい家','しい小説','しい局面','しい市場','しい年度','しい戦略','しい技術','しい携帯',
    'しい文化','しい未来','しい比喩','しい気持','しい決断','しい法案','しい漢字','しい環境',
    'しい環境政策','しい発想','しい発見','しい目標','しい答','しい練習','しい規制','しい視点',
    'しい貿易条約','しい質問','しい車','しえんきん','しおとコショウもいりますか','しおや','しお願','しかねません',
    'しがつきません','しが大事','しが素晴','しきけいきん','しくありません','しくだけすぎていませんか','しくても諦','しくて泣',
    'しく対応','しく聞','しけんちゅう','しこうりょく','しごとちゅう','しします','しすぎでした','しずつでも必',
    'しずつ変','しずつ慣','しずつ減','しずつ片付','しずつ練習','しずつ覚','しずつ譲','しずつ頑張',
    'しせい','したけど新','したら就職','したら役所','した上','した人','した分','した場合',
    'した後','した美','しだい','しだけ','しだけできます','しだけ読','しちじゅうねん','しちゃくしつ',
    'しっぱい','しつけ','しつれい','していますか','しできます','しないかぎり上手','しないで','しないで休',
    'しないと不安','しない規制','しながら主張','しながら日本語','しなければなりませんね','しなければ解決','しばいぬ','しぶやでおります',
    'しへい','しましたよ','しましま','しみを乗','しめきり','しゃかいこうけん','しゃかいじん','しゃかいふくし',
    'しゃかいもんだい','しゃけ','しゃちょうがやめるらしいよ','しゃない','しゅうかつ','しゅうしんこよう','しゅうぜん','しゅうりょう',
    'しゅうろく','しゅかんてき','しゅくじつ','しゅしょう','しゅだいぶん','しゅだん','しゅちょう','しゅっきん',
    'しゅっしゃ','しゅっせき','しゅっせきしゃ','しゅっぱつ','しゅっぴ','しゅとくりつ','しゅんかん','しょうがく',
    'しょうげんしゃ','しょうこ','しょうしか','しょうせ���','しょうたいじょう','しょうちょう','しょうとつ','しょうめい',
    'しょぎょうむじょう','しょくぎょう','しょくせいかつ','しょくひん','しょくりょう','しょざい','しょり','しょ���せつ',
    'しをしなければなりません','しをします','しを手伝','しを頼','しんがい','しんき','しんぎ','しんくうこう',
    'しんけん','しんじん','しんたいてき','しんど','しんぶんしゃ','しんらい','しんらいかんけい','しんらいせい',
    'しんろ','しんわ','しゴムを使','し不安','し具体的','し安心','し客観的','し時間',
    'し興味','し言葉','し調査','じかんがたりません','じきゅう','じくらい重要','じしょ','じじつ',
    'じっけんけっか','じっしょう','じったいけん','じつようか','じつわ','じている','じて世界','じて多',
    'じて頑張','じどうしゃ','じましたか','じません','じゃないかな','じゅういちがつ','じゅうおく','じゅうがつ',
    'じゅうごふん','じゅうし','じゅうたい','じゅうたく','じゅうたくもんだい','じゅうにさい','じゅうにん','じゅうねんまえ',
    'じゅうみんひょう','じゅうようせい','じゅきゅう','じゅしん','じゅっしゅう','じゅっぷんおくれます','じゅみょう','じゅよう',
    'じゅんかんがたしゃかい','じゅんびきかん','じゆうぼうえき','じょうけん','じょうねつ','じょうほうこうかいせいど','じょうほうろうえい','じょじょうせい',
    'じょじょうてき','じょちょう','じられないほどきれいな景色','じられます','じられません','じられませんね','じんけん','じんどうてきえんじょ',
    'じ間違','すいしつ','すいしつかいぜん','すいせんじょう','すいていむざい','すいぼくが','すうひゃく','すがた',
    'すぎましたね','すぎるという批判','すぐやります','すげー','すごく酸','すずきせんせい','すずめ','すとドアが開',
    'すばらしい景色','すばらしい理念','すばらしい覚悟','すべきだと考','すべてを言葉','すみだがわ','することができます','するしかありません',
    'するとAIも偏','すると思','するど','する不安','する作家','する制度','する国','する影響力',
    'する意識','する批評','する条約','する目標','する社会','する義務','する規制','すればうまくなりますよ',
    'すればかならずできます','すればするほど自信','すればできます','すればよかった','すれば必','すれば慣','すれば成功','すれば誰',
    'す学問','ずいひつぶんがく','ずかしがり屋','ずしも国民','ずつ譲','ずと日本語','ず成功','ず約束',
    'せいかつようしき','せいきゅう','せいげん','せいしょうなごん','せいしんりょく','せいじか','せいべつ','せいめいりんり',
    'せいよう','せかいいち','せかいかくち','せかいちゅう','せっけい','せっしゅ','せっしゅりつ','せっち',
    'せつぶん','せてもらえますか','せますよ','せません','せられます','せるかもしれません','せる普通','せんきゅうひゃくごじゅういちねん',
    'せんきゅうひゃくよんじゅうろくねん','せんけつ','せんこう','せんしんこく','せんねんいじょうまえ','せんぱい','せんべつ','せんもんい',
    'せんもんちしき','せん��い','ぜいりつ','ぜました','ぜます','ぜんきひ','ぜんこく','ぜんこくてき',
    'ぜんご','ぜんぜんできません','ぜんぴん','ぜんりょく','そういう文化','そういてん','そうごうてき','そうしつ',
    'そうしましょう','そうじ','そうじき','そうするね','そうだった','そうだといいね','そうだね','そうだよ',
    'そうば','そがい','そこが難','そこで遊','そざい','そしき','そんざいいぎ','そんちょう',
    'たいいく','たいいくかいけい','たいきょじ','たいけん','たいしゃ','たいしゅうぶんがく','たいしょう','たいせい',
    'たいほじょう','たくさん写真','たくさん勉強','たくさん降','たくましくなります','たこくかん','たこくせき','たこくせききぎょう',
    'たされました','たしましょう','たせしました','たたみ','たちあ','たったら','たったら何','たぬき',
    'たぶんデマだと思','たります','たりを右','たり前','たんご','たんそちゅうりつ','たんだ','た目的',
    'た経験','だいいちだんらく','だいいっかい','だいこくばしら','だいこん','だいじん','だいじ��うぶ','だいせいこう',
    'だいひょう','だいふく','だいぶ慣','だきょうてん','だけでなく海外','だけでなく背景','だけでも数百','だけで判断',
    'だけで有罪','だけなら','だけを信','だけ喜','だけ意見文','だけ買','だっけ','だったかな',
    'だったと思','だという比喩','だと作家','だと考','だと言','だるまを作','だんごを作','だんたい',
    'だんぼう','ちきゅうきぼ','ちください','ちしましょうか','ちたかわかりますか','ちたけど','ちだけで十分','ちてがっかりしました',
    'ちてしまいました','ちでお客','ちますよ','ちませんね','ちゃわん','ちゃんが寝','ちゃんが突然','ちゃんが誕生',
    'ちゅうおうせん','ちゅうき','ちゅうごくご','ちゅうごくじん','ちゅうしゃ','ちゅうしんち','ちゅうしんてき','ちゅうとう',
    'ちゅうりつ','ちょうえき','ちょうきてき','ちょうし','ちょうじょう','ちょうだい','ちょうぶん','ちょくせつてき',
    'ちょしゃ','ちょっとまって','ちょっと待','ちょっと我慢','ちょっと疲','ちょっと頼','ちよだ','ちを伝',
    'ちを教','ちを許','ちを認','ち国民主権','ち時間','ったかを理解','ったとき','ったら家',
    'ったら戻','ったんだ','った世代','った作品','った信用','った再生医療','った前提','った報道',
    'った後','った結論','った賃金','ってあげました','っていい','っていただけますか','っていました','っていましたね',
    'っているかもしれません','っている弁護士','っておきます','ってきてね','ってきてほっとしました','ってきて安心','ってきましたか','ってくだ���い',
    'ってくれませんか','ってみたら','ってみませんか','ってもいい結果','っても著作権','ってスープを飲','って休','って処理',
    'って効率','って寂','って左','って消','って生活','って行','って覚','って説明',
    'って頑張','つい余計','つうち','つお伺','つかっていません','つかりません','つきじ','つきみ',
    'つけましょう','つだけ問題','つまらない仕事','つもありません','つらい','つらぬ','つ作家','つ可能性',
    'づいて考察','づきました','づきましたか','づく作品','づく意思決定','づく提案','ていう名前','ていう映画',
    'ていき','ていきけんしん','ていきましょう','ていきます','ていしゅつきげん','ているか意識','てきせつ','てざわ',
    'てっぱい','てつがくてき','てつだ','てつだいましょうか','てづく','てますか','てますね','てみようよ',
    'ても異常','てれば嬉','てれば幸','てんかん','てんかんき','てんじ','てんねん','て後悔',
    'て支援金','て禁止','て��ださい','であって義務','でお礼','でお祭','でお茶','でお薬',
    'でお金','できたと思','できなくても','できますが','できませんでした','できれいなバラを買','でご飯','でした',
    'でしました','ですか','でたくさん飲','でだしを取','でとても成長','でなく','でなければなりません','でもSNSで情報',
    'でもSNSで連絡','でもない','でもやってみなければわかりません','でもらえますか','でも人気','でも便利','でも保障','でも品質',
    'でも地震','でも失敗','でも好','でも少','でも当','でも役','でも必要','でも応援',
    'でも意見','でも手頃','でも散歩','でも早','でも検索','でも歓迎','でも毒','でも注目',
    'でも活動','でも練習','でも習','でも証拠','でも評価','でも輸出','でも連絡','でも進',
    'でも間違','でも頂上','でも頑張','でんき','でんきじどうしゃ','でんしぶひん','でんとうぶんか','でんわばんごう',
    'でイベントが中止','でエプロンを作','でゴミを拾','でスープを作','でボールを打','でリコーダーを吹','でリズムを作','で三千二百円',
    'で三時間','で不起訴','で二千八百円','で二千円','で人気','で人間','で住所','で住民票',
    'で何時間','で使用','で価値観','で保護','で修理','で停戦協定','で努力','で医療',
    'で口下手','で口座','で各部分','で合意','で同意','で和牛','で哲学','で問題',
    'で困難','で売上','で大丈夫','で大変','で契約','で子供','で平和','で情報格差',
    'で手紙','で挑戦','で料理','で新幹線','で新規','で旅行','で日本語','で映画',
    'で景色','で検討','で検証','で歯磨','で残業時間','で毎日','で渋谷','で玄関',
    'で異常','で発表','で神社','で自分','で著者','で観光','で証言者','で説明',
    'で調停','で転職','で輸入','で連絡','で運転見合','で道徳','で遠回','で雨宿',
    'で頑張','で飛行機','というより寧','という観念','とうか','とうがいしゃ','とうきぼ','とうきょうだいがく',
    'とうけいてき','とうしか','とうじ','とうちゃく','とおっしゃいまし���か','とかい','とくい','とくいりょうり',
    'とくめいせい','としけん','としょかん','としよ','とじょう','とっきょしゅとく','とつながりだと思','とてもいい気持',
    'とてもきれいで','とても優','とても大','とても嬉','とても寒','とても役','とても忙','とても悲',
    'とても感動','とても深','とても満足','とても甘','とても美','とても辛','とても重要','とても難',
    'とても静','とても高','となりました','ともいえますね','ともだちといきます','ともな','とりにく','とんかつを揚',
    'とエネルギー自給','とエネルギー需給','と不安','と京都','と人情','と人権尊重','と人道的','と今後',
    'と併用','と全然','と公園','と判断','と利益','と制度','と労働','と勇気',
    'と半導体','と反対派','と命令','と品質','と喪失','と大衆文学','と学校','と快速',
    'と日本語','と時間','と暖房','と最後','と温泉','と現実','と環境','と目的',
    'と相違点','と確認','と社会','と経済','と若者','と茶色','と証言','と運動',
    'と野党','と食料','と食生活','どうが','どうぞ���','どうとくてき','どう思','どおりでした',
    'どおり進','どもが増','どもでも安全','どもを一人','どもを保育園','どもを塾','どようび','どりょくか',
    'どんでん返','どんな主張','どんな乗','どんな事件','どんな内容','どんな法律','どんな経験','どんな結果',
    'どんな車','なAIを作','ないかく','ないこうてき','ないてい','ないと批判','ない傾向','ながら旅行',
    'なくなる仕事','なく言','なく食','なしで診察','なないろ','なら春','なら暇','なら相談',
    'なら都合','なります','なる国','なれました','なんこ','なんごう','なんさつ','なんだい',
    'なんだん','なんでもありません','なんでも相談','なんとかなりますよ','なんとか折','なんばい','なんびき','なんぷんかかりますか',
    'なんぼん','なんみんすう','なんみんもんだい','なんめい','なアップデートも忘','なアプローチが必要','なガイドラインが必要','なシェフが失敗',
    'なスピーチでした','なデータで説明','な不安','な世界','な事実','な仕事','な会議','な作家',
    'な信頼','な俳人','な値段','な出費','な判断力','な労働','な勉強','な勉強方法',
    'な動植物','な原因','な友達','な命令','な善悪','な報道','な場合','な場所',
    'な大人','な客観性','な対策','な引用','な思想','な思考力','な指輪','な提案',
    'な援助','な時間','な枠組','な歴史','な気象','な決定','な現象','な理由',
    'な生態系','な生物','な発展','な発想','な発言','な目標','な睡眠','な瞬間',
    'な移行','な精神','な精神力','な結果','な結論','な緊張','な見解','な言葉',
    'な計画','な議論','な議題','な責任','な費用','な貿易','な返事','な野菜',
    'な開発','な開発目標','な関係','な電話','にじゅうさんさい','にせん','にひゃく','に旅行',
    'ねが大事','ねぎを炒','ねぎを細','ねっしん','ねんき','ねんしゅう','ねんど','ねんねん',
    'ねんまえ','ねんれい','の先生','はどこですか','ばせますか','ばなかった','ばれますね','ひかく',
    'ひがいしゃ','ひがしぐち','ひごろ','ひだりがわ','ひっこし','ひっす','ひとびと','ひとりぐ',
    'ひとりひとり','ひなんじゅんびをしましょう','ひばくこく','ひまか','ひみつ','ひゃくじゅうきゅうばん','ひゃくまい','ひゃっこ',
    'ひょうめん','ひょうめんてき','ひょうりいったい','ひりつ','ひるま','ひんしつかんり','びじゅつ','びた後',
    'びますね','びも大','びを家族','び住所','ふうせん','ふきそ','ふきゅうりつ','ふくごうてき',
    'ふくし','ふけいき','ふしん','ふそく','ふちゅうい','ふっき','ふっこう','ふへんてき',
    'ふようい','ふりょうひん','ぶかつ','ぶか迷','ぶっかじょうしょう','ぶっきょう','ぶっけん','ぶっしょう',
    'ぶなん','ぶもん','ぶんかてき','ぶんかろん','ぶんべつ','ぶんぽう','ぶ動機','ぶ番号',
    'ぷらが有名','ぷらを揚','へいこう','へいよう','へいわいじ','へんかん','へんしゅうちょう','べさせました',
    'べさせます','べさせられました','べた後','べている','べてくれなかった','べてみます','べてみませんか','べに行',
    'べばよかった','べますね','べますよ','べられます','べると何倍','べる人','べんきょうほうほう','べんとう',
    'べんろん','べ地震','ほいくしせつ','ほいくじょ','ほうこくしょ','ほうせいび','ほうてき','ほうりつ',
    'ほうりつてき','ほけんてきよう','ほしょう','ほっとしました','ほっとしましたね','ほど帰','ほんかく','ほんしつてき',
    'ほんじつ','ほ���','ぼうえい','ぼうえきあいてこく','ぼうえきかんけい','ぼうえきこうしょう','ぼうえきじょうやく','ぼうふう',
    'ぼんおど','まいこ','まいつき','まいりました','まいります','まえて計画','まえました','まえむ',
    'まくら','まされました','ましたよ','ましょうか','ましをセットしましたか','まじで','まずお互','まずくない',
    'まずやってみよう','まず俳句','まず原因','まず問題','まず国民主権','まず季語','まず対策','まず掃除機',
    'まず文章','まず気','まず無駄','まず自分','まず要旨','まず見積','まず許可','まず謝',
    'ませてきました','ませんでした','またこんどお願','またね','また連絡','まったく予想','まったんだ','まっていません',
    'まって困','まっ���ぐ行','まどぎわ','まどぐち','まないなら','まない方','まりました','まれましたね',
    'まれます','まれますか','まれません','まんかい','まんがもよみます','まんげつ','まんじゅう','まんてん',
    'みかんを','みが強化','みが必要','みが進','みが重要','みきわ','みごと','みじか',
    'みちをきいてみましょう','みぢか','みっかぶん','みつけられました','みで問題','みとお','みますね','みやすくてリズム感',
    'みりょく','みりょくてき','みをすべて信','みを取','みんじ','みんなで力','みんなで止','みんなで知恵',
    'みんなで話','みんな応援','みんな意見','むじ���うかん','むだん','むぼう','むりょうそうだん','めいかく',
    'めいじ','めいじじんぐう','めざるをえません','めていません','めてお目','めてお礼','めて使','めて手紙',
    'めて気','めないで','めますね','めようかな','められましたか','められます','められる場面','めると柔',
    'める人','める対策','める必要','める教育','める研修','めんせつ','もありません','もうしました',
    'もう三時','もう食','もお疲','もお金','もが暮','もくげきしゃ','もくようび','もだるい',
    'もっといい仕事','もっと丁寧','もっと効果的','もっと早','もっと気軽','もっと的確','もっと真剣','もっと融通無碍',
    'もない空間','もみじまんじゅうを買','もよろしくお願','もりをお願','もスライドも完成','も一日','も二千字','も人間',
    'も作家','も元気','も創造力','も加速','も反対','も台風','も失敗','も季節',
    'も徹底','も心配','も想像力','も手頃','も改正','も有名','も海外','も炭素中立',
    'も熱心','も花見','も見直','も見習','も転換期','も進出','も閉校','も���歌',
    'やお正月','やお祭','やかな天気','やくだ','やくぶつ','やしき','やしんてき','やちん',
    'やっきょく','やってみなければわかりません','やってみましょう','やっと工事','やっと試験','やっと鍵','やとう','やぬし',
    'やまなか','やまなかしんや','やめる会社','やらない後悔','やります','やり飲','やる気','や交通最適化',
    'や介護','や保育所','や保育施設','や保険','や出典','や台風','や名古屋','や大阪',
    'や存在','や性別','や環境','や看護師','や短歌','や社会','や西田幾多郎','や遠隔医療',
    'や電子部品','や風力','ゆうい','ゆうがた','ゆうごう','ゆうひ','ゆうりょう','ゆかた',
    'ゆきがふります','ゆとり世代','ゆびき','よい習慣','ようぎしゃ','ようけん','よかったかもしれませんね','よく勉強',
    'よく寝','よく考','よく聞','よく見','よく頑張','よけい','よとう','よにん',
    'よほう','よぼうせっしゅ','よりも健康','より流行','よろこ','よろこばれましたか','よろこんでひきうけます','よろし���お願',
    'よんせんごひゃくしゅ','よんせんしゅ','よんひゃく','よんひゃくまんえん','らいかい','らいねんど','らかい響','らかくなりますね',
    'らかくなりますよ','らかな主題文','らざるをえません','らしい先生','らしい取','らしい姿勢','らしい発見','らしい習慣',
    'らしい進歩','らしが多','らしが生','らしましょう','らすかが課題','らす取','らず世界','らせてしまいました',
    'らないと思','らない番号','らなくなりましたね','られた作品','られてしまいました','られてずぶ濡','られて信','られて腹',
    'られて���ますか','られなくなるよ','られなければならない','られます','りある資源','りが好','りが明日','りくつ',
    'りしなければなりません','りしました','りしましょう','りしますか','りせいてき','りそう','りたたみ傘','りっぱ',
    'りて左','りて戻','りでお願','りで踊','りない','りないと思','りない場合','りなくて困',
    'りましたよ','りましょうか','りますよ','りませんでした','りや温泉','りゅうがく','りょうしん','りょうとうじしゃ',
    'りょうりしますか','りょうりつ','りようしゃ','りをしました','りをします','りをなくす必要','りを延','りを持',
    'りを見','りを踊','りんごが好','りんごを','りんごを三','りんりいいんかい','るかが重要','ることが大切',
    'るときれいな景色','ると早','ると速','る主題','る勇気','る映画','る時間','る様子',
    'る法律','れいがい','れいきん','れいぎ','れいぎただ','れいたしかねます','れいねん','れいぼう',
    'れかも','れが出','れが少','れが必要','れが感','れきししょ','れすぎました','れたなあ',
    'れた布巾','れた理由','れていても休','れてきました','れてました','れてもらえますか','れてイライラします','れないで',
    'ればよかったと後悔','れば可能性','れましょうか','れませんでしたか','れませんね','れるという予測','れると思','れると直',
    'れれば楽','れを感','れんしゅうすれば','れんらく','れ対策','ろうえいじけん','ろうえいじこ','ろうきゅうか',
    'ろうどうしゃ','ろくじゅう','ろくじゅうねん','ろっこ','わいてるよ','わかった','わかってるけど','わぎゅう',
    'わくわくしますね','わされました','わしょく','わず参加','わせました','わせましょう','わせます','わったら飲',
    'わった後','わなきゃ','わなければなりません','わなければよかった','わば日本','わりをお願','われた','われた組織',
    'われて恥','われます','われる危険','をあきらめません','をいただきました','をいただけますか','をおかけし','をおかけしました',
    'をおろします','をお伝','をお出','をお渡','をお��','をかけてくれてありがとう','をかけてしまいました','をかけて大丈夫',
    'をかけて決','をかけます','をかけられて驚','をかぶりましょう','をご用意','をたくさん学','をたたみましょう','をついた',
    'をつかみましょう','をつかむ練習','をつかれて悲','をつけて','をつけなければなりません','をつけなければなりませんね','をつける権利','をとりましょう',
    'をなくしました','をなくす努力','をひきました','をまとめます','をもたらすかもしれません','をもって本日','をもっと強','をもらいました',
    'をやめたけど','をよく読','をチェックしますね','をドライヤーで乾','をメールで送','を一度','を一本','を一枚',
    'を三日分','を上座','を世界','を中東','を予約','を二十八度','を交換','を交番',
    'を人格化','を人間','を代表','を体系','を体験','を何個','を何冊','を作成',
    'を便利','を保存','を優先','を先生','を克服','を入力','を冷蔵庫','を判断',
    'を制限','を助長','を参照','を四捨五入','を固定','を多角的','を大事','を実施',
    'を封筒','を専攻','を小説','を展開','を山田','を引用','を心配','を応援',
    'を怪我','を意味','を意識','を手帳','を承認','を投稿','を提出','を料理',
    'を明確','を有機的','を検品','を注文','を準備','を無視','を発信','を発動',
    'を百個','を積極的','を策定','を納品','を終了','を行使','を裏切','を見極',
    'を計測','を計画','を記入','を診察','を論理的','を輸入','を輸出','を運転',
    'を選別','を部屋','を開拓','を電子','んでいた','んでいると景色','んでくだ���い','んでくれますか',
    'んでしまいました','んでもらえますか','んでも新','んで内容','んで輸入品','アジア市場','アジア経済圏','アセスメントが必要',
    'アニメを見','アプリで練習','アマゾンで本','アンケート調査','イノベーションを阻害','インターネットで情報','インターネットで調','インターネット情報',
    'エアコンが必要','エアコンを付','エネを心','エネルギー効率','エネルギー自給率','エネ意識','エネ技術','エレベーターが故障',
    'オリンピックが楽','オリンピックを開催','オーバーで','カニセットがよろこばれますよ','カメラが多','カメラが特','カレーが作','カードで払',
    'ガスが原因','ガスを減','ガソリン代','キャップとラベルを外','キャリアアップをめざす人','キロくらい走','クリーニング代','グラフが人口',
    'グローバルな課題','コストが上昇','コストが高','コストも下','コストも削減','コストを抑','コスト削減','コミュニケーションが大事',
    'コロナ以降','コーチが選手','コートを着','コーヒーをお願','サイズで','サインをお願','サービスを受','サービスを見',
    'サービス産業','シェア拡大','シャワーをあびます','シュノーケリングもしました','シールだ','ジャズが好','スケジュールも遅','スケジュールを確認',
    'スタイルを変','スタイルを心','ステルスマーケティングという問題','スミスです','スリッパを借','スープが熱','スープをつくりますか','セキュリティー対策',
    'セーフティネットが重要','ゼロが目標','ゼロ金利','タオルを濡','ダンスが上手','チケットかっとく','チョコを買','チョコレートをあげました',
    'チョコレートをかいましたか','チーズ','チームも派遣','テクノロジーが生活','テストがあるとおっしゃいました','テストがあると言','テニスが得意','テレビで取',
    'テレビも新聞','テレビを消','デジタルデバイドが高齢者','デジタル教室','デビュー作','デーを設','データで証明','トキやイリオモテヤマネコが有名',
    'トヨタやホンダが有名','ドアが開','ドアを閉','ドキュメンタリー番組','ドライヤーで髪','ネット上','ハプニングがあるかもしれませんね','ハムスターを飼',
    'バス乗','バターで炒','バックアップも重要','バランスが大事','バランスが難','パスポートを見','パスワードを定期的','パスワードを忘',
    'パスワード管理','パソコンを直','パターンがわかりますね','パターンが見','パネルをつけました','パーセント以上','パーセント削減','パーセント割引',
    'パーセント増','パーセント増加','パーセント綿','パーティーで彼女','パートで働','ビールが冷','ピアノを弾','ピアノを練習',
    'フィギュアを集','フリー素材','ブラックでお願','ブラックボックス化','プログラムを行','プロジェクトが大成功','プロジェクトを進','プールで泳',
    'ペンを','ペンを二本','ペンを持','ページを開','ページ三','ホテルを予約','ボウルで混','ボタンを押',
    'ボランティア団体','ポッキーが好','マイバッグを持','マスクも効果','マッサージしましょうか','マットを買','マネーでお願','マネーも使',
    'ミスが多','メートル泳','メールを送信','ラクな服','ラジオ体操','ランチセットBをお願','ラーメンをおねがいします','ラーメンを一',
    'リサです','リスクもある','リスクも高','リスクを最小限','リストを作','リズムを整','リターンが大','リターンも大',
    'リテラシーが大事','リテラシーを高','リテラシー教育','ルールを守','レポートを書','ロックが好','ワークライフバランスが大事','ワークライフバランスが重要',
    '一万五千円','一人一人','一人暮','一市民','一期一会','一生懸命','七十年','三十二度',
    '三十五度','三十代','三番線','上野動物園','不用意','不良品','世界各地','世界最大',
    '世界的','世界経済','世論調査','両当事者','中国人','中国語','中央線','予防接種',
    '二十三日','二十三歳','二十五','二十五万円','二十五歳','二十八度','二十八日','二千万人',
    '二名様','二時間','二時間半','二段階','二段階認証','二百年','五万円','五十円',
    '五千円','五年間','五百円','交通事故','人権尊重','介護保険制度','介護分野','介護離職',
    '仕事中','伝統文化','住宅問題','体育会系','保険適用','信頼関係','倫理委員会','健康保険証',
    '入居者','全国的','八時半','六十年','内向的','冷蔵庫','出席者','出産予定',
    '前期比','労働改革','動物園','募金活動','北海道','医療体制','匿名性','十一月',
    '十一歳','十二時間','十二歳','十五分','十五歳','千九百四十六年','千代田','千八百円',
    '午前中','参加者','取得率','古典文学','各部署','品質管理','四十人','四千五百首',
    '四百万円','国際情勢','国際紛争','土曜日','夏目漱石','外交的解決','外交関係','外国人労働者',
    '多国籍企業','多国間','孤独感','学生証','安全保障理事会','定期検診','定期的','実体験',
    '実名制…','実験結果','客観的','家計簿','少子化','少子化対策','就職活動','山中伸弥',
    '山手線','工学部','差別化','常任理事国','平和維持','平家物語','当該者','得意料理',
    '循環型社会','応���','情報公開制度','情報漏洩','感染症','懐中電灯','批評家','技術力',
    '技術協力','技術革新','投資家','控訴審','推定無罪','擬音語','政治家','政治的',
    '教育予算','教育改革','文化的','文化論','新空港','新聞社','日本三景','日本企業',
    '日本各地','日本国内','日本国民','日本政府','日本文化','日本料理','日本旅行','日本最古',
    '日本的','日本製','日本語','日本語学習','日本語能力','日本語能力試験','日本銀行','日米安保条約',
    '日米関係','日経平均','明後日','明日中','明治時代','明治神宮','普及率','普遍的',
    '最低賃金','最大規模','期限切','来年度','東野圭吾','検察側','残業時間','毎日書',
    '民主主義','水彩画','水曜日','水質改善','水道水','法律的','法整備','活火山',
    '海外旅行','消費税','清少納言','温泉旅館','準備期間','漏洩事故','火曜日','災害救援',
    '無料相談','物価上昇','特許取得','現代語訳','現金主義','理性的','生命倫理','生産性',
    '産業界','産業開発','男女平等','発想力','登記簿','百万人','目撃者','直接的',
    '相互依存','知的財産','研究開発','社会的','社会福祉','社会貢献','第一段落','第九条',
    '管理人','紫式部','終身雇用','経年劣化','経済効果','経済外交','経済学','経済成長',
    '結婚式','統計的','老朽化','脳科学','臓器提供者','臨床試験','自動券売機','自動販売機',
    '自動車','自動運転','自然資源','興味深','若者交流','表面的','被災者','裁判員制度',
    '製造業','複合的','規制緩和','観光客','解約金','言��','試着室','試験中',
    '諸行無常','議事録','費を差','貿易交渉','貿易関係','賛成派','近代化','運動会',
    '過疎地域','達成可能','遺伝子治療','野心的','金曜日','鈴木先生','長期的','関係性',
    '関係改善','防災訓練','隅田川','雇用者','難民認定率','電気自動車','電話詐欺','高校生',
    '高等裁判所','（あける）','��くひん','��ゅうまつ','��ゅじんこう','��んじょう','��千年以上前','��撮',
    '��立','��選','��題','���ぜん','���てんぶんがく','���れました','���んらく','���上',
    '���書','���本文学',
    // -- Batch 5: final 10 residual tokens --
    'iPS細胞','でもSNSで情報','がSNSで炎上','実名制','じつめいせい','を強化','すべきだという見解',
    'なAIを作','nStaff','nCustomer','browse','begins','するとAIも偏','ランチセットBをお願',
    'でもSNSで連絡','Just',
    // -- Batch 6: stage-direction English words and final fragments --
    'Staff','Customer','Entering','Everyone','and','claps','hands','eating','together',
    'begins','finishing','half','rest','return','reads','message','meal','the',
    'SNSで情報','SNSで炎上','SNSで連絡','AIを作','AIも偏','でもSNSで','がSNSで',
    'なAIを作','するとAIも偏','でもSNSで情報','がSNSで炎上','でもSNSで連絡',
    'ランチセットBをお願',
    // -- Batch 7: lowercase English stage-direction words + remaining compound SNS/AI tokens --
    'just','staff','customer','entering','everyone','claps','hands','and','begins','eating',
    'together','finishing','half','rest','return','reads','message','meal','the','store',
    'reply','needed','browse','iPS細胞',
    // SNS and AI compound tokens (appear after カタカナ context)
    'SNSで情報','SNSで炎上','SNSで連絡','でもSNSで情報','がSNSで炎上','でもSNSで連絡',
    'なAIを作','するとAIも偏','ランチセットBをお願',
    // Additional common compound context patterns that the tokenizer produces
    'でもSNSで','がSNSで','AIを作','AIも偏','ランチセットBを',
    // -- Batch 8: lowercase ASCII-containing compound tokens (stopwords.has uses t.toLowerCase()) --
    'でもsnsで情報','がsnsで炎上','でもsnsで連絡','snsで情報','snsで炎上','snsで連絡',
    'なaiを作','するとaiも偏','ips細胞','ランチセットbをお願','aiを作','aiも偏',
    'バイアスのなaiを作',
  ]),
  'ko': new Set([
