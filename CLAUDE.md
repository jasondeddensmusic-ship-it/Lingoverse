...
**Validator state (2026-04-24 — extended session):** Extended cleanup continued through PR #551. Additional milestones: (1) Japanese template notes ZEROED — 192 "JLPT N2/N1 level vocabulary" template notes across batch9+batch10 u25-u36 replaced with specific hanja breakdowns. (2) Mojibake cleanup — 30+ UTF-8 replacement characters (��) fixed across Japanese/Korean/Spanish unit files and Dutch foundations. (3) POS corrections — 400+ miscategorized teach cards corrected (Dutch 180+, Spanish 168, French 47 across numerals, past participles, conditional/subjunctive verbs, adverbs, pronouns, articles, colors, adjectives, months, proper noun genders). Runtime validator: 0 violations sustained throughout.
